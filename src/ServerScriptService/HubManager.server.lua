...
local function setQueuePhase(player, modeId)
	...
	HubState:FireClient(player, { phase = "queue", modeId = modeId, modeLabel = getModeLabel() })
end

local function clearQueuePhase(player)
...
hub.portalPrompt.Triggered:Connect(function(player)
	joinQueue(player, MatchmakingService.getSuggestedMode())
end)
...
HubService.register({
	...
	clearQueuePhase = clearQueuePhase,
