...
MatchmakingService.setOnMatchReady(function(playerList)
	for _, queuedPlayer in playerList do
		if queuedPlayer.Parent and playerPhase[queuedPlayer] == "hub" then
			leaveHubForArena(queuedPlayer)
		end
	end
end)
...
print("[HubManager] 3D Hub ready — walk to Arena Portal or mode pads to queue")
