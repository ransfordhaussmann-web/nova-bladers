...
local function getActiveModeId()
	return MatchModes.getDefaultModeForPlayerCount(#Players:GetPlayers()).id
end

local function getModeLabel()
	local mode = MatchModes.getDefaultModeForPlayerCount(#Players:GetPlayers())
...
MatchReady.Event:Connect(function(_modeId, roster)
