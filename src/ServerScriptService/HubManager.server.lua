...
MatchmakingService.start({
	getQuickMatchMode = getActiveModeId,
	isPlayerAvailable = function(player)
		return playerPhase[player] == "hub"
	end,
	onMatchReady = function(readyPlayers)
...
print("[HubManager] 3D Hub ready — Mode-Pads oder Quick Match für Warteschlange")
