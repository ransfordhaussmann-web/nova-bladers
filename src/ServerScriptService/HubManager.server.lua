...
local function getModeLabel()
	...
	return "Modus: " .. (config and config.label or modeId)
end
...
HubService.register({
	...
	getPhase = getPhase,
	onPlayerQueued = setPlayerQueued,
...
print("[HubManager] 3D Hub ready — use Mode Pads or Matchmaking Portal to queue")
