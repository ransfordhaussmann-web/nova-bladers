...
local function getActiveModeId()
	...
	return MatchModes.getDefaultForPlayerCount(count).id
end

local function getModeLabel()
	return "Modus: " .. MatchModes.getDefaultForPlayerCount(#Players:GetPlayers()).label
end
...
MatchmakingService.start({
	...
	onPlayerQueuedForArena = leaveHubForArena,
})
