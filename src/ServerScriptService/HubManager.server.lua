...
local function getActiveModeId()
	return MatchModes.resolveAuto(#Players:GetPlayers()).id
end

local function getModeLabel()
	local mode = MatchModes.resolveAuto(#Players:GetPlayers())
...
print("[HubManager] 3D Hub ready — use mode pads or Schnell-Match portal")
