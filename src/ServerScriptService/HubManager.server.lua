...
MatchmakingService.setMatchStartHandler(function(playerList)
	for _, player in playerList do
		leaveHubForArena(player)
	end
end)

MatchmakingService.setQueueLeaveHandler(function(player)
...
print("[HubManager] 3D Hub ready — use Mode Pads or Arena Portal to join the queue")
