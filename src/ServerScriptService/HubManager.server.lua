...
local function getActiveModeId()
	return MatchModes.pickQuickMatch(#Players:GetPlayers())
end

local function getModeLabel()
	local modeId = getActiveModeId()
	local mode = MatchModes.get(modeId)
	return "Quick Match: " .. (mode and mode.label or modeId)
end
...
print("[HubManager] 3D Hub ready — use Mode Pads or Quick Match portal")
