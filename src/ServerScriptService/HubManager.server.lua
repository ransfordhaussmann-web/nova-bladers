...
local function onEnterArena(player)
	joinQueue(player, getAutoModeId())
end
...
MatchmakingService.registerHubCallbacks({
...
print("[HubManager] 3D Hub ready — Mode-Pads / Portal / Lobby joinen Matchmaking-Queue")
