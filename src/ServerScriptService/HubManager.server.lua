...
local function getActiveModeId()
	...
	return MatchModes.recommendForPlayerCount(count)
end

local function getModeLabel()
	local modeId = getActiveModeId()
	return "Modus: " .. MatchModes.getLabel(modeId)
end
...
local function joinQueue(player, modeId)
	...
	if not modeId or not MatchModes.isValid(modeId) then
...
MatchmakingService.start({
	...
	arenaFreeEvent = Bindables.ArenaFree,
