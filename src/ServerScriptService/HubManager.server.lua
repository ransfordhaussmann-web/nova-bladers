...
local function getActiveModeId()
	return MatchmakingBridge.getRecommendedModeId()
end
...
local function onEnterArena(player)
	...
	enterQueue(player, MatchmakingBridge.getRecommendedModeId())
end

MatchmakingBridge.registerMatchReady(function(players, modeId)
...
MatchmakingBridge.registerLeaveQueue(function(player)
