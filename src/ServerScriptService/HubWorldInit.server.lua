...
if not ServerScriptService:FindFirstChild("ArenaEntryRequest") then
	local arenaEntry = Instance.new("BindableEvent")
	arenaEntry.Name = "ArenaEntryRequest"
	arenaEntry.Parent = ServerScriptService
end
...
remotes.EnterArena.OnServerEvent:Connect(function(player)
	...
	local arenaEntry = ServerScriptService:FindFirstChild("ArenaEntryRequest")
	if arenaEntry then
		arenaEntry:Fire(player)
	end
end)
