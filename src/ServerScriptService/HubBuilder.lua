...
local function addModePad(parent, hubOrigin, padConfig)
	...
	padPrompt.Name = "QueuePrompt"
	padPrompt.ActionText = "Queue beitreten"
	padPrompt.ObjectText = padConfig.label
	padPrompt.KeyboardKeyCode = Enum.KeyCode.E
...
function HubBuilder.build()
	...
	portalPrompt.ObjectText = "Nova Arena (FFA)"
