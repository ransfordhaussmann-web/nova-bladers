...
Bindables.MatchReady.Event:Connect(function(matchInfo)
	if typeof(matchInfo) ~= "table" or typeof(matchInfo.players) ~= "table" then
		return
	end
	beginMatch(matchInfo.players, matchInfo.mode)
end)
