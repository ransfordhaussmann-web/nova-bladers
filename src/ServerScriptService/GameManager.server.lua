...
MatchQueue.init(Remotes, { QUEUE_MAX_WAIT = require(ReplicatedStorage.NovaBladers.HubConfig).QUEUE_MAX_WAIT })
MatchQueue.setOnMatchReady(function(players, _mode)
...
Bindables.EnterArena.Event:Connect(function(player)
	-- Queue join is handled in HubManager; keep bindable for compatibility.
