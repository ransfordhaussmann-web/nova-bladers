...
local function onMatchReady(_modeId, playerList)
...
MatchmakingService.setArenaBusyCheck(function()
	return state.phase ~= MatchPhase.Idle and state.phase ~= MatchPhase.Ended
end)
