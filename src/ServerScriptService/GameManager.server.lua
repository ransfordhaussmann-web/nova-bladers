...
local function cleanupMatch()
	...
	MatchmakingManager.setMatchActive(false)
	ArenaBuilder.hide()
end
...
local function beginMatch(playerList)
	MatchmakingManager.setMatchActive(true)
...
-- Legacy bindable: portal / fallback button route through queue
