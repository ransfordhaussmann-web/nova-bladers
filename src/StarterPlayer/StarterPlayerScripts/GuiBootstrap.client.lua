...
if not playerGui:FindFirstChild("Lobby") then
	...
	queueLabel.Position = UDim2.fromOffset(8, 94)
	...
	queueLabel.Text = "Modus-Pad oder Portal nutzen."
	queueLabel.Parent = panel

	local startBtn = Instance.new("TextButton")
	startBtn.Name = "StartButton"
	startBtn.Size = UDim2.fromOffset(120, 28)
	startBtn.Position = UDim2.fromOffset(8, 134)
	...
	leaveQueueBtn.Position = UDim2.fromOffset(132, 134)
	leaveQueueBtn.BackgroundColor3 = Color3.fromRGB(80, 80, 95)
	...
	lb.Position = UDim2.fromOffset(8, 168)
