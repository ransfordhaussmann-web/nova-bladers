...
if not playerGui:FindFirstChild("MatchmakingQueue") then
	...
	queuePanel.Size = UDim2.fromOffset(320, 96)
	...
	modeLabel.Text = "Matchmaking"
	modeLabel.Parent = queuePanel
	...
	leaveBtn.Size = UDim2.fromOffset(110, 24)
	leaveBtn.Position = UDim2.new(1, -118, 1, -32)
