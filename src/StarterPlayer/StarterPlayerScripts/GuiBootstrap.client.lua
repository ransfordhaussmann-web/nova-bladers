...
if not playerGui:FindFirstChild("Matchmaking") then
	local queueGui = Instance.new("ScreenGui")
	queueGui.Name = "Matchmaking"
	...
	queuePanel.Size = UDim2.fromOffset(240, 150)
	queuePanel.Position = UDim2.new(0.5, -120, 1, -170)
	...
	queueTitle.Size = UDim2.new(1, -16, 0, 22)
	...
	queueStatus.Size = UDim2.new(1, -16, 0, 56)
	...
	queuePlayers.Size = UDim2.new(1, -16, 0, 48)
	queuePlayers.Position = UDim2.fromOffset(8, 88)
