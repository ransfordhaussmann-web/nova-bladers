...
if not playerGui:FindFirstChild("Lobby") then
	...
	queueLabel.TextColor3 = Color3.fromRGB(180, 220, 255)
	...
	startBtn.Position = UDim2.fromOffset(8, 128)
	startBtn.BackgroundColor3 = Color3.fromRGB(60, 120, 255)
	startBtn.Font = Enum.Font.GothamBold
	startBtn.TextSize = 13
	startBtn.TextColor3 = Color3.new(1, 1, 1)
	startBtn.Text = "Queue (Fallback)"
	...
	leaveQueueBtn.Position = UDim2.fromOffset(136, 128)
	leaveQueueBtn.BackgroundColor3 = Color3.fromRGB(90, 50, 60)
