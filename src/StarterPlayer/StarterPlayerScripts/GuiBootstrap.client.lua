...
if not playerGui:FindFirstChild("MatchmakingQueue") then
	...
	queuePanel.Size = UDim2.fromOffset(280, 96)
	queuePanel.Position = UDim2.new(0.5, -140, 0, 12)
	...
	leaveBtn.Position = UDim2.new(1, -108, 1, -32)
