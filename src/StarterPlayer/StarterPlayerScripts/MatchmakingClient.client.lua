...
local function formatStatus(payload)
	...
	elseif payload.queued and payload.minPlayers and payload.queued < payload.minPlayers then
...
Remotes.QueueUpdate.OnClientEvent:Connect(function(payload)
	...
	title.Text = payload.pending and "Warteschlange (ausstehend)" or "Warteschlange"
