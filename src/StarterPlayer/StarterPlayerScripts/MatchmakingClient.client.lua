...
local function formatStatus(payload)
	...
	elseif payload.status == "starting" and payload.fillSecondsLeft then
		table.insert(lines, string.format("Start in %ds (mehr Spieler können joinen)", payload.fillSecondsLeft))
	elseif payload.playersInQueue < payload.minPlayers then
		table.insert(lines, string.format("Noch %d Spieler nötig", payload.minPlayers - payload.playersInQueue))
	else
