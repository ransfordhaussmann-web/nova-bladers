...
local function formatStatus(payload)
	...
	if payload.minPlayers and payload.minPlayers > 1 and (payload.count or 0) < payload.minPlayers then
		countText = countText .. string.format(" (mind. %d)", payload.minPlayers)
	end
	return string.format("%s\n%s", payload.modeLabel or "Arena", countText)
end
...
Remotes.QueueUpdate.OnClientEvent:Connect(function(payload)
	...
	title.Text = if payload.status == "pending" then "Warteschlange (vorgemerkt)" else "Warteschlange"
