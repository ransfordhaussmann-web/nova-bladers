...
local function formatStatus(payload)
	local lines = {
		...
		string.format("%d / %d Spieler", payload.playersInQueue or 0, payload.maxPlayers or payload.playersNeeded or 1),
	}
	if payload.statusMessage then
		table.insert(lines, payload.statusMessage)
	end
