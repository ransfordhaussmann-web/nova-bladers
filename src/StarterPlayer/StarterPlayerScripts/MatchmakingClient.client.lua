...
local function formatStatus(payload)
	...
	local lines = {
		string.format("%s — %d/%d Spieler", payload.modeLabel, payload.queueSize, payload.minPlayers),
	}

	if payload.fillSeconds then
		table.insert(lines, string.format("Start in %ds (max. %d)", payload.fillSeconds, payload.maxPlayers))
	else
