...
leaveBtn.Position = UDim2.new(0.5, -60, 1, -38)
...
local function showQueue(payload)
	...
	local pendingText = payload.pending and "\n⏳ Arena belegt — warte..." or ""
	title.Text = payload.modeLabel .. " Queue"
	status.Text = string.format(
		"%d / %d Spieler\n%s%s",
		payload.count,
		payload.maxPlayers,
		formatPlayerList(payload.players),
		pendingText
	)
end
