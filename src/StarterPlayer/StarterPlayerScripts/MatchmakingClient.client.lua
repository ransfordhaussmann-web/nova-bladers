...
local function formatStatus(payload)
	...
	local lines = {
		...
		string.format("Spieler: %d / %d", payload.queueSize or 0, payload.minPlayers or 1),
	}
	...
	elseif payload.fillTimeout then
		table.insert(lines, string.format("Start nach %ds bei genug Spielern", payload.fillTimeout))
	end
