...
local function formatStatus(payload)
	...
	if payload.status == "matchFound" then
		return string.format("%s — Match gefunden!", payload.modeLabel)
	end
	return string.format(
		"%s — Suche Gegner...\n%d / %d Spieler",
		payload.modeLabel,
...
Remotes.QueueUpdate.OnClientEvent:Connect(function(payload)
	...
	gui.Enabled = true
	title.Text = if payload.status == "pending" then "Warteschlange (ausstehend)" else "Warteschlange"
