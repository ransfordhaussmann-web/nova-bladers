...
local function formatStatus(payload)
	...
	local lines = {
		string.format("%s — %d/%d Spieler", payload.modeLabel or "Queue", payload.queueSize or 0, payload.maxPlayers or 1),
	}
...
Remotes.QueueUpdate.OnClientEvent:Connect(function(payload)
	...
	gui.Enabled = true
	title.Text = payload.status == "pending" and "Match bereit" or "Warteschlange"
