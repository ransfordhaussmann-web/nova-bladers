...
local function formatStatus(payload)
	...
	local lines = {
		...
		string.format("Spieler: %d / %d", payload.playersInQueue or 0, payload.playersNeeded or 0),
	}
	...
	elseif payload.maxPlayers and payload.maxPlayers > payload.playersNeeded then
...
Remotes.QueueUpdate.OnClientEvent:Connect(function(payload)
	...
	title.Text = payload.status == "pending" and "Warteschlange (ausstehend)" or "Warteschlange"
	status.Text = text
	gui.Enabled = true
end)
