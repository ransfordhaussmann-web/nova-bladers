...
local function formatStatus(payload)
	...
	if payload.count and payload.minPlayers and payload.maxPlayers then
		table.insert(lines, string.format("Spieler: %d / %d–%d", payload.count, payload.minPlayers, payload.maxPlayers))
	end
