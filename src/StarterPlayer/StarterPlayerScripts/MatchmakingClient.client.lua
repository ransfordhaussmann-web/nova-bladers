...
local function statusText(payload)
	if payload.status == "pending" then
		return "Arena belegt — wartet auf freien Slot..."
	end
	...
	if payload.modeId == "ffa" and payload.fillTimeLeft and payload.fillTimeLeft > 0 then
		return base .. string.format("\nStart in %ds (oder bei %d Spielern)", payload.fillTimeLeft, payload.maxPlayers or 6)
	end
