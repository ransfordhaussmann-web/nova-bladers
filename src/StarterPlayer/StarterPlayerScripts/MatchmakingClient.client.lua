...
local function formatStatus(payload)
	...
	elseif payload.fillRemaining and payload.fillRemaining > 0 then
		table.insert(lines, string.format("Start in %ds (Plätze offen)", payload.fillRemaining))
	else
		table.insert(lines, string.format("Platz %d in der Warteschlange", payload.position))
	end
