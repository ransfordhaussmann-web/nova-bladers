...
leaveBtn.Position = UDim2.fromOffset(8, 108)
...
local function showQueue(payload)
	...
	local lines = {
		string.format("%d / %d Spieler", payload.count or 0, payload.maxPlayers or 1),
		payload.desc or "",
	}

	if payload.arenaBusy and payload.pending then
		table.insert(lines, "Arena belegt — warte auf freies Match...")
	elseif payload.modeId == "ffa" and payload.count >= (payload.minPlayers or 3) and payload.fillTimeout then
