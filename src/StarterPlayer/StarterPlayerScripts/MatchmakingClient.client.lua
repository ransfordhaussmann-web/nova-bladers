...
local function formatStatus(payload)
	...
	elseif payload.playersInQueue and payload.playersNeeded and payload.playersInQueue < payload.playersNeeded then
		table.insert(lines, string.format("Noch %d Spieler nötig", payload.playersNeeded - payload.playersInQueue))
	else
