...
local queueGui = gui:FindFirstChild("MatchmakingQueue")
if not queueGui then
	...
	leaveBtn.Position = UDim2.fromOffset(8, 72)
	leaveBtn.BackgroundColor3 = Color3.fromRGB(200, 70, 70)
...
Remotes.QueueUpdate.OnClientEvent:Connect(function(payload)
	...
	panel.Title.Text = "In Warteschlange"
