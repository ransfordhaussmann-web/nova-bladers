...
local function showQueue(payload)
	...
	if payload.status == "pending" then
		status.Text = "Match bereit — warte auf freie Arena..."
	elseif payload.modeId == "ffa" and payload.fillSecondsLeft then
...
Remotes.QueueUpdate.OnClientEvent:Connect(function(payload)
	if not payload or payload.status == "left" or payload.inQueue ~= true then
		hideQueue()
		return
	end
	showQueue(payload)
