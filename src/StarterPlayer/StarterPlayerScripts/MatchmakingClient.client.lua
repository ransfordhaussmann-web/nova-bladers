...
status.Name = "Status"
status.Size = UDim2.new(1, -108, 0, 40)
...
leaveButton.Position = UDim2.new(1, -96, 1, -40)
...
local function applyUpdate(payload)
	...
	if payload.total and payload.minPlayers then
		status.Text = string.format(
			"%s\n(%d/%d Spieler)",
			payload.message or "Warte auf Match...",
			payload.total,
