...
message.Size = UDim2.new(1, -16, 0, 40)
message.Position = UDim2.fromOffset(8, 34)
...
local function applyQueueState(payload)
	...
	gui.Enabled = true
	title.Text = string.format("Warteschlange — %s", payload.modeLabel or payload.mode or "Match")
