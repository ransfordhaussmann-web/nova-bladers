...
local function createBeyButton(bey)
	...
	statsLabel.TextColor3 = Color3.fromRGB(120, 140, 170)
	local s = bey.stats or {}
	statsLabel.Text = ("ATK %d  DEF %d  SPD %d  STA %d"):format(
		s.Attack or 0, s.Defense or 0, s.Speed or 0, s.Stamina or 0
	)
