...
local function createBeyButton(bey)
	...
	specialLabel.Position = UDim2.fromOffset(14, 28)
	specialLabel.BackgroundTransparency = 1
	specialLabel.Font = Enum.Font.GothamMedium
	specialLabel.TextSize = 13
	specialLabel.TextColor3 = bey.color
	...
	descLabel.Position = UDim2.fromOffset(14, 46)
