...
scroll.ScrollBarImageColor3 = Color3.fromRGB(100, 120, 160)
...
local function createBeyButton(bey)
	...
	nameLabel.Text = string.format("%s  —  %s", bey.name, bey.beyType)
	nameLabel.Parent = btn

	local specialLabel = Instance.new("TextLabel")
	specialLabel.Size = UDim2.new(1, -16, 0, 16)
	specialLabel.Position = UDim2.fromOffset(14, 30)
	...
	specialLabel.TextColor3 = bey.accentColor or bey.color
	specialLabel.Text = "Special: " .. (bey.special or "—")
	specialLabel.Parent = btn

	local descLabel = Instance.new("TextLabel")
	descLabel.Size = UDim2.new(1, -16, 0, 18)
	descLabel.Position = UDim2.fromOffset(14, 48)
