...
function SpecialVFX.phaseSlash(fromPos, toPos, color, folder)
	local mid = (fromPos + toPos) / 2
	local slash = Instance.new("Part")
	slash.Size = Vector3.new(0.3, 3, (fromPos - toPos).Magnitude)
	slash.Anchored = true
