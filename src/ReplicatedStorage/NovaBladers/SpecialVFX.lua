...
function SpecialVFX.frostRipple(origin, range, color, folder)
	local wave = Instance.new("Part")
	wave.Shape = Enum.PartType.Cylinder
...
function SpecialVFX.infernoTrail(origin, dir, color, folder)
	for i = 1, 4 do
		local mark = Instance.new("Part")
		...
		mark.CFrame = CFrame.new(origin + dir * (i * 2.5))
		mark.Parent = folder
