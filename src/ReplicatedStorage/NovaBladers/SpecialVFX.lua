...
function SpecialVFX.crownBarrier(controller, color, duration)
	local folder = SpecialVFX.ensureFolder(controller)
	local crown = Instance.new("Part")
	crown.Name = "CrownBarrier"
	crown.Shape = Enum.PartType.Cylinder
	crown.Size = Vector3.new(1.6, 6.5, 6.5)
	crown.Anchored = true
	...
	for i = 0, 5 do
		...
		spike.CFrame = CFrame.new(controller.part.Position) * offset
		spike.Parent = folder
