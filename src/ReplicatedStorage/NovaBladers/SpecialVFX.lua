...
function SpecialVFX.rendSlash(position, direction, color, folder)
	...
	slash.CFrame = CFrame.new(position + direction * 1.5, lookAt) * CFrame.Angles(math.rad(90), 0, 0)
	slash.Parent = folder
...
function SpecialVFX.iceShatter(origin, range, color, folder)
	...
	frost.Size = Vector3.new(0.25, 2, 2)
	frost.Anchored = true
