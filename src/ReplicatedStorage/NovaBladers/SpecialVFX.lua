...
function SpecialVFX.chillShield(controller, color, duration)
	...
	frost.Size = NumberSequence.new(0.3, 0.8)
...
function SpecialVFX.iceShard(shardPos, origin, color, folder)
	...
	shard.CFrame = CFrame.new(shardPos, origin)
	shard.Parent = folder

	TweenService:Create(shard, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
