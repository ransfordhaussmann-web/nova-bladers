...
function SpecialVFX.quakeBurst(origin, range, color, folder)
	local crack = Instance.new("Part")
	crack.Shape = Enum.PartType.Cylinder
	crack.Size = Vector3.new(0.4, 3, 3)
	crack.Anchored = true
...
function SpecialVFX.solarDriftTrail(fromPos, toPos, color, folder)
	...
	ember.Size = Vector3.new(1.5, 0.4, 1.5)
