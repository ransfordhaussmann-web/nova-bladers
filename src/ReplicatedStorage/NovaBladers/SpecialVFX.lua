...
function SpecialVFX.slashArc(position, facing, color, folder)
	...
	arc.CFrame = CFrame.new(position + Vector3.new(0, 0.6, 0), position + facing) * CFrame.Angles(0, math.rad(45), math.rad(70))
	arc.Parent = folder
...
function SpecialVFX.rendFinisher(position, facing, color, folder)
	local slash = Instance.new("Part")
	slash.Size = Vector3.new(0.2, 6, 1.5)
	slash.Anchored = true
	slash.CanCollide = false
	slash.Material = Enum.Material.Neon
	slash.Color = color
	slash.Transparency = 0.1
	slash.CFrame = CFrame.new(position + Vector3.new(0, 0.8, 0), position + facing) * CFrame.Angles(0, 0, math.rad(80))
	slash.Parent = folder
...
function SpecialVFX.frostWall(controller, color, duration)
	...
	ring.Name = "FrostWall"
	ring.Shape = Enum.PartType.Cylinder
	ring.Size = Vector3.new(1.5, 6.5, 6.5)
	ring.Anchored = true
	ring.CanCollide = false
