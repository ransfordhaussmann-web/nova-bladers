...
function SpecialVFX.groundShatter(position, color, folder)
	...
	crack.CFrame = CFrame.new(position - Vector3.new(0, 0.8, 0)) * CFrame.Angles(0, 0, math.rad(90))
	crack.Parent = folder
