...
function SpecialVFX.slashArc(origin, direction, color, folder)
	...
	local lookAt = origin + direction
	arc.CFrame = CFrame.new(origin + direction * 2.5, lookAt) * CFrame.Angles(0, math.rad(90), math.rad(25))
	arc.Parent = folder
...
function SpecialVFX.slashFinisher(position, color, folder)
	for i = 0, 2 do
		...
		slash.Size = Vector3.new(0.25, 0.6, 6)
		slash.Anchored = true
		slash.CanCollide = false
		slash.Material = Enum.Material.Neon
		slash.Color = color
		slash.Transparency = 0.1
		slash.CFrame = CFrame.new(position) * CFrame.Angles(0, math.rad(angle), math.rad(40))
		slash.Parent = folder
