...
function SpecialVFX.fireSpiral(position, color, folder)
	local spark = Instance.new("Part")
...
function SpecialVFX.frostMist(position, color, folder)
	...
	mist.CFrame = CFrame.new(position - Vector3.new(0, 0.5, 0))
	mist.Parent = folder
