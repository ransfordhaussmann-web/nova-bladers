...
function SpecialVFX.cycloneTrail(position, color, folder)
	...
	swirl.CFrame = CFrame.new(position + Vector3.new(0, 1, 0)) * CFrame.Angles(0, 0, math.rad(90))
	swirl.Parent = folder
...
function SpecialVFX.eruptionBurst(position, color, folder)
	local core = Instance.new("Part")
	core.Shape = Enum.PartType.Ball
