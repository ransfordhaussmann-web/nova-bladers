...
function SpecialVFX.flurrySlash(position, facing, color, folder)
	...
	slash.CFrame = CFrame.new(position + facing * 1.5) * CFrame.Angles(0, angle, math.rad(70))
	slash.Parent = folder
