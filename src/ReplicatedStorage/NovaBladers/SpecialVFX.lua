...
function SpecialVFX.blazeSpiral(origin, radius, color, folder)
	local arc = Instance.new("Part")
	arc.Shape = Enum.PartType.Cylinder
	arc.Size = Vector3.new(0.12, radius * 1.6, radius * 1.6)
	arc.Anchored = true
...
function SpecialVFX.frostShell(controller, color, duration)
	...
	shell.Size = Vector3.new(1.4, 5.5, 5.5)
	shell.Anchored = true
