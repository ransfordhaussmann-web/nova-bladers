...
function SpecialVFX.iceShard(origin, range, color, folder)
	for i = 1, 4 do
		...
		local pos = origin + Vector3.new(math.cos(angle) * dist, 0.3, math.sin(angle) * dist)
	...
	frost.Size = Vector3.new(0.15, 2, 2)
	frost.Anchored = true
