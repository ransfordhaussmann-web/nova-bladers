...
function SpecialVFX.slashMark(fromPos, toPos, color, folder)
	...
	slash.Size = Vector3.new(0.3, 2.5, 0.3)
	slash.Anchored = true
	...
	if dir.Magnitude > 0.1 then
		slash.CFrame = CFrame.lookAt(mid, mid + dir) * CFrame.Angles(math.rad(90), 0, 0)
	else
		slash.CFrame = CFrame.new(mid) * CFrame.Angles(0, math.random() * math.pi * 2, 0)
	end
	slash.Parent = folder
