...
function SpecialVFX.blazeSpiral(origin, angle, radius, color, folder)
	local offset = Vector3.new(math.cos(angle) * radius, 0.6, math.sin(angle) * radius)
	...
	ember.CFrame = CFrame.new(origin + offset)
	ember.Parent = folder
