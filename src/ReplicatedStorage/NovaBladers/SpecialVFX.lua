...
function SpecialVFX.forgeHeat(controller, color, duration)
	...
	glow.Size = Vector3.new(0.3, 3.5, 3.5)
	glow.Anchored = true
	glow.CanCollide = false
	glow.Material = Enum.Material.Neon
	glow.Color = color
	glow.Transparency = 0.35
	glow.CFrame = CFrame.new(pos) * CFrame.Angles(0, 0, math.rad(90))
	glow.Parent = folder
...
function SpecialVFX.forgeFlameTrail(fromPos, toPos, color, folder)
	local mid = (fromPos + toPos) / 2
	local trail = Instance.new("Part")
