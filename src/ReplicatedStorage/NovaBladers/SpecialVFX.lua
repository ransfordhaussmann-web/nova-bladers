...
function SpecialVFX.crimsonSlash(origin, facing, color, folder)
	...
	slash.CFrame = CFrame.new(origin + Vector3.new(0, 0.6, 0), origin + right) * CFrame.Angles(0, 0, math.rad(45))
	slash.Parent = folder
...
function SpecialVFX.auroraDomeBurst(position, range, color, folder)
	local burst = Instance.new("Part")
	burst.Shape = Enum.PartType.Ball
