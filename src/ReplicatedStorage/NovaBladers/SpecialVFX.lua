...
function SpecialVFX.clawSlash(position, facing, angleOffset, color, folder)
	...
	local rot = CFrame.lookAt(position, position + flatFacing) * CFrame.Angles(0, angleOffset, math.rad(35))
	slash.CFrame = rot * CFrame.new(0, 0, -2.2)
	slash.Parent = folder
