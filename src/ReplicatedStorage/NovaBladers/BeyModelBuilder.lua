...
local function buildAquaPrism(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	-- Prism facets (hexagonal water disk)
	for i = 0, 5 do
		local angle = i * 60
	...
	waterRing:SetAttribute("SpinMult", 1.05)
	...
	ripple:SetAttribute("SpinMult", 0.75)
