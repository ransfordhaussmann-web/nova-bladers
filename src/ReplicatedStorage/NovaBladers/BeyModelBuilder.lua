...
local function buildEmberRing(parent, color, accent, baseCFrame)
	...
	for i = 0, 2 do
		...
		plume:SetAttribute("SpinMult", 1.15)
		plume:SetAttribute("SpinOffset", offset)
		table.insert(spinVisuals, plume)
	end
	...
	heatRing:SetAttribute("SpinMult", 1)
	...
	outerEmber:SetAttribute("SpinMult", 0.7)
