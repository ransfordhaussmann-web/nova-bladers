...
local function buildNeonSpire(parent, color, accent, baseCFrame)
	...
	spire:SetAttribute("SpinMult", 0.5)
	...
	for i = 0, 3 do
		...
		ringSeg:SetAttribute("SpinMult", 1.3)
		ringSeg:SetAttribute("SpinOffset", offset)
		table.insert(spinVisuals, ringSeg)
	end
	...
	outerPulse:SetAttribute("SpinMult", -0.8)
	table.insert(spinVisuals, outerPulse)
