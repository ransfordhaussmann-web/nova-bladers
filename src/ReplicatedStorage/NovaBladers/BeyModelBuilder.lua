...
local function buildEmberRing(parent, color, accent, baseCFrame)
	...
	for i = 0, 3 do
		local seg = ringSegment(parent, 0.95, 1.55, 0.55, color, Enum.Material.Neon, i * 90, "EmberSeg_" .. i)
		seg:SetAttribute("SpinMult", 1.05)
		seg:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 90), 0) * CFrame.new(1.25, 0, 0))
		table.insert(spinVisuals, seg)
	end
