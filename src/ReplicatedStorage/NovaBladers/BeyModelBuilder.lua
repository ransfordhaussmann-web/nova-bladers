...
local function buildCrystalVortex(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		...
		local shard = part({
			...
			transparency = 0.1,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(angle), math.rad(25)) * CFrame.new(0, 0, 1.25),
		})
		shard:SetAttribute("SpinMult", 0.75)
		shard:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(angle), math.rad(25)) * CFrame.new(0, 0, 1.25))
...
local function buildEmberRing(parent, color, accent, baseCFrame)
	...
	for i = 0, 2 do
		...
		wing:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(angle), math.rad(15)) * CFrame.new(0, 0, 1.3))
	...
	emberGlow:SetAttribute("SpinMult", 1.0)
