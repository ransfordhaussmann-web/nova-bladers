...
local function buildCrimsonEdge(parent, color, accent, baseCFrame)
	...
	crimsonRing:SetAttribute("SpinMult", 1.2)
	table.insert(spinVisuals, crimsonRing)
...
local function buildFrostHalo(parent, color, accent, baseCFrame)
	...
	-- Icy halo segments
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.0, 1.6, 0.7, color, Enum.Material.Ice, i * 60, "IceSeg_" .. i)
