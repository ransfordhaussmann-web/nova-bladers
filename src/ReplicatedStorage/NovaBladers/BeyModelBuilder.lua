...
local function buildAuroraCrest(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.0, 1.6, 0.7, color, Enum.Material.SmoothPlastic, i * 60, "CrestSeg_" .. i)
	...
	crestTop:SetAttribute("SpinMult", -0.5)
	table.insert(spinVisuals, crestTop)
