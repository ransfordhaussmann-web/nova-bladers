...
local function buildFrostPulse(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	crystalRing:SetAttribute("SpinMult", 0.75)
	table.insert(spinVisuals, crystalRing)

	for i = 0, 5 do
		local seg = ringSegment(parent, 1.2, 1.7, 0.55, accent, Enum.Material.Neon, i * 60, "IceSeg_" .. i)
