...
local function buildCrimsonFang(parent, color, accent, baseCFrame)
	...
	rageRing:SetAttribute("SpinMult", 1.3)
...
local function buildFrostRing(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local offset = CFrame.Angles(0, math.rad(i * 60), math.rad(15)) * CFrame.new(0, 0.2, 1.25)
		local crystal = part({
			name = "IceCrystal_" .. i,
			parent = parent,
	...
	outerFrost:SetAttribute("SpinMult", -0.4)
