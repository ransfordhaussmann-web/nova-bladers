...
local function buildApexDrill(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	drillTip:SetAttribute("SpinMult", 1.5)
	drillTip:SetAttribute("SpinOffset", CFrame.new(0, 0, 1.5))
	table.insert(spinVisuals, drillTip)
...
local function buildNeonTide(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	for i = 0, 3 do
		...
		wave:SetAttribute("SpinMult", 0.95)
...
local BUILDERS = {
	...
	ApexDrill = buildApexDrill,
	NeonTide = buildNeonTide,
}
