...
local function buildBlazeOrbit(parent, color, accent, baseCFrame)
	...
	solarGlow:SetAttribute("SpinMult", 0.85)
	table.insert(spinVisuals, solarGlow)
...
local function buildFrostCrown(parent, color, accent, baseCFrame)
	...
	-- Crown ice spikes (spin)
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.1, 1.7, 0.85, color, Enum.Material.Ice, i * 60, "CrownSpike_" .. i)
