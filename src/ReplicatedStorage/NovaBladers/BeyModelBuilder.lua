...
local function buildCrimsonComet(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	for i = 0, 2 do
		...
		tail:SetAttribute("SpinMult", 1.2)
		tail:SetAttribute("SpinOffset", offset)
...
local function buildFrostAnchor(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	local core = part({
		...
		color = Color3.fromRGB(100, 140, 170),
	...
	anchorSpike:SetAttribute("SpinMult", 0.4)
	table.insert(spinVisuals, anchorSpike)
...
local BUILDERS = {
	...
	CrimsonComet = buildCrimsonComet,
	FrostAnchor = buildFrostAnchor,
}
