...
local function buildTideAnchor(parent, color, accent, baseCFrame)
	...
	anchor:SetAttribute("SpinOffset", CFrame.new(0, 0, 1.1))
...
local function buildPhantomEdge(parent, color, accent, baseCFrame)
	...
	local core = part({
		...
		parent = parent,
		shape = Enum.PartType.Cylinder,
		size = Vector3.new(0.88, 2.1, 2.1),
		color = Color3.fromRGB(45, 50, 80),
		material = Enum.Material.Metal,
		canCollide = false,
		cframe = baseCFrame,
	})
	...
	ghostRing:SetAttribute("SpinMult", 0.9)
