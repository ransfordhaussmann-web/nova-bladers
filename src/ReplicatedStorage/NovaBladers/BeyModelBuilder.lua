...
local function buildFrostGyre(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	for i = 0, 2 do
		local angle = i * 120
		local offset = CFrame.Angles(0, math.rad(angle), 0) * CFrame.new(0, 0.35, 1.0)
		local crystal = part({
			name = "IceCrystal_" .. i,
			parent = parent,
