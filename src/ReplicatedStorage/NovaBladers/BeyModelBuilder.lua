...
local function buildGraniteFort(parent, color, accent, baseCFrame)
	...
	for i = 0, 7 do
		local seg = ringSegment(parent, 1.0, 1.6, 1.0, color, Enum.Material.Concrete, i * 45, "FortSeg_" .. i)
		seg:SetAttribute("SpinMult", 0.5)
		seg:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 45), 0) * CFrame.new(1.3, 0, 0))
		table.insert(spinVisuals, seg)
	end
	...
	rampart:SetAttribute("SpinMult", 0.4)
...
local function buildSolarDrift(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		...
		local ray = part({
			name = "SolarRay_" .. i,
			parent = parent,
			size = Vector3.new(0.2, 0.15, 1.6),
			color = accent,
			material = Enum.Material.Neon,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(angle), math.rad(10)) * CFrame.new(0, 0, 1.1),
		})
		ray:SetAttribute("SpinMult", 0.9)
		ray:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(angle), math.rad(10)) * CFrame.new(0, 0, 1.1))
	...
	corona:SetAttribute("SpinMult", 0.7)
...
local function buildPhantomEdge(parent, color, accent, baseCFrame)
	...
	for i = 0, 1 do
		...
		local edge = part({
			name = "PhantomEdge_" .. i,
			parent = parent,
			size = Vector3.new(0.15, 0.6, 2.5),
			color = accent,
			material = Enum.Material.Neon,
			transparency = 0.1,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(angle), math.rad(15)) * CFrame.new(0, 0, 1.4),
		})
		edge:SetAttribute("SpinMult", 1.5)
		edge:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(angle), math.rad(15)) * CFrame.new(0, 0, 1.4))
	...
	mirage:SetAttribute("SpinMult", -1.2)
	table.insert(spinVisuals, mirage)
...
local function buildFrostCrown(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		...
		local spike = part({
			name = "IceSpike_" .. i,
			parent = parent,
			size = Vector3.new(0.35, 0.8, 0.7),
			color = accent,
			material = Enum.Material.Ice,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(angle), math.rad(40)) * CFrame.new(0, 0, 1.25),
		})
		spike:SetAttribute("SpinMult", 0.8)
		spike:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(angle), math.rad(40)) * CFrame.new(0, 0, 1.25))
...
local function buildCrimsonDrift(parent, color, accent, baseCFrame)
	...
	local driftRing = part({
		...
		parent = parent,
		shape = Enum.PartType.Cylinder,
		size = Vector3.new(0.2, 3.8, 3.8),
		color = color,
		material = Enum.Material.SmoothPlastic,
		canCollide = false,
		cframe = baseCFrame,
	})
	driftRing:SetAttribute("SpinMult", 1.3)
	...
	for i = 0, 2 do
		...
		local wing = part({
			name = "DriftWing_" .. i,
			parent = parent,
			size = Vector3.new(0.3, 0.2, 1.4),
			color = accent,
			material = Enum.Material.Neon,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(angle), math.rad(8)) * CFrame.new(0, 0, 1.0),
		})
		wing:SetAttribute("SpinMult", 1.5)
		wing:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(angle), math.rad(8)) * CFrame.new(0, 0, 1.0))
	...
	spinRing:SetAttribute("SpinMult", 1.6)
	table.insert(spinVisuals, spinRing)
	...
	trail:SetAttribute("SpinMult", 0.5)
	table.insert(spinVisuals, trail)
