...
local function buildGlacierShield(parent, color, accent, baseCFrame)
	...
	-- Thick ice shell plates
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.1, 1.7, 1.0, color, Enum.Material.Ice, i * 60, "IcePlate_" .. i)
	...
	frostRing:SetAttribute("SpinMult", 0.55)
