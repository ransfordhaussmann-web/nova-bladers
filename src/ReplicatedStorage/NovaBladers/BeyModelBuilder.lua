...
local function buildBlazeVortex(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	vortex:SetAttribute("SpinMult", -0.9)
...
local function buildCrystalGuard(parent, color, accent, baseCFrame)
	...
	prism:SetAttribute("SpinMult", 0.55)
