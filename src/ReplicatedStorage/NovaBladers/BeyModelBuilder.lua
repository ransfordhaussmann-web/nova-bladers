...
local function buildFrostCore(parent, color, accent, baseCFrame)
	...
	-- Crystalline shell segments
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.0, 1.6, 0.85, color, Enum.Material.Glass, i * 60, "CrystalSeg_" .. i)
