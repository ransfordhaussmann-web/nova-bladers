...
local function buildBlazeCore(parent, color, accent, baseCFrame)
	...
	magma:SetAttribute("SpinMult", 1.15)
...
local function buildFrostOrbit(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.0, 1.55, 0.55, accent, Enum.Material.Glass, i * 60, "CrystalSeg_" .. i)
	...
	frostHalo:SetAttribute("SpinMult", 0.75)
