...
local function buildCrimsonVortex(parent, color, accent, baseCFrame)
	...
	-- Spiral attack blades (spin fast)
	for i = 0, 3 do
		local angle = i * 90 + 20
	...
	vortexRing:SetAttribute("SpinMult", -0.8)
...
local function buildGlacierMantle(parent, color, accent, baseCFrame)
	...
	frostShield:SetAttribute("SpinMult", 0.5)
