...
local function buildFrostAnchor(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.1, 1.85, 0.85, color, Enum.Material.Ice, i * 60, "IceSeg_" .. i)
		seg:SetAttribute("SpinMult", 0.75)
		seg:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 60), 0) * CFrame.new(1.48, 0, 0))
		table.insert(spinVisuals, seg)
	end
