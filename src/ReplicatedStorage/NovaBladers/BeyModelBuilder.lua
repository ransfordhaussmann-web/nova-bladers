...
local function buildGlacierMantle(parent, color, accent, baseCFrame)
	...
	for i = 0, 2 do
		...
		local spike = part({
			...
			transparency = 0.2,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(angle), math.rad(15)) * CFrame.new(0, 0, 1.5),
		})
	...
	local mantle = part({
		...
		color = Color3.fromRGB(90, 140, 180),
		material = Enum.Material.Slate,
		transparency = 0.1,
		canCollide = false,
		cframe = baseCFrame,
	})
	mantle:SetAttribute("SpinMult", -0.3)
