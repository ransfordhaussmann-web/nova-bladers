...
local function buildBlazeOrbit(parent, color, accent, baseCFrame)
	...
	orbitRing:SetAttribute("SpinMult", 1.2)
	table.insert(spinVisuals, orbitRing)
...
local function buildTitanGuard(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	for i = 0, 7 do
		local seg = ringSegment(parent, 1.2, 1.9, 1.0, color, Enum.Material.Metal, i * 45, "TitanPlate_" .. i)
