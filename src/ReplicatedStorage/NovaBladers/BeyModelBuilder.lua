...
local function buildTideAnchor(parent, color, accent, baseCFrame)
	...
	for i = 0, 3 do
		local seg = ringSegment(parent, 1.0, 1.6, 0.85, color, Enum.Material.Glass, i * 90, "WaveSeg_" .. i)
	...
	bubbleRing:SetAttribute("SpinMult", 0.65)
	table.insert(spinVisuals, bubbleRing)
