...
local function buildFrostCrown(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local angle = i * 60
		local offset = CFrame.Angles(0, math.rad(angle), math.rad(12)) * CFrame.new(0, 0.35, 1.4)
		local spike = part({
			name = "CrownSpike_" .. i,
			parent = parent,
	...
	for i = 0, 2 do
		local seg = ringSegment(parent, 1.0, 1.55, 0.55, color, Enum.Material.Ice, i * 120, "IceRing_" .. i)
