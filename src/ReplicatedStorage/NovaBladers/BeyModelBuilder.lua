...
local function buildCrimsonEdge(parent, color, accent, baseCFrame)
	...
	typhoonRing:SetAttribute("SpinMult", 1.3)
	table.insert(spinVisuals, typhoonRing)
...
local function buildFrostHalo(parent, color, accent, baseCFrame)
	...
	frostHalo:SetAttribute("SpinMult", 0.65)
	...
	outerBarrier:SetAttribute("SpinMult", -0.3)
	table.insert(spinVisuals, outerBarrier)
