...
local function buildCrimsonVortex(parent, color, accent, baseCFrame)
	...
	for i = 0, 3 do
		...
		wing:SetAttribute("SpinMult", 1.2)
	...
	innerVortex:SetAttribute("SpinMult", -1.3)
