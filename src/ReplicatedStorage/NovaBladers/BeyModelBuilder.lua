...
local function buildCrimsonVortex(parent, color, accent, baseCFrame)
	...
	-- 4 spiral blades (offset angles for vortex look)
	for i = 0, 3 do
		local angle = i * 90 + 22
...
local function buildGlacierShield(parent, color, accent, baseCFrame)
	...
	-- Hexagonal ice crystal segments
	for i = 0, 5 do
	...
	frostPlate:SetAttribute("SpinMult", 0.65)
	table.insert(spinVisuals, frostPlate)
