...
local function buildFrostCore(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.0, 1.65, 0.85, color, Enum.Material.Glass, i * 60, "IceSeg_" .. i)
	...
	crystalRing:SetAttribute("SpinMult", 0.65)
	...
	for i = 0, 3 do
		...
		shard:SetAttribute("SpinMult", 0.65)
