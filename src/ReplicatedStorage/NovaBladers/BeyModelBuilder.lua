...
local function buildGraniteFort(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		...
		plate:SetAttribute("SpinMult", 0.5)
		plate:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(angle), math.rad(12)) * CFrame.new(0, 0, 1.5))
		table.insert(spinVisuals, plate)
	end
	...
	fortRing:SetAttribute("SpinMult", 0.4)
...
local function buildSolarDrift(parent, color, accent, baseCFrame)
	...
	sunDisk:SetAttribute("SpinMult", 0.9)
	...
	for i = 0, 7 do
		...
		local ray = part({
			...
			material = Enum.Material.Neon,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(angle), math.rad(8)) * CFrame.new(0, 0, 2.0),
		})
		ray:SetAttribute("SpinMult", 0.9)
		ray:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(angle), math.rad(8)) * CFrame.new(0, 0, 2.0))
