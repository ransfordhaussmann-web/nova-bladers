...
local function buildCrimsonFang(parent, color, accent, baseCFrame)
	...
	-- Aggressive fang blades (3 sharp wedges)
	for i = 0, 2 do
		local angle = i * 120
...
local function buildAuroraCrest(parent, color, accent, baseCFrame)
	...
	auroraLayer:SetAttribute("SpinMult", 0.9)
	table.insert(spinVisuals, auroraLayer)
