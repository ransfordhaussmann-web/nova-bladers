...
local function buildGraniteFort(parent, color, accent, baseCFrame)
	...
	for i = 0, 7 do
		local block = ringSegment(parent, 1.0, 1.85, 1.0, color, Enum.Material.Concrete, i * 45, "StoneBlock_" .. i)
		block:SetAttribute("SpinMult", 0.75)
		block:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 45), 0) * CFrame.new(1.42, 0, 0))
