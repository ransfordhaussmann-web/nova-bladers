...
local function buildGlacierShield(parent, color, accent, baseCFrame)
	...
	-- Ice crystal shell segments (slow spin)
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.2, 1.85, 1.0, color, Enum.Material.Glass, i * 60, "IceSeg_" .. i)
	...
	iceBumper:SetAttribute("SpinMult", -0.3)
	table.insert(spinVisuals, iceBumper)
