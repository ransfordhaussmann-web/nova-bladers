...
local function buildBlazeReactor(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	for i = 0, 3 do
		...
		vent:SetAttribute("SpinMult", 1.25)
...
local BUILDERS = {
	...
	BlazeReactor = buildBlazeReactor,
}
