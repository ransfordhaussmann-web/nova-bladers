...
local function buildCrimsonForge(parent, color, accent, baseCFrame)
	...
	for i = 0, 3 do
		local seg = ringSegment(parent, 1.0, 1.6, 0.7, color, Enum.Material.Metal, i * 90, "ForgeSeg_" .. i)
	...
	for i = 0, 2 do
		...
		blade:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(angle), math.rad(25)) * CFrame.new(0, 0, 1.5))
		table.insert(spinVisuals, blade)
	end
