...
local function buildSolarCoil(parent, color, accent, baseCFrame)
	...
	helix:SetAttribute("SpinMult", 1.25)
...
local function buildTideAnchor(parent, color, accent, baseCFrame)
	...
	for i = 0, 3 do
		...
		wave:SetAttribute("SpinMult", 0.8)
		wave:SetAttribute("SpinOffset", offset)
	...
	tide:SetAttribute("SpinMult", 0.7)
	table.insert(spinVisuals, tide)
