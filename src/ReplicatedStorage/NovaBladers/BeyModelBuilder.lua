...
local function buildCrimsonFang(parent, color, accent, baseCFrame)
	...
	-- Aggressive fang blades (4, offset angles)
	for i = 0, 3 do
		local angle = i * 90 + 20
...
local function buildFrostCrown(parent, color, accent, baseCFrame)
	...
	-- Crown spikes (6 crystalline points)
	for i = 0, 5 do
		local angle = i * 60
	...
	crystalBand:SetAttribute("SpinMult", -0.4)
	table.insert(spinVisuals, crystalBand)
