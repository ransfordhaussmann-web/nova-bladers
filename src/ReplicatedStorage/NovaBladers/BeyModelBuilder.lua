...
local function buildScarletVortex(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
...
local function buildAzureBulwark(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	tideShield:SetAttribute("SpinMult", 0.65)
	table.insert(spinVisuals, tideShield)
...
local BUILDERS = {
	...
	ScarletVortex = buildScarletVortex,
	AzureBulwark = buildAzureBulwark,
}
