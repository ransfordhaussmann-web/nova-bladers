...
local function buildGraniteFort(parent, color, accent, baseCFrame)
	...
	for i = 0, 7 do
		local seg = ringSegment(parent, 1.0, 1.6, 1.0, color, Enum.Material.Concrete, i * 45, "BlockSeg_" .. i)
...
local function buildPhantomEdge(parent, color, accent, baseCFrame)
	...
	voidRing:SetAttribute("SpinMult", -0.8)
	table.insert(spinVisuals, voidRing)
