...
local function buildAzureCrown(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	for i = 0, 5 do
		local angle = i * 60
		local offset = CFrame.Angles(math.rad(12), math.rad(angle), 0) * CFrame.new(0, 0.55, 0)
		local spike = part({
			name = "CrownSpike_" .. i,
			parent = parent,
