...
local function buildAuroraCrest(parent, color, accent, baseCFrame)
	...
	-- Crystal ridge segments (slow spin)
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.0, 1.6, 0.85, accent, Enum.Material.Glass, i * 60, "CrystalSeg_" .. i)
	...
	auroraGlow:SetAttribute("SpinMult", 0.5)
