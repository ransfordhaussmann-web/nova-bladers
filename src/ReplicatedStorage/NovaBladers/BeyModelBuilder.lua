...
local function buildCrystalBloom(parent, color, accent, baseCFrame)
	...
	bloomRing:SetAttribute("SpinMult", 0.75)
	...
	outerShard:SetAttribute("SpinMult", -0.35)
	table.insert(spinVisuals, outerShard)
