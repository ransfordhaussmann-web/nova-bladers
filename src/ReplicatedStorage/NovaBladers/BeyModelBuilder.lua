...
local function tryExternalMesh(beyData, parent, baseCFrame)
	...
	if not assets and beyData.creatorStore and beyData.creatorStore.meshId then
		assets = {
...
local function buildFrostVeil(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.0, 1.6, 0.75, color, Enum.Material.Glass, i * 60, "CrystalSeg_" .. i)
