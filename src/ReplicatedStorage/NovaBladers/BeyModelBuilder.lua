...
local function buildAuroraCrest(parent, color, accent, baseCFrame)
	...
	local crest = part({
		name = "AuroraCrest",
		parent = parent,
		size = Vector3.new(0.6, 0.9, 1.4),
		color = accent,
		material = Enum.Material.Neon,
		transparency = 0.15,
		canCollide = false,
		cframe = baseCFrame * CFrame.new(0, 0.5, 0) * CFrame.Angles(math.rad(15), 0, 0),
	})
	...
	shimmer:SetAttribute("SpinMult", -0.4)
