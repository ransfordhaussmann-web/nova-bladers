...
local function buildFrostPrism(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		...
		shard:SetAttribute("SpinMult", 0.95)
	...
	frostRing:SetAttribute("SpinMult", 0.8)
	...
	outerPrism:SetAttribute("SpinMult", -0.4)
	table.insert(spinVisuals, outerPrism)
