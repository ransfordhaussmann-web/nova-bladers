...
local function buildEmberCrown(parent, color, accent, baseCFrame)
	...
	crown:SetAttribute("SpinMult", 1.05)
...
local function buildGlacierPeak(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
