...
local function buildSolarCoil(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		...
		local coil = part({
			...
			canCollide = false,
			cframe = baseCFrame
				* CFrame.Angles(math.rad(35), math.rad(angle), math.rad(20))
				* CFrame.new(0, math.sin(math.rad(angle * 2)) * 0.15, 1.0),
		})
		local offset = CFrame.Angles(math.rad(35), math.rad(angle), math.rad(20))
			* CFrame.new(0, math.sin(math.rad(angle * 2)) * 0.15, 1.0)
