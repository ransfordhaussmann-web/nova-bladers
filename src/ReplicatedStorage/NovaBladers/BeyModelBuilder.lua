...
local function buildBlazeSurge(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	emberRing:SetAttribute("SpinMult", 1.15)
	...
	outerFlame:SetAttribute("SpinMult", 0.7)
	table.insert(spinVisuals, outerFlame)

	return visuals, spinVisuals, spinRing
end

local function buildGlacierHold(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	anchorPlate:SetAttribute("SpinMult", -0.25)
	table.insert(spinVisuals, anchorPlate)
...
local BUILDERS = {
	...
	BlazeSurge = buildBlazeSurge,
	GlacierHold = buildGlacierHold,
}
