...
local function buildCrimsonWheel(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	hotRing:SetAttribute("SpinMult", 1.3)
	...
	outerBurn:SetAttribute("SpinMult", 0.9)
	table.insert(spinVisuals, outerBurn)
...
local BUILDERS = {
	...
	CrimsonWheel = buildCrimsonWheel,
}
