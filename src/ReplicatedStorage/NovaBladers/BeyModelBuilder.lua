...
local function buildGraniteFort(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		...
		block:SetAttribute("SpinMult", 0.45)
...
local function buildSolarDrift(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local ray = part({
			...
			material = Enum.Material.Neon,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(i * 60), math.rad(10)) * CFrame.new(0, 0, 2.0),
		})
		ray:SetAttribute("SpinMult", 0.9)
		ray:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 60), math.rad(10)) * CFrame.new(0, 0, 2.0))
...
local function buildPhantomEdge(parent, color, accent, baseCFrame)
	...
	ghostAura:SetAttribute("SpinMult", 0.7)
