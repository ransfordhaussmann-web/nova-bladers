...
local function buildCrimsonVortex(parent, color, accent, baseCFrame)
	...
	vortexGlow:SetAttribute("SpinMult", -0.8)
...
local function buildGlacierMantle(parent, color, accent, baseCFrame)
	...
	-- Frost shell segments (slow spin)
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.1, 1.7, 0.85, color, Enum.Material.Ice, i * 60, "FrostSeg_" .. i)
