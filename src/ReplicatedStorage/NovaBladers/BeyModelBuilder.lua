...
local function buildBlazeComet(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
...
local function buildCrystalAegis(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	-- Hexagonal crystal plates
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.0, 1.7, 0.75, accent, Enum.Material.Glass, i * 60, "CrystalPlate_" .. i)
...
local function buildTurboNebula(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	dustRing:SetAttribute("SpinMult", 1.05)
	table.insert(spinVisuals, dustRing)
	...
	for i = 0, 3 do
		...
		star:SetAttribute("SpinMult", 1.1)
...
local BUILDERS = {
	...
	BlazeComet = buildBlazeComet,
	CrystalAegis = buildCrystalAegis,
	TurboNebula = buildTurboNebula,
}
