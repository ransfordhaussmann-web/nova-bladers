...
local function buildFrostCrown(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local angle = i * 60
		local offset = CFrame.Angles(0, math.rad(angle), math.rad(12)) * CFrame.new(0, 0.2, 1.4)
		local spike = part({
	...
	iceShell:SetAttribute("SpinMult", 0.65)
	table.insert(spinVisuals, iceShell)
