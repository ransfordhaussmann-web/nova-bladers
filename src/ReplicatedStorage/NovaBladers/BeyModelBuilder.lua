...
local function buildAuroraCrest(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local segColor = if i % 2 == 0 then color else accent
		local seg = ringSegment(parent, 1.0, 1.6, 0.7, segColor, Enum.Material.Neon, i * 60, "CrestSeg_" .. i)
	...
	polarCrown:SetAttribute("SpinMult", -0.5)
	table.insert(spinVisuals, polarCrown)
