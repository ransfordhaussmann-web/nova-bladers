...
local function buildFrostCoil(parent, color, accent, baseCFrame)
	...
	local core = part({
		...
		color = Color3.fromRGB(200, 220, 235),
	...
	-- Coiled ice crystal segments
	for i = 0, 5 do
		local seg = ringSegment(parent, 0.95, 1.55, 0.75, color, Enum.Material.Glass, i * 60 + 15, "CoilSeg_" .. i)
		seg:SetAttribute("SpinMult", 0.9)
		seg:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 60 + 15), 0) * CFrame.new(1.25, 0, 0))
		table.insert(spinVisuals, seg)
	end
	...
	counterRing:SetAttribute("SpinMult", -0.4)
