...
local function buildBlazeQuill(parent, color, accent, baseCFrame)
	...
	-- Feather quill spikes (spin fast)
	for i = 0, 3 do
		local angle = i * 90 + 15
...
local function buildTideAnchor(parent, color, accent, baseCFrame)
	...
	-- Anchor flukes (heavy shell segments)
	...
	for i = 0, 5 do
		local seg = ringSegment(parent, 1.2, 1.7, 0.75, color, Enum.Material.SmoothPlastic, i * 60, "TideSeg_" .. i)
