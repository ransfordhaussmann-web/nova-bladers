...
local function buildBlazeOrbit(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	innerFlame:SetAttribute("SpinMult", 1.3)
...
local function buildCrystalBloom(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
	...
	bloomRing:SetAttribute("SpinMult", 0.65)
	table.insert(spinVisuals, bloomRing)
	...
	outerCrystal:SetAttribute("SpinMult", -0.3)
	table.insert(spinVisuals, outerCrystal)
...
local BUILDERS = {
	...
	BlazeOrbit = buildBlazeOrbit,
	CrystalBloom = buildCrystalBloom,
}
