...
local function buildSolarDrift(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local ray = part({
			...
			material = Enum.Material.Neon,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(i * 60), math.rad(20)) * CFrame.new(0, 0, 1.55),
		})
		ray:SetAttribute("SpinMult", 0.9)
		ray:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 60), math.rad(20)) * CFrame.new(0, 0, 1.55))
...
local function buildPhantomEdge(parent, color, accent, baseCFrame)
	...
	for i = 0, 1 do
		local blade = part({
			...
			transparency = 0.25,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(i * 180 + 40), math.rad(15)) * CFrame.new(0, 0, 1.3),
		})
		blade:SetAttribute("SpinMult", 0.95)
		blade:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 180 + 40), math.rad(15)) * CFrame.new(0, 0, 1.3))
		table.insert(spinVisuals, blade)
	end
...
local function buildCrystalEdge(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local shard = part({
			...
			material = Enum.Material.Neon,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(i * 60), math.rad(35)) * CFrame.new(0, 0, 1.15),
		})
		shard:SetAttribute("SpinMult", 1.1)
		shard:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 60), math.rad(35)) * CFrame.new(0, 0, 1.15))
...
local function buildBlazeCrown(parent, color, accent, baseCFrame)
	...
	for i = 0, 5 do
		local spike = part({
			...
			material = Enum.Material.Neon,
			canCollide = false,
			cframe = baseCFrame * CFrame.Angles(0, math.rad(i * 60), math.rad(40)) * CFrame.new(0, 0.1, 1.2),
		})
		spike:SetAttribute("SpinMult", 1.0)
		spike:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 60), math.rad(40)) * CFrame.new(0, 0.1, 1.2))
