...
local function buildCrimsonVortex(parent, color, accent, baseCFrame)
	...
	-- Spiral flame fins (3 curved segments)
	for i = 0, 2 do
		local angle = i * 120
...
local function buildGlacierRing(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
