...
local function buildAuroraCrest(parent, color, accent, baseCFrame)
	...
	-- Layered crest rings (slow counter-rotation)
	for i = 0, 2 do
		local seg = ringSegment(parent, 1.0, 1.6, 0.7, color, Enum.Material.Ice, i * 120, "CrestSeg_" .. i)
		seg:SetAttribute("SpinMult", 0.5)
		seg:SetAttribute("SpinOffset", CFrame.Angles(0, math.rad(i * 120), 0) * CFrame.new(1.3, 0, 0))
		table.insert(spinVisuals, seg)
	end
	...
	shieldPlate:SetAttribute("SpinMult", 0.35)
