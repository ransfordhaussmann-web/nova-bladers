...
local function buildCrimsonRift(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
...
local function buildFrostLedger(parent, color, accent, baseCFrame)
	local visuals = {}
	local spinVisuals = {}
...
local BUILDERS = {
	...
	CrimsonRift = buildCrimsonRift,
	FrostLedger = buildFrostLedger,
}
