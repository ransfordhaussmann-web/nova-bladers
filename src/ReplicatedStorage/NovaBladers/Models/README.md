...
| `IronShell` | Iron Shell | Creator Store → defense top / metal shell |
| `VoltDash` | Volt Dash | Creator Store → stamina top / speed ring |
| `ShadowBite` | Shadow Bite | Creator Store → balance top / dark blade |
| `CrimsonBlaze` | Crimson Blaze | Creator Store → spinning top / battle top |
| `FrostCrown` | Frost Crown | Creator Store → spinning top / crystal top |
