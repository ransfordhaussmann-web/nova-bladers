	...
	SPECIAL_MOVES = {
		...
		BlazeCorkscrew = {
			...
			phases = {
				...
				{ id = "corkscrew", duration = 0.85, interval = 0.22, hitRadius = 5, damage = 10 },
				{ id = "flare", duration = 0.4, rushSpeed = 95, range = 7, damage = 32 },
			},
		},
		--[[ Frost Orbit — ice barrier + frost pulse ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
