local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — crimson meteor barrage ]]
		CrimsonFangBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.83, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		--[[ Granite Fort — stone fortress + quake pulses ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		--[[ Solar Drift — solar wind sonic rings ]]
		SolarWindSurge = {
			id = "SolarWindSurge",
		...
		--[[ Phantom Edge — ghost fade dive ]]
		PhantomFadeStrike = {
			id = "PhantomFadeStrike",
			name = "Phantom Fade Strike",
			mode = "eclipse",
			duration = 1.2,
			rushSpeed = 88,
			damage = 40,
			...
			phases = {
				...
				{ id = "burst", duration = 0.32, range = 6, damage = 36 },
			},
		},
		--[[ Crystal Edge — ice shard shatter surge ]]
		CrystalShatterSurge = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.82, hitInterval = 0.2, hitRadius = 6, damage = 13, hits = 4 },
			},
		},
		--[[ Blaze Crown — fire spiral inferno ]]
		BlazeCrownSpiral = {
			id = "BlazeCrownSpiral",
			...
			phases = {
				...
				{ id = "spiral", duration = 1.0, hitInterval = 0.22, hitRadius = 5.5, damage = 11 },
				{ id = "finale", duration = 0.3, range = 7, damage = 30 },
			},
		},
	},
