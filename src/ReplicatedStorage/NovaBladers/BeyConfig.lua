	...
	SPECIAL_MOVES = {
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "rend", duration = 0.63, hitInterval = 0.16, hitRadius = 4.5, damage = 10, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "shock", duration = 0.8, interval = 0.35, range = 9, damage = 14 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.42, rushSpeed = 95, dashes = 2 },
				{ id = "echo", duration = 0.35, range = 7, damage = 32 },
			},
		},
	},
