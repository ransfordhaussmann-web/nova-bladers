	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRend = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.6, interval = 0.2, hits = 3, range = 5.5, damage = 12 },
			},
		},
		--[[ Granite Fort — burrow + stone wall ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		PhantomPhase = {
			...
			phases = {
				...
				{ id = "dive", duration = 0.45, rushSpeed = 88, diveSpeed = 42 },
				{ id = "burst", duration = 0.35, range = 6, damage = 34 },
			},
		},
		--[[ Crystal Edge — multi-directional shard surge ]]
		CrystalShatterSurge = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "rush", duration = 0.3, rushSpeed = 70 },
				{ id = "burst", duration = 0.85, interval = 0.17, hits = 5, range = 6.5, damage = 10 },
			},
		},
		...
		BlazeCrownSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.95, interval = 0.22, damage = 9, radius = 4.5 },
				{ id = "finish", duration = 0.35, range = 7, damage = 32 },
			},
		},
	},
