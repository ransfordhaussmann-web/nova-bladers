local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Orbit — Solar ring / flare dash / heat burst ]]
		CrimsonSolarFlare = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.3, rushSpeed = 82 },
				{ id = "burst", duration = 0.8, hitInterval = 0.2, hitRadius = 5.5, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Anchor — Ice shield / glacier wall / frost pulse ]]
		FrostGlacierLock = {
			id = "FrostGlacierLock",
			...
			phases = {
				...
				{ id = "glacier", duration = 0.6 },
				{ id = "pulse", duration = 0.9, interval = 0.34, range = 7.5, damage = 11 },
			},
		},
	},
