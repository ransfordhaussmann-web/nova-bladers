local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — forge heat / flame rush / molten slam ]]
		CrimsonForgeOverdrive = {
			...
			phases = {
				...
				{ id = "slam", duration = 0.5, range = 7, damage = 42 },
			},
		},
		...
		CrystalTideBarrier = {
			...
			phases = {
				...
				{ id = "waves", duration = 0.85, interval = 0.32, range = 7.5, damage = 12 },
				{ id = "shatter", duration = 0.4, range = 8, damage = 35 },
			},
		},
	},
