	...
	SPECIAL_MOVES = {
		...
		CrimsonRendBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.55, hitInterval = 0.14, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		--[[ Glacier Shield — ice fortress burrow ]]
		GlacierVaultLock = {
			id = "GlacierVaultLock",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.32, range = 9, damage = 11 },
			},
		},
	},
