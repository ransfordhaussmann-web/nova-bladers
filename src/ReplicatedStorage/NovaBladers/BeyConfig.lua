local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — blade whirlwind rush ]]
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "whirl", duration = 0.55, interval = 0.14, hitRadius = 5, damage = 10 },
				{ id = "rush", duration = 0.65, rushSpeed = 88, hitRadius = 6, damage = 14 },
			},
		},
		--[[ Granite Fort — stone anchor + ground pulses ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pillars", duration = 0.6 },
				{ id = "slam", duration = 1.0, interval = 0.35, range = 9, damage = 12 },
			},
		},
		--[[ Solar Drift — sun trail orbit flare ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 0.7, trailInterval = 0.12, trailDamage = 6 },
				{ id = "flare", duration = 0.8, interval = 0.25, range = 7, damage = 11 },
			},
		},
		--[[ Phantom Edge — afterimage dash salvo ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.45, rushSpeed = 95, dashes = 3 },
				{ id = "salvo", duration = 0.6, interval = 0.15, range = 5.5, damage = 12 },
			},
		},
	},
