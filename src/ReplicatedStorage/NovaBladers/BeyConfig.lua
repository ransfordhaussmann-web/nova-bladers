local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Rending blade arc ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, rushSpeed = 85, hitInterval = 0.14, hitRadius = 4.5, damage = 12, hits = 3 },
				{ id = "rend", duration = 0.45, range = 7, damage = 35 },
			},
		},
