local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonMaelstrom = {
			...
			phases = {
				{ id = "roar", duration = 0.25 },
				{ id = "spin", duration = 0.85, interval = 0.17, range = 5.5, damage = 10 },
				{ id = "lunge", duration = 0.45, rushSpeed = 85, damage = 32 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.65, interval = 0.3, damage = 8 },
		...
		PhantomVoidSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.6, range = 7, damage = 40 },
			},
		},
	},
