	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperFang = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, interval = 0.18, slashes = 3, range = 5, damage = 12 },
				{ id = "lunge", duration = 0.5, rushSpeed = 88, range = 4, damage = 28 },
			},
		},
		...
		SolarCoronaLoop = {
			...
			phases = {
				{ id = "corona", duration = 0.6, interval = 0.2, range = 5, damage = 8 },
				{ id = "recover", duration = 0.5 },
				{ id = "drift", duration = 0.9, rushSpeed = 55 },
			},
		},
		...
		PhantomPhaseCut = {
			...
			phases = {
				{ id = "phase", duration = 0.35 },
				{ id = "dash", duration = 0.45, rushSpeed = 95 },
				{ id = "cut", duration = 0.3, range = 7, damage = 42 },
			},
		},
	},
