local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Inferno meteor rush ]]
		FangInfernoBurst = {
			id = "FangInfernoBurst",
		...
		HelixFlare = {
			...
			phases = {
				{ id = "charge", duration = 0.38 },
				{ id = "sonic", duration = 0.78, interval = 0.25, damage = 10 },
				{ id = "orbit", duration = 0.64 },
			},
		},
	},
