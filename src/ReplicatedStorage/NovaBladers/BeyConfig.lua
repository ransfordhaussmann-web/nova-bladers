local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — Hammer slam + shrapnel burst ]]
		CrimsonForgeBreak = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "slam", duration = 0.35, rushSpeed = 70 },
				{ id = "shrapnel", duration = 0.75, hitInterval = 0.22, hitRadius = 6, damage = 12, hits = 3 },
			},
		},
		--[[ Frost Crown — Frost aura + ice crown shield + shatter wave ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
