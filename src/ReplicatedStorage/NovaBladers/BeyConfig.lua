local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid blade salvo / meteor rush ]]
		CrimsonRendStorm = {
			id = "CrimsonRendStorm",
			...
			phases = {
				...
				{ id = "shower", duration = 0.78, hitInterval = 0.14, hitRadius = 5.0, damage = 12, hits = 5 },
			},
		},
		--[[ Glacier Core — ice fortress / frost pulse ]]
		GlacierBastion = {
			id = "GlacierBastion",
