local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — aggressive slash rush + fang combo ]]
		CrimsonRipper = {
			id = "CrimsonRipper",
			name = "Crimson Ripper",
			mode = "ripper",
			...
			phases = {
				...
				{ id = "rip", duration = 0.75, hitInterval = 0.14, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Glacier Core — frost aura, ice shell, binding pulses ]]
		GlacierBind = {
			id = "GlacierBind",
			name = "Glacier Bind",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "bind", duration = 0.85, interval = 0.32, range = 7.5, damage = 12 },
			},
		},
	},
