local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — spiralförmiger Fang-Rush ]]
		CrimsonSpiralFang = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.72, hitInterval = 0.14, hitRadius = 5.0, damage = 13, hits = 5 },
			},
		},
		--[[ Neon Pulse — pulsierende Schockwellen + Orbit ]]
		NeonPulseSurge = {
			id = "NeonPulseSurge",
			...
			phases = {
				...
				{ id = "sonic", duration = 0.9, interval = 0.24, damage = 8 },
