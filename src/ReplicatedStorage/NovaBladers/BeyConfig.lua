local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — spinning saw slashes + lunge ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "saw", duration = 0.7, interval = 0.16, hitRadius = 4.5, damage = 10, hits = 4 },
				{ id = "lunge", duration = 0.45, rushSpeed = 88, hitRadius = 5, damage = 22 },
			},
		},
		--[[ Frost Ring — ice barrier, slow, shatter burst ]]
		GlacialFrostBarrier = {
