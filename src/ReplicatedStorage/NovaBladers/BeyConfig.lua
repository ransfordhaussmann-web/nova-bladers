local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — fire lance rush + eruption ]]
		CrimsonInfernoLance = {
			id = "CrimsonInfernoLance",
			name = "Crimson Inferno Lance",
			mode = "inferno",
			duration = 1.25,
			rushSpeed = 88,
			damage = 40,
			...
			phases = {
				...
				{ id = "lance", duration = 0.38, rushSpeed = 88 },
				{ id = "eruption", duration = 0.55, interval = 0.22, range = 7, damage = 14 },
			},
		},
		--[[ Frost Crown — ice armor + shard rings + shatter ]]
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.75, interval = 0.3, range = 5, damage = 10 },
