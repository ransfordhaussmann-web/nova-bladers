	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "scatter", duration = 0.3, rushSpeed = 74 },
		...
		TideAnchorCrash = {
			...
			phases = {
				{ id = "rise", duration = 0.35, liftSpeed = 42 },
				{ id = "hang", duration = 0.25 },
				{ id = "crash", duration = 0.5, slamSpeed = 65, range = 7, damage = 38 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "phase", duration = 0.4, rushSpeed = 95 },
