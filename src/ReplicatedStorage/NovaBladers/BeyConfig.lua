	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "finisher", duration = 0.25, rushSpeed = 95, range = 7, damage = 28 },
			},
		},
		...
		--[[ Solar Drift — sun flare drift trail ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 0.85, hitInterval = 0.2, hitRadius = 4.5, damage = 8 },
				{ id = "flare", duration = 0.45, range = 7, damage = 32 },
			},
		},
		--[[ Phantom Edge — phantom dash + edge surge ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.45, rushSpeed = 100, clones = 3 },
