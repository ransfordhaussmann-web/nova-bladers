local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — aggressive fang rush (Creator Store) ]]
		CrimsonFangRush = {
			id = "CrimsonFangRush",
			...
			phases = {
				...
				{ id = "shower", duration = 0.68, hitInterval = 0.22, hitRadius = 5, damage = 14, hits = 3 },
			},
		},
		--[[ Frost Halo — ice crown fortress (Creator Store) ]]
		FrostHaloCrown = {
			id = "FrostHaloCrown",
