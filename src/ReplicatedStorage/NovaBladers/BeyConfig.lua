	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, interval = 0.17, hitRadius = 5, damage = 10, spins = 5 },
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "drift", duration = 0.95, rushSpeed = 76, trailInterval = 0.12, trailRadius = 4.5, trailDamage = 8 },
				{ id = "nova", duration = 0.4, range = 8, damage = 32 },
			},
		},
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.7, dashes = 3, dashSpeed = 95, hitRadius = 5, damage = 14 },
				{ id = "fade", duration = 0.35, range = 6, damage = 24 },
			},
		},
	},
