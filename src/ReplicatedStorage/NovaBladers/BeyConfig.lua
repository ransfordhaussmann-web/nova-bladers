local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — aggressive meteor claw rush ]]
		CrimsonRipperClaw = {
		...
		--[[ Granite Fort — stone fortress burrow ]]
		GraniteBulwark = {
			id = "GraniteBulwark",
		...
		--[[ Phantom Edge — ghost dive strike ]]
		PhantomVanishStrike = {
			id = "PhantomVanishStrike",
			name = "Phantom Vanish Strike",
			mode = "eclipse",
			duration = 1.1,
			rushSpeed = 88,
			damage = 40,
			...
			phases = {
				...
				{ id = "dive", duration = 0.35, rushSpeed = 88, diveSpeed = 44 },
				{ id = "burst", duration = 0.35, range = 7, damage = 36 },
			},
		},
		--[[ Crystal Edge — ice shard meteor shower ]]
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.25, rushSpeed = 74 },
				{ id = "shower", duration = 0.8, hitInterval = 0.2, hitRadius = 6, damage = 10, hits = 4 },
			},
		},
		--[[ Blaze Crown — flame sonic inferno ]]
		BlazeInfernoCrown = {
			id = "BlazeInfernoCrown",
			name = "Blaze Inferno Crown",
			mode = "sonic",
			duration = 1.65,
			damage = 34,
			spinLoss = 14,
			...
			phases = {
				...
				{ id = "sonic", duration = 0.7, interval = 0.22, damage = 10 },
				{ id = "orbit", duration = 0.7 },
			},
		},
	},
