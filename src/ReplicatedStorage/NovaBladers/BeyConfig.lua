	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.5, hitInterval = 0.15, hitRadius = 4.5, damage = 14, hits = 3 },
			},
		},
		--[[ Granite Fort — Stone bastion + counter pulses ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "counter", duration = 0.75, interval = 0.35, range = 7, damage = 15 },
			},
		},
		--[[ Solar Drift — Solar flare rings + burst ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "rings", duration = 0.7, interval = 0.2, damage = 8 },
				{ id = "burst", duration = 0.65, range = 9, damage = 22 },
			},
		},
		--[[ Phantom Edge — Mirage strikes + blade finale ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "mirage", duration = 0.55, strikes = 3, interval = 0.18, damage = 10 },
				{ id = "edge", duration = 0.55, rushSpeed = 95, range = 5, damage = 32 },
			},
		},
	},
