	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.65, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		...
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.75, interval = 0.3, range = 7, damage = 11 },
				{ id = "shimmer", duration = 0.4, range = 7.5, damage = 22 },
			},
		},
	},
