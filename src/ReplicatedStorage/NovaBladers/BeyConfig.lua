	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.65, interval = 0.16, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / shockwave release ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.7, interval = 0.35, range = 7, damage = 10 },
				{ id = "burst", duration = 0.65, range = 9, damage = 32 },
			},
		},
	},
