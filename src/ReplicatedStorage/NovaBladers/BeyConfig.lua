local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Blade Cyclone / spinning slash combo ]]
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, hitInterval = 0.17, hitRadius = 5, damage = 10, hits = 5 },
				{ id = "finisher", duration = 0.35, rushSpeed = 88, range = 7, damage = 32 },
			},
		},
		--[[ Granite Fort — Bastion Pulse / stone wall shockwaves ]]
		GraniteBastionPulse = {
		...
		--[[ Solar Drift — Flare Drift / solar ring burn ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "rings", duration = 0.75, interval = 0.25, damage = 8, range = 5 },
				{ id = "flare", duration = 0.55, range = 7.5, damage = 36 },
			},
		},
		--[[ Phantom Edge — Edge Surge / phantom dash + echo blades ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.45, rushSpeed = 95, echoCount = 3 },
				{ id = "burst", duration = 0.35, range = 6, damage = 34 },
			},
		},
	},
