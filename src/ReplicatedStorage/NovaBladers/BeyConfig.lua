local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrystalShatterSurge = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "leap", duration = 0.25, leapHeight = 6 },
				{ id = "shatter", duration = 0.95, interval = 0.22, range = 5, damage = 13, waves = 4 },
			},
		},
		BlazeCrownSpiral = {
			id = "BlazeCrownSpiral",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.95, rushSpeed = 75, spiralRadius = 8 },
				{ id = "crown", duration = 0.35, range = 7, damage = 40 },
			},
		},
	},
