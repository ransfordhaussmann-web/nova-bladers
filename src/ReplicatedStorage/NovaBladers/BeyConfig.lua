	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.45, rushSpeed = 86 },
				{ id = "ripper", duration = 0.5, hitInterval = 0.16, hitRadius = 4.5, damage = 10, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "phantom", duration = 0.5, rushSpeed = 88, clones = 3 },
				{ id = "converge", duration = 0.35, range = 7, damage = 36 },
			},
		},
	},
