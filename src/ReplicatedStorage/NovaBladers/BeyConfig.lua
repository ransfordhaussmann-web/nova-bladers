	...
	SPECIAL_MOVES = {
		...
		FangInfernoBurst = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.16, hitRadius = 5.8, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Crown — glacier bunker ]]
		GlacierBastion = {
			id = "GlacierBastion",
		...
		--[[ Blaze Quill — flame feather rush ]]
		BlazeQuillBarrage = {
		...
		--[[ Tide Anchor — tidal fortress pulse ]]
		TideAnchorSurge = {
			id = "TideAnchorSurge",
			...
			spinLoss = 6,
			damageReduction = 0.6,
			color = Color3.fromRGB(50, 190, 220),
			phases = {
