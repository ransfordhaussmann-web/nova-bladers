local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spiral orbit hits + fang rush ]]
		CrimsonSpiralFang = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.75, interval = 0.22, damage = 10, range = 4.5 },
				{ id = "fang", duration = 0.42, rushSpeed = 88, range = 7, damage = 36 },
			},
		},
