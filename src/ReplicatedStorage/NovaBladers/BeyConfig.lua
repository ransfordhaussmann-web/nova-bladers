	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperStrike = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.7, hitInterval = 0.22, hitRadius = 4.5, damage = 14, hits = 3 },
			},
		},
		--[[ Granite Fort — heavy fortress wall ]]
		GraniteBulwark = {
			id = "GraniteBulwark",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.38, range = 9, damage = 15 },
			},
		},
		--[[ Solar Drift — wide sonic flare orbit ]]
		SolarFlareLoop = {
			id = "SolarFlareLoop",
