local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Fire arc slash + rend strike ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "arc", duration = 0.55, interval = 0.14, hitRadius = 4.5, damage = 10, hits = 3 },
				{ id = "rend", duration = 0.35, rushSpeed = 95, range = 5, damage = 32 },
			},
		},
