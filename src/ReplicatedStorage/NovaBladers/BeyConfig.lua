	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge1", duration = 0.22, rushSpeed = 88 },
				{ id = "lunge2", duration = 0.22, rushSpeed = 92 },
				{ id = "fang", duration = 0.36, range = 5.5, damage = 28 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "counter", duration = 0.9, interval = 0.3, range = 7, damage = 10 },
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "blink", duration = 0.35, rushSpeed = 100 },
