	...
	SPECIAL_MOVES = {
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "rend", duration = 0.45, range = 7, damage = 36 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				{ id = "stomp", duration = 0.4, range = 7, damage = 12 },
				{ id = "rampart", duration = 0.6 },
				{ id = "bash", duration = 0.5, range = 8, damage = 22 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.35, range = 6, damage = 38 },
			},
		},
	},
