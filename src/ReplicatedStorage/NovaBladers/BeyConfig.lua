local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crystal Vortex — freeze, shard burst, ice rush ]]
		CrystalShatterStorm = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.45, rushSpeed = 70 },
			},
		},
		--[[ Ember Ring — ignite, spiral burn, phoenix burst ]]
		EmberPhoenixSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.8, interval = 0.2, damage = 9 },
