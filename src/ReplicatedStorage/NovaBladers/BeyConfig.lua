local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — Inferno charge / fire dash / flare burst ]]
		CrimsonInfernoRush = {
		...
		--[[ Frost Crown — Crystal aura / ice shard barrage / shatter wave ]]
		FrostCrownBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.9, interval = 0.22, hits = 4, damage = 10, range = 5 },
				{ id = "shatter", duration = 0.3, range = 8, damage = 28 },
			},
		},
	},
