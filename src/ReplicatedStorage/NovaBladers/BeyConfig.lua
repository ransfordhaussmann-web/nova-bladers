local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid slash combo + rend finish ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.65, hitInterval = 0.14, hitRadius = 4.5, damage = 12, slashes = 5 },
				{ id = "finish", duration = 0.35, range = 7, damage = 28, rushSpeed = 95 },
			},
		},
		--[[ Frost Ring — frost aura, ice barrier, shard pulse ]]
		GlacialFrostBarrier = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.7, interval = 0.25, range = 7, damage = 10 },
			},
		},
	},
