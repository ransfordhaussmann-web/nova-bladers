	...
	SPECIAL_MOVES = {
		...
		CrimsonRipClaw = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.72, hitInterval = 0.14, hitRadius = 4.5, damage = 13, hits = 5 },
			},
		},
		GraniteBulwark = {
			id = "GraniteBulwark",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.95, interval = 0.3, range = 9, damage = 15 },
			},
		},
		SolarFlareBurst = {
			id = "SolarFlareBurst",
			...
			phases = {
				...
				{ id = "sonic", duration = 0.85, interval = 0.22, damage = 8 },
