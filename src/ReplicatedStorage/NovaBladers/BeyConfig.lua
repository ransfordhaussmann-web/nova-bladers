	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.45, interval = 0.15, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "quake", duration = 0.85, interval = 0.32, range = 7.5, damage = 11 },
				{ id = "shatter", duration = 0.35, range = 8, damage = 22 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "flares", duration = 0.85, interval = 0.26, damage = 8 },
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "mirage", duration = 0.5, interval = 0.12, hitRadius = 4, damage = 10, hits = 4 },
				{ id = "edge", duration = 0.35, range = 5.5, damage = 30 },
			},
		},
	},
