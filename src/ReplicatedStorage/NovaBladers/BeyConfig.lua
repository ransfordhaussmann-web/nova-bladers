	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.7, interval = 0.14, hitRadius = 5, damage = 10 },
				{ id = "rush", duration = 0.55, rushSpeed = 85, damage = 32 },
			},
		},
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "slam", duration = 0.6, range = 9, damage = 36 },
			},
		},
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.5, range = 8, damage = 34 },
			},
		},
		--[[ Phantom Edge — phantom dash + edge burst ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "edge", duration = 0.5, range = 7, damage = 36 },
			},
		},
	},
