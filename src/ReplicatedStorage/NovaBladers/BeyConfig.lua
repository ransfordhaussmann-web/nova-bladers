local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				{ id = "scatter", duration = 0.35 },
				{ id = "storm", duration = 0.75, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 3 },
				{ id = "rush", duration = 0.4, rushSpeed = 80 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "wave", duration = 0.8, interval = 0.35, range = 7, damage = 11 },
				{ id = "crash", duration = 0.6, range = 8, damage = 32 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				{ id = "howl", duration = 0.2 },
				{ id = "lunge", duration = 0.35, rushSpeed = 88 },
				{ id = "rend", duration = 0.5, hitInterval = 0.15, hitRadius = 4.5, damage = 14, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "quake", duration = 0.9, interval = 0.4, range = 9, damage = 12 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "loop", duration = 0.85, interval = 0.3, damage = 8 },
				{ id = "burst", duration = 0.6, range = 8, damage = 22 },
			},
		},
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, rushSpeed = 95, range = 7, damage = 36 },
				{ id = "afterimage", duration = 0.3 },
			},
		},
	},
