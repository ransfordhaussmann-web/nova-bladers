local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Spiral rush + rotation slashes ]]
		CrimsonSpiralStrike = {
		...
		--[[ Frost Crown — Ice shell + frost waves ]]
		GlacierBastion = {
			id = "GlacierBastion",
			...
			phases = {
				...
				{ id = "frost", duration = 0.7, interval = 0.3, range = 9, damage = 11 },
				{ id = "snap", duration = 0.5, range = 10, damage = 18 },
			},
		},
	},
