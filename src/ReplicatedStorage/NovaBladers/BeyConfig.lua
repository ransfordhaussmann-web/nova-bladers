local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — wide slash rush + rending arc ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, rushSpeed = 82, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 3 },
				{ id = "rend", duration = 0.35, range = 7, damage = 36 },
			},
		},
		--[[ Frost Ring — frost barrier + shatter burst ]]
		GlacialFrostBarrier = {
