	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperBarrage = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.3, rushSpeed = 95 },
				{ id = "barrage", duration = 0.7, hitInterval = 0.12, hitRadius = 4.5, damage = 9, hits = 6 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "shock", duration = 1.1, interval = 0.35, range = 7.5, damage = 12 },
			},
		},
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
			...
			phases = {
				...
				{ id = "corona", duration = 0.55, interval = 0.25, damage = 8 },
				{ id = "loop", duration = 0.95 },
			},
		},
		PhantomMirageCut = {
			id = "PhantomMirageCut",
			...
			damage = 40,
			spinLoss = 14,
			color = Color3.fromRGB(80, 230, 240),
			phases = {
				{ id = "fade", duration = 0.2 },
				{ id = "dash", duration = 0.35, rushSpeed = 100 },
				{ id = "slash", duration = 0.4, range = 6, damage = 40 },
			},
		},
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.8, interval = 0.25, range = 8, damage = 14 },
			},
		},
		CrimsonDriftSurge = {
			...
			phases = {
				{ id = "surge", duration = 0.25 },
				{ id = "drift", duration = 0.9, rushSpeed = 88 },
			},
		},
	},
