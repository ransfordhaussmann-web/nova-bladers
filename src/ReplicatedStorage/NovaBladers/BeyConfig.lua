local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Rip Tide / Fang Chain ]]
		CrimsonRipTide = {
			id = "CrimsonRipTide",
			...
			phases = {
				...
				{ id = "whirl", duration = 0.7, interval = 0.22, hitRadius = 5, damage = 10 },
				{ id = "rip", duration = 0.5, rushSpeed = 88, range = 7, damage = 32 },
			},
		},
		--[[ Frost Crown — Ice Bastion / Shatter Crown ]]
		FrostCrownBastion = {
			...
			phases = {
				{ id = "frostfield", duration = 0.5, range = 7, slowMult = 0.45 },
				{ id = "crown", duration = 0.6 },
				{ id = "shatter", duration = 0.8, interval = 0.35, range = 9, damage = 14 },
			},
		},
		--[[ Neon Spire — Pulse Resonance / Tower Burst ]]
		NeonPulseResonance = {
			...
			phases = {
				{ id = "tune", duration = 0.35 },
				{ id = "pulse", duration = 0.75, interval = 0.28, range = 5, damage = 9 },
				{ id = "resonance", duration = 0.55, chainRange = 14, damage = 22 },
			},
		},
	},
