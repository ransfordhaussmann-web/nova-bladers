	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 1.0, hitInterval = 0.2, hitRadius = 6, damage = 10, hits = 5 },
				{ id = "finisher", duration = 0.25, range = 7, damage = 28 },
			},
		},
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "erupt", duration = 0.5, range = 9, damage = 22 },
			},
		},
		--[[ Solar Drift — sun flare rings while coasting ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 1.0, interval = 0.25, range = 5, damage = 8 },
				{ id = "flare", duration = 0.5, range = 8, damage = 26 },
			},
		},
		--[[ Phantom Edge — phase dash with afterimage strikes ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.65, dashCount = 3, rushSpeed = 88, damage = 14 },
				{ id = "echo", duration = 0.4, range = 7, damage = 32 },
			},
		},
	},
