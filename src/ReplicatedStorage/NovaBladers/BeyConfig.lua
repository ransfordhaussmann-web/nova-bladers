local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Orbit — Solar orbit rush + flame burst ]]
		CrimsonSolarFlare = {
			...
			phases = {
				...
				{ id = "orbit", duration = 0.85, damage = 10 },
				{ id = "burst", duration = 0.35, range = 7, damage = 28 },
			},
		},
		--[[ Frost Anchor — Freeze aura, anchor guard, ice shatter ]]
		FrostGlacierLock = {
			id = "FrostGlacierLock",
			...
			phases = {
				{ id = "freeze", duration = 0.4, range = 7 },
