	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.25, rushSpeed = 82 },
				{ id = "shower", duration = 0.75, hitInterval = 0.16, hitRadius = 5.2, damage = 12, hits = 4 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomMirageCut = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.35, range = 6, damage = 32 },
			},
		},
		CrystalShatterSurge = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.7, interval = 0.2, range = 5, damage = 13, waves = 3 },
			},
		},
		BlazeCrownSpiral = {
			id = "BlazeCrownSpiral",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.22, damage = 9 },
				{ id = "flare", duration = 0.35, rushSpeed = 85, range = 7, damage = 34 },
			},
		},
	},
