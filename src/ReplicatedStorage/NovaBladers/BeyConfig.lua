	...
	SPECIAL_MOVES = {
		...
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.55, hitInterval = 0.14, hitRadius = 4.5, damage = 10, spiralSpeed = 14 },
				{ id = "burst", duration = 0.45, range = 7, damage = 34 },
			},
		},
		--[[ Glacier Mantle — frost barrier / ice shatter ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
