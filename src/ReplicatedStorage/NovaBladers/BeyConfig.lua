local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — Inferno rush + fire meteor trail ]]
		CrimsonInfernoRoar = {
			...
			phases = {
				...
				{ id = "inferno", duration = 0.84, hitInterval = 0.16, hitRadius = 5.8, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Crown — Ice aura, frost shield, crystal shatter ]]
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "fortress", duration = 0.55 },
				{ id = "shatter", duration = 0.95, interval = 0.3, range = 7.5, damage = 14 },
			},
		},
	},
