local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				{ id = "dive", duration = 0.4 },
				{ id = "crash", duration = 0.35, range = 7, damage = 18 },
				{ id = "surge", duration = 0.95, interval = 0.3, range = 7.5, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "rend", duration = 0.55, hitInterval = 0.18, hitRadius = 4.5, damage = 14, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.4, range = 6, damage = 36 },
			},
		},
	},
