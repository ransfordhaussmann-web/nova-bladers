	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.4, rushSpeed = 85, damage = 28 },
			},
		},
		--[[ Granite Fort — stone bastion + pillar pulses + quake ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pillars", duration = 0.9, interval = 0.3, range = 7, damage = 12 },
				{ id = "quake", duration = 0.5, range = 9, damage = 22 },
			},
		},
		--[[ Solar Drift — solar flare trail + wide orbit drift ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "flare", duration = 0.8, interval = 0.2, damage = 8 },
				{ id = "drift", duration = 0.6 },
			},
		},
		--[[ Phantom Edge — phase dashes + edge slash finisher ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.7, dashes = 3, rushSpeed = 88, damage = 14 },
