	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.75, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomMirageCut = {
			...
			phases = {
				...
				{ id = "cut", duration = 0.35, range = 5.5, damage = 36 },
			},
		},
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.9, interval = 0.28, range = 7, damage = 11 },
			},
		},
		CrimsonDriftSurge = {
			...
			phases = {
				{ id = "surge", duration = 0.2 },
				{ id = "drift", duration = 0.45, rushSpeed = 95 },
				{ id = "impact", duration = 0.3, range = 6, damage = 40 },
			},
		},
	},
