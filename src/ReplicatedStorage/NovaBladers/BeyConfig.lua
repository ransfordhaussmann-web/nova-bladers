	...
	SPECIAL_MOVES = {
		...
		CrimsonInfernoRush = {
			...
			phases = {
				...
				{ id = "blaze", duration = 0.75, rushSpeed = 85, hitInterval = 0.2, hitRadius = 4.5, damage = 10 },
				{ id = "inferno", duration = 0.35, range = 7, damage = 32 },
			},
		},
		AuroraPrismShield = {
			...
			phases = {
				...
				{ id = "refract", duration = 0.9, interval = 0.3, range = 7, damage = 11 },
				{ id = "finale", duration = 0.45, range = 9, damage = 22 },
			},
		},
	},
