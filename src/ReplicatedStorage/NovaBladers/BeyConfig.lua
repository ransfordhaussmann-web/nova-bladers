	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, interval = 0.15, hitRadius = 5, damage = 10, spinSpeed = 22 },
				{ id = "slash", duration = 0.4, rushSpeed = 85, damage = 28, range = 7 },
			},
		},
		--[[ Granite Fort — stone bastion + ground quake ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pillars", duration = 0.6, count = 4 },
				{ id = "quake", duration = 0.8, interval = 0.35, range = 9, damage = 14 },
			},
		},
		--[[ Solar Drift — sun flare + coast drift ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "flare", duration = 0.45, range = 7.5, damage = 32 },
				{ id = "drift", duration = 0.8, coastSpeed = 58 },
			},
		},
		--[[ Phantom Edge — phase dashes + finisher ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			damage = 36,
			spinLoss = 14,
			color = Color3.fromRGB(100, 220, 210),
			phases = {
				{ id = "fade", duration = 0.2 },
				{ id = "surge", duration = 0.7, strikes = 3, interval = 0.22, rushSpeed = 88, damage = 14 },
				{ id = "finisher", duration = 0.5, rushSpeed = 95, damage = 35, range = 6 },
			},
		},
	},
