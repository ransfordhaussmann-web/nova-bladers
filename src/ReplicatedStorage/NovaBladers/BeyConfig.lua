	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.68, hitInterval = 0.14, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
		...
		CrystalShardRain = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.95, hitInterval = 0.15, hitRadius = 6, damage = 9, hits = 6 },
			},
		},
		BlazeCrownInferno = {
			...
			phases = {
				...
				{ id = "dive", duration = 0.42, rushSpeed = 86, diveSpeed = 44 },
				{ id = "burst", duration = 0.4, range = 7.5, damage = 42 },
			},
		},
	},
