local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				{ id = "draw", duration = 0.25 },
				{ id = "lunge", duration = 0.35, rushSpeed = 88 },
				{ id = "ripper", duration = 0.6, hitInterval = 0.2, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / frost release ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "release", duration = 0.6, range = 9, damage = 18 },
			},
		},
	},
