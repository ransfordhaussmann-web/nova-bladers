	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "slam", duration = 0.35, rushSpeed = 70, diveSpeed = 55 },
				{ id = "wave", duration = 0.85, interval = 0.3, range = 9, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				{ id = "lunge", duration = 0.2, rushSpeed = 88 },
				{ id = "rend", duration = 0.55, hitInterval = 0.12, hitRadius = 4.5, damage = 9, hits = 4 },
				{ id = "finish", duration = 0.25, range = 5.5, damage = 22 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "quake", duration = 0.95, interval = 0.34, range = 7.5, damage = 14 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			damage = 38,
			spinLoss = 14,
			color = Color3.fromRGB(180, 180, 230),
			phases = {
				{ id = "phase", duration = 0.22 },
				{ id = "slash", duration = 0.38, rushSpeed = 95 },
				{ id = "exit", duration = 0.35, range = 6, damage = 32 },
			},
		},
	},
