local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — expanding fire cyclone ]]
		EmberCyclone = {
			id = "EmberCyclone",
			name = "Ember Cyclone",
			mode = "cyclone",
			...
			phases = {
				...
				{ id = "sweep", duration = 0.9, interval = 0.2, hitRadius = 5, damage = 10, expandRate = 1.5 },
				{ id = "flare", duration = 0.3, range = 7, damage = 22 },
			},
		},
		...
		GlacierShroud = {
			...
			phases = {
				...
				{ id = "shroud", duration = 0.4, range = 8, damage = 18 },
			},
		},
	},
