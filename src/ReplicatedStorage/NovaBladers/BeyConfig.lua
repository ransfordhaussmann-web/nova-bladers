local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Comet — fire rush with impact burst ]]
		CometStreak = {
			id = "CometStreak",
			name = "Comet Streak",
			mode = "comet",
			...
			phases = {
				...
				{ id = "streak", duration = 0.45, rushSpeed = 95 },
				{ id = "impact", duration = 0.3, range = 7, damage = 36 },
			},
		},
		--[[ Frost Prism — crystal shield and shatter wave ]]
		CrystalBastion = {
			id = "CrystalBastion",
