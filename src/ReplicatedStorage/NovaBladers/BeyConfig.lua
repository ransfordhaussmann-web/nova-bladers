	...
	SPECIAL_MOVES = {
		...
		EmberCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, interval = 0.22, range = 5, damage = 10 },
				{ id = "rush", duration = 0.35, rushSpeed = 80 },
			},
		},
		--[[ Frost Veil — ice shroud + shard burst ]]
		GlacierShroud = {
			id = "GlacierShroud",
			name = "Glacier Shroud",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shroud", duration = 0.7, interval = 0.35, range = 7, damage = 8 },
				{ id = "shards", duration = 0.6, interval = 0.2, range = 8, damage = 14 },
			},
		},
	},
