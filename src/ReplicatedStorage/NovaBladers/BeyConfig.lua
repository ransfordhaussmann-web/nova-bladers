local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Inferno meteor burst ]]
		FangInfernoBurst = {
			id = "FangInfernoBurst",
			...
			phases = {
				...
				{ id = "shower", duration = 0.95, hitInterval = 0.15, hitRadius = 6, damage = 13, hits = 5 },
			},
		},
		...
		GlacierBastion = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.3, range = 9, damage = 15 },
			},
		},
