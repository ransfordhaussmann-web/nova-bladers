	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.7, hitInterval = 0.14, hitRadius = 4.5, damage = 12, hits = 5 },
			},
		},
		--[[ Aurora Crest — Polar barrier dome + energy burst ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.75, interval = 0.38, range = 9, damage = 15 },
			},
		},
	},
