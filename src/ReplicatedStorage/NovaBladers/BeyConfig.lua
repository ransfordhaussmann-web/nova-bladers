local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "cyclone", duration = 1.0, hitInterval = 0.2, hitRadius = 5, damage = 10 },
				{ id = "slash", duration = 0.3, range = 7, damage = 32 },
			},
		},
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.5, interval = 0.38, range = 9, damage = 14 },
			},
		},
		...
		SolarFlareDrift = {
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "flare", duration = 1.2, hitInterval = 0.25, hitRadius = 4.5, damage = 9 },
				{ id = "burst", duration = 0.25, range = 6, damage = 28 },
			},
		},
		--[[ Phantom Edge — phantom dash slashes ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.85, dashes = 3, dashSpeed = 95, hitRadius = 4, damage = 12 },
				{ id = "finisher", duration = 0.3, range = 6.5, damage = 36 },
			},
		},
	},
