	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, interval = 0.2, baseRadius = 4, damage = 10, hits = 5 },
				{ id = "lunge", duration = 0.45, rushSpeed = 82 },
			},
		},
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.75, interval = 0.3, range = 7, damage = 12 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "echo", duration = 0.35, rushSpeed = 88 },
