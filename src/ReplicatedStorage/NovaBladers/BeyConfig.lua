local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — spinning blade arcs and finisher slash ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.9, interval = 0.22, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "finisher", duration = 0.3, range = 7, damage = 28 },
			},
		},
		--[[ Frost Ring — ice barrier and shatter burst ]]
		GlacialFrostBarrier = {
			...
			phases = {
				...
				{ id = "barrier", duration = 0.85, interval = 0.38, range = 7, damage = 11 },
