local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — fire orbit + inferno burst ]]
		BlazeInfernoLoop = {
			id = "BlazeInfernoLoop",
			...
			phases = {
				...
				{ id = "orbit", duration = 0.85, sparkInterval = 0.12, damage = 8 },
				{ id = "inferno", duration = 0.5, range = 7, damage = 34 },
			},
		},
		--[[ Frost Veil — ice wall + frost pulses ]]
		FrostBastion = {
			id = "FrostBastion",
			name = "Frost Bastion",
			mode = "fortress",
			...
			phases = {
				...
				{ id = "wall", duration = 0.55 },
				{ id = "pulse", duration = 0.95, interval = 0.34, range = 8.5, damage = 12 },
			},
		},
	},
