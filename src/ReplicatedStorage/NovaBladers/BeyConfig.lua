	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.9, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "pull", duration = 0.5, pullStrength = 22, range = 10 },
				{ id = "crash", duration = 0.35, rushSpeed = 65 },
				{ id = "splash", duration = 0.6, range = 7.5, damage = 28 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "rend", duration = 0.75, hitInterval = 0.22, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "quake", duration = 1.0, interval = 0.35, range = 8.5, damage = 14 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				{ id = "phase", duration = 0.35, rushSpeed = 95 },
				{ id = "slash", duration = 0.4, range = 7, damage = 40 },
