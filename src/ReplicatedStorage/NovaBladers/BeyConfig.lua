local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — Inferno charge / flame rush / fire burst ]]
		CrimsonInfernoRoar = {
			...
			phases = {
				...
				{ id = "roar", duration = 0.35, rushSpeed = 82 },
				{ id = "inferno", duration = 0.85, hitInterval = 0.2, hitRadius = 5.5, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Crown — Ice crown / frost shield / crystal shatter ]]
		FrostCrownShatter = {
