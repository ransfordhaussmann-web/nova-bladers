	...
	SPECIAL_MOVES = {
		...
		BlazeCorkscrew = {
			...
			phases = {
				...
				{ id = "corkscrew", duration = 0.75, orbitRadius = 5, orbitSpeed = 24, hitInterval = 0.2, damage = 10 },
				{ id = "flare", duration = 0.35, range = 7, damage = 28 },
			},
		},
		--[[ Frost Orbit — ice shield + frost pulses ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "freeze", duration = 0.55, range = 9, damage = 8 },
				{ id = "lock", duration = 0.95, interval = 0.35, range = 7, damage = 11 },
			},
		},
	},
