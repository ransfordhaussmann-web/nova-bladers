	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.5, hitInterval = 0.15, hitRadius = 5, damage = 14, hits = 3 },
			},
		},
		--[[ Aurora Crest — Polar dome shield / frost wave pulses ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "waves", duration = 1.2, interval = 0.38, range = 7, damage = 11 },
			},
		},
	},
