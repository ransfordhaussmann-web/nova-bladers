	...
	SPECIAL_MOVES = {
		...
		CrimsonFangStorm = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.55, rushSpeed = 85, hitInterval = 0.16, hitRadius = 4.5, damage = 12, hits = 3 },
		...
		PhantomPhaseStrike = {
			...
			damage = 40,
			spinLoss = 15,
			color = Color3.fromRGB(120, 90, 210),
			phases = {
				{ id = "phase", duration = 0.28 },
				{ id = "strike", duration = 0.38, rushSpeed = 88 },
				{ id = "echo", duration = 0.4, range = 6, damage = 36 },
			},
		},
	},
