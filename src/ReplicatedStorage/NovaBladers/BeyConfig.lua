	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.75, hitInterval = 0.15, hitRadius = 4.5, damage = 8, hits = 5 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / polar shield nova ]]
		AuroraBarrierDome = {
			...
			spinLoss = 10,
			damageReduction = 0.6,
			color = Color3.fromRGB(90, 220, 240),
			accentColor = Color3.fromRGB(255, 130, 210),
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "dome", duration = 1.1, interval = 0.4, range = 5, damage = 10 },
				{ id = "nova", duration = 0.45, range = 9, damage = 32 },
			},
		},
	},
