local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — hammer rush + fire impacts ]]
		ForgeHammerBarrage = {
			id = "ForgeHammerBarrage",
			name = "Forge Hammer Barrage",
			mode = "meteor",
			duration = 1.2,
			rushSpeed = 82,
			damage = 38,
			...
			phases = {
				...
				{ id = "shower", duration = 0.65, hitInterval = 0.2, hitRadius = 5, damage = 13, hits = 3 },
			},
		},
		--[[ Aqua Spiral — water sonic rings + orbit vortex ]]
		TidalVortex = {
			id = "TidalVortex",
			name = "Tidal Vortex",
			mode = "sonic",
