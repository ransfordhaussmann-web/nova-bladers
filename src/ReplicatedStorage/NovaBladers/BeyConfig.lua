	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.38, rushSpeed = 98 },
				{ id = "rip", duration = 0.25, hitRadius = 4.5, damage = 42 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "hold", duration = 0.65 },
				{ id = "counter", duration = 0.4, interval = 0.2, range = 7.5, damage = 22 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				{ id = "glow", duration = 0.28 },
				{ id = "flares", duration = 0.85, interval = 0.24, damage = 8 },
				{ id = "sustain", duration = 0.42, interval = 0.3, damage = 10 },
			},
		},
		PhantomBladeMirage = {
			...
			phases = {
				{ id = "fade", duration = 0.18 },
				{ id = "dash1", duration = 0.22, rushSpeed = 70 },
				{ id = "dash2", duration = 0.22, rushSpeed = 80 },
				{ id = "slash", duration = 0.28, range = 5.5, damage = 32 },
			},
		},
	},
