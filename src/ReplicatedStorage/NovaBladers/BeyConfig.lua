local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Prism — ice cage / frost waves / crystal shatter ]]
		GlacierPrismCage = {
			id = "GlacierPrismCage",
			...
			phases = {
				{ id = "cage", duration = 0.6 },
				{ id = "freeze", duration = 0.7, interval = 0.25, range = 7, damage = 10 },
				{ id = "shatter", duration = 0.6, range = 9, damage = 32 },
			},
		},
		--[[ Ember Core — ignite / melt rush / core explosion ]]
		CoreMeltdown = {
			id = "CoreMeltdown",
			name = "Core Meltdown",
			mode = "melt",
			...
			phases = {
				...
				{ id = "melt", duration = 0.45, rushSpeed = 82 },
				{ id = "meltdown", duration = 0.45, range = 7.5, damage = 42 },
			},
		},
	},
