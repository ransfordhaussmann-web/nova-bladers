local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		AuroraBarrierDome = {
			...
			phases = {
				{ id = "channel", duration = 0.3 },
				{ id = "dome", duration = 1.0 },
				{ id = "shock", duration = 0.5, interval = 0.25, range = 7, damage = 11 },
				{ id = "shatter", duration = 0.25, range = 8, damage = 22 },
			},
		},
	},
