local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Quill — fire feather meteor rush ]]
		BlazeFeatherStorm = {
		...
		--[[ Tide Anchor — tidal burrow + surge pulses ]]
		TideLockSurge = {
			id = "TideLockSurge",
		...
		--[[ Crimson Fang — crimson dive ripper ]]
		CrimsonRipperSlash = {
		...
		--[[ Granite Fort — earthquake sonic orbit ]]
		GraniteQuakeBastion = {
			...
			phases = {
				...
				{ id = "sonic", duration = 0.85, interval = 0.32, damage = 10 },
				{ id = "orbit", duration = 0.65 },
			},
		},
	},
