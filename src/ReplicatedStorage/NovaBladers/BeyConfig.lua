	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.7, hitInterval = 0.14, hitRadius = 4.5, damage = 9, hits = 5 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "quake", duration = 0.9, interval = 0.34, range = 9, damage = 14 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "heatwave", duration = 0.7, interval = 0.26, damage = 8 },
				{ id = "orbit", duration = 0.65 },
			},
		},
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "mirage", duration = 0.5, dashInterval = 0.17, dashes = 3, dashSpeed = 95 },
