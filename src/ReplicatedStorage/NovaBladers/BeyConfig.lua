local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spinning vortex + crimson rush ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "vortex", duration = 0.55, interval = 0.14, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "rush", duration = 0.65, rushSpeed = 88 },
			},
		},
		--[[ Glacier Mantle — frost mantle + ice wall + shatter pulse ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
			...
			phases = {
				{ id = "mantle", duration = 0.4 },
				{ id = "frostwall", duration = 0.55 },
				{ id = "shatter", duration = 0.95, interval = 0.34, range = 7.5, damage = 12 },
			},
		},
	},
