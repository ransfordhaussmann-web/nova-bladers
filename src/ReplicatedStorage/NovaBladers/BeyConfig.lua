	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.63, hitInterval = 0.15, hitRadius = 4.5, damage = 12, hits = 4 },
			},
		},
		...
		AuroraBarrierDome = {
			...
			color = Color3.fromRGB(90, 220, 245),
			phases = {
				{ id = "charge", duration = 0.3 },
				{ id = "dome", duration = 0.85 },
				{ id = "burst", duration = 0.75, interval = 0.38, range = 9, damage = 14 },
			},
		},
	},
