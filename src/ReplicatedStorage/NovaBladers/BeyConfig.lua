local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — ignite, fire rush, ground slam ]]
		CrimsonForgeBreak = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.4, rushSpeed = 84 },
				{ id = "slam", duration = 0.5, range = 7.5, damage = 40 },
			},
		},
		--[[ Frost Crown — chill aura, ice barrier, shard pulses ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
