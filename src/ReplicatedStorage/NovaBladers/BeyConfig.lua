	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.45, rushSpeed = 80 },
				{ id = "burst", duration = 0.4, range = 6, damage = 14, hitInterval = 0.15 },
			},
		},
		--[[ Tide Anchor — Anchor slam + tidal waves ]]
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "slam", duration = 0.35, slamSpeed = 55 },
				{ id = "waves", duration = 0.75, interval = 0.3, range = 9, damage = 11 },
			},
		},
		--[[ Crimson Fang — Triple slash combo ]]
		CrimsonRend = {
			id = "CrimsonRend",
			name = "Crimson Rend",
			mode = "rend",
			...
			phases = {
				...
				{ id = "slash1", duration = 0.25, rushSpeed = 65, damage = 12 },
				{ id = "slash2", duration = 0.25, rushSpeed = 70, damage = 13 },
				{ id = "slash3", duration = 0.3, rushSpeed = 80, damage = 16, range = 5 },
			},
		},
		--[[ Granite Fort — Stone rampart + pulses ]]
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.7, interval = 0.32, range = 7.5, damage = 12 },
				{ id = "crumble", duration = 0.5, range = 10, damage = 18 },
			},
		},
		...
		SolarFlareLoop = {
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "loop", duration = 0.85 },
				{ id = "flare", duration = 0.45, range = 8, damage = 22 },
			},
		},
		--[[ Phantom Edge — Phase dash + echo slashes ]]
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "echo", duration = 0.4, hits = 3, hitInterval = 0.12, range = 5, damage = 10 },
			},
		},
	},
