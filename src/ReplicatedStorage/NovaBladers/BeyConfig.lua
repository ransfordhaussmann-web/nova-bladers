	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.65, hitInterval = 0.16, hitRadius = 4.5, damage = 10, hits = 3 },
			},
		},
		--[[ Granite Fort — Stone bastion + shard pulse ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.5, range = 6, damage = 36 },
			},
		},
	},
