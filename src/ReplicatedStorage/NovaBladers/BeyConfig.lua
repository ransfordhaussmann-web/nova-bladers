	...
	SPECIAL_MOVES = {
		...
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, rushSpeed = 88, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 3 },
				{ id = "rend", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Frost Ring — Glacial barrier and shatter ]]
		GlacialFrostBarrier = {
			...
			phases = {
				...
				{ id = "barrier", duration = 0.75, slowRadius = 9, slowMult = 0.45 },
