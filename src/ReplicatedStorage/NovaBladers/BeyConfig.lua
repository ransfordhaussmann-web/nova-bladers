	...
	SPECIAL_MOVES = {
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "bastion", duration = 1.4, interval = 0.38, range = 7.5, damage = 11 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				{ id = "drift", duration = 0.4, rushSpeed = 55 },
				{ id = "flare", duration = 0.85, interval = 0.26, damage = 8 },
				{ id = "afterburn", duration = 0.45, range = 8, damage = 22 },
			},
		},
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "edgeBurst", duration = 0.4, range = 7, damage = 36 },
			},
		},
	},
