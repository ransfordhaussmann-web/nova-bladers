local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Prism — Ice cage / crystal shatter ]]
		GlacierPrismCage = {
			id = "GlacierPrismCage",
		...
		CoreMeltdown = {
			...
			phases = {
				{ id = "overheat", duration = 0.35 },
				{ id = "rush", duration = 0.45, rushSpeed = 74 },
				{ id = "erupt", duration = 0.5, range = 7, damage = 36 },
			},
		},
	},
