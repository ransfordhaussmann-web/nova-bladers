local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — leap slam with shockwaves ]]
		ForgeHammerSlam = {
			id = "ForgeHammerSlam",
			...
			phases = {
				...
				{ id = "slam", duration = 0.35, diveSpeed = 55, rushSpeed = 75 },
				{ id = "shock", duration = 0.5, interval = 0.25, range = 7.5, damage = 14 },
			},
		},
		--[[ Frost Prism — crystal shield and shatter burst ]]
		PrismCrystalShield = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.8, range = 7, damage = 32 },
			},
		},
	},
