	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.45, rushSpeed = 95 },
				{ id = "slash", duration = 0.35, range = 7, damage = 40 },
			},
		},
		--[[ Granite Fort — Bastion / Quake ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "fortify", duration = 0.9, damageReduction = 0.7 },
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.55, dashes = 3, rushSpeed = 88 },
				{ id = "converge", duration = 0.3, range = 6, damage = 36 },
			},
		},
	},
