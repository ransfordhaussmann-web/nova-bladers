local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Ripper — spiral rush with claw strikes ]]
		CrimsonSpiralClaw = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.22, orbitRadius = 9, orbitSpeed = 14, damage = 10 },
				{ id = "claw", duration = 0.45, rushSpeed = 95, range = 7, damage = 36 },
			},
		},
		--[[ Frost Ward — ice prism shield and shatter burst ]]
		FrostPrismLock = {
			id = "FrostPrismLock",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.6, interval = 0.3, range = 7.5, damage = 14 },
			},
		},
	},
