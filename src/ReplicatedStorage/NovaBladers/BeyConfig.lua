local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — Inferno dash + flame rings ]]
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "wheel", duration = 0.45, rushSpeed = 82 },
				{ id = "inferno", duration = 0.85, interval = 0.25, range = 6, damage = 12 },
			},
		},
		...
		FrostCrystalVeil = {
			...
			phases = {
				...
				{ id = "freeze", duration = 0.75, interval = 0.3, range = 7, damage = 10 },
				{ id = "shatter", duration = 0.65, range = 7, damage = 32 },
			},
		},
	},
