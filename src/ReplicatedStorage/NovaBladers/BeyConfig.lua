local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		ForgeHammerSlam = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "leap", duration = 0.35, leapSpeed = 55 },
				{ id = "slam", duration = 0.25, rushSpeed = 95 },
				{ id = "shock", duration = 0.5, range = 9, damage = 16 },
			},
		},
		...
		PrismCrystalShield = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.8, range = 7.5, damage = 22 },
			},
		},
	},
