local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — Inferno rush / flame shower ]]
		CrimsonInfernoRush = {
			...
			phases = {
				...
				{ id = "blaze", duration = 0.8, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		--[[ Frost Crown — Ice barrage / freeze burst ]]
		FrostCrownBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.85, interval = 0.22, damage = 8, count = 4 },
				{ id = "freeze", duration = 0.4, range = 7, damage = 28 },
			},
		},
	},
