local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — spiraling flame rush ]]
		BlazeCorkscrew = {
			id = "BlazeCorkscrew",
			...
			phases = {
				...
				{ id = "corkscrew", duration = 0.6, rushSpeed = 82, hitInterval = 0.15, hitRadius = 4.5, damage = 10 },
				{ id = "eruption", duration = 0.4, range = 7, damage = 32 },
			},
		},
		--[[ Frost Orbit — ice fortress + shatter waves ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
			...
			phases = {
				{ id = "frostfield", duration = 0.4, slowRadius = 9 },
				{ id = "glaciate", duration = 0.6 },
				{ id = "shatter", duration = 0.75, interval = 0.35, range = 7.5, damage = 12 },
			},
		},
	},
