local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — blood-red dive burst ]]
		CrimsonBloodFang = {
			id = "CrimsonBloodFang",
			...
			phases = {
				...
				{ id = "dive", duration = 0.38, rushSpeed = 98, diveSpeed = 52 },
				{ id = "burst", duration = 0.32, range = 7, damage = 40 },
			},
		},
		--[[ Granite Fort — extended fortress wall ]]
		GraniteRampart = {
			id = "GraniteRampart",
			...
			color = Color3.fromRGB(130, 140, 115),
			phases = {
		...
		--[[ Solar Drift — fast solar orbit rings ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "sonic", duration = 0.8, interval = 0.22, damage = 8 },
				{ id = "orbit", duration = 0.75 },
			},
		},
		--[[ Phantom Edge — multi-hit ghost meteor ]]
		PhantomPhaseRush = {
			id = "PhantomPhaseRush",
			name = "Phantom Phase Rush",
			mode = "meteor",
			duration = 1.5,
			rushSpeed = 72,
			damage = 30,
			spinLoss = 12,
			color = Color3.fromRGB(190, 170, 230),
			phases = {
				{ id = "windup", duration = 0.25 },
				{ id = "launch", duration = 0.22, rushSpeed = 72 },
				{ id = "shower", duration = 1.0, hitInterval = 0.14, hitRadius = 5, damage = 8, hits = 6 },
			},
		},
		--[[ Crystal Edge — fast ice shard barrage ]]
		CrystalShardBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.7, hitInterval = 0.12, hitRadius = 5.2, damage = 10, hits = 5 },
			},
		},
		--[[ Blaze Crown — expanding flame nova rings ]]
		BlazeCrownNova = {
			id = "BlazeCrownNova",
