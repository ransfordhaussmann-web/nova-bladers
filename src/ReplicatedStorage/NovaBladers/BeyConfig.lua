	...
	SPECIAL_MOVES = {
		...
		CrimsonMaelstrom = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.75, hitInterval = 0.22, hitRadius = 5, damage = 10, hits = 3 },
				{ id = "fang", duration = 0.5, rushSpeed = 95, range = 7, damage = 36 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "quake", duration = 0.95, interval = 0.34, range = 7.5, damage = 12 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "rings", duration = 0.7, interval = 0.26, damage = 8 },
