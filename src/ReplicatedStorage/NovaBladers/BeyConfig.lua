local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "scatter", duration = 0.9, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 5 },
				{ id = "finale", duration = 0.2, range = 7, damage = 18 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "pull", duration = 0.4, pullRadius = 10 },
				{ id = "leap", duration = 0.35 },
				{ id = "crash", duration = 0.45, range = 9, damage = 32 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(220, 50, 65),
			phases = {
				{ id = "windup", duration = 0.2 },
				{ id = "charge", duration = 0.45, rushSpeed = 95 },
				{ id = "rend", duration = 0.35, range = 5.5, damage = 36 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "shards", duration = 0.65, interval = 0.3, range = 7, damage = 12 },
				{ id = "quake", duration = 0.45, range = 8, damage = 20 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.35, range = 6, damage = 40 },
			},
		},
	},
