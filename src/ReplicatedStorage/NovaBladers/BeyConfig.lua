	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "spin", duration = 0.9, hitInterval = 0.15, hitRadius = 5, damage = 10 },
				{ id = "lunge", duration = 0.35, rushSpeed = 85 },
			},
		},
		--[[ Granite Fort — stone bastion pulse ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "slam", duration = 0.35, range = 7, damage = 22 },
			},
		},
		--[[ Solar Drift — sun flare trail ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 1.0, hitInterval = 0.22, hitRadius = 4.5, damage = 8, rushSpeed = 65 },
				{ id = "burst", duration = 0.3, range = 7, damage = 26 },
			},
		},
