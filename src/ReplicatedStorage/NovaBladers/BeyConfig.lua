	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, interval = 0.22, hitRadius = 5, damage = 10, hits = 5 },
				{ id = "slash", duration = 0.35, rushSpeed = 88, damage = 28 },
			},
		},
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "shock", duration = 1.0, interval = 0.35, range = 9, damage = 12 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "drift", duration = 0.9, trailInterval = 0.15, damage = 8 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.55, dashes = 3, dashSpeed = 90 },
				{ id = "edge", duration = 0.35, range = 6, damage = 34 },
			},
		},
	},
