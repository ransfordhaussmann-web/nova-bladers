	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.82, hitInterval = 0.16, hitRadius = 5.8, damage = 10, hits = 5 },
			},
		},
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "slam", duration = 0.35, rushSpeed = 70, diveSpeed = 52 },
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.2, interval = 0.35, range = 8.5, damage = 14 },
			},
		},
