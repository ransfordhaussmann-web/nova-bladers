local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			damage = 38,
			spinLoss = 16,
			color = Color3.fromRGB(220, 60, 55),
			phases = {
				{ id = "windup", duration = 0.22 },
				{ id = "launch", duration = 0.2, rushSpeed = 88 },
				{ id = "shower", duration = 0.78, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.8, interval = 0.3, range = 9, damage = 14 },
			},
		},
		--[[ Solar Drift — solar sonic rings ]]
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
		...
		--[[ Phantom Edge — ghost eclipse slash ]]
		PhantomVoidSlash = {
			id = "PhantomVoidSlash",
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(170, 160, 210),
			phases = {
				{ id = "aura", duration = 0.28 },
				{ id = "dive", duration = 0.42, rushSpeed = 96, diveSpeed = 52 },
				{ id = "burst", duration = 0.35, range = 7, damage = 36 },
			},
		},
		--[[ Crystal Edge — shard meteor shower ]]
		CrystalShatterRain = {
			id = "CrystalShatterRain",
			name = "Crystal Shatter Rain",
			mode = "meteor",
			duration = 1.45,
			rushSpeed = 74,
			damage = 32,
			...
			phases = {
				...
				{ id = "shower", duration = 0.95, hitInterval = 0.15, hitRadius = 6, damage = 10, hits = 6 },
			},
		},
		--[[ Blaze Crown — fire sonic tempest ]]
		BlazeCrownTempest = {
			id = "BlazeCrownTempest",
			name = "Blaze Crown Tempest",
			mode = "sonic",
			duration = 1.7,
			damage = 34,
			spinLoss = 14,
