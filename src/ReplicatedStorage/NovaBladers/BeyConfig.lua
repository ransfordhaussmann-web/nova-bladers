local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Rending Slash / wide arc finisher ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, rushSpeed = 88, hitRadius = 5, damage = 16, hitInterval = 0.15 },
				{ id = "rend", duration = 0.5, range = 7, damage = 28 },
			},
		},
		--[[ Frost Ring — Ice barrier / frost shatter pulse ]]
		GlacialFrostBarrier = {
