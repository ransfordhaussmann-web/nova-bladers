	...
	SPECIAL_MOVES = {
		...
		CrimsonSlashBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.78, hitInterval = 0.14, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		FrostCitadelLock = {
			id = "FrostCitadelLock",
			name = "Frost Citadel Lock",
			mode = "frost",
			duration = 1.9,
			damage = 28,
			spinLoss = 6,
			...
			phases = {
				...
				{ id = "frostPulse", duration = 0.9, interval = 0.3, range = 7.5, damage = 11 },
			},
		},
	},
