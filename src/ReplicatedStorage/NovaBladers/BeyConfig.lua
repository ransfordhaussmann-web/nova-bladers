	...
	SPECIAL_MOVES = {
		...
		CrimsonWildSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.7, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 4 },
		...
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.55, interval = 0.22, range = 5, damage = 8 },
				{ id = "shatter", duration = 0.65, range = 9, damage = 24 },
			},
		},
	},
