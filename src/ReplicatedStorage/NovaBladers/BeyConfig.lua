local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — molten hammer smash + lava eruption ]]
		CrimsonForgeBreak = {
			...
			phases = {
				...
				{ id = "smash", duration = 0.35, rushSpeed = 80 },
				{ id = "eruption", duration = 0.8, hitInterval = 0.2, hitRadius = 6, damage = 12, hits = 3 },
			},
		},
