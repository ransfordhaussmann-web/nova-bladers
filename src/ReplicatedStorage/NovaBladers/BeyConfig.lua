local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — fire rush + burn waves ]]
		CrimsonInfernoDrive = {
			id = "CrimsonInfernoDrive",
			name = "Crimson Inferno Drive",
			mode = "inferno",
			duration = 1.25,
			rushSpeed = 85,
			damage = 38,
			...
			phases = {
				...
				{ id = "blaze", duration = 0.35, rushSpeed = 85 },
				{ id = "scorch", duration = 0.62, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		...
		FrostCrownBastion = {
			...
			phases = {
				...
				{ id = "shard", duration = 0.8, interval = 0.3, range = 7.5, damage = 11 },
			},
		},
	},
