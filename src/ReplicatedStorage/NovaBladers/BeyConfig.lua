	...
	SPECIAL_MOVES = {
		...
		CrystalShatter = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.3, rushSpeed = 70 },
				{ id = "shower", duration = 0.75, hitInterval = 0.2, hitRadius = 6, damage = 13, hits = 4 },
			},
		},
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
			...
			phases = {
				...
				{ id = "wall", duration = 0.4 },
				{ id = "pulse", duration = 0.9, interval = 0.28, range = 7, damage = 16 },
			},
		},
	},
