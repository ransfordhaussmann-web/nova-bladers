	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.14, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
		...
		PhantomVeilStrike = {
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(80, 210, 190),
			phases = {
		...
		CrystalShardBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.16, hitRadius = 5.5, damage = 10, hits = 5 },
			},
		},
		BlazeCrownInferno = {
			...
			phases = {
				...
				{ id = "sonic", duration = 0.7, interval = 0.22, damage = 11 },
