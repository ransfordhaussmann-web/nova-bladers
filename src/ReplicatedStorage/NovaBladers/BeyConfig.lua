local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — spiraling fire rush ]]
		BlazeCorkscrew = {
			id = "BlazeCorkscrew",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.75, hitInterval = 0.2, hitRadius = 4.5, damage = 10 },
				{ id = "finale", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Frost Orbit — ice shield and shatter wave ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.65, interval = 0.3, range = 9, damage = 14 },
			},
		},
	},
