local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				{ id = "leap", duration = 0.4, leapForce = 38 },
				{ id = "slam", duration = 0.35, range = 9, damage = 36 },
				{ id = "ripple", duration = 0.75, interval = 0.3, range = 7.5, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.34, range = 8.5, damage = 14 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
