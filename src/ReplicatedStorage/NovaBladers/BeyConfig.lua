	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.65, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.7, interval = 0.28, damage = 8 },
				{ id = "orbit", duration = 0.65 },
			},
		},
		...
		PhantomBladeMirage = {
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(130, 90, 220),
			phases = {
				{ id = "vanish", duration = 0.25 },
				{ id = "mirage", duration = 0.45, rushSpeed = 95 },
				{ id = "strike", duration = 0.4, range = 7, damage = 36 },
			},
		},
	},
