	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.7, interval = 0.15, range = 5, damage = 10 },
				{ id = "rush", duration = 0.5, rushSpeed = 85, range = 4, damage = 28 },
			},
		},
		--[[ Granite Fort — fortress stance + stone pulses ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.0, interval = 0.33, range = 9, damage = 14 },
				{ id = "shatter", duration = 0.4, range = 11, damage = 22 },
			},
		},
		--[[ Solar Drift — sun flare + orbital drift ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 0.9, interval = 0.25, damage = 8 },
				{ id = "burst", duration = 0.4, range = 7, damage = 32 },
			},
		},
		--[[ Phantom Edge — phase dashes + ghost finisher ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.65, dashes = 3, rushSpeed = 95, damage = 12 },
				{ id = "finisher", duration = 0.4, range = 7, damage = 36 },
			},
		},
	},
