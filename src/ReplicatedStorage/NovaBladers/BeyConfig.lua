local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Blade Storm / rapid slash barrage ]]
		CrimsonBladeStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.78, hitInterval = 0.14, hitRadius = 5.0, damage = 13, hits = 5 },
			},
		},
		--[[ Frost Crown — Ice Bastion / frost barrier + pulse ]]
		FrostBastion = {
			id = "FrostBastion",
			name = "Frost Bastion",
			mode = "fortress",
