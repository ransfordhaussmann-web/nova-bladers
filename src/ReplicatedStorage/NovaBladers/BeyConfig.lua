	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperFang = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.75, interval = 0.25, hits = 3, hitRadius = 5, damage = 12 },
				{ id = "lunge", duration = 0.4, rushSpeed = 88, hitRadius = 4, damage = 28 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.85, interval = 0.32, range = 9, damage = 15 },
			},
		},
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
			...
			phases = {
				{ id = "corona", duration = 0.8, interval = 0.28, damage = 8 },
				{ id = "recover", duration = 0.45 },
