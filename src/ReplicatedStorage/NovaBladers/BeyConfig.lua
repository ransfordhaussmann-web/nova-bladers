	...
	SPECIAL_MOVES = {
		...
		CrimsonInfernoRoar = {
			...
			phases = {
				...
				{ id = "charge", duration = 0.35, rushSpeed = 82 },
				{ id = "burn", duration = 0.85, interval = 0.22, range = 5.5, damage = 10, hits = 3 },
			},
		},
		...
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.95, interval = 0.28, range = 6, damage = 11 },
			},
		},
	},
