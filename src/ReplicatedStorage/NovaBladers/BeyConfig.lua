	...
	SPECIAL_MOVES = {
		...
		BlazeCometLoop = {
			...
			phases = {
				...
				{ id = "slam", duration = 0.45, rushSpeed = 95, diveSpeed = 55 },
				{ id = "flare", duration = 0.3, range = 7, damage = 40 },
			},
		},
		--[[ Frost Crown — ice crown barrier + shards + snap ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
			...
			phases = {
				...
				{ id = "snap", duration = 0.4, range = 9, damage = 32 },
			},
		},
	},
