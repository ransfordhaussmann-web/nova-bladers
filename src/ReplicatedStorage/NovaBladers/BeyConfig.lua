local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Starfall Edge — comet rush with blade shower ]]
		StarfallRush = {
			id = "StarfallRush",
			name = "Starfall Rush",
			mode = "meteor",
		...
		--[[ Stone Halo — earth fortress and shock pulses ]]
		HaloGuard = {
			id = "HaloGuard",
			name = "Halo Guard",
			mode = "fortress",
			...
			spinLoss = 7,
			damageReduction = 0.6,
			color = Color3.fromRGB(180, 165, 120),
			phases = {
		...
		--[[ Thunder Coil — lightning spiral orbit ]]
		ThunderLoop = {
			id = "ThunderLoop",
			name = "Thunder Loop",
			mode = "sonic",
		...
		--[[ Night Maw — shadow leap and venom burst ]]
		NightFang = {
			id = "NightFang",
			name = "Night Fang",
			mode = "eclipse",
			...
			phases = {
				...
				{ id = "burst", duration = 0.32, range = 6.8, damage = 36 },
			},
		},
	},
