	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.7, hitInterval = 0.14, hitRadius = 5, damage = 10, hits = 5 },
				{ id = "slash", duration = 0.55, rushSpeed = 95, damage = 28 },
			},
		},
		--[[ Granite Fort — anchored fortress with stone pulses ]]
		GraniteBastionPulse = {
		...
		--[[ Solar Drift — solar glide with flare finale ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "flare", duration = 0.5, range = 7, damage = 34 },
			},
		},
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.55, rushSpeed = 88, hitInterval = 0.18, hitRadius = 4.5, damage = 12, hits = 3 },
				{ id = "fade", duration = 0.35, range = 6, damage = 26 },
			},
		},
	},
