local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — fire charge / inferno rush / blaze shower ]]
		CrimsonInfernoRush = {
			...
			phases = {
				...
				{ id = "blaze", duration = 0.8, hitInterval = 0.2, hitRadius = 5.8, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Crown — chill aura / ice shard barrage / freeze burst ]]
		FrostCrownBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.85, interval = 0.22, damage = 10, shards = 4 },
				{ id = "freeze", duration = 0.5, range = 7.5, damage = 28 },
			},
		},
	},
