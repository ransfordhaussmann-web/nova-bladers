	...
	SPECIAL_MOVES = {
		...
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, rushSpeed = 82, interval = 0.22, damage = 10 },
				{ id = "slam", duration = 0.4, range = 7, damage = 36 },
			},
		},
		--[[ Glacier Mantle — frost shield + ice burst ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
