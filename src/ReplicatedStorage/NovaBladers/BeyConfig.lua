local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — spinning vortex assault ]]
		CrimsonMaelstrom = {
			id = "CrimsonMaelstrom",
			...
			phases = {
				...
				{ id = "vortex", duration = 1.0, interval = 0.22, range = 5.5, damage = 10 },
		...
		--[[ Solar Drift — solar orbit flares ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		PhantomVoidSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, range = 7.5, damage = 40 },
			},
		},
	},
