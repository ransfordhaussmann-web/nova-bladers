local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — leap slam + shock rings ]]
		ForgeHammerSlam = {
			id = "ForgeHammerSlam",
			...
			phases = {
				...
				{ id = "leap", duration = 0.3, leapHeight = 14 },
				{ id = "slam", duration = 0.35, range = 7, damage = 44 },
		...
		PrismCrystalShield = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.45, range = 8, damage = 36 },
			},
		},
	},
