	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.75, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 3 },
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "bastion", duration = 0.55, damageReduction = 0.6 },
				{ id = "pulse", duration = 0.85, interval = 0.3, range = 7.5, damage = 12 },
			},
		},
		--[[ Solar Drift — solar flare rings + drift rush ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 0.65, rushSpeed = 68 },
			},
		},
