local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Spiral rush with fang barrage ]]
		CrimsonSpiralRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.7, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		...
		FrostIcewall = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.35, range = 7.5, damage = 11 },
			},
		},
	},
