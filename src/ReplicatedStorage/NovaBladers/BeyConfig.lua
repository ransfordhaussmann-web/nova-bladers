local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — Fire Rush / Inferno Burst ]]
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "wheel", duration = 0.55, rushSpeed = 82, trailInterval = 0.12, trailDamage = 8 },
				{ id = "inferno", duration = 0.55, range = 7, damage = 32 },
			},
		},
		--[[ Frost Veil — Crystal Shield / Ice Shatter ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
