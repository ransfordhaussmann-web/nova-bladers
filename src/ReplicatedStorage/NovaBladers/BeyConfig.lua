local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Comet — Starfall comet dash + fire trail ]]
		StarfallRush = {
			id = "StarfallRush",
			name = "Starfall Rush",
			mode = "starfall",
			...
			phases = {
				...
				{ id = "comet", duration = 0.42, rushSpeed = 95 },
				{ id = "trail", duration = 0.75, hitInterval = 0.16, hitRadius = 4.5, damage = 10, hits = 4 },
			},
		},
		--[[ Crystal Guard — Glacier vault shield + ice shatter ]]
		GlacierVault = {
			id = "GlacierVault",
			name = "Glacier Vault",
			mode = "glacier",
