	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.65, hitInterval = 0.16, hitRadius = 4.5, damage = 12, hits = 4 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "reflect", duration = 0.9, interval = 0.3, range = 7, damage = 14 },
				{ id = "quake", duration = 0.45, range = 9, damage = 18 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
