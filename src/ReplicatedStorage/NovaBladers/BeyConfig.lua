	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperBarrage = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.55, rushSpeed = 85, hitInterval = 0.12, hitRadius = 4.5, damage = 10, hits = 4 },
		...
		--[[ Solar Drift — corona rings + orbit flare ]]
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
			...
			phases = {
				...
				{ id = "flare", duration = 0.75 },
			},
		},
		--[[ Phantom Edge — mirage cuts ]]
		PhantomMirageCut = {
			id = "PhantomMirageCut",
			...
			phases = {
				...
				{ id = "cut", duration = 0.35, rushSpeed = 88, hitRadius = 5, damage = 16 },
				{ id = "cut2", duration = 0.35, rushSpeed = 88, hitRadius = 5, damage = 16 },
				{ id = "fade", duration = 0.25, range = 5.5, damage = 22 },
			},
		},
		--[[ Frost Crown — freeze and shatter ]]
		FrostCrownShatter = {
			...
			phases = {
				{ id = "freeze", duration = 0.5, range = 8, slowMult = 0.35 },
				{ id = "shatter", duration = 0.45, range = 9, damage = 34 },
			},
		},
		--[[ Crimson Drift — speed surge dash ]]
		CrimsonDriftSurge = {
			...
			phases = {
				{ id = "boost", duration = 0.12 },
				{ id = "dash", duration = 0.55, rushSpeed = 105 },
				{ id = "aftershock", duration = 0.3, range = 7, damage = 26 },
			},
		},
	},
