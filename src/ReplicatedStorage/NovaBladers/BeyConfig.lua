local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Rip Tide rush + crimson wave slashes ]]
		CrimsonRipTide = {
			id = "CrimsonRipTide",
			...
			phases = {
				...
				{ id = "rip", duration = 0.75, interval = 0.22, hitRadius = 5, damage = 12 },
			},
		},
		...
		FrostBastion = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.34, range = 7.5, damage = 11 },
