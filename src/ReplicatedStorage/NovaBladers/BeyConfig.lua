	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRend = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.38, rushSpeed = 85 },
				{ id = "rend", duration = 0.55, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Frost Crown — freeze guard + ice spike burst ]]
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "spikes", duration = 0.6, interval = 0.25, damage = 10 },
