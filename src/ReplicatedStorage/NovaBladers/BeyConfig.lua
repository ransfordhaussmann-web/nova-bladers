	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperBarrage = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.3, rushSpeed = 85 },
				{ id = "barrage", duration = 0.75, hitInterval = 0.12, hitRadius = 4.5, damage = 9, hits = 6 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomMirageCut = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.35, rushSpeed = 100 },
				{ id = "cut", duration = 0.3, range = 7, damage = 36 },
			},
		},
		FrostCrownShatter = {
			...
			phases = {
				{ id = "chill", duration = 0.35 },
				{ id = "freeze", duration = 0.5, range = 6, damage = 10 },
		...
		CrimsonDriftSurge = {
			...
			damage = 36,
			spinLoss = 14,
			color = Color3.fromRGB(210, 40, 80),
			phases = {
				{ id = "boost", duration = 0.2 },
				{ id = "surge", duration = 0.55, rushSpeed = 95 },
				{ id = "impact", duration = 0.25, range = 5.5, damage = 32 },
			},
		},
	},
