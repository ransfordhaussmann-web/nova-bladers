local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — spinning fire ring / inferno burst ]]
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "wheel", duration = 0.7, interval = 0.22, damage = 10, range = 5 },
				{ id = "inferno", duration = 0.5, range = 9, damage = 28 },
			},
		},
		--[[ Frost Veil — ice barrier / crystal shatter ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
