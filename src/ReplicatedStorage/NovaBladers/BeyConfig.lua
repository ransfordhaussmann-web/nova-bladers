	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "rise", duration = 0.35, liftSpeed = 22 },
				{ id = "crash", duration = 0.45, slamDamage = 32, range = 9 },
				{ id = "wave", duration = 0.4, interval = 0.3, range = 7, damage = 11 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "slash1", duration = 0.22, rushSpeed = 88, damage = 14 },
				{ id = "slash2", duration = 0.22, rushSpeed = 88, damage = 14 },
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "rampart", duration = 0.55 },
				{ id = "quake", duration = 0.75, interval = 0.34, range = 7.5, damage = 12 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "exit", duration = 0.3, range = 6, damage = 30 },
			},
		},
	},
