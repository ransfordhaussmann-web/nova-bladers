	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.3, rushSpeed = 96 },
				{ id = "rip", duration = 0.45, hitInterval = 0.12, hitRadius = 4.5, damage = 10, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.28, rushSpeed = 88 },
				{ id = "phantom", duration = 0.28, rushSpeed = 82, angleOffset = 55 },
