	...
	SPECIAL_MOVES = {
		...
		GraniteBulwark = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.3, range = 7, damage = 12 },
			},
		},
		SolarWindLoop = {
			id = "SolarWindLoop",
		...
		PhantomMirage = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.35, range = 5.5, damage = 32 },
			},
		},
		CrystalShatterSurge = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.65, shardCount = 8, range = 7, damage = 14 },
			},
		},
		BlazeCrownSpiral = {
			id = "BlazeCrownSpiral",
			...
			phases = {
				{ id = "spiral", duration = 0.5, spinRate = 14 },
				{ id = "trail", duration = 0.55, rushSpeed = 75, hitInterval = 0.2, damage = 9 },
				{ id = "crown", duration = 0.45, range = 7, damage = 36 },
			},
		},
	},
