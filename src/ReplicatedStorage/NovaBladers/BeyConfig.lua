local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — sweeping fire blade arc ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, rushSpeed = 85, sweepAngle = 140, hitInterval = 0.12, damage = 12 },
				{ id = "rend", duration = 0.35, range = 7, damage = 28 },
			},
		},
		--[[ Frost Ring — glacial barrier and shatter wave ]]
		GlacialFrostBarrier = {
