local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid scythe barrage (meteor variant) ]]
		CrimsonScytheBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 1.0, hitInterval = 0.14, hitRadius = 5, damage = 13, hits = 5 },
			},
		},
		--[[ Frost Core — ice fortress (fortress variant) ]]
		FrostBastion = {
			id = "FrostBastion",
			name = "Frost Bastion",
			mode = "fortress",
