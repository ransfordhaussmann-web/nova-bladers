	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.65, hitInterval = 0.15, hitRadius = 4.5, damage = 10, hits = 4 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / shield + heal burst ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.7, range = 9, damage = 18 },
			},
		},
	},
