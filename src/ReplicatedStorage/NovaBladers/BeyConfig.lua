local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — expanding fire rings + orbit (sonic mode) ]]
		BlazeInfernoLoop = {
			id = "BlazeInfernoLoop",
			...
			phases = {
				...
				{ id = "sonic", duration = 0.72, interval = 0.26, damage = 10 },
				{ id = "orbit", duration = 0.62 },
			},
		},
		--[[ Frost Veil — ice barrier + frost pulses (fortress mode) ]]
		FrostCrystalLock = {
			id = "FrostCrystalLock",
