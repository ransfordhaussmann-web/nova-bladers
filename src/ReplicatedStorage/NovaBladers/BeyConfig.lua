	...
	SPECIAL_MOVES = {
		...
		CrimsonRendStorm = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.65, hitInterval = 0.15, hitRadius = 5, damage = 13, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "blink", duration = 0.35, rushSpeed = 88 },
		...
		CrystalShardBarrage = {
			...
			phases = {
				{ id = "charge", duration = 0.3 },
				{ id = "orbit", duration = 0.5, interval = 0.2, damage = 7 },
				{ id = "barrage", duration = 0.6, hitInterval = 0.12, hitRadius = 7, damage = 10, hits = 4 },
			},
		},
		BlazeCrownInferno = {
			id = "BlazeCrownInferno",
			name = "Blaze Crown Inferno",
			mode = "inferno",
			duration = 1.5,
			damage = 36,
			spinLoss = 14,
			...
			phases = {
				{ id = "spin", duration = 0.45 },
				{ id = "charge", duration = 0.35 },
				{ id = "burst", duration = 0.7, interval = 0.22, range = 9, damage = 12 },
			},
		},
	},
