local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Forge — Inferno charge, flame thrust, flare burst ]]
		ForgeInfernoDrive = {
			...
			phases = {
				...
				{ id = "thrust", duration = 0.45, rushSpeed = 88 },
				{ id = "flare", duration = 0.35, range = 7, damage = 40 },
			},
		},
		--[[ Frost Prism — Crystal shield, shard volley, frost shatter ]]
		PrismCrystalLock = {
			id = "PrismCrystalLock",
			...
			phases = {
				...
				{ id = "shards", duration = 0.9, interval = 0.28, range = 6, damage = 10 },
				{ id = "shatter", duration = 0.35, range = 8, damage = 28 },
			},
		},
	},
