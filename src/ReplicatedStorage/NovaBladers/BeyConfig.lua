local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — ignite / fire rush / blaze shower ]]
		CrimsonInfernoRush = {
			...
			phases = {
				...
				{ id = "blaze", duration = 0.85, hitInterval = 0.17, hitRadius = 5.8, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Crown — chill / shard barrage / freeze burst ]]
		FrostCrownBarrage = {
			...
			phases = {
				{ id = "chill", duration = 0.32 },
				{ id = "barrage", duration = 0.88, interval = 0.22, hitRadius = 5.2, damage = 10, hits = 4 },
				{ id = "freeze", duration = 0.45, range = 7.5, damage = 28 },
			},
		},
	},
