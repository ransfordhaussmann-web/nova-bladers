local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		PhantomMirageSlash = {
			id = "PhantomMirageSlash",
			name = "Phantom Mirage Slash",
			mode = "eclipse",
			duration = 1.2,
			rushSpeed = 88,
			damage = 40,
			...
			phases = {
				...
				{ id = "burst", duration = 0.34, range = 7, damage = 36 },
			},
		},
		CrystalShardBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.14, hitRadius = 5.2, damage = 10, hits = 6 },
			},
		},
		BlazeInfernoCrown = {
