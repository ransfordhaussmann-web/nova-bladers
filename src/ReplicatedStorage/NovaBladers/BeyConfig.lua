	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.55, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 3 },
			},
		},
		--[[ Granite Fort — Bastion wall / counter pulse ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "counter", duration = 0.75, interval = 0.35, range = 7, damage = 14 },
			},
		},
		--[[ Solar Drift — Flare rings / drift boost ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "drift", duration = 0.65, speedBoost = 1.35 },
			},
		},
		--[[ Phantom Edge — Mirage clone / teleport slash ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "feint", duration = 0.35, rushSpeed = 80 },
				{ id = "slash", duration = 0.4, range = 5.5, damage = 32 },
			},
		},
	},
