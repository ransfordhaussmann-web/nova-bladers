	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.5, hitInterval = 0.15, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / aurora shield ]]
		AuroraBarrierDome = {
			...
			phases = {
				{ id = "channel", duration = 0.35 },
				{ id = "dome", duration = 0.9, damageReduction = 0.65 },
				{ id = "release", duration = 0.75, interval = 0.3, range = 9, damage = 15 },
			},
		},
	},
