local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Ripper — Vortex rush + cross slash ]]
		CrimsonVortexSlash = {
			...
			phases = {
				...
				{ id = "vortex", duration = 0.7, interval = 0.22, damage = 10 },
				{ id = "slash", duration = 0.35, rushSpeed = 95, range = 7, damage = 40 },
			},
		},
		--[[ Frost Monarch — Ice citadel + frost pulses ]]
		FrostCitadel = {
			id = "FrostCitadel",
			name = "Frost Citadel",
			mode = "citadel",
