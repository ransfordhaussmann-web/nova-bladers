local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid fang chain rush ]]
		CrimsonFangRush = {
			id = "CrimsonFangRush",
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.15, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		...
		--[[ Solar Drift — solar halo rings + orbit drain ]]
		SolarHaloBurst = {
			id = "SolarHaloBurst",
			name = "Solar Halo Burst",
			mode = "sonic",
			duration = 1.8,
			damage = 30,
			spinLoss = 10,
		...
		--[[ Phantom Edge — mirage clones + teleport slash ]]
		PhantomMirageCut = {
			id = "PhantomMirageCut",
			...
			damage = 38,
			spinLoss = 14,
			color = Color3.fromRGB(80, 210, 220),
			phases = {
		...
		--[[ Crystal Edge — ice crystallize + shatter bursts ]]
		CrystalShatterSurge = {
			...
			phases = {
				{ id = "crystallize", duration = 0.3 },
				{ id = "rush", duration = 0.35, rushSpeed = 75 },
				{ id = "shatter", duration = 0.75, interval = 0.22, range = 6, damage = 12 },
			},
		},
		--[[ Blaze Crown — fire spiral + crown burst ]]
		BlazeCrownSpiral = {
			id = "BlazeCrownSpiral",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.2, damage = 9 },
				{ id = "crown", duration = 0.5, range = 7.5, damage = 36 },
			},
		},
	},
