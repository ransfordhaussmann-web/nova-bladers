local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — flame rush + multi-hit barrage ]]
		CrimsonFlameBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.65, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Crown — chill aura, ice crown guard, shatter waves ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
