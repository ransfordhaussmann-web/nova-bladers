	...
	SPECIAL_MOVES = {
		...
		CrimsonFlameVortex = {
			...
			phases = {
				...
				{ id = "flame", duration = 0.7, interval = 0.25, damage = 8 },
				{ id = "spiral", duration = 0.6, rushSpeed = 85 },
			},
		},
		GlacierFrostFortress = {
			id = "GlacierFrostFortress",
			name = "Glacier Frost Fortress",
			mode = "frost",
			duration = 1.9,
			damage = 28,
			spinLoss = 6,
			...
			phases = {
				{ id = "frost", duration = 0.6 },
				{ id = "pulse", duration = 1.0, interval = 0.35, range = 9, damage = 12 },
				{ id = "shatter", duration = 0.5, range = 7, damage = 26 },
			},
		},
	},
