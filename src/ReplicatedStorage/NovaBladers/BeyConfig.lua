	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.7, interval = 0.12, range = 5, damage = 8, hits = 5 },
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "rebound", duration = 0.4, range = 12, damage = 18 },
			},
		},
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.85, interval = 0.25, damage = 10 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.35, rushSpeed = 98 },
