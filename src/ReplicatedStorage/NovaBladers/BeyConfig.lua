local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / fang chain slashes ]]
		CrimsonRipperLunge = {
		...
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "dome", duration = 1.0, interval = 0.4, range = 7, damage = 10 },
				{ id = "shatter", duration = 0.4, range = 9, damage = 32 },
			},
		},
	},
