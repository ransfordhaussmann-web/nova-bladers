local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Drift — expanding fire rings + flame surge ]]
		BlazeInfernoRing = {
			id = "BlazeInfernoRing",
			...
			phases = {
				...
				{ id = "inferno", duration = 0.7, interval = 0.24, damage = 10 },
				{ id = "surge", duration = 0.65, rushSpeed = 82 },
			},
		},
		--[[ Frost Crown — crystal shield + frost pulses ]]
		FrostCrystalBastion = {
