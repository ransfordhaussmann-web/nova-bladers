local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — flaming ring rush + ember burst ]]
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "wheel", duration = 0.75, rushSpeed = 80, interval = 0.22, damage = 10 },
				{ id = "ember", duration = 0.55, range = 9, damage = 28 },
			},
		},
		--[[ Frost Veil — crystal shield + shatter wave ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
			...
			phases = {
				...
				{ id = "veil", duration = 0.85, interval = 0.35, range = 7, damage = 9 },
				{ id = "shatter", duration = 0.65, range = 10, damage = 22 },
			},
		},
	},
