local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid shred rush + blade flurry ]]
		CrimsonShredStorm = {
			id = "CrimsonShredStorm",
			name = "Crimson Shred Storm",
			mode = "meteor",
			duration = 1.2,
			rushSpeed = 86,
			damage = 38,
			...
			phases = {
				...
				{ id = "launch", duration = 0.2, rushSpeed = 86 },
				{ id = "shower", duration = 0.8, hitInterval = 0.14, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Crown — ice burrow, crystal wall, frost pulses ]]
		GlacierAegis = {
			id = "GlacierAegis",
			name = "Glacier Aegis",
			mode = "fortress",
