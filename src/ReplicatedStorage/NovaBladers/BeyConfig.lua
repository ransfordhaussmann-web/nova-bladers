local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spiral rush with fire trail ]]
		CrimsonSpiralRush = {
		...
		--[[ Frost Crown — ice wall and shatter pulse ]]
		FrostCrystalFortress = {
			id = "FrostCrystalFortress",
			name = "Frost Crystal Fortress",
			mode = "frost",
			duration = 1.9,
			damage = 28,
			spinLoss = 6,
