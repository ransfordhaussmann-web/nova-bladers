	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, spinSpeed = 14, hitInterval = 0.22, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "slash", duration = 0.4, rushSpeed = 88, range = 7, damage = 28 },
			},
		},
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "crumble", duration = 0.5, range = 7, damage = 22 },
			},
		},
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "drift", duration = 0.9, rushSpeed = 74, hitInterval = 0.2, hitRadius = 6, damage = 8 },
				{ id = "flare", duration = 0.4, range = 8, damage = 26 },
			},
		},
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.75, dashes = 3, rushSpeed = 95, hitRadius = 5, damage = 12 },
				{ id = "finisher", duration = 0.4, rushSpeed = 100, range = 6, damage = 24 },
			},
		},
	},
