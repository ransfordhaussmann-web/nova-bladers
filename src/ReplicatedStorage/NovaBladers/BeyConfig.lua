local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Reaver — rapid blade rush + multi-slash ]]
		CrimsonBladeBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.65, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Arctic Crown — frost shield + ice pulse ]]
		ArcticFrostLock = {
			id = "ArcticFrostLock",
			name = "Arctic Frost Lock",
			mode = "frost",
			duration = 1.9,
			damage = 28,
			spinLoss = 6,
