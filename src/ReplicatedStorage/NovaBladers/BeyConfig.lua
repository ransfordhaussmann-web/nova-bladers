	...
	SPECIAL_MOVES = {
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.35, range = 7, damage = 15 },
			},
		},
		--[[ Solar Drift — solar flare sonic orbit ]]
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		--[[ Phantom Edge — ghost phase slash ]]
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.38, range = 6, damage = 34 },
			},
		},
	},
