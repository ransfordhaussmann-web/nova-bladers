	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "sweep", duration = 0.4, rushSpeed = 95, range = 7, damage = 28 },
			},
		},
		--[[ Granite Fort — rock anchor + shock pulses ]]
		GraniteBastionPulse = {
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "drift", duration = 0.9, driftSpeed = 68, interval = 0.25, damage = 8 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.55, dashCount = 3, dashSpeed = 88, dashInterval = 0.18 },
