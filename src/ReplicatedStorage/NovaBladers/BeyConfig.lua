local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Comet — fire comet rush + flare burst ]]
		CometFlareBurst = {
			id = "CometFlareBurst",
			...
			phases = {
				...
				{ id = "comet", duration = 0.45, rushSpeed = 85 },
				{ id = "flare", duration = 0.65, hitInterval = 0.2, hitRadius = 6, damage = 12, hits = 3 },
			},
		},
		--[[ Frost Crown — ice shield + shatter wave ]]
		GlacierBastion = {
			id = "GlacierBastion",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.8, interval = 0.35, range = 7.5, damage = 11 },
			},
		},
	},
