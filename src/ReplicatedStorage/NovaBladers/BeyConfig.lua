local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Flame rush + blade barrage ]]
		CrimsonRendBarrage = {
		...
		--[[ Glacier Spin — Ice spiral + frost lock ]]
		GlacierSpiralLock = {
			id = "GlacierSpiralLock",
			name = "Glacier Spiral Lock",
			mode = "glacier",
			duration = 1.9,
			damage = 28,
			spinLoss = 10,
			...
			phases = {
				...
				{ id = "lock", duration = 0.65, range = 7, damage = 18 },
			},
		},
	},
