local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Crown — ice fortress / freeze pulse ]]
		GlacierCrownLock = {
			id = "GlacierCrownLock",
		...
		--[[ Crimson Fang — rage rush / fang strikes ]]
		CrimsonRageLunge = {
			id = "CrimsonRageLunge",
			...
			phases = {
				{ id = "rage", duration = 0.2 },
				{ id = "lunge", duration = 0.55, rushSpeed = 88 },
				{ id = "fang", duration = 0.5, hitInterval = 0.2, hitRadius = 5.5, damage = 18, hits = 2 },
			},
		},
	},
