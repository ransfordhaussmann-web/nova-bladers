local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Prism — Ice barrier + frost pulse ]]
		PrismFreezeLock = {
			id = "PrismFreezeLock",
			name = "Prism Freeze Lock",
			mode = "fortress",
			duration = 1.9,
			damage = 28,
			spinLoss = 6,
		...
		--[[ Crimson Fang — Meteor rush with crimson trail ]]
		CrimsonMeteorRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
	},
