	...
	SPECIAL_MOVES = {
		...
		CrimsonRendingStrike = {
			...
			phases = {
				...
				{ id = "rend", duration = 0.66, interval = 0.16, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Crown — ice halo lock + burst ]]
		FrostHaloLock = {
			id = "FrostHaloLock",
			...
			phases = {
				...
				{ id = "lock", duration = 0.9, interval = 0.3, range = 7, damage = 10 },
				{ id = "burst", duration = 0.4, range = 7.5, damage = 32 },
			},
		},
	},
