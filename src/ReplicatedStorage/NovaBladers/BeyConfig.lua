	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.0, interval = 0.3, range = 9, damage = 14 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "dive", duration = 0.35, rushSpeed = 95, diveSpeed = 42 },
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.35, range = 7.5, damage = 12 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
