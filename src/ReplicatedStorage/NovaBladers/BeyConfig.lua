	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.9, hitInterval = 0.16, hitRadius = 5.2, damage = 10, hits = 5 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "crash", duration = 0.35, rushSpeed = 65, diveSpeed = 55 },
				{ id = "wave", duration = 0.7, interval = 0.3, range = 9, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "slash", duration = 0.3, range = 7, damage = 36 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "blink", duration = 0.25, rushSpeed = 95 },
				{ id = "slash", duration = 0.35, range = 6.8, damage = 34 },
				{ id = "reappear", duration = 0.15 },
			},
		},
	},
