local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — aggressive fang rush ]]
		CrimsonBloodRush = {
			id = "CrimsonBloodRush",
		...
		GraniteBastionWall = {
			id = "GraniteBastionWall",
			name = "Granite Bastion Wall",
			mode = "fortress",
			duration = 2.0,
			damage = 28,
			spinLoss = 6,
		...
		--[[ Solar Drift — solar shockwave orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		PhantomVeilStrike = {
			...
			phases = {
				...
				{ id = "dive", duration = 0.42, rushSpeed = 88, diveSpeed = 45 },
