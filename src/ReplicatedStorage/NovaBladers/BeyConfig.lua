local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Spiral fang rush with tight hit radius ]]
		FangSpiralRush = {
			id = "FangSpiralRush",
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.14, hitRadius = 4.5, damage = 13, hits = 5 },
			},
		},
		--[[ Frost Coil — Ice burrow, frost wall, cold pulses ]]
		GlacierCoilLock = {
			id = "GlacierCoilLock",
