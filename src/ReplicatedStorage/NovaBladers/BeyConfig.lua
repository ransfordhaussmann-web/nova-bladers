	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "feathers", duration = 0.7, hitInterval = 0.15, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			damage = 30,
			spinLoss = 10,
			color = Color3.fromRGB(40, 160, 220),
			phases = {
				{ id = "pull", duration = 0.4 },
				{ id = "crash", duration = 0.35, rushSpeed = 65 },
				{ id = "wave", duration = 0.75, interval = 0.3, range = 9, damage = 14 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
		...
		GraniteRampart = {
			...
			phases = {
				{ id = "rise", duration = 0.5 },
				{ id = "fortify", duration = 0.6 },
				{ id = "quake", duration = 0.8, interval = 0.35, range = 7, damage = 12 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "rings", duration = 0.7, interval = 0.25, damage = 8 },
				{ id = "orbit", duration = 0.65 },
			},
		},
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.35, rushSpeed = 100, range = 6.5, damage = 36 },
				{ id = "afterimage", duration = 0.3, range = 5, damage = 18 },
			},
		},
	},
