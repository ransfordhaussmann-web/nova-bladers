local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "cyclone", duration = 0.7, interval = 0.22, range = 5.5, damage = 10 },
				{ id = "rush", duration = 0.6, rushSpeed = 80, damage = 28 },
			},
		},
		...
		--[[ Solar Drift — sun trail orbit + flare burst ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "flare", duration = 0.55, range = 7, damage = 32 },
			},
		},
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "echo", duration = 0.35, range = 6, damage = 34 },
			},
		},
	},
