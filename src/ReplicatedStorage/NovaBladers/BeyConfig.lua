local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — fire charge + blazing rush ]]
		CrimsonInfernoRush = {
			...
			phases = {
				...
				{ id = "inferno", duration = 0.65, hitInterval = 0.15, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Frost Crown — ice shield + shattering frost waves ]]
		FrostCrownShatter = {
