	...
	SPECIAL_MOVES = {
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.95, interval = 0.3, range = 9, damage = 12 },
			},
		},
		--[[ Solar Drift — solar flare coast + burst ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 0.8, rushSpeed = 68, hitInterval = 0.22, hitRadius = 4.5, damage = 8 },
				{ id = "flare", duration = 0.55, range = 7.5, damage = 32 },
			},
		},
		--[[ Phantom Edge — vanish dash + afterimage hits ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "echo", duration = 0.55, hitInterval = 0.14, hitRadius = 5.5, damage = 9, hits = 3 },
			},
		},
	},
