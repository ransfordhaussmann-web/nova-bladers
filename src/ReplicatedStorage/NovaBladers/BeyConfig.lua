	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "pull", duration = 0.45, interval = 0.2, range = 10, damage = 6 },
				{ id = "crash", duration = 0.45, rushSpeed = 70, range = 7, damage = 28 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, rushSpeed = 88, hitInterval = 0.12, damage = 9 },
				{ id = "finish", duration = 0.3, range = 5.5, damage = 32 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.75, interval = 0.3, range = 7.5, damage = 12 },
				{ id = "shove", duration = 0.4, range = 9, damage = 18 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				{ id = "phase", duration = 0.28 },
				{ id = "slash", duration = 0.42, rushSpeed = 95 },
				{ id = "exit", duration = 0.3, range = 6, damage = 34 },
			},
		},
	},
