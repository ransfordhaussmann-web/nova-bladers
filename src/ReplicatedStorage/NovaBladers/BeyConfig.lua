local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — heavy leap slam + shockwave ]]
		ForgeHammerSlam = {
			id = "ForgeHammerSlam",
			...
			phases = {
				...
				{ id = "leap", duration = 0.3, leapForce = 55 },
				{ id = "slam", duration = 0.25 },
				{ id = "shock", duration = 0.6, range = 9, damage = 22 },
			},
		},
		--[[ Frost Prism — crystal armor, shield, shatter burst ]]
		PrismCrystalShield = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.35, range = 7, damage = 30 },
			},
		},
	},
