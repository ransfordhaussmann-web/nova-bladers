local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRaptorRush = {
			id = "CrimsonRaptorRush",
			name = "Crimson Raptor Rush",
			mode = "meteor",
			duration = 1.2,
			rushSpeed = 88,
			damage = 38,
			...
			phases = {
				...
				{ id = "shower", duration = 0.65, hitInterval = 0.14, hitRadius = 5.2, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Core — ice fortress + frost pulses ]]
		FrostBarrierLock = {
			id = "FrostBarrierLock",
			name = "Frost Barrier Lock",
			mode = "fortress",
			duration = 2.0,
			damage = 28,
			spinLoss = 6,
