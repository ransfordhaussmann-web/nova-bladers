local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / Blood Fang Combo ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.68, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		...
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.38, range = 7, damage = 11 },
