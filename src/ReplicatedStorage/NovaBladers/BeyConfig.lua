local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "cyclone", duration = 0.65, interval = 0.2, range = 5.5, damage = 10, hits = 3 },
				{ id = "slash", duration = 0.55, rushSpeed = 85, damage = 28 },
			},
		},
		...
		--[[ Solar Drift — solar flare trail + wide orbit ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "flare", duration = 0.7, interval = 0.22, damage = 8 },
				{ id = "drift", duration = 0.85 },
			},
		},
		--[[ Phantom Edge — afterimage dash + edge burst ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "edgeBurst", duration = 0.35, range = 7, damage = 36 },
			},
		},
	},
