local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / blade flurry ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.68, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		--[[ Aurora Crest — polar barrier dome / shockwave release ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "release", duration = 0.8, interval = 0.3, range = 9, damage = 14 },
			},
		},
	},
