	...
	SPECIAL_MOVES = {
		...
		CrimsonFangBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		...
		PhantomPhaseCut = {
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(120, 160, 200),
			phases = {
				{ id = "aura", duration = 0.2 },
				{ id = "dive", duration = 0.35, rushSpeed = 100, diveSpeed = 52 },
				{ id = "burst", duration = 0.3, range = 7, damage = 36 },
			},
		},
		--[[ Crystal Edge — shatter surge ]]
		CrystalShatterSurge = {
			...
			phases = {
				{ id = "charge", duration = 0.3 },
				{ id = "shards", duration = 0.9, interval = 0.22, shardCount = 6, range = 5, damage = 9 },
				{ id = "surge", duration = 0.4, range = 8, damage = 32 },
			},
		},
		...
		BlazeCrownSpiral = {
			...
			phases = {
				{ id = "spiral", duration = 0.8, interval = 0.18, range = 5, damage = 10, spinSpeed = 22 },
				{ id = "crown", duration = 0.5, range = 9, damage = 36 },
			},
		},
	},
