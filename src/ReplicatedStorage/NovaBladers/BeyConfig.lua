	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.4, hitInterval = 0.12, hitRadius = 6, damage = 14, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "slam", duration = 0.55, range = 9, damage = 22 },
				{ id = "shards", duration = 0.55, interval = 0.2, range = 7, damage = 10 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "burst", duration = 0.35, range = 8, damage = 28 },
			},
		},
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "ambush", duration = 0.45, rushSpeed = 95 },
				{ id = "fade", duration = 0.35, range = 7, damage = 34 },
			},
		},
	},
