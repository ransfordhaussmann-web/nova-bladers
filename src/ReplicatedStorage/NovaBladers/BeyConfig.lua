local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "flurry", duration = 0.7, interval = 0.22, damage = 8 },
		...
		TideAnchorCrash = {
			...
			phases = {
				{ id = "tether", duration = 0.5, pullSpeed = 28 },
				{ id = "slam", duration = 0.35, range = 7, damage = 32 },
				{ id = "wave", duration = 0.75, interval = 0.35, range = 9, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				{ id = "bloodlust", duration = 0.2 },
				{ id = "slash", duration = 0.45, rushSpeed = 88 },
				{ id = "cleave", duration = 0.35, range = 6, damage = 36 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "blink", duration = 0.4, rushSpeed = 95 },
