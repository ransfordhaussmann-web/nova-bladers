	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.75, hitInterval = 0.22, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / shockwave pulses ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.6, interval = 0.3, range = 7.5, damage = 14 },
			},
		},
	},
