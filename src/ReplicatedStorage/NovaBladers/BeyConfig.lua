local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Comet — fire rush + flare explosion ]]
		CometFlareBurst = {
			id = "CometFlareBurst",
			...
			phases = {
				...
				{ id = "flare", duration = 0.4, range = 7, damage = 36 },
			},
		},
		--[[ Frost Crown — frost aura + ice wall + shatter pulse ]]
		GlacierBastion = {
			id = "GlacierBastion",
			...
			phases = {
				{ id = "frost", duration = 0.4, slowRadius = 9 },
