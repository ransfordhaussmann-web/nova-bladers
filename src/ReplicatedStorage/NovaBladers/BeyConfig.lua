	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "scatter", duration = 0.8, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "phase", duration = 0.45, rushSpeed = 95 },
				{ id = "slash", duration = 0.45, range = 7, damage = 34 },
			},
		},
	},
