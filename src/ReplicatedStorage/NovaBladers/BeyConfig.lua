	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, interval = 0.22, hitRadius = 5, damage = 10, spinRate = 22 },
				{ id = "lunge", duration = 0.4, rushSpeed = 88, damage = 28, range = 4 },
			},
		},
		--[[ Granite Fort — stone bastion + heavy pulses ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.8, interval = 0.35, range = 9, damage = 15 },
			},
		},
		--[[ Solar Drift — solar flare rings + speed drift ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 0.7, driftSpeed = 68 },
			},
		},
		--[[ Phantom Edge — blink surge + edge slash ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
