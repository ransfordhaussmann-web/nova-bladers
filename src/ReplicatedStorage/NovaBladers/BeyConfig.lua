	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.9, hitInterval = 0.15, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		--[[ Aurora Crest — Frost dome / shimmer barrier ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "shimmer", duration = 0.7, interval = 0.28, range = 7, damage = 11 },
