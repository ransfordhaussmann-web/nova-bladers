	...
	SPECIAL_MOVES = {
		...
		CrimsonSlashBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.85, hitInterval = 0.15, hitRadius = 6, damage = 10, hits = 5 },
			},
		},
		--[[ Frost Halo — ice fortress lock ]]
		GlacialHaloLock = {
			id = "GlacialHaloLock",
			...
			phases = {
				...
				{ id = "hail", duration = 0.9, interval = 0.35, range = 9, damage = 11 },
			},
		},
	},
