local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spiral rush with vortex pulses ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.8, interval = 0.22, range = 7, damage = 12 },
			},
		},
		--[[ Glacier Mantle — frost shield and ice shatter ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.45, range = 8, damage = 30 },
			},
		},
	},
