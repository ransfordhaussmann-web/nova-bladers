local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Blaze Ripper / flame rush combo ]]
		BlazeRipper = {
			id = "BlazeRipper",
			name = "Blaze Ripper",
			mode = "meteor",
			...
			phases = {
				...
				{ id = "shower", duration = 0.78, hitInterval = 0.15, hitRadius = 5.8, damage = 12, hits = 5 },
			},
		},
		--[[ Glacier Crown — Frost Bastion / ice wall + chill pulses ]]
		FrostBastion = {
			id = "FrostBastion",
			name = "Frost Bastion",
			mode = "fortress",
