	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, interval = 0.2, hitRadius = 6, damage = 10 },
				{ id = "sweep", duration = 0.55, rushSpeed = 85 },
			},
		},
		GraniteBastionPulse = {
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "drift", duration = 1.0, interval = 0.25, hitRadius = 5, damage = 8 },
				{ id = "burn", duration = 0.5, range = 7, damage = 28 },
			},
		},
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.6, dashes = 3, rushSpeed = 95, interval = 0.2 },
				{ id = "edge", duration = 0.6, rushSpeed = 100, range = 7, damage = 36 },
			},
		},
	},
