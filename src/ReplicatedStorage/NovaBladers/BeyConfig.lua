local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Rush / blade arcs / bite burst ]]
		CrimsonRipperFang = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.55, rushSpeed = 86, slashInterval = 0.14, slashDamage = 10 },
				{ id = "fang", duration = 0.45, range = 5.5, damage = 32 },
			},
		},
		--[[ Frost Halo — ice aura / shield ring / shatter wave ]]
		FrostHaloGlacier = {
			id = "FrostHaloGlacier",
			name = "Frost Halo Glacier",
			mode = "glacier",
			duration = 1.9,
			damage = 28,
			spinLoss = 6,
			...
			phases = {
				...
				{ id = "halo", duration = 0.85, interval = 0.35, range = 7, damage = 8 },
				{ id = "shatter", duration = 0.65, range = 9, damage = 22 },
			},
		},
	},
