local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid fang rush / multi-slash flurry ]]
		CrimsonFangFlurry = {
			...
			phases = {
				...
				{ id = "flurry", duration = 0.9, hitInterval = 0.12, hitRadius = 4.5, damage = 9, hits = 6 },
			},
		},
		--[[ Frost Halo — ice dome shield / frost shatter pulse ]]
		GlacierDome = {
			id = "GlacierDome",
			name = "Glacier Dome",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "dome", duration = 0.7, damageReduction = 0.6 },
				{ id = "shatter", duration = 0.6, interval = 0.25, range = 7, damage = 12 },
			},
		},
	},
