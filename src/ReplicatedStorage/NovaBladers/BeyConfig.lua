local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Flare — fire rush / burn shower ]]
		CrimsonNovaBurst = {
			id = "CrimsonNovaBurst",
			name = "Crimson Nova Burst",
			mode = "meteor",
			duration = 1.25,
			rushSpeed = 82,
			damage = 38,
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.17, hitRadius = 5.2, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Crown — ice barrier / frost pulse ]]
		FrostCrownShield = {
			id = "FrostCrownShield",
			name = "Frost Crown Shield",
			mode = "fortress",
			duration = 1.9,
			damage = 28,
			spinLoss = 7,
