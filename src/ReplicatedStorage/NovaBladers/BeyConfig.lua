local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — flame charge + wide slash arc ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, rushSpeed = 88, hitInterval = 0.12, hitRadius = 4.5, damage = 10 },
				{ id = "rend", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Frost Ring — ice barrier + shatter pulse ]]
		GlacialFrostBarrier = {
