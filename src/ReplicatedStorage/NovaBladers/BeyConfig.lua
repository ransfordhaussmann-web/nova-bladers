	...
	SPECIAL_MOVES = {
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.9, interval = 0.38, range = 9, damage = 14 },
			},
		},
		--[[ Solar Drift — Flare Orbit / expanding sun rings ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		--[[ Phantom Edge — Blade Mirage / feint strike ]]
		PhantomBladeMirage = {
			...
			phases = {
				{ id = "mirage", duration = 0.3, cloneCount = 3 },
				{ id = "feint", duration = 0.35, rushSpeed = 88 },
				{ id = "strike", duration = 0.4, range = 5.5, damage = 34 },
			},
		},
	},
