local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		NovaMeteorShower = {
			...
			mode = "meteor", -- windup → launch → shower
			duration = 1.35,
			rushSpeed = 78,
			damage = 35,
			spinLoss = 14,
		...
		CrimsonFangBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.12, hitRadius = 4.5, damage = 10, hits = 6 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomMirageCut = {
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(120, 130, 210),
			phases = {
		...
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.9, hitInterval = 0.2, hitRadius = 6.5, damage = 12, hits = 4 },
			},
		},
		BlazeCrownNova = {
			id = "BlazeCrownNova",
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "burst", duration = 0.55, range = 8, damage = 44 },
			},
		},
	},
