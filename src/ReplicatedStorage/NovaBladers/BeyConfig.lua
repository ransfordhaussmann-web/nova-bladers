local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Flame Rush / rapid fire barrage ]]
		CrimsonFlameBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.9, interval = 0.2, range = 5.5, damage = 10, hits = 5 },
			},
		},
		--[[ Frost Crown — Ice aura / crown shield / frost shatter ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
