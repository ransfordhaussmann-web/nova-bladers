local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Ripper — Vortex spin + slash rush ]]
		CrimsonVortexSlash = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "vortex", duration = 0.55, interval = 0.2, hitRadius = 5, damage = 10, hits = 3 },
				{ id = "slash", duration = 0.45, rushSpeed = 85, damage = 32 },
			},
		},
		--[[ Frost Monarch — Ice citadel + shatter burst ]]
		FrostCitadel = {
			id = "FrostCitadel",
			name = "Frost Citadel",
			mode = "frost",
