	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.75, interval = 0.25, rushSpeed = 88, damage = 12, hits = 3 },
				{ id = "finisher", duration = 0.45, rushSpeed = 100, range = 5.5, damage = 38 },
			},
		},
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "rings", duration = 0.75, interval = 0.25, damage = 10 },
				{ id = "orbit", duration = 0.7 },
			},
		},
		--[[ Phantom Edge — Mirage Clone + Blade Strike ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "phantom", duration = 0.45, rushSpeed = 86 },
				{ id = "strike", duration = 0.45, range = 7, damage = 36 },
			},
		},
	},
