local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / double strike ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.5, hitInterval = 0.15, hitRadius = 4.5, damage = 12, hits = 3 },
				{ id = "finish", duration = 0.3, range = 5.5, damage = 22 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / shield pulse ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "dome", duration = 0.65 },
				{ id = "pulse", duration = 0.7, interval = 0.3, range = 7, damage = 14 },
			},
		},
	},
