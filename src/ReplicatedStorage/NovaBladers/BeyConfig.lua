local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid fang barrage rush ]]
		CrimsonRipperBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.65, hitInterval = 0.12, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Granite Fort — stone rampart + seismic pulses ]]
		GraniteRampart = {
			id = "GraniteRampart",
		...
		--[[ Solar Drift — corona heat rings + orbit ]]
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
			...
			phases = {
				...
				{ id = "heat", duration = 0.8, interval = 0.25, damage = 8 },
				{ id = "orbit", duration = 0.7 },
			},
		},
		--[[ Phantom Edge — mirage blink + slash ]]
		PhantomMirageCut = {
			id = "PhantomMirageCut",
			...
			phases = {
				...
				{ id = "slash", duration = 0.35, range = 7, damage = 36, rushSpeed = 100 },
				{ id = "burst", duration = 0.25, range = 5.5, damage = 22 },
			},
		},
		--[[ Frost Crown — ice shield + shatter ]]
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shield", duration = 0.55 },
				{ id = "shatter", duration = 0.65, range = 8.5, damage = 28 },
			},
		},
		--[[ Crimson Drift — high-speed surge ]]
		CrimsonDriftSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.55, rushSpeed = 108 },
				{ id = "afterburn", duration = 0.35, hitInterval = 0.14, hitRadius = 4.5, damage = 9, hits = 2 },
			},
		},
	},
