local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Orbit — expanding solar rings + flame rush ]]
		CrimsonSolarFlare = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.65, interval = 0.25, damage = 10 },
				{ id = "impact", duration = 0.55, rushSpeed = 80, range = 7, damage = 32 },
			},
		},
		--[[ Frost Anchor — freeze shield + ice pulse shatter ]]
		FrostGlacierLock = {
			id = "FrostGlacierLock",
