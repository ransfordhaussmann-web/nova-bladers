local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — twin lunge with ripper fang slashes ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.35, rushSpeed = 88, damage = 14, hitRadius = 4.5 },
				{ id = "slash", duration = 0.35, rushSpeed = 95, damage = 16, hitRadius = 5 },
				{ id = "rip", duration = 0.45, range = 7, damage = 28 },
			},
		},
		--[[ Aurora Crest — protective dome with aurora pulses ]]
		AuroraBarrierDome = {
