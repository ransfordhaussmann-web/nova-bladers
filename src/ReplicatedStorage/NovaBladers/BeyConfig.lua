	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.9, hitInterval = 0.2, hitRadius = 5, damage = 9, hits = 5 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "rend", duration = 0.4, range = 5.5, damage = 38 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "quake", duration = 0.7, interval = 0.32, range = 8.5, damage = 14 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "flares", duration = 0.7, interval = 0.25, damage = 10 },
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "phase", duration = 0.35, rushSpeed = 96 },
