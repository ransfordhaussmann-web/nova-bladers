local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ember meteor barrage ]]
		EmberStarfall = {
			id = "EmberStarfall",
			name = "Ember Starfall",
			mode = "meteor",
			...
			phases = {
				...
				{ id = "shower", duration = 0.78, hitInterval = 0.14, hitRadius = 5.8, damage = 13, hits = 5 },
			},
		},
		--[[ Frost Crown — Ice burrow + glacier wall ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "fortress",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.3, range = 9, damage = 15 },
			},
		},
	},
