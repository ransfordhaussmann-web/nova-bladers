local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Comet — flaming comet dash + flare detonation ]]
		CometFlareBurst = {
			id = "CometFlareBurst",
			...
			phases = {
				...
				{ id = "streak", duration = 0.42, rushSpeed = 88 },
				{ id = "flare", duration = 0.35, range = 7.5, damage = 36 },
			},
		},
		--[[ Frost Crown — ice armor + shard volley + frost wave ]]
		GlacierBastion = {
			id = "GlacierBastion",
			...
			phases = {
				...
				{ id = "shards", duration = 0.75, interval = 0.3, range = 7, damage = 10 },
				{ id = "avalanche", duration = 0.45, range = 9, damage = 22 },
			},
		},
	},
