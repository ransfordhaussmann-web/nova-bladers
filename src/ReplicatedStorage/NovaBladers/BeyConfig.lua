	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.7, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 4 },
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "crash", duration = 0.35, slamDamage = 30 },
				{ id = "ripple", duration = 0.85, interval = 0.3, range = 9, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				{ id = "snarl", duration = 0.2 },
				{ id = "lunge", duration = 0.35, rushSpeed = 95 },
				{ id = "rend", duration = 0.3, range = 5.5, damage = 36 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "collapse", duration = 0.85, range = 10, damage = 22 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "afterimage", duration = 0.3, range = 6, damage = 28 },
			},
		},
	},
