	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperFang = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, interval = 0.18, slashes = 3, range = 5.5, damage = 12 },
				{ id = "lunge", duration = 0.35, rushSpeed = 88, range = 7, damage = 28 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.9, interval = 0.3, range = 9, damage = 14 },
			},
		},
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
			...
			phases = {
				{ id = "corona", duration = 0.55, interval = 0.22, damage = 8 },
				{ id = "recover", duration = 0.4 },
				{ id = "drift", duration = 0.9, rushSpeed = 58 },
			},
		},
		PhantomPhaseCut = {
			id = "PhantomPhaseCut",
