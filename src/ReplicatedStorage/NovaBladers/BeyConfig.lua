local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				{ id = "snarl", duration = 0.25 },
				{ id = "lunge", duration = 0.35, rushSpeed = 88 },
				{ id = "ripper", duration = 0.65, hitInterval = 0.13, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / Polar Pulse ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "dome", duration = 0.8, damageReduction = 0.6 },
				{ id = "pulse", duration = 0.8, interval = 0.35, range = 7, damage = 12 },
			},
		},
	},
