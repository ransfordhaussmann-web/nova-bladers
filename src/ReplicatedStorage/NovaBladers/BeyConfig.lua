	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, hitInterval = 0.15, hitRadius = 5, damage = 10, hits = 5 },
				{ id = "slash", duration = 0.35, rushSpeed = 88, range = 7, damage = 28 },
			},
		},
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.0, interval = 0.32, range = 7.5, damage = 12 },
				{ id = "quake", duration = 0.45, range = 10, damage = 22 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "flares", duration = 0.75, interval = 0.25, damage = 8 },
				{ id = "drift", duration = 0.75 },
			},
		},
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.65, dashes = 3, dashInterval = 0.18, hitRadius = 4.5, damage = 14 },
				{ id = "exit", duration = 0.3, range = 6, damage = 32 },
			},
		},
	},
