local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spinning fire cyclone with pull ]]
		EmberCyclone = {
			id = "EmberCyclone",
			name = "Ember Cyclone",
			mode = "cyclone",
			...
			phases = {
				...
				{ id = "eruption", duration = 0.35, range = 8, damage = 34 },
			},
		},
		--[[ Frost Crown — ice fortress with frost pulses ]]
		GlacierVault = {
			id = "GlacierVault",
			name = "Glacier Vault",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.95, interval = 0.34, range = 8, damage = 12 },
			},
		},
	},
