	...
	SPECIAL_MOVES = {
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "rend", duration = 0.7, hitInterval = 0.14, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		...
		--[[ Solar Drift — solar flare rings + orbit loop ]]
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.35, rushSpeed = 100, range = 7, damage = 36 },
