local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — Fire cyclone pull + multi-hit ]]
		BlazeCycloneWheel = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, interval = 0.2, range = 7, damage = 10, pullStrength = 18 },
				{ id = "flare", duration = 0.35, range = 8, damage = 28 },
			},
		},
		--[[ Frost Veil — Ice shield + shatter pulse ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
