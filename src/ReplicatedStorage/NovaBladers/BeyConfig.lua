local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — spinning blade cyclone + final slash ]]
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, spinRate = 12, hitInterval = 0.2, hitRadius = 5.5, damage = 12, hits = 4 },
				{ id = "slash", duration = 0.45, rushSpeed = 85, damage = 32 },
			},
		},
		--[[ Granite Fort — stone brace + ground pulses ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.2, interval = 0.35, range = 9, damage = 14 },
				{ id = "quake", duration = 0.4, range = 11, damage = 20 },
			},
		},
		--[[ Solar Drift — solar flare rush + burn trail ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "flare", duration = 0.5, rushSpeed = 75 },
				{ id = "drift", duration = 1.1, hitInterval = 0.22, hitRadius = 6, damage = 10 },
			},
		},
		--[[ Phantom Edge — vanish dash + afterimage burst ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.45, rushSpeed = 100 },
				{ id = "afterimage", duration = 0.5, range = 7, damage = 34 },
			},
		},
	},
