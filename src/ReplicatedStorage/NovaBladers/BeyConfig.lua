	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.35, rushSpeed = 88, damage = 18 },
				{ id = "rip", duration = 0.35, rushSpeed = 95, damage = 22, turnDeg = 90 },
				{ id = "finisher", duration = 0.25, range = 5.5, damage = 28 },
			},
		},
		--[[ Granite Fort — anchored stone bastion ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "mirage", duration = 0.35, range = 7, damage = 36 },
			},
		},
	},
