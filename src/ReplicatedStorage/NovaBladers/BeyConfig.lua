local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / triple fang slash ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.65, hitInterval = 0.2, hitRadius = 5, damage = 13, hits = 3 },
			},
		},
		--[[ Granite Fort — Bastion shield / counter slam ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "counter", duration = 0.8, rushSpeed = 55, range = 7, damage = 32 },
			},
		},
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.75, interval = 0.3, damage = 10 },
				{ id = "orbit", duration = 0.75 },
			},
		},
		--[[ Phantom Edge — Blade mirage / illusion dash ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.4, rushSpeed = 85 },
				{ id = "burst", duration = 0.55, range = 6, damage = 34 },
			},
		},
	},
