local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — flame ignite, rush, burning orbit ]]
		CrimsonFlameSpiral = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.4, rushSpeed = 85 },
				{ id = "spiral", duration = 1.15, interval = 0.22, damage = 10 },
			},
		},
		--[[ Frost Prism — crystal shield, frost pulses, shatter burst ]]
		FrostCrystalAegis = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.6, range = 8, damage = 32 },
			},
		},
	},
