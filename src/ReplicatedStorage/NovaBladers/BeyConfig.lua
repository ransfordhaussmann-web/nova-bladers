	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			color = Color3.fromRGB(60, 190, 210),
			phases = {
				{ id = "surge", duration = 0.4, interval = 0.2, range = 6, damage = 8 },
				{ id = "crash", duration = 0.35, rushSpeed = 55 },
				{ id = "ripple", duration = 0.85, interval = 0.3, range = 9, damage = 14 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "rush", duration = 0.35, rushSpeed = 95 },
				{ id = "rend", duration = 0.35, range = 5.5, damage = 36, hitInterval = 0.12, hits = 2 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			color = Color3.fromRGB(140, 145, 120),
			phases = {
				{ id = "burrow", duration = 0.5 },
				{ id = "wall", duration = 0.65 },
				{ id = "pulse", duration = 0.85, interval = 0.35, range = 7, damage = 11 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			damage = 38,
			spinLoss = 14,
			color = Color3.fromRGB(170, 160, 220),
			phases = {
				{ id = "phase", duration = 0.3 },
				{ id = "blink", duration = 0.3, rushSpeed = 88 },
				{ id = "slash", duration = 0.4, range = 7, damage = 34 },
			},
		},
	},
