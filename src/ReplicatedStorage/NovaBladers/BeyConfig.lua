	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, rushSpeed = 82, hitInterval = 0.22, hitRadius = 5, damage = 10, hits = 4 },
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "drift", duration = 1.1, rushSpeed = 68, hitInterval = 0.25, hitRadius = 4.5, damage = 8 },
				{ id = "flare", duration = 0.4, range = 7, damage = 28 },
			},
		},
		--[[ Phantom Edge — Multi-dash surge ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.55, dashes = 3, dashSpeed = 95, dashInterval = 0.16 },
				{ id = "edge", duration = 0.4, range = 6, damage = 36 },
			},
		},
	},
