local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Blood Rush / Fang Chain ]]
		CrimsonBloodRend = {
			id = "CrimsonBloodRend",
			name = "Crimson Blood Rend",
			mode = "meteor",
			duration = 1.25,
			rushSpeed = 82,
			damage = 38,
		...
		--[[ Granite Fort — Stone Anchor / Rampart / Quake ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		--[[ Solar Drift — Heat Flare / Sun Orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		--[[ Phantom Edge — Phase Dash / Blade Cascade ]]
		PhantomBladeCascade = {
			id = "PhantomBladeCascade",
			name = "Phantom Blade Cascade",
			mode = "eclipse",
			duration = 1.2,
			rushSpeed = 88,
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(190, 210, 230),
			phases = {
