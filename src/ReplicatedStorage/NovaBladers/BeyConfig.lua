	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.5, hitInterval = 0.12, hitRadius = 4.2, damage = 14, hits = 4 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / Aurora Pulse / Shock Burst ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "hold", duration = 0.9, interval = 0.38, range = 7, damage = 10 },
				{ id = "burst", duration = 0.5, range = 10, damage = 22 },
			},
		},
	},
