local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spiral rend rush ]]
		CrimsonSpiralRend = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.75, orbitRadius = 5, orbitSpeed = 22, hitInterval = 0.2, damage = 10 },
				{ id = "rend", duration = 0.35, rushSpeed = 95, range = 7, damage = 32 },
			},
		},
		--[[ Glacier Shield — frost bulwark + ice waves ]]
		GlacierFrostBulwark = {
			...
			phases = {
				...
				{ id = "bulwark", duration = 0.6 },
				{ id = "pulse", duration = 0.85, interval = 0.32, range = 7.5, damage = 12 },
			},
		},
	},
