local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Quill — feather rush + multi-hit storm ]]
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.32, rushSpeed = 80 },
				{ id = "storm", duration = 0.8, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Tide Anchor — heavy slam + tidal pulses ]]
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "hoist", duration = 0.35 },
				{ id = "slam", duration = 0.4, slamDamage = 28, range = 7 },
				{ id = "wave", duration = 0.95, interval = 0.3, range = 9, damage = 12 },
			},
		},
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "slash1", duration = 0.28, rushSpeed = 75, damage = 14 },
				{ id = "slash2", duration = 0.28, rushSpeed = 75, damage = 14 },
				{ id = "slash3", duration = 0.35, rushSpeed = 85, damage = 22, range = 5.5 },
			},
		},
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.95, interval = 0.32, range = 8.5, damage = 14 },
			},
		},
		...
		--[[ Phantom Edge — phase blink + ghost slash ]]
		PhantomPhaseSlash = {
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(190, 190, 240),
			phases = {
				{ id = "vanish", duration = 0.2 },
				{ id = "blink", duration = 0.15 },
				{ id = "slash", duration = 0.35, rushSpeed = 88, range = 6, damage = 36 },
