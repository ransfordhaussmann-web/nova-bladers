local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid meteor barrage ]]
		CrimsonRipperBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.12, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		...
		--[[ Solar Drift — corona sonic rings ]]
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
		...
		--[[ Phantom Edge — mirage eclipse cut ]]
		PhantomMirageCut = {
			id = "PhantomMirageCut",
		...
		--[[ Frost Crown — ice shards + shatter ]]
		FrostCrownShatter = {
		...
		--[[ Crimson Drift — surge rush + orbit ]]
		CrimsonDriftSurge = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.35, rushSpeed = 80 },
				{ id = "shower", duration = 0.8, hitInterval = 0.16, hitRadius = 5.5, damage = 9, hits = 4 },
			},
		},
	},
