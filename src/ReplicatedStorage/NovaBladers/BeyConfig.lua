local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spiral pull + slam rush ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.9, interval = 0.22, pullRadius = 10, damage = 10 },
				{ id = "slam", duration = 0.4, rushSpeed = 95, range = 7, damage = 40 },
			},
		},
		--[[ Glacier Mantle — frost field + armor lock + ice shatter ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
