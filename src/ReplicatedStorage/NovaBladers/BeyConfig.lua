local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Orbit — fire orbit + comet slam ]]
		BlazeCometLoop = {
			id = "BlazeCometLoop",
			...
			phases = {
				...
				{ id = "slam", duration = 0.45, rushSpeed = 88, range = 7, damage = 34 },
			},
		},
		--[[ Frost Crown — ice crown + shards + snap ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
			...
			phases = {
				...
				{ id = "shards", duration = 0.85, interval = 0.28, range = 7, damage = 10 },
