	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Tide Anchor — sink + anchor slam + tidal pulse ]]
		TideAnchorCrash = {
			id = "TideAnchorCrash",
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.0, interval = 0.4, range = 7.5, damage = 12 },
			},
		},
