	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.28, rushSpeed = 88 },
				{ id = "ripper", duration = 0.35, hitInterval = 0.12, hitRadius = 4.5, damage = 10, hits = 3 },
				{ id = "finish", duration = 0.25, rushSpeed = 95, damage = 22, range = 5 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			color = Color3.fromRGB(130, 145, 105),
			phases = {
				{ id = "anchor", duration = 0.3 },
				{ id = "bastion", duration = 0.75, interval = 0.4, range = 6, damage = 10 },
				{ id = "collapse", duration = 0.45, range = 9, damage = 20 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "flare", duration = 0.75, interval = 0.3, damage = 8 },
				{ id = "orbit", duration = 0.65 },
			},
		},
		PhantomBladeMirage = {
			...
			phases = {
				{ id = "split", duration = 0.22 },
				{ id = "rush", duration = 0.35, rushSpeed = 86 },
				{ id = "converge", duration = 0.28, rushSpeed = 98 },
				{ id = "slash", duration = 0.25, range = 6, damage = 32 },
			},
		},
	},
