	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.55, hitInterval = 0.15, hitRadius = 4.5, damage = 14, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "shock", duration = 0.65, interval = 0.35, range = 9, damage = 15 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "burn", duration = 0.75, interval = 0.25, damage = 8 },
			},
		},
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "dash1", duration = 0.35, rushSpeed = 75 },
				{ id = "dash2", duration = 0.35, rushSpeed = 85 },
				{ id = "fade", duration = 0.35, range = 7, damage = 28 },
			},
		},
	},
