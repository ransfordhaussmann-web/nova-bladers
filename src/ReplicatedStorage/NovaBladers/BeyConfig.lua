local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — fire rush + inferno burst ]]
		CrimsonInfernoRoar = {
			...
			phases = {
				{ id = "roar", duration = 0.3 },
				{ id = "blaze", duration = 0.35, rushSpeed = 82 },
				{ id = "inferno", duration = 0.75, interval = 0.25, range = 7, damage = 12 },
			},
		},
		--[[ Frost Crown — ice shield + shatter shards ]]
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.85, interval = 0.28, range = 5.5, damage = 10 },
			},
		},
	},
