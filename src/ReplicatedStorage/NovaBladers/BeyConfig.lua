local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRend = {
			...
			phases = {
				{ id = "brace", duration = 0.2 },
				{ id = "slash", duration = 0.35, rushSpeed = 85 },
				{ id = "rend", duration = 0.9, hitInterval = 0.28, hitRadius = 6, damage = 13, hits = 3 },
			},
		},
		...
		--[[ Solar Drift — solar rings + burn orbit ]]
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		--[[ Phantom Edge — phase dash + cross slash ]]
		PhantomPhaseSlash = {
