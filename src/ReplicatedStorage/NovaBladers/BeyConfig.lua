local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — fire rush with burning aftershocks ]]
		CrimsonInfernoRoar = {
			...
			phases = {
				...
				{ id = "blaze", duration = 0.45, rushSpeed = 85 },
				{ id = "roar", duration = 0.55, hitInterval = 0.2, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Frost Crown — ice guard, crown ring, shard burst ]]
		FrostCrownShatter = {
