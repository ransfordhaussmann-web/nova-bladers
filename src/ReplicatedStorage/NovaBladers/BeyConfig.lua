local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / chain slash combo ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.7, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / reflect pulses / crest burst ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "reflect", duration = 0.8, interval = 0.35, range = 7, damage = 11 },
				{ id = "crest", duration = 0.45, range = 7, damage = 32 },
			},
		},
	},
