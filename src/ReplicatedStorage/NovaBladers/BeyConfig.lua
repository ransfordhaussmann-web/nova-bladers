	...
	SPECIAL_MOVES = {
		...
		BlazeSpiralDrive = {
			...
			phases = {
				...
				{ id = "finisher", duration = 0.45, range = 7, damage = 28 },
			},
		},
		--[[ Frost Core — ice shield and slam ]]
		GlacierAegis = {
			id = "GlacierAegis",
			name = "Glacier Aegis",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shards", duration = 0.7, interval = 0.25, range = 7, damage = 11 },
				{ id = "slam", duration = 0.7, range = 9, damage = 22 },
			},
		},
	},
