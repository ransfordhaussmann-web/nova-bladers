	...
	SPECIAL_MOVES = {
		...
		BlazeCorkscrew = {
			...
			phases = {
				...
				{ id = "corkscrew", duration = 0.75, rushSpeed = 82, spiralRadius = 2.5, hitInterval = 0.2, hitRadius = 4.5, damage = 10 },
				{ id = "erupt", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Frost Orbit — ice barrier and shatter pulses ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.8, interval = 0.3, range = 7, damage = 14 },
			},
		},
	},
