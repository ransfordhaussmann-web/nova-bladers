local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — chain-link rush / fang combo / ripper burst ]]
		CrimsonRipperChain = {
			...
			phases = {
				...
				{ id = "latch", duration = 0.4, rushSpeed = 85 },
				{ id = "chain", duration = 0.7, hitInterval = 0.12, hitRadius = 5, damage = 9, hits = 5 },
				{ id = "burst", duration = 0.2, range = 6, damage = 28 },
			},
		},
