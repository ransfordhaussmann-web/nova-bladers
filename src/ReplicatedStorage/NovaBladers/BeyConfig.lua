	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.76, hitInterval = 0.15, hitRadius = 5.0, damage = 12, hits = 5 },
			},
		},
		--[[ Granite Fort — heavy fortress variant ]]
		GraniteWallLock = {
			id = "GraniteWallLock",
			name = "Granite Wall Lock",
			mode = "fortress",
			duration = 2.0,
			damage = 28,
			spinLoss = 6,
		...
		--[[ Phantom Edge — spectral eclipse variant ]]
		PhantomSlashVeil = {
			id = "PhantomSlashVeil",
			name = "Phantom Slash Veil",
			mode = "eclipse",
			duration = 1.1,
			rushSpeed = 88,
			damage = 40,
