local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "slam", duration = 0.35, rushSpeed = 55 },
				{ id = "wave", duration = 1.0, interval = 0.38, range = 9, damage = 14 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "dive", duration = 0.38, rushSpeed = 95, diveSpeed = 42 },
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.3, range = 7.5, damage = 11 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "sonic", duration = 0.65, interval = 0.25, damage = 8 },
		...
		PhantomPhaseSlash = {
			...
			damage = 40,
			spinLoss = 14,
			color = Color3.fromRGB(140, 160, 210),
			phases = {
				{ id = "vanish", duration = 0.2 },
				{ id = "slash", duration = 0.45, rushSpeed = 105 },
				{ id = "reveal", duration = 0.3, range = 5.5, damage = 36 },
			},
		},
	},
