local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Crown — ice barrier / frost shatter ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
		...
		--[[ Crimson Forge — molten rush / lava splash ]]
		ForgeEruption = {
			id = "ForgeEruption",
			name = "Forge Eruption",
			mode = "forge",
			...
			phases = {
				...
				{ id = "erupt", duration = 0.35, rushSpeed = 82 },
				{ id = "splash", duration = 0.75, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 3 },
			},
		},
	},
