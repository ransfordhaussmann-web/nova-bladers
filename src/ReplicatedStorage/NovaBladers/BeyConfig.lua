	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "zigzag", duration = 0.55, rushSpeed = 85, zigCount = 3 },
				{ id = "rip", duration = 0.35, range = 7, damage = 40 },
			},
		},
		--[[ Aurora Crest — aurora dome barrier + frost burst ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "frostburst", duration = 0.75, interval = 0.3, range = 9, damage = 14 },
			},
		},
	},
