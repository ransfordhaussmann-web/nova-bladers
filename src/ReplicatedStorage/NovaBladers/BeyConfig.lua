	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.5, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "slam", duration = 0.7, range = 9, damage = 32 },
			},
		},
		...
		SolarFlareOrbit = {
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "flare", duration = 0.7, interval = 0.3, damage = 10 },
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "strike", duration = 0.55, range = 7, damage = 34 },
			},
		},
	},
