	...
	SPECIAL_MOVES = {
		...
		CrimsonFangFlurry = {
			...
			phases = {
				...
				{ id = "flurry", duration = 0.9, hitInterval = 0.12, hitRadius = 4.2, damage = 8, hits = 6 },
				{ id = "finisher", duration = 0.25, range = 7, damage = 22 },
			},
		},
		...
		GlacierDome = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.4, range = 9, damage = 15 },
			},
		},
	},
