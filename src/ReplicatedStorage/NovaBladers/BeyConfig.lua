	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.55, hitInterval = 0.15, hitRadius = 5.2, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / light cascade ]]
		AuroraBarrierDome = {
			...
			phases = {
				{ id = "glow", duration = 0.35 },
				{ id = "dome", duration = 0.65 },
				{ id = "cascade", duration = 0.75, interval = 0.3, range = 7.5, damage = 11 },
			},
		},
	},
