	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.82, hitInterval = 0.17, hitRadius = 5.8, damage = 10, hits = 5 },
			},
		},
		--[[ Tide Anchor — Anchor Crash ]]
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "tide", duration = 0.55 },
				{ id = "crash", duration = 0.85, interval = 0.3, range = 8.5, damage = 12 },
			},
		},
		--[[ Crimson Fang — Rend ]]
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "rend", duration = 0.35, range = 6, damage = 36 },
			},
		},
		--[[ Granite Fort — Rampart ]]
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "quake", duration = 0.85, interval = 0.34, range = 7.5, damage = 11 },
			},
		},
		...
		PhantomPhaseSlash = {
			...
			phases = {
				{ id = "fade", duration = 0.28 },
				{ id = "blink", duration = 0.42, rushSpeed = 100 },
				{ id = "slash", duration = 0.35, range = 6.2, damage = 34 },
			},
		},
	},
