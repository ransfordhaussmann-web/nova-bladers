	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperBarrage = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.3, rushSpeed = 82 },
				{ id = "barrage", duration = 0.65, hitInterval = 0.2, hitRadius = 4.5, damage = 14, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "counter", duration = 0.35, rushSpeed = 65 },
				{ id = "quake", duration = 0.85, interval = 0.3, range = 7.5, damage = 12 },
			},
		},
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
			...
			phases = {
				...
				{ id = "flare", duration = 0.65, rushSpeed = 75 },
			},
		},
		PhantomMirageCut = {
			id = "PhantomMirageCut",
			...
			phases = {
				...
				{ id = "cut", duration = 0.35, range = 5.5, damage = 32 },
			},
		},
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.55, interval = 0.28, range = 7, damage = 10 },
				{ id = "shards", duration = 0.6, range = 6, damage = 22 },
			},
		},
		CrimsonDriftSurge = {
			...
			phases = {
				{ id = "accel", duration = 0.25 },
				{ id = "drift", duration = 0.55, rushSpeed = 88 },
				{ id = "impact", duration = 0.35, range = 6, damage = 30 },
			},
		},
	},
