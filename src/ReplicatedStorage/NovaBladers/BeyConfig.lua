local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid blade storm rush ]]
		CrimsonBladeStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.85, hitInterval = 0.15, hitRadius = 6, damage = 12, hits = 5 },
			},
		},
		...
		FrostBastion = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.35, range = 9, damage = 11 },
			},
		},
	},
