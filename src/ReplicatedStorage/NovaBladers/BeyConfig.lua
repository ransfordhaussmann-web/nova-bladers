local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Dash / spinning blade barrage ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.7, interval = 0.22, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Northern Lights shield dome ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "dome", duration = 1.0, interval = 0.35, range = 7, damage = 10 },
