local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — sweeping blade arc ]]
		CrimsonRendingArc = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, interval = 0.15, hitRadius = 6, damage = 12, hits = 3 },
		...
		GlacialFrostBarrier = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.95, interval = 0.3, range = 7.5, damage = 10 },
			},
		},
	},
