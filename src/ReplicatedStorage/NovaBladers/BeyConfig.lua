local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				{ id = "prime", duration = 0.25 },
				{ id = "lunge", duration = 0.35, rushSpeed = 88 },
				{ id = "rip", duration = 0.6, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		...
		--[[ Phantom Edge — Mirage clones + phantom cleave ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "cleave", duration = 0.5, range = 7, damage = 36 },
			},
		},
	},
