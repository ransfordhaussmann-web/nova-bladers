	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "wave", duration = 0.75, interval = 0.3, range = 7, damage = 10 },
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "rend", duration = 0.4, range = 5.5, damage = 36 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.95, interval = 0.34, range = 7.5, damage = 14 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			spinLoss = 14,
			damageReduction = 0.7,
			color = Color3.fromRGB(130, 90, 230),
			phases = {
				{ id = "fade", duration = 0.2 },
				{ id = "slash", duration = 0.45, rushSpeed = 100 },
				{ id = "recover", duration = 0.3, range = 6, damage = 30 },
			},
		},
	},
