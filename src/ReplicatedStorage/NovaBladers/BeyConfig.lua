local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Comet — spiral orbit rush + fire burst ]]
		BlazeSpiralStrike = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.9 },
				{ id = "burst", duration = 0.35, range = 7, damage = 40 },
			},
		},
		--[[ Frost Ring — freeze aura, ice barricade, shatter waves ]]
		GlacialBarricade = {
			id = "GlacialBarricade",
			name = "Glacial Barricade",
			mode = "glacial",
			duration = 1.9,
			damage = 28,
			spinLoss = 6,
