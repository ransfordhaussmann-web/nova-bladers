local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — spinning blade cyclone + strike ]]
		CrimsonBladeCyclone = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "cyclone", duration = 0.9, interval = 0.22, hitRadius = 5, damage = 10, orbitRadius = 4 },
				{ id = "strike", duration = 0.3, rushSpeed = 88, damage = 28 },
			},
		},
		--[[ Granite Fort — anchor, stone shield, seismic pulses ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "seismic", duration = 0.9, interval = 0.3, range = 9, damage = 12 },
			},
		},
		--[[ Solar Drift — solar gather, wide drift trail, flare burst ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 1.0, interval = 0.25, hitRadius = 4.5, damage = 7, orbitRadius = 8, orbitSpeed = 12 },
				{ id = "flare", duration = 0.45, range = 7, damage = 32 },
			},
		},
		--[[ Phantom Edge — vanish, surge dash, echo strike ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.5, rushSpeed = 95 },
				{ id = "echo", duration = 0.5, range = 6, damage = 30, hits = 2, hitInterval = 0.2 },
			},
		},
	},
