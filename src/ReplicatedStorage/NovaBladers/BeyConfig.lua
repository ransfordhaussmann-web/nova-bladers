local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crystal Vortex — crystal fracture + vortex rush ]]
		CrystalShatterStorm = {
			...
			phases = {
				...
				{ id = "fracture", duration = 0.55, interval = 0.28, range = 7, damage = 10 },
				{ id = "vortex", duration = 0.7, rushSpeed = 74, hitInterval = 0.22, hitRadius = 5, damage = 12 },
			},
		},
		--[[ Ember Ring — fire spiral orbit + phoenix dive ]]
		EmberPhoenixSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.3, damage = 9 },
				{ id = "dive", duration = 0.5, rushSpeed = 88, range = 7, damage = 36 },
			},
		},
	},
