	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, interval = 0.22, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "slash", duration = 0.5, rushSpeed = 88, damage = 28, range = 4 },
			},
		},
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.95, interval = 0.32, range = 9, damage = 14 },
			},
		},
		--[[ Solar Drift — solar orbit trail + flare burst ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 1.0, interval = 0.25, trailDamage = 7 },
				{ id = "flare", duration = 0.5, range = 7, damage = 32 },
			},
		},
		--[[ Phantom Edge — vanish dash + echo strikes ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "echo", duration = 0.5, interval = 0.17, echoes = 3, damage = 12, range = 5 },
			},
		},
	},
