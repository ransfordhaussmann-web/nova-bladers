local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — aggressive lunge with ripper blades ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.55, interval = 0.15, range = 5.5, damage = 14, slashes = 3 },
			},
		},
		--[[ Aurora Crest — barrier dome with pulse rings ]]
		AuroraBarrierDome = {
