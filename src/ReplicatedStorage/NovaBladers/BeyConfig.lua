	...
	SPECIAL_MOVES = {
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		GraniteBulwark = {
			id = "GraniteBulwark",
		...
		PhantomWraithStrike = {
			id = "PhantomWraithStrike",
			name = "Phantom Wraith Strike",
			mode = "eclipse",
			duration = 1.1,
			rushSpeed = 88,
			damage = 36,
			...
			phases = {
				...
				{ id = "burst", duration = 0.32, range = 6, damage = 32 },
			},
		},
		CrystalShatterSurge = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.65, hitInterval = 0.14, hitRadius = 4.5, damage = 10 },
		...
		BlazeCrownSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, hitInterval = 0.2, hitRadius = 4, damage = 9 },
				{ id = "flare", duration = 0.35, range = 7.5, damage = 34 },
			},
		},
	},
