local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Quill — Feather volley + flame rush ]]
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.3, rushSpeed = 80 },
				{ id = "shower", duration = 0.82, hitInterval = 0.17, hitRadius = 5.8, damage = 12, hits = 4 },
			},
		},
		--[[ Tide Anchor — Sink, anchor wall, tidal wave ]]
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "anchor", duration = 0.55 },
				{ id = "wave", duration = 0.95, interval = 0.3, range = 9, damage = 14 },
			},
		},
		--[[ Crimson Fang — Blood charge, lunge, rend burst ]]
		CrimsonRend = {
			id = "CrimsonRend",
			name = "Crimson Rend",
			mode = "rend",
			...
			phases = {
				...
				{ id = "lunge", duration = 0.38, rushSpeed = 95 },
				{ id = "rip", duration = 0.35, range = 6, damage = 36 },
			},
		},
		--[[ Granite Fort — Stone rise, rampart, tremor ]]
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				{ id = "rise", duration = 0.4 },
				{ id = "rampart", duration = 0.6 },
				{ id = "tremor", duration = 1.0, interval = 0.4, range = 7.5, damage = 15 },
			},
		},
		--[[ Solar Drift — Solar charge, flare rings, healing orbit ]]
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "flare", duration = 0.7, interval = 0.26, damage = 8 },
				{ id = "loop", duration = 0.78 },
			},
		},
		--[[ Phantom Edge — Phase, dash, ghost slash ]]
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.42, rushSpeed = 88 },
