	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.55, hitInterval = 0.15, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Frost dome / pulse / shatter ]]
		AuroraBarrierDome = {
			...
			phases = {
				{ id = "dome", duration = 0.8 },
				{ id = "frost", duration = 0.7, interval = 0.35, range = 7, damage = 10 },
