	...
	SPECIAL_MOVES = {
		...
		CrimsonMaelstrom = {
			...
			phases = {
				...
				{ id = "vortex", duration = 0.75, interval = 0.22, range = 5.5, damage = 10, hits = 3 },
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.35, range = 9, damage = 12 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		PhantomVoidSlash = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.38, rushSpeed = 98 },
