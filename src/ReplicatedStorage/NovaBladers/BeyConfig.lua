local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper double-lunge ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.25, range = 5.5, damage = 14 },
				{ id = "lunge2", duration = 0.35, rushSpeed = 95 },
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.75, interval = 0.35, range = 9, damage = 14 },
			},
		},
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "mirage1", duration = 0.3, rushSpeed = 80 },
				{ id = "mirage2", duration = 0.3, rushSpeed = 88 },
				{ id = "blade", duration = 0.35, range = 6.5, damage = 40 },
			},
		},
	},
