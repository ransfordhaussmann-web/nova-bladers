local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		GraniteBastionPulse = {
			...
			phases = {
				{ id = "root", duration = 0.45 },
				{ id = "pulse", duration = 1.0, interval = 0.32, range = 7.5, damage = 12 },
				{ id = "quake", duration = 0.45, range = 9, damage = 22 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 1.2, interval = 0.25, hitRadius = 6, damage = 8 },
				{ id = "burst", duration = 0.4, range = 7, damage = 26 },
			},
		},
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.9, dashes = 3, dashSpeed = 95, hitRadius = 4.5, damage = 14 },
				{ id = "fade", duration = 0.3, rushSpeed = 105, range = 6, damage = 28 },
			},
		},
	},
