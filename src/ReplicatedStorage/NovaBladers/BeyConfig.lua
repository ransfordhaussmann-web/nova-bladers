local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crystal Bloom — petal rings and crystal orbit ]]
		CrystalPetalSpiral = {
			...
			phases = {
				...
				{ id = "sonic", duration = 0.85, interval = 0.32, damage = 7 },
				{ id = "orbit", duration = 0.65 },
			},
		},
		--[[ Ember Forge — molten meteor rush ]]
		EmberMoltenRush = {
			id = "EmberMoltenRush",
