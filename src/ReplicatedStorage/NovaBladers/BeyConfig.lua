local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / blade rush combo ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.6, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Granite Fort — Bastion barrier / ground quake ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "quake", duration = 0.65, interval = 0.35, range = 7, damage = 12 },
			},
		},
		--[[ Solar Drift — Flare rings / solar orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "burn", duration = 0.7, interval = 0.25, damage = 10 },
				{ id = "orbit", duration = 0.65 },
			},
		},
		--[[ Phantom Edge — Blade mirage / multi-strike ]]
		PhantomBladeMirage = {
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(190, 210, 240),
			phases = {
				{ id = "fade", duration = 0.3 },
				{ id = "mirage", duration = 0.5, clones = 3 },
				{ id = "strike", duration = 0.35, range = 7, damage = 40 },
			},
		},
	},
