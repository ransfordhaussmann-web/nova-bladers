local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid blade rush + slash barrage ]]
		CrimsonFangFlurry = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.28, rushSpeed = 85 },
				{ id = "flurry", duration = 0.75, hitInterval = 0.14, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Frost Halo — ice aura, protective dome, shard burst ]]
		GlacierDome = {
			id = "GlacierDome",
			name = "Glacier Dome",
			mode = "glacier",
