local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — blade storm variant ]]
		CrimsonBladeStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.16, hitRadius = 5.8, damage = 12, hits = 4 },
			},
		},
		--[[ Granite Fort — stone fortress variant ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		--[[ Solar Drift — solar orbit variant ]]
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "sonic", duration = 0.8, interval = 0.26, damage = 10 },
				{ id = "orbit", duration = 0.7 },
			},
		},
		--[[ Phantom Edge — spectral dive variant ]]
		PhantomStrike = {
			id = "PhantomStrike",
			name = "Phantom Strike",
			mode = "eclipse",
			...
			phases = {
				...
				{ id = "dive", duration = 0.38, rushSpeed = 88, diveSpeed = 45 },
				{ id = "burst", duration = 0.32, range = 6.2, damage = 36 },
			},
		},
		--[[ Crystal Edge — prism sonic variant ]]
		CrystalPrismWave = {
			id = "CrystalPrismWave",
			name = "Crystal Prism Wave",
			mode = "sonic",
			duration = 1.7,
			damage = 28,
			spinLoss = 9,
		...
		--[[ Blaze Crown — flame meteor variant ]]
		BlazeCrownRush = {
			id = "BlazeCrownRush",
			name = "Blaze Crown Rush",
			mode = "meteor",
			duration = 1.3,
			rushSpeed = 80,
			damage = 36,
			...
			phases = {
				{ id = "windup", duration = 0.26 },
				{ id = "launch", duration = 0.24, rushSpeed = 80 },
				{ id = "shower", duration = 0.8, hitInterval = 0.17, hitRadius = 5.2, damage = 13, hits = 4 },
			},
		},
	},
