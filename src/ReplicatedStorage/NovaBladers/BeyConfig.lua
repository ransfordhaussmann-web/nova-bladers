local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Torrent — flame meteor rush ]]
		BlazeTorrentDrive = {
			id = "BlazeTorrentDrive",
			name = "Blaze Torrent Drive",
			mode = "meteor",
			duration = 1.4,
			rushSpeed = 82,
			damage = 38,
			...
			phases = {
				...
				{ id = "shower", duration = 0.9, hitInterval = 0.16, hitRadius = 6, damage = 12, hits = 5 },
			},
		},
		--[[ Crystal Aegis — crystal dome fortress ]]
		CrystalAegisDome = {
			id = "CrystalAegisDome",
			name = "Crystal Aegis Dome",
			mode = "fortress",
			duration = 2.0,
			damage = 28,
			spinLoss = 6,
