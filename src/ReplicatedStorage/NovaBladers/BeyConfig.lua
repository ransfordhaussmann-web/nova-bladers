local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Orbit — Solar flare rush + inferno burn ]]
		CrimsonSolarFlare = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.35, rushSpeed = 82 },
				{ id = "inferno", duration = 0.75, hitInterval = 0.2, hitRadius = 6, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Anchor — Ice barrier + shatter pulse ]]
		FrostGlacierLock = {
			id = "FrostGlacierLock",
