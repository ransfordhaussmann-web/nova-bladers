local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — heavy leap + ground shockwave ]]
		ForgeHammerSlam = {
			id = "ForgeHammerSlam",
			...
			phases = {
				...
				{ id = "leap", duration = 0.35, leapForce = 48 },
				{ id = "slam", duration = 0.35, rushSpeed = 85, diveSpeed = 55 },
				{ id = "shock", duration = 0.45, range = 9, damage = 18 },
			},
		},
		...
		PrismCrystalShield = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.8, range = 7.5, damage = 15, interval = 0.25 },
			},
		},
	},
