local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Edge — Blazing blade rush with flame impacts ]]
		CrimsonBlazingBlade = {
			id = "CrimsonBlazingBlade",
			name = "Crimson Blazing Blade",
			mode = "meteor",
			duration = 1.2,
			rushSpeed = 85,
			damage = 38,
		...
		--[[ Frost Guard — Ice barrier / frost pulse defense ]]
		FrostBarrierShard = {
			id = "FrostBarrierShard",
			name = "Frost Barrier Shard",
			mode = "fortress",
			duration = 2.0,
			damage = 28,
			spinLoss = 6,
