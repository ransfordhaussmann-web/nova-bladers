	...
	SPECIAL_MOVES = {
		...
		FangSpiralRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 1.0, interval = 0.22, hitRadius = 4.5, damage = 10, orbitSpeed = 20 },
				{ id = "rend", duration = 0.35, range = 7, damage = 36 },
			},
		},
		--[[ Frost Coil — glacial lock + ice shatter ]]
		GlacierCoilLock = {
			id = "GlacierCoilLock",
			...
			phases = {
				...
				{ id = "coil", duration = 1.2, interval = 0.35, range = 7, damage = 8 },
