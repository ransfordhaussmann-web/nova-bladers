local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — fire spiral orbit + eruption ]]
		CrimsonInfernoLoop = {
			id = "CrimsonInfernoLoop",
			name = "Crimson Inferno Loop",
			mode = "inferno",
			duration = 1.6,
			damage = 38,
			spinLoss = 14,
			...
			phases = {
				...
				{ id = "eruption", duration = 0.45, range = 7.5, damage = 32 },
			},
		},
		--[[ Frost Crown — frost guard + ice crown + crystal shatter ]]
		GlacialCrownShield = {
			id = "GlacialCrownShield",
			name = "Glacial Crown Shield",
			mode = "glacial",
			duration = 1.9,
			damage = 28,
			spinLoss = 6,
