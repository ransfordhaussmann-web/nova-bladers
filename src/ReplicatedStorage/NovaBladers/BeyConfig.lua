local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		SolarFlareDrift = {
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "orbit", duration = 0.75, orbitRadius = 7, orbitSpeed = 14 },
				{ id = "flare", duration = 0.7, range = 7.5, damage = 32 },
			},
		},
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "aftershock", duration = 0.35, range = 6, damage = 24, interval = 0.12 },
			},
		},
	},
