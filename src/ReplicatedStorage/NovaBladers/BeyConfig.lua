local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Creator Store Attack Bey ]]
		CrimsonStarfallRush = {
		...
		--[[ Granite Fort — Creator Store Defense Bey ]]
		GraniteBastionLock = {
		...
		--[[ Solar Drift — Creator Store Stamina Bey ]]
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
		...
		--[[ Phantom Edge — Creator Store Balance Bey ]]
		PhantomVoidRend = {
			id = "PhantomVoidRend",
			name = "Phantom Void Rend",
			mode = "eclipse",
			duration = 1.2,
			rushSpeed = 88,
			damage = 40,
