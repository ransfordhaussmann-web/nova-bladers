	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "tide", duration = 0.95, interval = 0.3, range = 9, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "rend", duration = 0.55, hitInterval = 0.14, hitRadius = 4.5, damage = 13, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "spikes", duration = 0.9, interval = 0.34, range = 7.5, damage = 14 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			damage = 38,
			spinLoss = 15,
			color = Color3.fromRGB(140, 120, 220),
			phases = {
				{ id = "phase", duration = 0.3 },
				{ id = "blink", duration = 0.25, rushSpeed = 100 },
