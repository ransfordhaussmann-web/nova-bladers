local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — spinning fire tornado ]]
		EmberCyclone = {
			id = "EmberCyclone",
			name = "Ember Cyclone",
			mode = "cyclone",
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.95, interval = 0.22, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "erupt", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Frost Veil — ice barrier + frost pulses + shatter ]]
		GlacierShroud = {
			id = "GlacierShroud",
			name = "Glacier Shroud",
			mode = "glacier",
