local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Orbit — Solar flare rush + burn zone ]]
		CrimsonSolarFlare = {
			...
			phases = {
				...
				{ id = "burn", duration = 0.85, hitInterval = 0.2, hitRadius = 6, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Anchor — Ice shell + anchor + frost pulses ]]
		FrostGlacierLock = {
			id = "FrostGlacierLock",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.9, interval = 0.3, range = 7.5, damage = 11 },
			},
		},
	},
