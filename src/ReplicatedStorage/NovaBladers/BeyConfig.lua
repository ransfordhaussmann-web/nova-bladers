	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.16, hitRadius = 5.2, damage = 10, hits = 5 },
			},
		},
		--[[ Tide Anchor — Anchor Crash + tidal wave ]]
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "slam", duration = 0.4, slamDamage = 26 },
				{ id = "wave", duration = 0.9, interval = 0.3, range = 9, damage = 12 },
			},
		},
		--[[ Crimson Fang — Rend slash ]]
		CrimsonRend = {
			id = "CrimsonRend",
			name = "Crimson Rend",
			mode = "rend",
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, rushSpeed = 90 },
				{ id = "bleed", duration = 0.38, range = 7, damage = 34 },
			},
		},
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.35, range = 8.5, damage = 14 },
			},
		},
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.5, range = 8, damage = 38 },
			},
		},
	},
