local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / multi-slash combo ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		...
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "release", duration = 0.75, interval = 0.25, range = 9, damage = 14 },
			},
		},
	},
