	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.4, range = 7, damage = 28 },
			},
		},
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.5, range = 9, damage = 18 },
			},
		},
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.55, range = 8, damage = 22 },
			},
		},
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "blink", duration = 0.35 },
				{ id = "slash", duration = 0.35, rushSpeed = 88, range = 6.5, damage = 36 },
			},
		},
	},
