	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.7, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Granite Fort — Stone Bastion / Shockwave ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		--[[ Phantom Edge — Mirage / Blade Slash ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "strike", duration = 0.45, rushSpeed = 85, strikes = 2 },
