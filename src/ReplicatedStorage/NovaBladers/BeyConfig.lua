local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Granite Fort — burrow + pulse wall ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		CrystalShatter = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 6 },
			},
		},
		--[[ Blaze Crown — fire eclipse ]]
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
