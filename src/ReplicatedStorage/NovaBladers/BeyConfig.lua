local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — fire wheel rush with burn trail ]]
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "wheelburn", duration = 0.75, hitInterval = 0.2, hitRadius = 5.8, damage = 12, hits = 3 },
			},
		},
		--[[ Frost Veil — ice crystal shield and shatter burst ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
