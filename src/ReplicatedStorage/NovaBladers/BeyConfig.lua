	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.7, hitInterval = 0.16, hitRadius = 5, damage = 13, hits = 4 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / aurora flare ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.55, interval = 0.32, range = 9, damage = 12 },
			},
		},
	},
