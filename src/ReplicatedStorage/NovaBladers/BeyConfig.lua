	...
	SPECIAL_MOVES = {
		...
		BlazeFlareStrike = {
			...
			phases = {
				...
				{ id = "lance", duration = 0.45, rushSpeed = 82 },
				{ id = "burst", duration = 0.5, range = 7, damage = 32 },
			},
		},
		--[[ Coral Tide — tide pool, surge waves, undertow pull ]]
		CoralTidalSurge = {
			id = "CoralTidalSurge",
			...
			phases = {
				{ id = "pool", duration = 0.4 },
				{ id = "surge", duration = 0.7, interval = 0.35, range = 9, damage = 12 },
				{ id = "undertow", duration = 0.5, range = 6, damage = 18, pullStrength = 40 },
			},
		},
	},
