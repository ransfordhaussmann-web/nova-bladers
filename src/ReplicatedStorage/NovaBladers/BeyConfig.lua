local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crystal Vortex — shard vortex and crystal hail ]]
		CrystalShatterStorm = {
			...
			phases = {
				...
				{ id = "vortex", duration = 0.55, interval = 0.22, damage = 8 },
				{ id = "shatter", duration = 0.8, hitInterval = 0.2, hitRadius = 5.5, damage = 12, hits = 4 },
			},
		},
		--[[ Ember Ring — phoenix spiral and blaze crash ]]
		EmberPhoenixSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.7, rushSpeed = 86 },
				{ id = "blaze", duration = 0.45, range = 7, damage = 36 },
			},
		},
	},
