local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — dual cross slash rush ]]
		CrimsonCrossSlash = {
			...
			phases = {
				...
				{ id = "slash1", duration = 0.3, rushSpeed = 88, damage = 14 },
				{ id = "slash2", duration = 0.3, rushSpeed = 88, damage = 14 },
				{ id = "cross", duration = 0.4, range = 7, damage = 22 },
			},
		},
		--[[ Frost Core — ice bastion and crystal shatter ]]
		FrostCrystalBastion = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.9, interval = 0.3, range = 9, damage = 12 },
			},
		},
	},
