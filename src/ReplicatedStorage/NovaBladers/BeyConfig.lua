local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / Fang Slash Combo ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.65, hitInterval = 0.14, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / Shield Pulse / Nova Burst ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "nova", duration = 0.6, range = 9, damage = 32 },
			},
		},
	},
