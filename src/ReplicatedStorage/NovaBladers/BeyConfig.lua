local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				{ id = "flare", duration = 0.25 },
				{ id = "lunge", duration = 0.35, rushSpeed = 88 },
				{ id = "ripper", duration = 0.5, hitInterval = 0.15, hitRadius = 4.5, damage = 14, slashes = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / ice shield ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "refract", duration = 0.85, interval = 0.35, range = 7, damage = 12 },
			},
		},
	},
