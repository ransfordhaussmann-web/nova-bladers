local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / blood slash combo ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.75, hitInterval = 0.12, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / aurora shimmer pulses ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "shimmer", duration = 0.9, interval = 0.3, range = 7, damage = 10 },
