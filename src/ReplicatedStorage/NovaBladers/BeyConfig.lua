local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			damage = 38,
			spinLoss = 14,
			color = Color3.fromRGB(230, 50, 70),
			phases = {
				{ id = "windup", duration = 0.25 },
				{ id = "cyclone", duration = 0.65, interval = 0.16, range = 5, damage = 10, maxRange = 9 },
				{ id = "rush", duration = 0.6, rushSpeed = 82, damage = 34, range = 4.5 },
			},
		},
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "ram", duration = 0.55, rushSpeed = 58, damage = 36, range = 5 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "drift", duration = 0.9, interval = 0.22, damage = 8 },
				{ id = "flare", duration = 0.55, range = 8, damage = 32 },
			},
		},
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(120, 210, 235),
			phases = {
				{ id = "vanish", duration = 0.2, blinkDistance = 10 },
				{ id = "surge", duration = 0.45, interval = 0.12, damage = 11, hits = 3 },
				{ id = "edge", duration = 0.35, range = 7, damage = 36, arcAngle = 120 },
			},
		},
	},
