	...
	SPECIAL_MOVES = {
		...
		CrimsonFuryRend = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		GraniteBulwark = {
			id = "GraniteBulwark",
		...
		CrystalShardRain = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.25, rushSpeed = 75 },
				{ id = "shower", duration = 0.8, hitInterval = 0.14, hitRadius = 6, damage = 10, hits = 6 },
			},
		},
		BlazeInfernoCrown = {
