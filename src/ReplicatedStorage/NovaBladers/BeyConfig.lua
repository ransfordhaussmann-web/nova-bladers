	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.9, hitInterval = 0.2, hitRadius = 6, damage = 10, hits = 4 },
				{ id = "land", duration = 0.2 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "cast", duration = 0.4 },
				{ id = "pull", duration = 0.5, pullForce = 28 },
				{ id = "crash", duration = 0.35, range = 9, damage = 40 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "slash1", duration = 0.25, rushSpeed = 88, damage = 14 },
				{ id = "slash2", duration = 0.25, rushSpeed = 88, damage = 14 },
				{ id = "slash3", duration = 0.3, rushSpeed = 95, damage = 18, range = 5 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				{ id = "raise", duration = 0.45 },
				{ id = "wall", duration = 0.6 },
				{ id = "quake", duration = 0.85, interval = 0.3, range = 9, damage = 12 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.3, range = 7, damage = 42 },
			},
		},
	},
