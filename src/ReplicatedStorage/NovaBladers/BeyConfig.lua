local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spiral rush + ember burst ]]
		EmberCyclone = {
			id = "EmberCyclone",
			name = "Ember Cyclone",
			mode = "cyclone",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, orbitRadius = 8, orbitSpeed = 22, shrink = 5, interval = 0.15, damage = 8 },
				{ id = "burst", duration = 0.45, range = 7, damage = 42 },
			},
		},
		--[[ Frost Crown — burrow, ice wall, frost pulses ]]
		GlacierVault = {
			id = "GlacierVault",
			name = "Glacier Vault",
			mode = "fortress",
