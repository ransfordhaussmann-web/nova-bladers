local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Orbit — fiery tightening spiral rush ]]
		BlazeSpiralDrive = {
			id = "BlazeSpiralDrive",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, hitInterval = 0.22, hitRadius = 4.5, damage = 10, spiralSpeed = 14 },
				{ id = "eruption", duration = 0.3, range = 7, damage = 34 },
			},
		},
		...
		CrystalBloomLock = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.7, interval = 0.35, range = 9, damage = 12 },
			},
		},
	},
