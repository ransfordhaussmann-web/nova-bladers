	...
	SPECIAL_MOVES = {
		...
		CrimsonCrossSlash = {
			...
			phases = {
				...
				{ id = "slash1", duration = 0.3, rushSpeed = 82, damage = 14, hitRadius = 5 },
				{ id = "slash2", duration = 0.3, rushSpeed = 82, damage = 14, hitRadius = 5 },
				{ id = "cross", duration = 0.4, range = 7, damage = 22 },
			},
		},
		--[[ Frost Core — crystal shield + ice spikes ]]
		FrostCrystalBastion = {
			...
			phases = {
				{ id = "crystal", duration = 0.5 },
				{ id = "spikes", duration = 0.85, interval = 0.3, range = 7, damage = 11 },
				{ id = "shatter", duration = 0.55, range = 8, damage = 18 },
			},
		},
	},
