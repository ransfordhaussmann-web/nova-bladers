local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Orbit — fiery comet loop + slam ]]
		BlazeCometLoop = {
			id = "BlazeCometLoop",
			...
			phases = {
				...
				{ id = "loop", duration = 0.95, interval = 0.22, damage = 10 },
				{ id = "slam", duration = 0.4, rushSpeed = 88, range = 7, damage = 36 },
			},
		},
		--[[ Frost Crown — ice barrier + shard burst ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
