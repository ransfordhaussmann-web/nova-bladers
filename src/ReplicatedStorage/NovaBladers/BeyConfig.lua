local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Ripper — flame rush + ember trail ]]
		CrimsonReaperFlare = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.35, rushSpeed = 85 },
				{ id = "ember", duration = 0.6, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 3 },
			},
		},
		--[[ Frost Halo — ice shield + frost pulses ]]
		GlacierHaloFrost = {
			id = "GlacierHaloFrost",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.7, interval = 0.35, range = 7, damage = 12 },
			},
		},
	},
