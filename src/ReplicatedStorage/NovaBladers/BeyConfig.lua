local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — spiral fang rush with multi-hit barrage ]]
		CrimsonFangSpiral = {
			id = "CrimsonFangSpiral",
			...
			phases = {
				...
				{ id = "shower", duration = 0.7, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Coil — ice burrow, frost shield, cold pulse ]]
		FrostCoilLock = {
			id = "FrostCoilLock",
