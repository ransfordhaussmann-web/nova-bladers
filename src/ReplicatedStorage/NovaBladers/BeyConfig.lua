	...
	SPECIAL_MOVES = {
		...
		CrimsonFangBreak = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.65, hitInterval = 0.16, hitRadius = 5.2, damage = 12, hits = 3 },
			},
		},
		GraniteBulwark = {
			id = "GraniteBulwark",
		...
		SolarWindLoop = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.95, interval = 0.22, damage = 8 },
		...
		CrystalShatterSurge = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "rush", duration = 0.25, rushSpeed = 74 },
				{ id = "shatter", duration = 0.9, hitInterval = 0.14, hitRadius = 6, damage = 10, hits = 5 },
			},
		},
		BlazeCrownSpiral = {
			id = "BlazeCrownSpiral",
			...
			phases = {
				...
				{ id = "flare", duration = 0.42, range = 6.5, damage = 36 },
			},
		},
	},
