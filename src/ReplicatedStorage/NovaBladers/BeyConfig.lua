local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spiral orbit + fang rush ]]
		CrimsonSpiralFang = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "spiral", duration = 0.85, orbitRadius = 8, orbitSpeed = 20, shrinkRate = 3.5, interval = 0.22, damage = 10 },
				{ id = "fang", duration = 0.45, rushSpeed = 88, range = 7, damage = 36 },
			},
		},
