local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ember rush + burning star shower ]]
		EmberStarfall = {
			id = "EmberStarfall",
			name = "Ember Starfall",
			mode = "ember",
			...
			phases = {
				...
				{ id = "rush", duration = 0.22, rushSpeed = 82 },
				{ id = "starfall", duration = 0.75, hitInterval = 0.14, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Crown — Glacier shield + frost pulses ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
