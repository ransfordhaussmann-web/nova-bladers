	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperFang = {
			...
			phases = {
				...
				{ id = "slash1", duration = 0.25, rushSpeed = 70, hitRadius = 4.5, damage = 12, turnDeg = 90 },
				{ id = "slash2", duration = 0.25, rushSpeed = 74, hitRadius = 4.5, damage = 14, turnDeg = -180 },
				{ id = "lunge", duration = 0.35, rushSpeed = 88, hitRadius = 5.5, damage = 28 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.5, interval = 0.22, range = 9, damage = 16 },
			},
		},
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
			...
			phases = {
				...
				{ id = "corona", duration = 0.9, interval = 0.25, damage = 8 },
		...
		PhantomPhaseCut = {
			...
			phases = {
				...
				{ id = "phase", duration = 0.35, rushSpeed = 110 },
