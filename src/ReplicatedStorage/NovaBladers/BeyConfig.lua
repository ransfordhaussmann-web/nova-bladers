local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / triple saw-blade slash ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.55, hitInterval = 0.15, hitRadius = 5, damage = 14, hits = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / reflection pulses ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "reflect", duration = 0.9, interval = 0.3, range = 7, damage = 11 },
			},
		},
	},
