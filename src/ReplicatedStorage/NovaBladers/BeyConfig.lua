	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
		...
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.17, hitRadius = 5.2, damage = 10, hits = 5 },
			},
		},
		BlazeCrownDive = {
			id = "BlazeCrownDive",
			name = "Blaze Crown Dive",
			mode = "eclipse",
			duration = 1.2,
			rushSpeed = 90,
			damage = 44,
