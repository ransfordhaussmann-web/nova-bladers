local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — fire rush + inferno waves ]]
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "wheel", duration = 0.55, rushSpeed = 88 },
				{ id = "inferno", duration = 0.6, interval = 0.2, range = 7, damage = 12 },
			},
		},
		--[[ Frost Veil — ice shield + crystal burst ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
