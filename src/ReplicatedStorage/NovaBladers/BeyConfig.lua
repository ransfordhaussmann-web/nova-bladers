	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.55, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "bastion", duration = 0.75, interval = 0.3, range = 7, damage = 10 },
				{ id = "slam", duration = 0.4, range = 9, damage = 32 },
			},
		},
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "drift", duration = 0.6, interval = 0.2, damage = 7 },
			},
		},
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "strike", duration = 0.45, rushSpeed = 86 },
				{ id = "fade", duration = 0.4, range = 7, damage = 28 },
			},
		},
	},
