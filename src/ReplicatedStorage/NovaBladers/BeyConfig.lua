local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — fire spiral / ember orbit / eruption ]]
		EmberCyclone = {
			id = "EmberCyclone",
			name = "Ember Cyclone",
			mode = "cyclone",
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.75, interval = 0.22, orbitSpeed = 14, hitRadius = 5, damage = 10 },
				{ id = "eruption", duration = 0.45, range = 7, damage = 28 },
			},
		},
		--[[ Frost Veil — ice shroud / frost shield / shard burst ]]
		GlacierShroud = {
			id = "GlacierShroud",
			name = "Glacier Shroud",
			mode = "glacier",
