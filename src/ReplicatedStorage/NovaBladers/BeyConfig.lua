local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Ripper — fire rush + explosive flare burst ]]
		CrimsonReaperFlare = {
		...
		--[[ Frost Halo — ice shards + freezing ring ]]
		GlacierHaloFrost = {
			id = "GlacierHaloFrost",
			...
			phases = {
				...
				{ id = "shards", duration = 0.7, interval = 0.22, damage = 8, hits = 3, range = 5 },
				{ id = "freeze", duration = 0.55, range = 7.5, damage = 22 },
			},
		},
	},
