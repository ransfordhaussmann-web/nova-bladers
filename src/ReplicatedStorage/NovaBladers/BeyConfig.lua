local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Claw lunge + triple slash ]]
		CrimsonRipperClaw = {
			...
			phases = {
				...
				{ id = "claw", duration = 0.6, hitInterval = 0.15, hits = 3, hitRadius = 5, damage = 14 },
			},
		},
		--[[ Granite Fort — Stone shell + quake pulses ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				{ id = "harden", duration = 0.4 },
				{ id = "shell", duration = 0.8, damageReduction = 0.65 },
				{ id = "quake", duration = 0.8, interval = 0.35, range = 9, damage = 15 },
			},
		},
		--[[ Solar Drift — Solar charge + flare rings + orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		--[[ Phantom Edge — Phase blink + slash wave ]]
		PhantomSlashWave = {
			id = "PhantomSlashWave",
			name = "Phantom Slash Wave",
			mode = "phantom",
			duration = 1.3,
			rushSpeed = 95,
			damage = 40,
