	...
	SPECIAL_MOVES = {
		...
		BlazeCometLoop = {
			...
			phases = {
				...
				{ id = "orbit", duration = 0.95, interval = 0.22, damage = 9 },
				{ id = "slam", duration = 0.4, rushSpeed = 85, range = 7, damage = 34 },
			},
		},
		...
		FrostCrownLock = {
			...
			phases = {
				...
				{ id = "snap", duration = 0.45, range = 6, damage = 24 },
			},
		},
	},
