	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.83, hitInterval = 0.16, hitRadius = 5.8, damage = 12, hits = 5 },
			},
		},
		--[[ Granite Fort — heavy fortress burrow ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		--[[ Phantom Edge — ghost eclipse dive ]]
		PhantomStrike = {
			id = "PhantomStrike",
			name = "Phantom Strike",
			mode = "eclipse",
			...
			phases = {
				...
				{ id = "burst", duration = 0.35, range = 6, damage = 36 },
			},
		},
		--[[ Crystal Edge — icy meteor shatter ]]
		CrystalShatter = {
			id = "CrystalShatter",
			...
			phases = {
				{ id = "windup", duration = 0.32 },
				{ id = "launch", duration = 0.28, rushSpeed = 76 },
				{ id = "shower", duration = 0.8, hitInterval = 0.2, hitRadius = 5.2, damage = 10, hits = 4 },
			},
		},
		--[[ Blaze Crown — fiery sonic tempest ]]
		CrownInferno = {
			id = "CrownInferno",
			name = "Crown Inferno",
			mode = "sonic",
			...
			phases = {
				...
				{ id = "sonic", duration = 0.7, interval = 0.24, damage = 11 },
