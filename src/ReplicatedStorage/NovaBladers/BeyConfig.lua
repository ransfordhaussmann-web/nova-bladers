local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRiposte = {
			...
			phases = {
				{ id = "stance", duration = 0.35 },
				{ id = "lunge", duration = 0.45, rushSpeed = 88 },
				{ id = "riposte", duration = 0.4, range = 5.5, damage = 40 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomVeilSlash = {
			...
			phases = {
				...
				{ id = "dive", duration = 0.35, rushSpeed = 95, diveSpeed = 44 },
		...
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.9, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
			...
			phases = {
				...
				{ id = "flare", duration = 0.55, rushSpeed = 70, trailInterval = 0.12 },
				{ id = "crown", duration = 0.45, range = 7, damage = 34 },
			},
		},
	},
