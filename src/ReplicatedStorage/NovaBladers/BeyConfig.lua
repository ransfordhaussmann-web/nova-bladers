local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Comet — solar flare rush + impact ]]
		CrimsonSolarFlare = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.55, rushSpeed = 85 },
				{ id = "impact", duration = 0.4, range = 7, damage = 36 },
			},
		},
		--[[ Glacier Helm — frost shield + ice shard pulses ]]
		GlacierBastion = {
			id = "GlacierBastion",
