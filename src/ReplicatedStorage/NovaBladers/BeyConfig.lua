local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid fang slashes ]]
		CrimsonWildSlash = {
			id = "CrimsonWildSlash",
			...
			phases = {
				...
				{ id = "shower", duration = 0.78, hitInterval = 0.14, hitRadius = 5, damage = 9, hits = 5 },
			},
		},
		--[[ Frost Crown — ice fortress dome ]]
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.28, range = 7.5, damage = 11 },
			},
		},
	},
