	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.35, rushSpeed = 76 },
				{ id = "storm", duration = 0.85, hitInterval = 0.2, hitRadius = 6, damage = 10, hits = 5 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "pull", duration = 0.4, pullStrength = 38 },
				{ id = "slam", duration = 0.35, damage = 22 },
				{ id = "wave", duration = 0.7, interval = 0.35, range = 9, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				{ id = "dash", duration = 0.2 },
				{ id = "slash", duration = 0.45, rushSpeed = 88 },
				{ id = "finish", duration = 0.25, range = 5, damage = 38 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "block", duration = 0.6, damageReduction = 0.6 },
				{ id = "shatter", duration = 0.5, range = 7, damage = 15 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "flare", duration = 0.55, interval = 0.25, damage = 8 },
		...
		PhantomPhaseSlash = {
			...
			damage = 36,
			spinLoss = 14,
			color = Color3.fromRGB(130, 100, 220),
			phases = {
				{ id = "fade", duration = 0.22 },
				{ id = "dash", duration = 0.38, rushSpeed = 96 },
				{ id = "slash", duration = 0.3, range = 6, damage = 34 },
			},
		},
	},
