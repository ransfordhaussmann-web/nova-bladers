local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — Inferno rush + burning wheel trail ]]
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "inferno", duration = 0.55, rushSpeed = 85, hitInterval = 0.14, hitRadius = 4.5, damage = 10 },
				{ id = "burst", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Frost Veil — Ice shield + crystal shard burst ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
