	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.9, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "burst", duration = 0.35, range = 7, damage = 22 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "pull", duration = 0.6, pullStrength = 28, range = 10 },
				{ id = "crash", duration = 0.35, range = 9, damage = 28 },
				{ id = "wave", duration = 0.75, interval = 0.3, range = 8, damage = 11 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				{ id = "dash", duration = 0.3, rushSpeed = 88 },
				{ id = "rend", duration = 0.55, hitInterval = 0.15, hitRadius = 4, damage = 12, hits = 3 },
				{ id = "finisher", duration = 0.35, range = 5.5, damage = 30 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				{ id = "rampart", duration = 0.7 },
				{ id = "quake", duration = 1.2, interval = 0.35, range = 8.5, damage = 12 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, rushSpeed = 95, hitInterval = 0.12, hitRadius = 4.5, damage = 14, hits = 3 },
				{ id = "emerge", duration = 0.35, range = 6, damage = 26 },
			},
		},
	},
