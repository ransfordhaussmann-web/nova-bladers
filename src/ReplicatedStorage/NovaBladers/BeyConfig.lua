	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "rise", duration = 0.35, riseSpeed = 42 },
				{ id = "crash", duration = 0.35, slamSpeed = 65 },
				{ id = "wave", duration = 0.45, range = 9, damage = 16 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "charge", duration = 0.45, rushSpeed = 88 },
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.35, range = 6, damage = 44 },
			},
		},
	},
