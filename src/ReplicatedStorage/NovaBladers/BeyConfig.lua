	...
	SPECIAL_MOVES = {
		...
		CrimsonFangBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.78, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		SolarFlareLoop = {
			...
			phases = {
				...
				{ id = "sonic", duration = 0.85, interval = 0.25, damage = 8 },
		...
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.9, hitInterval = 0.16, hitRadius = 5.8, damage = 10, hits = 5 },
			},
		},
		BlazeCrownNova = {
			id = "BlazeCrownNova",
			...
			phases = {
				...
				{ id = "dive", duration = 0.42, rushSpeed = 90, diveSpeed = 50 },
