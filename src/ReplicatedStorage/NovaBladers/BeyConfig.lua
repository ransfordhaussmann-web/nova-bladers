	...
	SPECIAL_MOVES = {
		...
		CrimsonRiposte = {
			...
			phases = {
				...
				{ id = "counter", duration = 0.45, rushSpeed = 95, damage = 44 },
				{ id = "followup", duration = 0.4, range = 5.5, damage = 18 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomVeilSlash = {
			...
			phases = {
				...
				{ id = "aftermath", duration = 0.4, range = 6, damage = 32 },
			},
		},
		CrystalShardStorm = {
		...
		BlazeCrownBurst = {
			...
			phases = {
				{ id = "charge", duration = 0.3 },
				{ id = "rings", duration = 0.95, interval = 0.22, damage = 10 },
				{ id = "crown", duration = 0.4, range = 7, damage = 28 },
			},
		},
	},
