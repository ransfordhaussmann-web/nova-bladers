	...
	SPECIAL_MOVES = {
		...
		CrimsonRiposte = {
			...
			phases = {
				...
				{ id = "strike", duration = 0.35, range = 5.5, damage = 42 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomVeilSlash = {
			...
			phases = {
				...
				{ id = "dive", duration = 0.45, rushSpeed = 88, diveSpeed = 45 },
		...
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.85, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
			...
			phases = {
				...
				{ id = "flares", duration = 0.75, interval = 0.28, range = 5.5, damage = 10 },
				{ id = "crown", duration = 0.4, range = 8, damage = 40 },
			},
		},
	},
