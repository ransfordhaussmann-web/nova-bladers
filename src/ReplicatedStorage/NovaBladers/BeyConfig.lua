	...
	SPECIAL_MOVES = {
		...
		BlazeSpiralDrive = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.7, hitInterval = 0.14, hitRadius = 4.5, damage = 10, spiralRadius = 5 },
				{ id = "flare", duration = 0.3, range = 7, damage = 32 },
			},
		},
		--[[ Frost Core — ice shield and shatter pulse ]]
		GlacierAegis = {
			id = "GlacierAegis",
			name = "Glacier Aegis",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.85, interval = 0.38, range = 7.5, damage = 12 },
			},
		},
	},
