	...
	SPECIAL_MOVES = {
		...
		BlazeCycloneWheel = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, interval = 0.22, range = 5, damage = 12 },
				{ id = "flare", duration = 0.35, range = 7.5, damage = 28 },
			},
		},
		--[[ Frost Veil — crystal shield and shatter burst ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.6, range = 7.5, damage = 24 },
			},
		},
	},
