local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Crown — ice shield + blizzard pulses ]]
		GlacierBastion = {
			id = "GlacierBastion",
			...
			phases = {
				{ id = "frostup", duration = 0.35 },
				{ id = "shield", duration = 0.6 },
				{ id = "blizzard", duration = 0.95, interval = 0.3, range = 7.5, damage = 12 },
			},
		},
		--[[ Ember Fang — fire rush + claw burst ]]
		InfernoClaw = {
			id = "InfernoClaw",
			name = "Inferno Claw",
			mode = "inferno",
			...
			phases = {
				...
				{ id = "rush", duration = 0.55, rushSpeed = 88, hitInterval = 0.14, damage = 10 },
