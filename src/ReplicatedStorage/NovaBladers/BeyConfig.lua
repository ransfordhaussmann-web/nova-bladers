	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.4, rushSpeed = 98 },
				{ id = "ripper", duration = 0.7, hitInterval = 0.2, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / reflection wave ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "release", duration = 0.5, range = 9, damage = 15 },
			},
		},
	},
