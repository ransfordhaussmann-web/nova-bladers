	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.55, interval = 0.14, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "slash", duration = 0.7, rushSpeed = 88, hitInterval = 0.22, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		GraniteBastionPulse = {
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.75, range = 7, damage = 34 },
			},
		},
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
