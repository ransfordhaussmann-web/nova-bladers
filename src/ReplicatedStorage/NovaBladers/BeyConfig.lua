	...
	SPECIAL_MOVES = {
		...
		CrimsonSolarFlare = {
			...
			phases = {
				...
				{ id = "burn", duration = 0.75, hitInterval = 0.2, hitRadius = 6, damage = 10, hits = 3 },
			},
		},
		--[[ Frost Anchor — Freeze aura, glacier wall, ice shatter ]]
		FrostGlacierLock = {
			id = "FrostGlacierLock",
			...
			phases = {
				{ id = "freeze", duration = 0.4, slowRange = 7, slowMult = 0.45 },
