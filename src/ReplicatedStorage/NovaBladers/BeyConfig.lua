local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Granite Fort — Stone Bastion / Spike Ring / Quake ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "quake", duration = 0.85, interval = 0.38, range = 9, damage = 15 },
			},
		},
		--[[ Solar Drift — Solar Flare / Burn Orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		--[[ Phantom Edge — Mirage Blink / Blade Slash ]]
		PhantomBladeMirage = {
