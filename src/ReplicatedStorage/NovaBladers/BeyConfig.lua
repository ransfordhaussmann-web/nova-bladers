	...
	SPECIAL_MOVES = {
		...
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "wheel", duration = 0.5, rushSpeed = 85 },
				{ id = "inferno", duration = 0.6, hitInterval = 0.15, hitRadius = 6, damage = 10, hits = 4 },
			},
		},
		--[[ Frost Veil — Crystal shield and shatter wave ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.6, range = 9, damage = 18 },
			},
		},
	},
