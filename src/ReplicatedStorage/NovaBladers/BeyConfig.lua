	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, interval = 0.22, hitRadius = 5.5, damage = 10 },
				{ id = "slash", duration = 0.35, rushSpeed = 85, range = 4.5, damage = 28 },
			},
		},
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "bastion", duration = 0.7, interval = 0.3, range = 7, damage = 12 },
				{ id = "counter", duration = 0.8, range = 9, damage = 22 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				{ id = "flare", duration = 0.35, spinGain = 25 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.55, dashes = 3, rushSpeed = 95, damage = 14 },
				{ id = "return", duration = 0.45, range = 5, damage = 34 },
			},
		},
	},
