local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid fang rush / multi-strike flurry ]]
		CrimsonFangFlurry = {
			...
			phases = {
				...
				{ id = "flurry", duration = 0.9, hitInterval = 0.15, hitRadius = 4.8, damage = 9, hits = 6 },
			},
		},
		--[[ Frost Halo — ice dome shield / frost shatter burst ]]
		GlacierDome = {
			id = "GlacierDome",
			name = "Glacier Dome",
			mode = "glacier",
