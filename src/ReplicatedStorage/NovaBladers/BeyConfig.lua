	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.7, interval = 0.22, range = 5, damage = 10, hits = 3 },
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "drift", duration = 1.0, interval = 0.25, trailDamage = 8, trailRadius = 4 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "afterimage", duration = 0.35, range = 5.5, damage = 36 },
			},
		},
	},
