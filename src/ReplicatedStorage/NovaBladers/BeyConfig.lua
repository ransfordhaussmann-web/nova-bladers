local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Blood Rush / Cleave Spin ]]
		CrimsonBloodRush = {
			id = "CrimsonBloodRush",
			name = "Crimson Blood Rush",
			mode = "fang",
			duration = 1.2,
			rushSpeed = 88,
			damage = 38,
			...
			phases = {
				...
				{ id = "cleave", duration = 0.65, hitInterval = 0.2, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Granite Fort — Stone Bastion / Quake Slam ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "quake", duration = 0.9, interval = 0.35, range = 7, damage = 11 },
		...
		--[[ Phantom Edge — Mirage Vanish / Echo Cut ]]
		PhantomMirageCut = {
			id = "PhantomMirageCut",
			...
			phases = {
				...
				{ id = "strike", duration = 0.35, rushSpeed = 95 },
				{ id = "echo", duration = 0.35, range = 5.5, damage = 30 },
			},
		},
	},
