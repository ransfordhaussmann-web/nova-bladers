	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.4, hitInterval = 0.12, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / reflect pulses ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "reflect", duration = 0.75, interval = 0.35, range = 7, damage = 14 },
			},
		},
	},
