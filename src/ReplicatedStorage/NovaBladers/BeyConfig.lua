local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — spinning blade cyclone + lunge ]]
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, interval = 0.15, hitRadius = 5, damage = 10, damageReduction = 0.3 },
				{ id = "lunge", duration = 0.35, rushSpeed = 85, range = 4, damage = 28 },
			},
		},
		--[[ Granite Fort — anchored fortress + stone pulses ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.2, interval = 0.4, range = 9, damage = 12 },
				{ id = "slam", duration = 0.4, range = 10, damage = 22 },
			},
		},
		--[[ Solar Drift — sun flare drift trail + nova ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			damage = 33,
			spinLoss = 10,
			color = Color3.fromRGB(255, 165, 45),
			phases = {
				{ id = "charge", duration = 0.3 },
				{ id = "drift", duration = 1.0, trailInterval = 0.12, trailRadius = 4, damage = 7, driftSpeed = 55 },
				{ id = "nova", duration = 0.5, range = 8, damage = 30 },
			},
		},
		--[[ Phantom Edge — phase dash + reappear burst ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.5, rushSpeed = 110 },
				{ id = "reappear", duration = 0.5, range = 7, damage = 25 },
			},
		},
	},
