local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / slash trail ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.7, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		...
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "sustain", duration = 0.9, interval = 0.38, range = 7, damage = 10 },
				{ id = "flare", duration = 0.4, range = 8, damage = 22 },
			},
		},
	},
