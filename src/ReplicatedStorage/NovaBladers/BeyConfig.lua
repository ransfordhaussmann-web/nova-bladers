local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Glacier Spin — ice spiral pull + shatter ]]
		GlacierSpiral = {
			id = "GlacierSpiral",
			name = "Glacier Spiral",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.9, interval = 0.3, pullRange = 10, pullStrength = 18, damage = 8 },
				{ id = "shatter", duration = 0.6, range = 9, damage = 28 },
			},
		},
	},
