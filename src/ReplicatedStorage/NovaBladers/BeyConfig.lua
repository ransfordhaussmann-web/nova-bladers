	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "fangs", duration = 0.8, hitInterval = 0.14, hitRadius = 5, damage = 9, hits = 5 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "bastion", duration = 0.95 },
				{ id = "quake", duration = 0.75, interval = 0.38, range = 9, damage = 14 },
			},
		},
		SolarCoronaBurst = {
			id = "SolarCoronaBurst",
			name = "Solar Corona Burst",
			mode = "solar",
			duration = 1.85,
			rushSpeed = 76,
			damage = 34,
			...
			phases = {
				...
				{ id = "corona", duration = 0.95, interval = 0.26, damage = 10 },
				{ id = "flare", duration = 0.55, rushSpeed = 76 },
			},
		},
		PhantomPhaseCut = {
			id = "PhantomPhaseCut",
			...
			phases = {
				...
				{ id = "strike", duration = 0.35, rushSpeed = 98 },
				{ id = "aftershock", duration = 0.4, range = 7, damage = 32 },
			},
		},
	},
