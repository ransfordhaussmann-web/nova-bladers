local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — Spiral rush with finisher burst ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, spiralRadius = 5, spiralSpeed = 14, hitInterval = 0.22, damage = 10 },
				{ id = "burst", duration = 0.4, range = 7, damage = 32 },
			},
		},
		--[[ Glacier Mantle — Frost aura, ice mantle, shatter wave ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
