local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spinning vortex slash rings + rush ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "vortex", duration = 0.9, interval = 0.22, damage = 10, maxRange = 7 },
				{ id = "rush", duration = 0.5, rushSpeed = 85 },
			},
		},
		--[[ Glacier Mantle — frost aura, ice shield, shatter burst ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
