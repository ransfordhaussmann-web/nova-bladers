local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRiposte = {
			...
			phases = {
				{ id = "brace", duration = 0.25 },
				{ id = "riposte", duration = 0.35, rushSpeed = 88 },
				{ id = "fangs", duration = 0.55, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomVeilSlash = {
			...
			damage = 38,
			spinLoss = 16,
			color = Color3.fromRGB(120, 130, 200),
			phases = {
				{ id = "aura", duration = 0.3 },
				{ id = "dive", duration = 0.42, rushSpeed = 95, diveSpeed = 44 },
				{ id = "burst", duration = 0.38, range = 7, damage = 36 },
			},
		},
		CrystalShardStorm = {
			...
			damage = 33,
			spinLoss = 12,
			color = Color3.fromRGB(120, 220, 245),
			phases = {
				{ id = "windup", duration = 0.28 },
				{ id = "launch", duration = 0.28, rushSpeed = 74 },
				{ id = "shower", duration = 0.84, hitInterval = 0.17, hitRadius = 5.2, damage = 10, hits = 5 },
			},
		},
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
			...
			phases = {
				...
				{ id = "blaze", duration = 0.55, rushSpeed = 80, hitInterval = 0.2, hitRadius = 4.5, damage = 10 },
			},
		},
	},
