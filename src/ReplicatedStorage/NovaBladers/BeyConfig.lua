	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.6, hitInterval = 0.2, hitRadius = 4.5, damage = 14, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.8, interval = 0.38, range = 7.5, damage = 15 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		CrystalShatterSurge = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.75, interval = 0.22, hitRadius = 5, damage = 10, waves = 4 },
				{ id = "burst", duration = 0.4, range = 7, damage = 28 },
			},
		},
		BlazeCrownSpiral = {
			id = "BlazeCrownSpiral",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, rushSpeed = 80, interval = 0.15 },
				{ id = "crown", duration = 0.4, range = 6, damage = 36 },
			},
		},
	},
