	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.55, hitInterval = 0.15, hitRadius = 5, damage = 14, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "fortress", duration = 0.7, damageReduction = 0.7 },
				{ id = "counter", duration = 0.75, interval = 0.38, range = 7, damage = 16 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "orbit", duration = 1.0, orbitRadius = 7, orbitSpeed = 18 },
				{ id = "burst", duration = 0.45, range = 8, damage = 40 },
			},
		},
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.5, range = 7, damage = 36 },
			},
		},
	},
