	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge1", duration = 0.35, rushSpeed = 88 },
				{ id = "slash", duration = 0.4, range = 5.5, damage = 14 },
				{ id = "lunge2", duration = 0.35, rushSpeed = 95 },
				{ id = "finisher", duration = 0.3, range = 7, damage = 32 },
			},
		},
		--[[ Aurora Crest — protective dome + shockwave release ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "dome", duration = 0.8, interval = 0.35, range = 7, damage = 10 },
				{ id = "burst", duration = 0.5, range = 9, damage = 26 },
			},
		},
	},
