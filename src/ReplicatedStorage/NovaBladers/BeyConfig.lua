local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Ember Lance — Flame charge / piercing lance rush ]]
		EmberFlameLance = {
			id = "EmberFlameLance",
			...
			phases = {
				...
				{ id = "flare", duration = 0.6, hitInterval = 0.2, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Arctic Bulwark — Frost freeze / ice barrier / shatter pulse ]]
		ArcticFrostBarrier = {
