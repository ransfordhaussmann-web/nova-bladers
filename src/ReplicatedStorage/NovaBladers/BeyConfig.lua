local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — flaming wheel rush + inferno burst ]]
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "wheel", duration = 0.85, interval = 0.22, damage = 10 },
				{ id = "inferno", duration = 0.4, range = 7, damage = 36 },
			},
		},
		--[[ Frost Veil — crystal shield + frost pulses + shatter ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
			...
			phases = {
				...
				{ id = "frost", duration = 0.75, interval = 0.3, range = 7.5, damage = 11 },
				{ id = "shatter", duration = 0.5, range = 6, damage = 32 },
			},
		},
	},
