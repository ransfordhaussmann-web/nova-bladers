	...
	SPECIAL_MOVES = {
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "counter", duration = 0.8, interval = 0.4, range = 7, damage = 15 },
			},
		},
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "flare", duration = 0.65, interval = 0.25, damage = 8 },
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "mirage", duration = 0.5, rushSpeed = 88, dashCount = 2 },
				{ id = "storm", duration = 0.5, range = 7, damage = 32 },
			},
		},
	},
