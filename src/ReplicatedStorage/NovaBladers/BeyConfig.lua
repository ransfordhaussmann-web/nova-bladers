	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "feathers", duration = 1.0, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 5 },
				{ id = "finisher", duration = 0.15, rushSpeed = 80 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "crash", duration = 0.45, rushSpeed = 55, diveSpeed = 35 },
				{ id = "splash", duration = 0.65, range = 7.5, damage = 32 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "bleed", duration = 0.4, interval = 0.2, damage = 12, range = 5 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.75, interval = 0.38, range = 9, damage = 14 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "loop", duration = 1.0 },
				{ id = "burst", duration = 0.45, range = 6, damage = 34 },
			},
		},
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, rushSpeed = 95 },
				{ id = "afterimage", duration = 0.4, range = 5.5, damage = 28 },
			},
		},
	},
