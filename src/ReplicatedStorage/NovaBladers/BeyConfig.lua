	...
	SPECIAL_MOVES = {
		...
		BlazeSpiralDrive = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.15, hitRadius = 4.5, damage = 10 },
				{ id = "finisher", duration = 0.3, range = 7, damage = 32 },
			},
		},
		--[[ Frost Core — ice shield + frost shatter ]]
		GlacierAegis = {
			id = "GlacierAegis",
			name = "Glacier Aegis",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.8, interval = 0.35, range = 9, damage = 12 },
			},
		},
	},
