	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.6, hitInterval = 0.15, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / reflective shockwave ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.7, range = 9, damage = 18 },
			},
		},
	},
