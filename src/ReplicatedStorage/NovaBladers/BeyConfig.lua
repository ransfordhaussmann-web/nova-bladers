local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Prism — Crystal barrier / frost shock ]]
		CrystalLockdown = {
			id = "CrystalLockdown",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.8, interval = 0.3, range = 7, damage = 12 },
			},
		},
		--[[ Blaze Ripper — Flame cyclone / eruption ]]
		InfernoCyclone = {
			id = "InfernoCyclone",
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, interval = 0.22, damage = 10, orbitRadius = 5, orbitSpeed = 20 },
