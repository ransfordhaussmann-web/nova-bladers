local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / saw-blade rush ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.65, hitInterval = 0.14, hitRadius = 4.5, damage = 12, hits = 4 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / reflection pulse ]]
		AuroraBarrierDome = {
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "dome", duration = 0.75 },
				{ id = "reflect", duration = 0.8, interval = 0.3, range = 9, damage = 14 },
			},
		},
	},
