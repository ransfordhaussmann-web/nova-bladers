	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRend = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.22, rushSpeed = 88 },
				{ id = "shower", duration = 0.76, hitInterval = 0.14, hitRadius = 5, damage = 13, hits = 5 },
			},
		},
		--[[ Granite Fort — heavy fortress lock ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.38, range = 9, damage = 15 },
			},
		},
