	...
	SPECIAL_MOVES = {
		...
		ForgeHammerSlam = {
			...
			phases = {
				...
				{ id = "leap", duration = 0.35, leapHeight = 14 },
				{ id = "slam", duration = 0.25, damage = 28 },
				{ id = "shock", duration = 0.55, interval = 0.28, range = 9, damage = 14 },
			},
		},
		--[[ Frost Prism — crystal shield and shatter ]]
		PrismCrystalShield = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.75, range = 7.5, damage = 22 },
			},
		},
	},
