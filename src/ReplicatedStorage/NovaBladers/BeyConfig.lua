local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — Vortex Rush / spiral impact ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.15, hitRadius = 5.0, damage = 12, hits = 5 },
			},
		},
		--[[ Glacier Mantle — Frost Lock / ice wall burrow ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
