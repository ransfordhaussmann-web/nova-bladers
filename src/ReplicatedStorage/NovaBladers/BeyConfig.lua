	...
	SPECIAL_MOVES = {
		...
		BlazeCorkscrew = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, rushSpeed = 85, hitInterval = 0.15, hitRadius = 4.5, damage = 10 },
				{ id = "eruption", duration = 0.35, range = 7, damage = 28 },
			},
		},
		--[[ Frost Orbit — ice shield + frost pulse ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.85, interval = 0.35, range = 9, damage = 12 },
			},
		},
	},
