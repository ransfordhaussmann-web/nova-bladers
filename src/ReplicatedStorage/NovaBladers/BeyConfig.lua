	...
	SPECIAL_MOVES = {
		...
		FangSpiralRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 1.0, interval = 0.22, orbitRadius = 7, orbitSpeed = 22, damage = 10, range = 4.5 },
				{ id = "rend", duration = 0.35, rushSpeed = 95, damage = 42, range = 5 },
			},
		},
		...
		GlacierCoilLock = {
			...
			phases = {
				{ id = "frost", duration = 0.4, range = 9, damage = 6 },
				{ id = "coil", duration = 0.9 },
