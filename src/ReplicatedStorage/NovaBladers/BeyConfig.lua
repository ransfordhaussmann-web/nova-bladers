local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / chain slash ]]
		CrimsonRipperLunge = {
		...
		--[[ Granite Fort — Anchor Bastion / ground quake ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.65, interval = 0.22, damage = 11 },
			},
		},
		--[[ Phantom Edge — Vanish / mirage strike / blade echo ]]
		PhantomBladeMirage = {
