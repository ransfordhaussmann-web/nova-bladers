	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.28, rushSpeed = 80 },
				{ id = "shower", duration = 0.84, hitInterval = 0.16, hitRadius = 5.8, damage = 10, hits = 5 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "pulse", duration = 1.05, interval = 0.28, range = 9.5, damage = 14 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "shower", duration = 0.73, hitInterval = 0.14, hitRadius = 5.2, damage = 12, hits = 4 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.35, range = 7.5, damage = 15 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "dive", duration = 0.38, rushSpeed = 95, diveSpeed = 44 },
				{ id = "burst", duration = 0.42, range = 7.0, damage = 36 },
			},
		},
	},
