local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Edge — Spiral flame rush ]]
		BlazeSpiralDrive = {
			id = "BlazeSpiralDrive",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.65, orbitRadius = 5, orbitSpeed = 22, trailInterval = 0.12, damage = 8 },
				{ id = "impact", duration = 0.45, rushSpeed = 95, range = 7, damage = 32 },
			},
		},
		--[[ Frost Core — Ice shield and shatter burst ]]
		GlacierAegis = {
			id = "GlacierAegis",
			name = "Glacier Aegis",
			mode = "glacier",
			...
			phases = {
				{ id = "frost", duration = 0.4, slowRadius = 9, slowMult = 0.45 },
