	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.22, rushSpeed = 76 },
				{ id = "storm", duration = 0.8, hitInterval = 0.16, hitRadius = 5.2, damage = 10, hits = 4 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.38, rushSpeed = 88 },
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.9, interval = 0.34, range = 7.5, damage = 11 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
