local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — Fire wheel rush + inferno burst ]]
		BlazeInfernoWheel = {
			...
			phases = {
				...
				{ id = "wheel", duration = 0.55, rushSpeed = 85, hitInterval = 0.2, hitRadius = 4.5, damage = 10, hits = 3 },
				{ id = "inferno", duration = 0.55, range = 7, damage = 32 },
			},
		},
		--[[ Frost Veil — Crystal shield + frost pulse ]]
		FrostCrystalVeil = {
			id = "FrostCrystalVeil",
