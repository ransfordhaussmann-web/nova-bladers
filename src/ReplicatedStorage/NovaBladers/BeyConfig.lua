local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Quill — Feather barrage / flame rush ]]
		BlazeQuillBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.14, hitRadius = 6, damage = 12, hits = 5 },
			},
		},
		--[[ Tide Anchor — Anchor wall / tidal pulses ]]
		TideAnchorSurge = {
			id = "TideAnchorSurge",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.35, range = 7, damage = 11 },
			},
		},
	},
