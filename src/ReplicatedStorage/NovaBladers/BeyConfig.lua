	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.7, hitInterval = 0.22, hitRadius = 4.5, damage = 10, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "rampart", duration = 0.85 },
				{ id = "counter", duration = 0.75, interval = 0.38, range = 7, damage = 14 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "flare", duration = 0.85, interval = 0.32, damage = 8 },
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "feint", duration = 0.35 },
				{ id = "strike", duration = 0.55, rushSpeed = 85, range = 5.5, damage = 34 },
			},
		},
	},
