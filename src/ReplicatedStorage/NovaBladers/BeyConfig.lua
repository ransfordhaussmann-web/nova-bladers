local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid lunge with blade chain ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "slashes", duration = 0.65, hitInterval = 0.15, hitRadius = 4.5, damage = 12, hits = 4 },
			},
		},
		--[[ Aurora Crest — frost dome shield + release burst ]]
		AuroraBarrierDome = {
