	...
	SPECIAL_MOVES = {
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "slashes", duration = 0.9, hitInterval = 0.22, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.9, interval = 0.35, range = 7, damage = 12 },
			},
		},
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "phase", duration = 0.4, rushSpeed = 105 },
