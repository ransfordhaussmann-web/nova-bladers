local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Comet — fiery starfall rush ]]
		StarfallRush = {
			id = "StarfallRush",
			name = "Starfall Rush",
			mode = "comet",
			...
			phases = {
				...
				{ id = "streak", duration = 0.45, rushSpeed = 88 },
				{ id = "fallout", duration = 0.77, hitInterval = 0.2, hitRadius = 6, damage = 12, hits = 3 },
			},
		},
		--[[ Crystal Guard — ice fortress and crystal pulse ]]
		GlacierVault = {
			id = "GlacierVault",
			name = "Glacier Vault",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.95, interval = 0.33, range = 7.5, damage = 14 },
			},
		},
	},
