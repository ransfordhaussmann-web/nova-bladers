	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.75, hitInterval = 0.22, hitRadius = 5, damage = 13, hits = 3 },
			},
		},
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.9, interval = 0.3, range = 7.5, damage = 14 },
			},
		},
		--[[ Solar Drift — Solar flare rings + warm orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		PhantomBladeMirage = {
			...
			phases = {
				{ id = "mirage", duration = 0.2 },
				{ id = "dash1", duration = 0.25, rushSpeed = 95 },
				{ id = "dash2", duration = 0.25, rushSpeed = 95 },
