local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		ForgeHammerSlam = {
			...
			phases = {
				{ id = "leap", duration = 0.35, jumpForce = 38 },
				{ id = "slam", duration = 0.45, rushSpeed = 85, diveSpeed = 55 },
				{ id = "pulse", duration = 0.8, interval = 0.28, range = 7.5, damage = 14 },
			},
		},
		...
		PrismCrystalShield = {
			...
			phases = {
				...
				{ id = "freeze", duration = 0.55, range = 7, spinLoss = 3 },
