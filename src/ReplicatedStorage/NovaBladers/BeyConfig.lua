local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Starfall Edge — meteor rush variant ]]
		StarfallRush = {
			id = "StarfallRush",
			name = "Starfall Rush",
			mode = "meteor",
			...
			phases = {
				...
				{ id = "launch", duration = 0.28, rushSpeed = 82 },
				{ id = "shower", duration = 0.84, hitInterval = 0.16, hitRadius = 5.8, damage = 12, hits = 5 },
			},
		},
		--[[ Stone Halo — fortress variant ]]
		StoneHaloBastion = {
			id = "StoneHaloBastion",
			name = "Stone Halo Bastion",
			mode = "fortress",
			duration = 2.0,
			damage = 28,
			spinLoss = 6,
		...
		--[[ Thunder Coil — sonic orbit variant ]]
		ThunderCoilLoop = {
			id = "ThunderCoilLoop",
			name = "Thunder Coil Loop",
			mode = "sonic",
			duration = 1.85,
			damage = 30,
			spinLoss = 10,
			...
			phases = {
				...
				{ id = "sonic", duration = 0.8, interval = 0.24, damage = 10 },
				{ id = "orbit", duration = 0.65 },
			},
		},
		--[[ Night Maw — eclipse dive variant ]]
		NightMawRend = {
			id = "NightMawRend",
			name = "Night Maw Rend",
			mode = "eclipse",
			...
			phases = {
				...
				{ id = "dive", duration = 0.42, rushSpeed = 95, diveSpeed = 50 },
				{ id = "burst", duration = 0.38, range = 7, damage = 40 },
			},
		},
	},
