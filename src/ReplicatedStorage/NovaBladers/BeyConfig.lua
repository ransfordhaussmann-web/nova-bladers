	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.55, hitInterval = 0.14, hitRadius = 4.5, damage = 12, hits = 4 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / frost shatter ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.75, interval = 0.25, range = 9, damage = 14 },
			},
		},
	},
