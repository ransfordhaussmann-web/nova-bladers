local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — Spiral rush with blade slashes ]]
		CrimsonSpiralRend = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "spiral", duration = 0.75, hitInterval = 0.14, hitRadius = 4.5, damage = 10, spiralRadius = 3.5, spiralSpeed = 14 },
				{ id = "rend", duration = 0.4, range = 7, damage = 32 },
			},
		},
		--[[ Glacier Shield — Frost aura, ice wall, frost pulses ]]
		GlacierFrostBulwark = {
