	...
	SPECIAL_MOVES = {
		...
		CrimsonMawRend = {
			...
			phases = {
				...
				{ id = "dive", duration = 0.35, rushSpeed = 95, diveSpeed = 52 },
				{ id = "burst", duration = 0.3, range = 5.5, damage = 36 },
			},
		},
		GraniteAvalancheLock = {
			id = "GraniteAvalancheLock",
			name = "Granite Avalanche Lock",
			mode = "fortress",
			duration = 2.0,
			damage = 28,
			spinLoss = 6,
		...
		PhantomPhaseSlash = {
			...
			damage = 38,
			spinLoss = 14,
			color = Color3.fromRGB(190, 185, 220),
			phases = {
		...
		BlazeCrownInferno = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.7, hitInterval = 0.2, hitRadius = 6, damage = 13, hits = 3 },
			},
		},
	},
