	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.65, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "counter", duration = 0.5, interval = 0.35, range = 7, damage = 14 },
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.5, range = 7, damage = 36 },
			},
		},
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "strike", duration = 0.45, rushSpeed = 82 },
				{ id = "fade", duration = 0.35, range = 6.5, damage = 34 },
			},
		},
	},
