local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Quill — triple fire lance thrust ]]
		EmberLanceBarrage = {
			...
			phases = {
				{ id = "aim", duration = 0.2 },
				{ id = "thrust", duration = 0.22, rushSpeed = 85, damage = 12 },
				{ id = "thrust", duration = 0.22, rushSpeed = 88, damage = 13 },
				{ id = "thrust", duration = 0.28, rushSpeed = 92, damage = 15 },
			},
		},
		--[[ Tide Anchor — tidal pull + shield ]]
		TidalAnchorLock = {
			id = "TidalAnchorLock",
			...
			phases = {
				...
				{ id = "pull", duration = 0.5, range = 10, pullStrength = 22 },
				{ id = "lock", duration = 0.8, interval = 0.35, range = 7, damage = 11 },
			},
		},
		--[[ Crimson Fang — zigzag slash combo ]]
		CrimsonRend = {
			id = "CrimsonRend",
			name = "Crimson Rend",
			mode = "rend",
			...
			phases = {
				{ id = "focus", duration = 0.2 },
				{ id = "slash", duration = 0.3, rushSpeed = 78, angle = 55 },
				{ id = "slash", duration = 0.3, rushSpeed = 82, angle = -55 },
				{ id = "finish", duration = 0.3, range = 6, damage = 32 },
			},
		},
		--[[ Granite Fort — stone wall + quake counter ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				{ id = "brace", duration = 0.45 },
				{ id = "quake", duration = 0.7, interval = 0.3, range = 7, damage = 10 },
				{ id = "counter", duration = 0.4, rushSpeed = 70, damage = 28 },
			},
		},
	},
