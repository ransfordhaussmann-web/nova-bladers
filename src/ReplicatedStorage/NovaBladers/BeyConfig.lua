local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Prism — ice barrier + shatter burst ]]
		CrystalLockdown = {
			id = "CrystalLockdown",
		...
		--[[ Blaze Ripper — fire rings + rush slam ]]
		InfernoCyclone = {
			id = "InfernoCyclone",
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.8, interval = 0.25, damage = 10 },
				{ id = "slam", duration = 0.5, rushSpeed = 85, range = 7, damage = 40 },
			},
		},
	},
