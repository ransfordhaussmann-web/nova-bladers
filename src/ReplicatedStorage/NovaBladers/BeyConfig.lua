local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Flame Crown — Inferno meteor rush ]]
		FlameInfernoSpiral = {
			id = "FlameInfernoSpiral",
			name = "Flame Inferno Spiral",
			mode = "meteor",
			duration = 1.2,
			rushSpeed = 82,
			damage = 38,
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.16, hitRadius = 5.8, damage = 12, hits = 5 },
			},
		},
		--[[ Crystal Bloom — Prism sonic rings ]]
		PrismShardTempest = {
			id = "PrismShardTempest",
			name = "Prism Shard Tempest",
			mode = "sonic",
			duration = 1.9,
			damage = 30,
			spinLoss = 10,
