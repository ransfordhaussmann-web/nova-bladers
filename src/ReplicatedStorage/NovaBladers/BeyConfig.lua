	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.7, interval = 0.2, hitRadius = 5, damage = 10 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.65, slashes = 3, rushSpeed = 95, damage = 14 },
				{ id = "finish", duration = 0.4, range = 6, damage = 36 },
			},
		},
	},
