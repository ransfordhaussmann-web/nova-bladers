local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Flame spiral rush with meteor hits ]]
		CrimsonFlameSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, hitInterval = 0.17, hitRadius = 5.8, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Crown — Ice barrier and frost pulses ]]
		FrostBastion = {
			id = "FrostBastion",
			name = "Frost Bastion",
			mode = "fortress",
