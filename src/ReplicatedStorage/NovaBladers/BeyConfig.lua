	...
	SPECIAL_MOVES = {
		...
		BlazeSpiralRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.9, orbitRadius = 7, orbitSpeed = 22, hitInterval = 0.22, damage = 10 },
		...
		CrystalPrismWall = {
			...
			phases = {
				{ id = "freeze", duration = 0.4, damageReduction = 0.35 },
				{ id = "shield", duration = 0.6, damageReduction = 0.65 },
				{ id = "shatter", duration = 0.9, interval = 0.3, range = 8, damage = 12 },
			},
		},
	},
