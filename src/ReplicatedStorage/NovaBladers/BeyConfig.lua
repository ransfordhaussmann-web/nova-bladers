	...
	SPECIAL_MOVES = {
		...
		EmberCyclone = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, hitInterval = 0.2, hitRadius = 5, damage = 10 },
				{ id = "rush", duration = 0.35, rushSpeed = 82 },
				{ id = "burst", duration = 0.2, range = 7, damage = 30 },
			},
		},
		--[[ Frost Veil — ice barrier and shatter pulse ]]
		GlacierShroud = {
			id = "GlacierShroud",
			name = "Glacier Shroud",
			mode = "glacier",
