	...
	SPECIAL_MOVES = {
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "counter", duration = 0.4, range = 7, damage = 22 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 1.0, orbitRadius = 10, orbitSpeed = 9, damage = 8 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "afterimage", duration = 0.5, hits = 3, interval = 0.16, damage = 12 },
			},
		},
	},
