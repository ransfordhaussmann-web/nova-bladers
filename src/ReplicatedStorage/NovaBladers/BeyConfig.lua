	...
	SPECIAL_MOVES = {
		...
		CrimsonRiposte = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.5, hitInterval = 0.15, hitRadius = 4.5, damage = 13, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.8, interval = 0.3, range = 8.5, damage = 14 },
			},
		},
		SolarHaloDrive = {
			id = "SolarHaloDrive",
		...
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
			...
			phases = {
				...
				{ id = "rings", duration = 0.6, interval = 0.24, damage = 10 },
				{ id = "burst", duration = 0.45, range = 7, damage = 40 },
			},
		},
	},
