local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — fire lunge + rapid strike barrage ]]
		CrimsonLanceBarrage = {
			id = "CrimsonLanceBarrage",
			name = "Crimson Lance Barrage",
			mode = "lance",
			duration = 1.2,
			rushSpeed = 88,
			damage = 38,
			spinLoss = 16,
			color = Color3.fromRGB(255, 90, 55),
			phases = {
				{ id = "charge", duration = 0.25 },
				{ id = "lunge", duration = 0.35, rushSpeed = 88 },
				{ id = "barrage", duration = 0.6, hitInterval = 0.15, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		--[[ Frost Prism — crystal shell + ice shockwaves ]]
		FrostPrismLock = {
			id = "FrostPrismLock",
