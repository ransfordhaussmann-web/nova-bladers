local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — aggressive meteor variant ]]
		CrimsonStarfall = {
			id = "CrimsonStarfall",
		...
		--[[ Granite Fort — heavy fortress variant ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		--[[ Solar Drift — extended sonic orbit ]]
		SolarTempest = {
			id = "SolarTempest",
			name = "Solar Tempest",
			mode = "sonic",
		...
		--[[ Phantom Edge — ghost eclipse variant ]]
		PhantomVeilStrike = {
		...
		--[[ Crystal Edge — fast crystal meteor ]]
		CrystalBarrage = {
			id = "CrystalBarrage",
			...
			phases = {
				...
				{ id = "shower", duration = 0.7, hitInterval = 0.12, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		--[[ Blaze Crown — fiery sonic burst ]]
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
