local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — Whirlwind rush with pull-in cyclone ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.87, hitInterval = 0.2, hitRadius = 6, damage = 10, hits = 4, pullStrength = 22 },
			},
		},
		--[[ Glacier Mantle — Frost aura, ice wall, shatter burst ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
