local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Flame spiral rush + ember burst ]]
		CrimsonFlameSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "ember", duration = 0.3, range = 7, damage = 28 },
			},
		},
		--[[ Glacier Ring — Frost aura, ice rings, crystal burst ]]
		GlacierFrostBloom = {
			id = "GlacierFrostBloom",
			name = "Glacier Frost Bloom",
			mode = "frost",
			duration = 1.7,
			damage = 28,
			spinLoss = 10,
			...
			phases = {
				...
				{ id = "bloom", duration = 0.6, interval = 0.25, range = 6, damage = 8 },
				{ id = "shard", duration = 0.7, range = 7, damage = 22 },
			},
		},
	},
