local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				{ id = "coil", duration = 0.25 },
				{ id = "lunge", duration = 0.45, rushSpeed = 88 },
				{ id = "rip", duration = 0.5, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Granite Fort — Bastion wall / quake counter ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		--[[ Solar Drift — Flare orbit / sun burst ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "orbit", duration = 0.85, interval = 0.3, damage = 8 },
				{ id = "burst", duration = 0.6, range = 7, damage = 22 },
			},
		},
		--[[ Phantom Edge — Mirage clones / blade slash ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.6, range = 7, damage = 34 },
			},
		},
	},
