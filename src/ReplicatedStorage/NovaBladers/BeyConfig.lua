local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid blade combo / rend barrage ]]
		CrimsonRendBarrage = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.3, rushSpeed = 85 },
				{ id = "rend", duration = 0.75, hitInterval = 0.15, hitRadius = 5, damage = 10, hits = 5 },
				{ id = "finisher", duration = 0.25, range = 7, damage = 28 },
			},
		},
		--[[ Glacier Shield — ice fortress / frost pulse ]]
		GlacierVaultLock = {
			id = "GlacierVaultLock",
			...
			phases = {
				...
				{ id = "wall", duration = 0.55 },
				{ id = "shatter", duration = 0.95, interval = 0.32, range = 8.5, damage = 12 },
			},
		},
	},
