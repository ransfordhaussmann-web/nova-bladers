	...
	SPECIAL_MOVES = {
		...
		CrimsonFlameSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.95, hitInterval = 0.22, hitRadius = 4.5, damage = 10 },
				{ id = "inferno", duration = 0.4, range = 7, damage = 28 },
			},
		},
		...
		FrostCrystalAegis = {
			...
			phases = {
				...
				{ id = "frostPulse", duration = 0.85, interval = 0.3, range = 7.5, damage = 12 },
			},
		},
	},
