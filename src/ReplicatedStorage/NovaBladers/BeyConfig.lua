	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, hitInterval = 0.15, hitRadius = 6, damage = 10, hits = 5 },
				{ id = "finisher", duration = 0.3, rushSpeed = 95, range = 7, damage = 40 },
			},
		},
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "bastion", duration = 0.8, damageReduction = 0.65 },
				{ id = "pulse", duration = 0.7, interval = 0.25, range = 9, damage = 14 },
			},
		},
		--[[ Solar Drift — solar flares while drifting ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "flare", duration = 0.7, interval = 0.2, damage = 8, range = 5 },
				{ id = "drift", duration = 0.75, rushSpeed = 65 },
			},
		},
		--[[ Phantom Edge — phase dashes + ghost slash ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.55, rushSpeed = 100, dashCount = 3, dashInterval = 0.18 },
				{ id = "slash", duration = 0.35, range = 6.5, damage = 42 },
			},
		},
	},
