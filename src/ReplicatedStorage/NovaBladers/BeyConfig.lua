local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "scatter", duration = 0.65, interval = 0.14, hitRadius = 4.5, damage = 8, hits = 4 },
				{ id = "flare", duration = 0.45, rushSpeed = 82 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "rise", duration = 0.35, liftSpeed = 38 },
				{ id = "slam", duration = 0.35, diveSpeed = 55, impactRadius = 7, damage = 28 },
				{ id = "ripple", duration = 0.8, interval = 0.3, range = 9, damage = 11 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "rend", duration = 0.35, rushSpeed = 98 },
				{ id = "bleed", duration = 0.65, interval = 0.16, hitRadius = 4, damage = 7, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				{ id = "brace", duration = 0.3 },
				{ id = "rampart", duration = 0.6 },
				{ id = "shatter", duration = 0.8, interval = 0.35, range = 9, damage = 15 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.35, range = 7, damage = 36, rushSpeed = 90 },
			},
		},
	},
