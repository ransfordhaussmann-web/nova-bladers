local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — flame ignite → lance rush → burn trail ]]
		CrimsonFlameLance = {
			...
			phases = {
				...
				{ id = "lance", duration = 0.35, rushSpeed = 95 },
				{ id = "burn", duration = 0.75, hitInterval = 0.2, hitRadius = 4.5, damage = 10, hits = 3 },
			},
		},
		--[[ Glacier Core — freeze → aegis shield → ice shard pulses ]]
		GlacierAegis = {
			id = "GlacierAegis",
			name = "Glacier Aegis",
			mode = "frost",
