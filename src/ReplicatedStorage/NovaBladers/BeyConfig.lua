local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spiral rush + fire impact ]]
		CrimsonSpiralFang = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "spiral", duration = 0.85, orbitRadius = 7, orbitSpeed = 22, shrinkRate = 5 },
		...
		GlacierFrostBastion = {
			...
			phases = {
				...
				{ id = "frostPulse", duration = 0.75, interval = 0.3, range = 7, damage = 10 },
