	...
	SPECIAL_MOVES = {
		...
		GlacierShardStorm = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.9, hitInterval = 0.22, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "freeze", duration = 0.25, range = 7, damage = 18 },
			},
		},
		...
		InfernoSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, rushSpeed = 80 },
				{ id = "eruption", duration = 0.25, range = 8, damage = 28 },
			},
		},
	},
