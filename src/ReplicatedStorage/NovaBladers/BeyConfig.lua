	...
	SPECIAL_MOVES = {
		...
		CrimsonCrossSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, rushSpeed = 85, hitInterval = 0.18, hits = 3, damage = 12, hitRadius = 5 },
				{ id = "cross", duration = 0.35, range = 7, damage = 28 },
			},
		},
		--[[ Frost Core — Crystal fortress + ice shatter ]]
		FrostCrystalBastion = {
			...
			phases = {
				...
				{ id = "bastion", duration = 0.7, damageReduction = 0.6 },
