	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.82, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Tide Anchor — Pull and slam ]]
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "splash", duration = 0.75, interval = 0.3, range = 7, damage = 12 },
			},
		},
		--[[ Crimson Fang — Dual claw rend ]]
		CrimsonRend = {
			id = "CrimsonRend",
			name = "Crimson Rend",
			mode = "rend",
			...
			phases = {
				...
				{ id = "slash1", duration = 0.35, rushSpeed = 75, range = 5.5, damage = 18 },
				{ id = "slash2", duration = 0.38, rushSpeed = 85, range = 6, damage = 22 },
				{ id = "finisher", duration = 0.3, range = 5, damage = 28 },
			},
		},
		...
		--[[ Phantom Edge — Phase blink slash ]]
		PhantomPhaseSlash = {
			...
			damage = 40,
			spinLoss = 17,
			color = Color3.fromRGB(80, 210, 240),
			phases = {
				{ id = "fade", duration = 0.2 },
				{ id = "blink", duration = 0.25, blinkRange = 16 },
				{ id = "slash", duration = 0.35, rushSpeed = 100, range = 7, damage = 40 },
				{ id = "echo", duration = 0.3, range = 5.5, damage = 18 },
			},
		},
	},
