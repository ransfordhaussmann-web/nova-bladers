	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.95, interval = 0.22, hitRadius = 5, damage = 10 },
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "stomp", duration = 0.4, range = 6, damage = 18 },
				{ id = "pulse", duration = 1.05, interval = 0.32, range = 9, damage = 12 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				{ id = "charge", duration = 0.3 },
				{ id = "flare", duration = 0.85, interval = 0.26, damage = 10 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				{ id = "vanish", duration = 0.18 },
				{ id = "strike", duration = 0.32, rushSpeed = 98 },
				{ id = "strike2", duration = 0.32, rushSpeed = 98 },
