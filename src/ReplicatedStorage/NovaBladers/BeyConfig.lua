local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — corkscrew fire rush ]]
		BlazeCorkscrew = {
			id = "BlazeCorkscrew",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.9, hitInterval = 0.2, hitRadius = 5, damage = 10, spiralRate = 14 },
				{ id = "flare", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Frost Orbit — ice fortress + shatter ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "lock", duration = 0.75, interval = 0.3, range = 7.5, damage = 11 },
				{ id = "shatter", duration = 0.8, range = 9, damage = 22 },
			},
		},
	},
