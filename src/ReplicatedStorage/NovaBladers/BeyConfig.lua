	...
	SPECIAL_MOVES = {
		...
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.14, hitRadius = 5.2, damage = 10, hits = 5 },
			},
		},
		BlazeCrownNova = {
			id = "BlazeCrownNova",
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "nova", duration = 0.45, range = 8, damage = 42 },
				{ id = "afterburn", duration = 0.45, interval = 0.2, range = 5, damage = 10 },
			},
		},
	},
