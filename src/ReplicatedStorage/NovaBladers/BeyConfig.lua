local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Ripper — Vortex spin slash ]]
		CrimsonVortexSlash = {
			...
			phases = {
				...
				{ id = "spin", duration = 0.7, interval = 0.22, range = 4.5, damage = 10 },
				{ id = "slash", duration = 0.5, rushSpeed = 88, range = 7, damage = 28 },
			},
		},
		--[[ Frost Monarch — Ice citadel / frost wall ]]
		FrostCitadel = {
			id = "FrostCitadel",
			name = "Frost Citadel",
			mode = "frost",
			...
			phases = {
				...
				{ id = "citadel", duration = 0.6 },
				{ id = "shatter", duration = 0.9, interval = 0.35, range = 9, damage = 14 },
			},
		},
	},
