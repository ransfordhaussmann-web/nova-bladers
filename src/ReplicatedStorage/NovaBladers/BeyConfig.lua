	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.65, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.75, interval = 0.25, range = 9, damage = 14 },
			},
		},
		...
		--[[ Phantom Edge — mirage feint strike ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "strike", duration = 0.4, rushSpeed = 95, range = 7, damage = 36 },
			},
		},
	},
