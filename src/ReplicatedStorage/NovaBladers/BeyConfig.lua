	...
	SPECIAL_MOVES = {
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "fortress", duration = 0.7 },
				{ id = "shock", duration = 0.9, interval = 0.35, range = 9, damage = 14 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "blade", duration = 0.45, rushSpeed = 80 },
				{ id = "phantom", duration = 0.35, range = 7, damage = 32 },
			},
		},
	},
