	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.6, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
		...
		SolarFlareLoop = {
			...
			phases = {
				...
				{ id = "sonic", duration = 0.85, interval = 0.32, damage = 8 },
				{ id = "orbit", duration = 0.65 },
			},
		},
		PhantomPhaseStrike = {
		...
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.9, hitInterval = 0.14, hitRadius = 6, damage = 9, hits = 5 },
			},
		},
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
