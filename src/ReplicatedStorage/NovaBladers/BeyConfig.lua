local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — Flame ignition / rush / burning orbit spiral ]]
		CrimsonFlameSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 1.0, interval = 0.22, damage = 10 },
			},
		},
		...
		FrostCrystalAegis = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.3, range = 7, damage = 11 },
