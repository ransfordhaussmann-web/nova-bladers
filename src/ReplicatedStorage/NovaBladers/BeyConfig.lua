local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / blade slash combo ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, hitInterval = 0.14, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Granite Fort — stone bastion / earthquake slam ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "fortify", duration = 0.7, interval = 0.35, range = 7, damage = 10 },
				{ id = "slam", duration = 0.8, range = 9, damage = 32 },
			},
		},
		--[[ Solar Drift — solar flare rings / burn orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "flare", duration = 0.75, interval = 0.26, damage = 8 },
				{ id = "orbit", duration = 0.7 },
			},
		},
		--[[ Phantom Edge — mirage copies / blade dash ]]
		PhantomBladeMirage = {
			...
			damage = 36,
			spinLoss = 14,
			color = Color3.fromRGB(70, 220, 230),
			phases = {
				{ id = "split", duration = 0.3, copies = 3 },
				{ id = "dash", duration = 0.5, rushSpeed = 80 },
				{ id = "strike", duration = 0.5, range = 7, damage = 34 },
			},
		},
	},
