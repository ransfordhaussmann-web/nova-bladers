	...
	SPECIAL_MOVES = {
		...
		CrimsonMaelstrom = {
			...
			phases = {
				...
				{ id = "maelstrom", duration = 0.85, hitInterval = 0.17, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "flares", duration = 0.75, interval = 0.26, damage = 8 },
				{ id = "solarOrbit", duration = 0.7 },
			},
		},
		PhantomVoidSlash = {
			id = "PhantomVoidSlash",
			...
			phases = {
				{ id = "void", duration = 0.22 },
				{ id = "slash", duration = 0.35, rushSpeed = 105 },
				{ id = "rupture", duration = 0.38, range = 5.5, damage = 36 },
			},
		},
	},
