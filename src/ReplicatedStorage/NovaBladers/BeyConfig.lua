	...
	SPECIAL_MOVES = {
		...
		CrimsonRiposte = {
			...
			phases = {
				...
				{ id = "fang", duration = 0.45, hitInterval = 0.15, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			spinLoss = 7,
			damageReduction = 0.6,
			color = Color3.fromRGB(140, 150, 160),
			phases = {
		...
		PhantomVeilSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, rushSpeed = 80 },
				{ id = "finisher", duration = 0.3, range = 5.5, damage = 32 },
			},
		},
		CrystalShardStorm = {
