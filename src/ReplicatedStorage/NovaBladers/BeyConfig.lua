	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.85, hitInterval = 0.17, hitRadius = 6, damage = 10, hits = 5 },
				{ id = "slash", duration = 0.3, rushSpeed = 95, range = 7, damage = 28 },
			},
		},
		GraniteBastionPulse = {
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.55, rushSpeed = 88, dashes = 3, dashInterval = 0.18 },
