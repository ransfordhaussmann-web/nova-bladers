local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Flame charge / blazing rush / ember trail ]]
		CrimsonBlazeRush = {
			id = "CrimsonBlazeRush",
			...
			damage = 38,
			spinLoss = 16,
			color = Color3.fromRGB(240, 70, 45),
			phases = {
				{ id = "ignite", duration = 0.25 },
				{ id = "rush", duration = 0.45, rushSpeed = 85 },
				{ id = "ember", duration = 0.55, hitInterval = 0.15, hitRadius = 5, damage = 10, hits = 3 },
			},
		},
		--[[ Frost Crown — Ice armor / crown shield / frost pulse ]]
		GlacierCrownLock = {
			id = "GlacierCrownLock",
