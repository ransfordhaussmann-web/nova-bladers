local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				{ id = "crouch", duration = 0.25 },
				{ id = "lunge", duration = 0.4, rushSpeed = 100 },
				{ id = "ripper", duration = 0.55, hitInterval = 0.15, hitRadius = 4.5, damage = 10, hits = 3 },
			},
		},
		--[[ Granite Fort — Bastion wall + counter slam ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "reflect", duration = 0.45, interval = 0.3, range = 7, damage = 11 },
				{ id = "slam", duration = 0.5, range = 9, damage = 32 },
			},
		},
		--[[ Solar Drift — Flare rings + drift orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "expand", duration = 0.75, interval = 0.32, damage = 8 },
				{ id = "drift", duration = 0.5 },
			},
		},
		--[[ Phantom Edge — Mirage clones + blade dash ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, hitInterval = 0.12, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
	},
