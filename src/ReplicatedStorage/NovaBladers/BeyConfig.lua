local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spinning blade rush ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "vortex", duration = 0.75, hitInterval = 0.15, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		--[[ Glacier Mantle — frost aura + ice ring + shatter ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
