	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.65, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 3 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
		...
		PhantomPhaseSlice = {
			id = "PhantomPhaseSlice",
			name = "Phantom Phase Slice",
			mode = "eclipse",
			duration = 1.05,
			rushSpeed = 98,
			damage = 36,
			...
			phases = {
				...
				{ id = "dive", duration = 0.35, rushSpeed = 98, diveSpeed = 42 },
				{ id = "burst", duration = 0.3, range = 7, damage = 34 },
			},
		},
		CrystalShatterSurge = {
			...
			phases = {
				{ id = "charge", duration = 0.3 },
				{ id = "fracture", duration = 0.35, rushSpeed = 75 },
				{ id = "shards", duration = 0.75, hitInterval = 0.22, hitRadius = 6, damage = 12, hits = 4 },
			},
		},
		BlazeCrownSpiral = {
			id = "BlazeCrownSpiral",
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85 },
				{ id = "erupt", duration = 0.4, range = 8, damage = 36 },
			},
		},
	},
