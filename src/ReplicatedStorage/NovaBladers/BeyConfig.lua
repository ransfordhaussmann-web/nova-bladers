	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.95, hitInterval = 0.22, hitRadius = 5.8, damage = 10, hits = 4 },
				{ id = "finisher", duration = 0.27, rushSpeed = 88, range = 7, damage = 28 },
			},
		},
		--[[ Granite Fort — stone bastion with ground pulses ]]
		GraniteBastionPulse = {
		...
		--[[ Phantom Edge — afterimage dash and blade surge ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.45, rushSpeed = 96 },
