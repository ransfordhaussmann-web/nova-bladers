local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Edge — Flame spiral rush + impact burst ]]
		BlazeSpiralDrive = {
			id = "BlazeSpiralDrive",
			...
			phases = {
				...
				{ id = "impact", duration = 0.35, range = 7, damage = 36 },
			},
		},
		--[[ Frost Core — Ice shield + frost pulse + shatter ]]
		GlacierAegis = {
			id = "GlacierAegis",
			name = "Glacier Aegis",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "frost", duration = 0.9, interval = 0.3, range = 7, damage = 11 },
