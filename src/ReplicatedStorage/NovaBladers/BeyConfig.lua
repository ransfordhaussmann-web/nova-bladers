	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.95, hitInterval = 0.22, hitRadius = 5, damage = 10, hits = 4 },
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.1, interval = 0.36, range = 9, damage = 12 },
			},
		},
		--[[ Solar Drift — heat trail glide ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 1.0, hitInterval = 0.25, hitRadius = 4.5, damage = 8 },
				{ id = "flare", duration = 0.5, range = 8, damage = 22 },
			},
		},
		--[[ Phantom Edge — afterimage dash surge ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.45, rushSpeed = 88 },
