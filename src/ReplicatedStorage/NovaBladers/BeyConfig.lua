	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.65, interval = 0.16, hitRadius = 5, damage = 10, spins = 3 },
				{ id = "rush", duration = 0.6, rushSpeed = 85 },
			},
		},
		...
		--[[ Phantom Edge — ghost surge with afterimages ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "strike", duration = 0.4, rushSpeed = 95, range = 5.5, damage = 34 },
			},
		},
	},
