local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / Fang Chain ]]
		CrimsonRipperLunge = {
		...
		--[[ Granite Fort — Stone Bunker / Earth Wall ]]
		GraniteBastion = {
			id = "GraniteBastion",
		...
		--[[ Phantom Edge — Mirage Decoys / Phantom Slash ]]
		PhantomBladeMirage = {
			...
			damage = 40,
			spinLoss = 16,
			color = Color3.fromRGB(90, 200, 210),
			phases = {
				{ id = "mirage", duration = 0.3, decoys = 3 },
