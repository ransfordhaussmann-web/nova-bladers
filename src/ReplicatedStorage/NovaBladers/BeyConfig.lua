local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid scythe meteor rush ]]
		CrimsonScytheBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.78, hitInterval = 0.14, hitRadius = 5.2, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Core — ice fortress burrow + frost pulses ]]
		FrostBastion = {
			id = "FrostBastion",
			name = "Frost Bastion",
			mode = "fortress",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.95, interval = 0.3, range = 7.5, damage = 11 },
			},
		},
	},
