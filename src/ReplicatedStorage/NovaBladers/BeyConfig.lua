	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.95, interval = 0.2, hitRadius = 5.5, damage = 10 },
			},
		},
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "drift", duration = 1.1, interval = 0.25, trailRadius = 4, damage = 8 },
				{ id = "burst", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Phantom Edge — ghost dash + afterimage strikes ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "afterimage", duration = 0.6, interval = 0.2, hitRadius = 5, damage = 12 },
			},
		},
	},
