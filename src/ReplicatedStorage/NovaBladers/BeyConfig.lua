local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — molten rush + ground slam ]]
		CrimsonForgeBreak = {
			...
			phases = {
				...
				{ id = "break", duration = 0.5, range = 7, damage = 42 },
			},
		},
		--[[ Frost Crown — ice crown guard + frost pulses ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
			...
			phases = {
				...
				{ id = "freeze", duration = 0.85, interval = 0.3, range = 7, damage = 10 },
				{ id = "lock", duration = 0.65, range = 8, damage = 18 },
			},
		},
	},
