local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonMeteorClaw = {
			id = "CrimsonMeteorClaw",
			name = "Crimson Meteor Claw",
			mode = "meteor",
			duration = 1.2,
			rushSpeed = 82,
			damage = 38,
			...
			phases = {
				...
				{ id = "shower", duration = 0.7, hitInterval = 0.14, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
		...
		CrystalShardRain = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.95, hitInterval = 0.16, hitRadius = 6, damage = 10, hits = 5 },
			},
		},
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
			...
			phases = {
				...
				{ id = "dive", duration = 0.45, rushSpeed = 95, diveSpeed = 50 },
