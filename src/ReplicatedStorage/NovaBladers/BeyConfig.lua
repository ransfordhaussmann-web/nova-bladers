local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — Spiral Rush / Fang Strike ]]
		CrimsonSpiralFang = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.22, damage = 10, radius = 5 },
				{ id = "fang", duration = 0.45, rushSpeed = 95, range = 7, damage = 36 },
			},
		},
		--[[ Glacier Shield — Frost Bastion / Ice Shards / Shatter Wave ]]
		GlacierFrostBastion = {
			...
			phases = {
				...
				{ id = "shard", duration = 0.85, interval = 0.3, range = 7, damage = 11 },
