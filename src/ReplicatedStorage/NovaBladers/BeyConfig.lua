local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid fang slashes + rush finisher ]]
		CrimsonWildSlash = {
			id = "CrimsonWildSlash",
			...
			phases = {
				...
				{ id = "slash", duration = 0.7, hitInterval = 0.14, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "rush", duration = 0.5, rushSpeed = 88, range = 7, damage = 30 },
			},
		},
		--[[ Frost Crown — ice crown / frost pulses / shatter burst ]]
		FrostCrownShatter = {
