	...
	SPECIAL_MOVES = {
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "crash", duration = 0.4, slamSpeed = 55 },
				{ id = "ripple", duration = 0.95, interval = 0.3, range = 9, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "rend", duration = 0.3, range = 7, damage = 36 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomPhaseSlash = {
			...
			damage = 38,
			spinLoss = 14,
			color = Color3.fromRGB(140, 160, 220),
			phases = {
				{ id = "phase", duration = 0.25 },
				{ id = "slash", duration = 0.4, rushSpeed = 100 },
