	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, interval = 0.22, hitRadius = 6, damage = 10 },
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "trail", duration = 0.85, interval = 0.2, hitRadius = 4.5, damage = 8 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.75, dashes = 3, rushSpeed = 88 },
				{ id = "surge", duration = 0.45, range = 6, damage = 34 },
			},
		},
	},
