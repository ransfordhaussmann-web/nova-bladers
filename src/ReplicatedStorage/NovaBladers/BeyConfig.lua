local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / Crimson Slash ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.35, range = 6.5, damage = 32 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / Aurora Burst ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "burst", duration = 0.55, interval = 0.25, range = 9, damage = 14 },
			},
		},
	},
