local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — fire rush + inferno trail ]]
		BlazeOverdrive = {
			id = "BlazeOverdrive",
			name = "Blaze Overdrive",
			mode = "blaze",
			duration = 1.4,
			rushSpeed = 82,
			damage = 36,
			...
			phases = {
				...
				{ id = "inferno", duration = 0.82, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		--[[ Frost Veil — ice fortress + frost pulses ]]
		FrostBastion = {
			id = "FrostBastion",
			name = "Frost Bastion",
			mode = "fortress",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.8, interval = 0.35, range = 8.5, damage = 12 },
			},
		},
	},
