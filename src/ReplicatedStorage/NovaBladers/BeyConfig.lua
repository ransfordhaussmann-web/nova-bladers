local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "cyclone", duration = 0.75, interval = 0.22, range = 5, damage = 10, hits = 3 },
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "erupt", duration = 0.6, range = 9, damage = 32 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "flurry", duration = 0.65, interval = 0.13, damage = 9, hits = 4 },
				{ id = "vanish", duration = 0.55, range = 6, damage = 30 },
			},
		},
	},
