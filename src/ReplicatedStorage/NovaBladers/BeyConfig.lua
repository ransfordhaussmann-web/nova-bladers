	...
	SPECIAL_MOVES = {
		...
		EmberCyclone = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.22, hitRadius = 5, damage = 10, rushSpeed = 82 },
				{ id = "inferno", duration = 0.4, range = 7.5, damage = 34 },
			},
		},
		--[[ Frost Veil — ice barrier and shatter wave ]]
		GlacierShroud = {
			id = "GlacierShroud",
			name = "Glacier Shroud",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "veil", duration = 0.75, interval = 0.4, range = 6, damage = 8 },
