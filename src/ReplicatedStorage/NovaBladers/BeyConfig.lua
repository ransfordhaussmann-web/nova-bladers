	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.4, range = 5.5, damage = 32 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "shock", duration = 0.9, interval = 0.3, range = 7.5, damage = 12 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "detonate", duration = 0.6, range = 8, damage = 26 },
			},
		},
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "strike", duration = 0.6, range = 6, damage = 34 },
			},
		},
	},
