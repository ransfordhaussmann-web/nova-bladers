local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crystal Vortex — shard burst + vortex orbit ]]
		CrystalShatterStorm = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.7, interval = 0.22, damage = 10, range = 5 },
				{ id = "vortex", duration = 0.65 },
			},
		},
		--[[ Ember Ring — phoenix rise + fire spiral ]]
		EmberPhoenixSpiral = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.24, damage = 9 },
