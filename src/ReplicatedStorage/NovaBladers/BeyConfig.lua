	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, interval = 0.22, baseRange = 4, damage = 10, hits = 4 },
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.0, interval = 0.32, range = 7.5, damage = 11 },
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "drift", duration = 1.1, interval = 0.28, damage = 8 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "edge", duration = 0.3, range = 6, damage = 36 },
			},
		},
	},
