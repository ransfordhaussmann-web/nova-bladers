	...
	SPECIAL_MOVES = {
		...
		CrimsonInfernoRush = {
			...
			phases = {
				...
				{ id = "blaze", duration = 0.8, hitInterval = 0.2, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Crown — Ice Barrage / frost burst ]]
		FrostCrownBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.85, interval = 0.22, damage = 8, hits = 5 },
				{ id = "freeze", duration = 0.5, range = 7, damage = 28 },
			},
		},
	},
