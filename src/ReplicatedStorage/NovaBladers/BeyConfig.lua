	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "feathers", duration = 0.8, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "rise", duration = 0.35, riseSpeed = 22 },
				{ id = "slam", duration = 0.3, slamSpeed = 55 },
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.35, range = 5.5, damage = 36 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "shock", duration = 0.8, interval = 0.35, range = 7.5, damage = 14 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			damage = 38,
			spinLoss = 14,
			color = Color3.fromRGB(130, 140, 220),
			phases = {
				{ id = "vanish", duration = 0.2 },
				{ id = "blink", duration = 0.25 },
				{ id = "slash", duration = 0.4, range = 6, damage = 34 },
			},
		},
	},
