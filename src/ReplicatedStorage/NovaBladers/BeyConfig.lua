	...
	SPECIAL_MOVES = {
		...
		BlazeSpiralDrive = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.22, damage = 10, rushSpeed = 82 },
				{ id = "impact", duration = 0.3, range = 7, damage = 34 },
			},
		},
		--[[ Frost Core — ice armor + shard pulses ]]
		GlacierAegis = {
			id = "GlacierAegis",
			name = "Glacier Aegis",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "slam", duration = 0.4, range = 8, damage = 30 },
			},
		},
	},
