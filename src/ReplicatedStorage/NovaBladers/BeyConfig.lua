local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Coil — spiral fire rush + flare burst ]]
		BlazeCoilSpiral = {
			id = "BlazeCoilSpiral",
			name = "Blaze Coil Spiral",
			mode = "blaze",
			duration = 1.4,
			rushSpeed = 82,
			damage = 38,
			...
			phases = {
				...
				{ id = "spiral", duration = 0.95, hitInterval = 0.15, hitRadius = 5, damage = 10, hits = 5 },
				{ id = "flare", duration = 0.3, range = 7, damage = 28 },
			},
		},
		--[[ Glacier Mantle — ice barrier + frost shatter waves ]]
		GlacierMantleFreeze = {
			id = "GlacierMantleFreeze",
			name = "Glacier Mantle Freeze",
			mode = "glacier",
			duration = 1.9,
			damage = 28,
			spinLoss = 6,
			...
			phases = {
				...
				{ id = "shatter", duration = 0.75, interval = 0.3, range = 9, damage = 12 },
			},
		},
	},
