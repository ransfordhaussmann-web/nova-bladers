	...
	SPECIAL_MOVES = {
		...
		CrimsonSolarFlare = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.82, hitInterval = 0.16, hitRadius = 5.8, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Anchor — Glacier shield / ice anchor / frost pulse ]]
		FrostGlacierLock = {
			id = "FrostGlacierLock",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.34, range = 8.5, damage = 12 },
			},
		},
	},
