	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.85, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "pull", duration = 0.55, interval = 0.15, pullRadius = 10 },
				{ id = "anchor", duration = 0.35 },
				{ id = "crash", duration = 0.5, range = 9, damage = 28 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "rend", duration = 0.35, range = 7, damage = 32 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
