	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.35, rushSpeed = 98 },
				{ id = "rip", duration = 0.4, rushSpeed = 88, hitInterval = 0.13, hitRadius = 4.5, damage = 12, hits = 3 },
				{ id = "finish", duration = 0.3, range = 5.5, damage = 24 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "bastion", duration = 0.85 },
				{ id = "quake", duration = 0.85, interval = 0.32, range = 9, damage = 15 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "orbit", duration = 0.95 },
				{ id = "burst", duration = 0.55, range = 7.5, damage = 30 },
			},
		},
		PhantomBladeMirage = {
			...
			damage = 40,
			spinLoss = 14,
			color = Color3.fromRGB(185, 205, 235),
			phases = {
				{ id = "split", duration = 0.22 },
				{ id = "feint", duration = 0.35, rushSpeed = 78 },
				{ id = "strike", duration = 0.38, rushSpeed = 105, range = 5.5, damage = 36 },
			},
		},
	},
