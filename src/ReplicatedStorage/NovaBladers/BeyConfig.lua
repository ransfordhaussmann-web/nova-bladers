	...
	SPECIAL_MOVES = {
		...
		CrimsonInfernoRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.75, rushSpeed = 82, turnRate = 9 },
				{ id = "flare", duration = 0.45, range = 7, damage = 42 },
			},
		},
		...
		FrostCrownBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.9, interval = 0.22, damage = 10, hits = 4 },
				{ id = "shatter", duration = 0.5, range = 8, damage = 35 },
			},
		},
	},
