local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — fiery corkscrew rush ]]
		BlazeCorkscrew = {
			id = "BlazeCorkscrew",
			...
			phases = {
				...
				{ id = "corkscrew", duration = 0.75, rushSpeed = 85, hitInterval = 0.22, hitRadius = 4.5, damage = 10 },
				{ id = "erupt", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Frost Orbit — ice barrier and freeze pulses ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
