	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.5, range = 5.5, damage = 22, hitInterval = 0.22 },
			},
		},
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.55, rushSpeed = 75, dashes = 3 },
				{ id = "strike", duration = 0.45, range = 6, damage = 36 },
			},
		},
	},
