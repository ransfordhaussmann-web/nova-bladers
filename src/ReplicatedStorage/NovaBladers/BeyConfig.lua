	...
	SPECIAL_MOVES = {
		...
		CrimsonSlashBurst = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.65, hitInterval = 0.12, hitRadius = 4.5, damage = 10, hits = 5 },
		...
		--[[ Solar Flare — nova rings + spiral orbit ]]
		SolarNovaSpiral = {
			id = "SolarNovaSpiral",
			...
			phases = {
				...
				{ id = "nova", duration = 0.7, interval = 0.25, damage = 8 },
				{ id = "spiral", duration = 0.8 },
			},
		},
	},
