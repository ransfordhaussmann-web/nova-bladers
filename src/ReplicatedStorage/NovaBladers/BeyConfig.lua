local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Starfall Edge — comet rush with impact waves ]]
		StarfallRush = {
			id = "StarfallRush",
			name = "Starfall Rush",
			mode = "meteor",
			...
			phases = {
				...
				{ id = "shower", duration = 0.75, hitInterval = 0.2, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Stone Halo — earth fortress and quake pulses ]]
		StoneHaloGuard = {
			id = "StoneHaloGuard",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.9, interval = 0.35, range = 9, damage = 14 },
			},
		},
		--[[ Thunder Coil — lightning spiral and chain orbit ]]
		ThunderLoop = {
			id = "ThunderLoop",
			name = "Thunder Loop",
			mode = "sonic",
		...
		--[[ Night Maw — shadow dive and fang burst ]]
		NightFang = {
			id = "NightFang",
			name = "Night Fang",
			mode = "eclipse",
