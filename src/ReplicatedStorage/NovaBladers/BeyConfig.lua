local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ignite / Flame Rush / Ember Trail ]]
		CrimsonInfernoFang = {
			...
			phases = {
				...
				{ id = "ember", duration = 0.75, hitInterval = 0.2, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Frost Crown — Frost Aura / Ice Bastion / Shatter Pulse ]]
		FrostCrownBastion = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.9, interval = 0.35, range = 8.5, damage = 14 },
			},
		},
	},
