	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.65, hitInterval = 0.15, hitRadius = 4.5, damage = 10, hits = 4 },
			},
		},
		...
		SolarFlareOrbit = {
			...
			phases = {
				...
				{ id = "orbit", duration = 1.0, interval = 0.25, damage = 8 },
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.45, rushSpeed = 80 },
				{ id = "converge", duration = 0.6, range = 6, damage = 36 },
			},
		},
	},
