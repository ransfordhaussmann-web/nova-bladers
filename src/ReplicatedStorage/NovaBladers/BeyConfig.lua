local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Comet — Starfall comet dash + stellar burst ]]
		StarfallRush = {
			id = "StarfallRush",
			name = "Starfall Rush",
			mode = "comet",
			...
			phases = {
				...
				{ id = "comet", duration = 0.55, rushSpeed = 85, trailInterval = 0.12, trailDamage = 8 },
				{ id = "starburst", duration = 0.4, range = 7, damage = 32 },
			},
		},
		--[[ Crystal Guard — Glacier wall + frost shards ]]
		GlacierVault = {
			id = "GlacierVault",
			name = "Glacier Vault",
			mode = "glacier",
