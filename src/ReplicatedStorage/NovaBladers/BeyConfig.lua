	...
	SPECIAL_MOVES = {
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "lacerate", duration = 0.55, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 3 },
			},
		},
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "pillars", duration = 0.65 },
				{ id = "quake", duration = 0.9, interval = 0.38, range = 9, damage = 14 },
			},
		},
		--[[ Solar Drift — solar orbit flare ]]
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "burst", duration = 0.7, interval = 0.3, damage = 11 },
			},
		},
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, rushSpeed = 98 },
				{ id = "afterimage", duration = 0.35, range = 7, damage = 32 },
			},
		},
	},
