local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rending rush + slash combo ]]
		CrimsonRendStorm = {
			id = "CrimsonRendStorm",
			...
			phases = {
				...
				{ id = "rend", duration = 0.55, hitInterval = 0.15, hitRadius = 5, damage = 14, hits = 3 },
			},
		},
		--[[ Frost Ring — ice halo spirals + shatter burst ]]
		FrostHaloSpiral = {
			id = "FrostHaloSpiral",
			name = "Frost Halo Spiral",
			mode = "frost",
			duration = 1.6,
			damage = 28,
			spinLoss = 10,
			...
			phases = {
				...
				{ id = "spiral", duration = 0.9, interval = 0.3, range = 7, damage = 10 },
				{ id = "shatter", duration = 0.3, range = 8, damage = 22 },
			},
		},
	},
