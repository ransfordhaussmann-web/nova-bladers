	...
	SPECIAL_MOVES = {
		...
		FangSpiralRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, interval = 0.22, damage = 10, hitRadius = 4.2 },
				{ id = "rend", duration = 0.45, rushSpeed = 95, range = 7, damage = 34 },
			},
		},
		--[[ Frost Coil — glacial lock + ice burst ]]
		GlacierCoilLock = {
			id = "GlacierCoilLock",
			...
			phases = {
				...
				{ id = "lock", duration = 0.7, damageReduction = 0.6 },
