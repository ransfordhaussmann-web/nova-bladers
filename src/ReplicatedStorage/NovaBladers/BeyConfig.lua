local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Orbit — ignite, fiery orbit, comet slam ]]
		BlazeCometLoop = {
			id = "BlazeCometLoop",
			...
			phases = {
				...
				{ id = "slam", duration = 0.45, rushSpeed = 88, range = 7, damage = 40 },
			},
		},
		--[[ Frost Crown — crown shield, ice shards, frost snap ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
			...
			phases = {
				...
				{ id = "snap", duration = 0.4, range = 8, damage = 32 },
			},
		},
	},
