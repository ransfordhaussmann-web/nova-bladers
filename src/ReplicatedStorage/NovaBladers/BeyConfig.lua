	...
	SPECIAL_MOVES = {
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "slash1", duration = 0.3, rushSpeed = 85, damage = 14, range = 5 },
				{ id = "slash2", duration = 0.3, rushSpeed = 80, damage = 14, range = 5 },
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "spike", duration = 0.6, interval = 0.3, range = 7, damage = 11 },
				{ id = "fortress", duration = 0.9, interval = 0.45, range = 9, damage = 15 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				{ id = "vanish", duration = 0.25, blinkRange = 14 },
				{ id = "slash", duration = 0.35, rushSpeed = 95, damage = 22, range = 6 },
				{ id = "afterimage", duration = 0.4, range = 7, damage = 32 },
			},
		},
	},
