local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — rapid fang slashes and rush combo ]]
		FangRendBarrage = {
			id = "FangRendBarrage",
		...
		--[[ Glacier Spin — frost aura, ice spiral rings, shatter burst ]]
		GlacierSpiral = {
			id = "GlacierSpiral",
			name = "Glacier Spiral",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "spiral", duration = 1.0, interval = 0.3, range = 5, damage = 9 },
