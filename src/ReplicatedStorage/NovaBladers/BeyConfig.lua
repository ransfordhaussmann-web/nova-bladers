	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.65, hitInterval = 0.14, hitRadius = 4.5, damage = 12, hits = 4 },
			},
		},
		--[[ Aurora Crest — Crystal barrier dome ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "frost", duration = 0.8, interval = 0.3, range = 7, damage = 11 },
			},
		},
	},
