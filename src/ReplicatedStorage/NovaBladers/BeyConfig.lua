	...
	SPECIAL_MOVES = {
		...
		CrimsonRend = {
			...
			phases = {
				...
				{ id = "rend", duration = 0.68, hitInterval = 0.17, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		SolarFlareLoop = {
			...
			phases = {
				...
				{ id = "loop", duration = 0.85, interval = 0.26, damage = 8 },
				{ id = "flare", duration = 0.65, range = 7.5, damage = 32 },
			},
		},
		PhantomPhaseSlash = {
