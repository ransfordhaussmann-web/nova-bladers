	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "flurry", duration = 0.9, interval = 0.15, hitRadius = 4.5, damage = 8 },
				{ id = "blaze_dash", duration = 0.35, rushSpeed = 85 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "wave", duration = 0.7, interval = 0.3, range = 7, damage = 10 },
				{ id = "crash", duration = 0.4, rushSpeed = 55 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				{ id = "hunt", duration = 0.25 },
				{ id = "rend", duration = 0.5, rushSpeed = 88 },
				{ id = "blood_mist", duration = 0.45, range = 5.5, damage = 14 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				{ id = "rampart", duration = 0.5 },
				{ id = "quake", duration = 0.75, interval = 0.35, range = 7.5, damage = 11 },
				{ id = "roll", duration = 0.4, rushSpeed = 45 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "flare_loop", duration = 0.8, interval = 0.22, damage = 8 },
				{ id = "nova", duration = 0.35, range = 8, damage = 22 },
			},
		},
		PhantomPhaseSlash = {
			...
			damage = 44,
			spinLoss = 18,
			color = Color3.fromRGB(190, 195, 230),
			phases = {
