local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Comet — fire comet rush + ember trail ]]
		CometStreak = {
			id = "CometStreak",
			name = "Comet Streak",
			mode = "meteor",
			...
			phases = {
				...
				{ id = "launch", duration = 0.3, rushSpeed = 90 },
				{ id = "shower", duration = 0.7, hitInterval = 0.15, hitRadius = 5.2, damage = 10, hits = 5 },
			},
		},
		--[[ Frost Prism — ice crystal fortress ]]
		CrystalBastion = {
			id = "CrystalBastion",
