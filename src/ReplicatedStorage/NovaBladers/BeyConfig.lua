local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — fiery vortex rush with multi-hit spiral ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.9, hitInterval = 0.15, hitRadius = 5.0, damage = 10, hits = 5 },
			},
		},
		--[[ Glacier Mantle — ice burrow, frost wall, chilling pulses ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
