	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.85, hitInterval = 0.17, hitRadius = 5, damage = 10, hits = 5 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				...
				{ id = "slam", duration = 0.25, slamSpeed = 55 },
				{ id = "wave", duration = 1.0, interval = 0.32, range = 9, damage = 12 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "slash", duration = 0.75, hitInterval = 0.15, hitRadius = 4.5, damage = 12, hits = 4 },
				{ id = "finisher", duration = 0.25, rushSpeed = 95, range = 5, damage = 28 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "quake", duration = 0.9, interval = 0.35, range = 7.5, damage = 11 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "phase", duration = 0.45, rushSpeed = 100 },
