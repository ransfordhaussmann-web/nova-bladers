local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — zigzag ripper lunge ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "zigzag", duration = 0.55, rushSpeed = 88, zigInterval = 0.14, hitRadius = 4.5, damage = 10 },
				{ id = "rip", duration = 0.45, rushSpeed = 95, hitRadius = 6, damage = 28 },
			},
		},
		--[[ Aurora Crest — protective dome + pulse ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "pulse", duration = 0.7, interval = 0.3, range = 9, damage = 14 },
			},
		},
	},
