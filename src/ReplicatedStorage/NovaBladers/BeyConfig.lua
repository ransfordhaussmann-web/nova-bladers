local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Lance Rush / Fang Barrage ]]
		CrimsonLanceSurge = {
			id = "CrimsonLanceSurge",
			name = "Crimson Lance Surge",
			mode = "meteor",
			duration = 1.2,
			rushSpeed = 85,
			damage = 38,
			...
			phases = {
				...
				{ id = "shower", duration = 0.7, hitInterval = 0.16, hitRadius = 5, damage = 13, hits = 3 },
			},
		},
		--[[ Frost Coil — Ice Fortress / Glacier Pulse ]]
		GlacierCoilLock = {
			id = "GlacierCoilLock",
