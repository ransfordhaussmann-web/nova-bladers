local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Orbit — solar flare rings + rush ]]
		CrimsonSolarFlare = {
			...
			phases = {
				{ id = "charge", duration = 0.35 },
				{ id = "flare", duration = 0.75, interval = 0.25, range = 5.5, damage = 10 },
				{ id = "rush", duration = 0.5, rushSpeed = 84 },
			},
		},
		--[[ Frost Anchor — freeze wall + glacier shatter ]]
		FrostGlacierLock = {
			id = "FrostGlacierLock",
