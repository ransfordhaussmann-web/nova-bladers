local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Quill — fiery feather rush ]]
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.16, hitRadius = 5.2, damage = 10, hits = 4 },
			},
		},
		...
		TideAnchorCrash = {
			...
			phases = {
				...
				{ id = "slam", duration = 0.3, slamDamage = 22 },
				{ id = "wave", duration = 0.95, interval = 0.3, range = 9, damage = 12 },
			},
		},
		--[[ Crimson Fang — triple dash slashes ]]
		CrimsonRend = {
			id = "CrimsonRend",
			name = "Crimson Rend",
			mode = "rend",
			...
			phases = {
				{ id = "dash1", duration = 0.28, rushSpeed = 88, damage = 12 },
				{ id = "dash2", duration = 0.28, rushSpeed = 88, damage = 12 },
				{ id = "finisher", duration = 0.35, rushSpeed = 95, range = 5.5, damage = 28 },
			},
		},
		...
		GraniteRampart = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.75, interval = 0.28, range = 7.5, damage = 14 },
			},
		},
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.45, rushSpeed = 100 },
				{ id = "reappear", duration = 0.3, range = 6, damage = 36 },
			},
		},
	},
