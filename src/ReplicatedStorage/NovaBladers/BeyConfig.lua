local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Flame barrage / inferno finisher ]]
		CrimsonFlameBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.92, interval = 0.14, hitRadius = 4.5, damage = 10, shots = 5 },
				{ id = "inferno", duration = 0.35, range = 7, damage = 28 },
			},
		},
		...
		FrostCrownLock = {
			...
			phases = {
				...
				{ id = "lock", duration = 0.75 },
				{ id = "shatter", duration = 0.65, interval = 0.3, range = 7.5, damage = 14 },
			},
		},
	},
