	...
	SPECIAL_MOVES = {
		...
		BlazeCorkscrew = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.75, hitInterval = 0.15, hitRadius = 4.5, damage = 10, spiralRadius = 5 },
				{ id = "finale", duration = 0.35, range = 7, damage = 28 },
			},
		},
		--[[ Frost Orbit — ice aura slow + frost burst ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "lock", duration = 0.85, slowMult = 0.45, range = 9 },
