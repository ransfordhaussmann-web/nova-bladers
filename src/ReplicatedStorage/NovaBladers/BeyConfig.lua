local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Quill — fiery feather spiral ]]
		BlazeFeatherStorm = {
			...
			phases = {
				...
				{ id = "storm", duration = 0.67, hitInterval = 0.16, hitRadius = 5, damage = 10, hits = 4 },
			},
		},
		--[[ Tide Anchor — tidal pull and anchor slam ]]
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "pull", duration = 0.5, pullRadius = 14, pullStrength = 22 },
				{ id = "sink", duration = 0.35 },
				{ id = "crash", duration = 0.45, range = 9, damage = 28 },
				{ id = "wave", duration = 0.4, interval = 0.3, range = 10, damage = 12 },
			},
		},
		--[[ Crimson Fang — rending dash slashes ]]
		CrimsonRend = {
			id = "CrimsonRend",
			name = "Crimson Rend",
			mode = "rend",
			...
			phases = {
				...
				{ id = "rend", duration = 0.55, hitInterval = 0.14, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		--[[ Granite Fort — stone rampart and quake pulses ]]
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "quake", duration = 0.55, interval = 0.28, range = 7.5, damage = 11 },
				{ id = "shatter", duration = 0.6, range = 8, damage = 22 },
			},
		},
		--[[ Solar Drift — solar flare rings and orbit ]]
		SolarFlareLoop = {
			id = "SolarFlareLoop",
		...
		--[[ Phantom Edge — phase blink and ghost slash ]]
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "blink", duration = 0.18 },
				{ id = "slash", duration = 0.35, rushSpeed = 88 },
				{ id = "burst", duration = 0.3, range = 6, damage = 34 },
			},
		},
	},
