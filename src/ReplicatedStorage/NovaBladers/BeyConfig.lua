local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — spiral pull + rush finisher ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "vortex", duration = 0.62, interval = 0.2, pullRadius = 9, pullStrength = 38, damage = 8 },
				{ id = "rush", duration = 0.5, rushSpeed = 85 },
			},
		},
		--[[ Glacier Mantle — frost aura, ice shield, shatter pulses ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
			...
			phases = {
				...
				{ id = "shatter", duration = 0.8, interval = 0.35, range = 7.5, damage = 12 },
			},
		},
	},
