local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRendingArc = {
			...
			phases = {
				{ id = "prep", duration = 0.25 },
				{ id = "sweep", duration = 0.55, hitInterval = 0.12, hitRadius = 6, damage = 12, hits = 3 },
				{ id = "finisher", duration = 0.3, range = 7, damage = 22 },
			},
		},
		--[[ Frost Ring — ice barrier and shatter pulse ]]
		GlacialFrostBarrier = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.7, interval = 0.35, range = 9, damage = 14 },
			},
		},
	},
