	...
	SPECIAL_MOVES = {
		...
		CrimsonCrossSlash = {
			...
			phases = {
				...
				{ id = "slash1", duration = 0.35, rushSpeed = 82, damage = 14, hitRadius = 5 },
				{ id = "slash2", duration = 0.35, rushSpeed = 82, damage = 14, hitRadius = 5 },
				{ id = "cross", duration = 0.5, range = 7, damage = 28 },
			},
		},
		--[[ Frost Core — Ice crystal fortress ]]
		FrostCrystalBastion = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.75, range = 9, damage = 22 },
			},
		},
	},
