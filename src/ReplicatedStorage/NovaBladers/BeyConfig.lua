	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.65, hitInterval = 0.14, hitRadius = 5, damage = 10, hits = 5 },
				{ id = "rush", duration = 0.5, rushSpeed = 88 },
			},
		},
		--[[ Granite Fort — stone bastion + seismic pulses ]]
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "seismic", duration = 0.8, interval = 0.3, range = 9, damage = 14 },
			},
		},
		...
		SolarFlareDrift = {
			...
			phases = {
				...
				{ id = "drift", duration = 0.75, interval = 0.25, damage = 8 },
				{ id = "flare", duration = 0.6, range = 7, damage = 32 },
			},
		},
		--[[ Phantom Edge — phase dash + afterimage surge ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.45, rushSpeed = 95, hitInterval = 0.12, damage = 12 },
				{ id = "echo", duration = 0.35, range = 5.5, damage = 28 },
			},
		},
	},
