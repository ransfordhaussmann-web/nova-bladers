local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — flame rush + eruption ]]
		CrimsonInfernoRoar = {
			...
			phases = {
				...
				{ id = "blaze", duration = 0.55, rushSpeed = 85 },
				{ id = "eruption", duration = 0.55, range = 7, damage = 22 },
			},
		},
		--[[ Frost Crown — ice shards + shatter wave ]]
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shards", duration = 0.75, interval = 0.3, damage = 10 },
