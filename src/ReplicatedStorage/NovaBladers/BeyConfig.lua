local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — blood rush + fang combo ]]
		CrimsonFangRush = {
			id = "CrimsonFangRush",
			...
			phases = {
				...
				{ id = "fang", duration = 0.9, hitInterval = 0.2, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Crown — ice shield + crystal shatter ]]
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.6, interval = 0.25, range = 7, damage = 10 },
