local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		CrimsonRiposte = {
			...
			phases = {
				{ id = "brace", duration = 0.28 },
				{ id = "riposte", duration = 0.35, rushSpeed = 88 },
				{ id = "fang", duration = 0.62, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
		...
		PhantomVeilSlash = {
			...
			damage = 40,
			spinLoss = 17,
			color = Color3.fromRGB(160, 180, 220),
			phases = {
				{ id = "vanish", duration = 0.28 },
				{ id = "slash", duration = 0.42, rushSpeed = 98 },
				{ id = "after", duration = 0.35, range = 7, damage = 36 },
			},
		},
		CrystalShardStorm = {
			...
			phases = {
				...
				{ id = "launch", duration = 0.28, rushSpeed = 75 },
				{ id = "shower", duration = 0.85, hitInterval = 0.16, hitRadius = 5.2, damage = 10, hits = 5 },
			},
		},
		BlazeCrownBurst = {
			id = "BlazeCrownBurst",
			...
			phases = {
				{ id = "crown", duration = 0.32 },
				{ id = "burst", duration = 0.55, interval = 0.22, damage = 10 },
				{ id = "flare", duration = 0.38, range = 8, damage = 42 },
			},
		},
	},
