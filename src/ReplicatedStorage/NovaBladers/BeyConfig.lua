local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Blaze — fire spiral rush + eruption ]]
		CrimsonInfernoSpin = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.65, rushSpeed = 82, hitInterval = 0.22, hitRadius = 5, damage = 10 },
				{ id = "eruption", duration = 0.45, range = 7, damage = 30 },
			},
		},
		--[[ Frost Crown — ice barrier + shatter wave ]]
		FrostBarrierCrown = {
