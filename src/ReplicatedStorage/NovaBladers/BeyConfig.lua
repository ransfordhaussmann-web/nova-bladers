	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.55, rushSpeed = 95, hitInterval = 0.12, damage = 8, hits = 3 },
				{ id = "ripper", duration = 0.45, range = 7, damage = 28 },
			},
		},
		--[[ Granite Fort — Bastion / ground slam / stone spikes ]]
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "slam", duration = 0.45, range = 9, damage = 18 },
				{ id = "spikes", duration = 0.95, interval = 0.3, range = 7, damage = 12 },
			},
		},
		--[[ Solar Drift — Flare rings / burn orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		--[[ Phantom Edge — Mirage clones / blink strike ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "blink", duration = 0.45, rushSpeed = 88 },
				{ id = "mirage", duration = 0.5, range = 6.5, damage = 35 },
			},
		},
	},
