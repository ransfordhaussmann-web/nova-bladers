local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Coil / Ripper Lunge / Slash combo ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.45, hitInterval = 0.12, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Frost dome / shield / shatter burst ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "shield", duration = 0.8, damageReduction = 0.65 },
