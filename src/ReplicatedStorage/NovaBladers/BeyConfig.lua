local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Vortex — tightening spiral rush + slam ]]
		CrimsonVortexRush = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.85, orbitRadius = 5, orbitSpeed = 22, hitInterval = 0.2, damage = 10 },
				{ id = "slam", duration = 0.35, range = 7, damage = 32 },
			},
		},
		--[[ Glacier Mantle — slow field, freeze, ice shatter ]]
		GlacierFrostLock = {
			id = "GlacierFrostLock",
			...
			phases = {
				{ id = "frostfield", duration = 0.55, range = 9, slowMult = 0.45, slowDuration = 1.2 },
				{ id = "lock", duration = 0.6, range = 6, freezeDuration = 0.45 },
				{ id = "shatter", duration = 0.5, range = 8, damage = 24 },
			},
		},
	},
