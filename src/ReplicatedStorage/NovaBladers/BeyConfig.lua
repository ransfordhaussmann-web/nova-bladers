	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rush", duration = 0.45, rushSpeed = 96 },
				{ id = "rip", duration = 0.4, range = 7, damage = 42 },
			},
		},
		GraniteBastion = {
			id = "GraniteBastion",
			...
			phases = {
				...
				{ id = "tremor", duration = 0.85, interval = 0.35, range = 9, damage = 14 },
			},
		},
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
		...
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "strike", duration = 0.45, rushSpeed = 88, range = 6.5, damage = 38 },
			},
		},
	},
