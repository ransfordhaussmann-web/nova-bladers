local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Crown — ice field + crown shield + shard burst ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
			...
			phases = {
				{ id = "frostfield", duration = 0.4, slowRadius = 10, slowMult = 0.45 },
				{ id = "crown", duration = 0.55 },
				{ id = "shatter", duration = 0.75, interval = 0.3, range = 7.5, damage = 12 },
			},
		},
		--[[ Crimson Forge — forge charge + fire rush + lava burst ]]
		ForgeEruption = {
			id = "ForgeEruption",
			name = "Forge Eruption",
			mode = "forge",
			...
			phases = {
				{ id = "forge", duration = 0.3 },
				{ id = "rush", duration = 0.45, rushSpeed = 80 },
				{ id = "eruption", duration = 0.65, hitInterval = 0.2, hitRadius = 5.5, damage = 14, hits = 3 },
			},
		},
	},
