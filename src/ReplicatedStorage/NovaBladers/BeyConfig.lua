	...
	SPECIAL_MOVES = {
		...
		CrimsonFangRush = {
			...
			phases = {
				...
				{ id = "fangs", duration = 0.9, hitInterval = 0.15, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		--[[ Frost Halo — ice crown shield + shatter burst ]]
		FrostHaloCrown = {
			id = "FrostHaloCrown",
			...
			phases = {
				...
				{ id = "crown", duration = 0.75, interval = 0.3, range = 7, damage = 10 },
