	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.9, interval = 0.22, baseRange = 4, rangeGrowth = 1.2, damage = 10 },
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.0, interval = 0.35, range = 7, damage = 12 },
				{ id = "shock", duration = 0.4, range = 10, damage = 22 },
			},
		},
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 1.0, rushSpeed = 68, trailInterval = 0.12 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				{ id = "phantom", duration = 0.3 },
				{ id = "surge", duration = 0.65, dashes = 3, dashSpeed = 88, dashInterval = 0.2, damage = 14 },
				{ id = "edge", duration = 0.35, range = 5.5, damage = 28 },
			},
		},
	},
