local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — lunge slash combo ]]
		CrimsonFangRend = {
			id = "CrimsonFangRend",
			...
			phases = {
				...
				{ id = "rend", duration = 0.65, hitInterval = 0.14, hitRadius = 4.5, damage = 12, hits = 5 },
			},
		},
		...
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "shatter", duration = 0.65, interval = 0.3, range = 9, damage = 16 },
			},
		},
	},
