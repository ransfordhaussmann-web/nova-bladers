	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "ripper", duration = 0.68, interval = 0.22, hitRadius = 5, damage = 14, slashes = 3 },
			},
		},
		--[[ Aurora Crest — Frost dome / barrier burst ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "shield", duration = 0.75, interval = 0.38, range = 7, damage = 10 },
