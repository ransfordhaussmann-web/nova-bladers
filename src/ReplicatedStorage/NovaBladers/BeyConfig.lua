local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — triple fang rush + ripper finisher ]]
		CrimsonRipperSlash = {
			...
			phases = {
				...
				{ id = "slash", duration = 0.55, hitInterval = 0.18, hitRadius = 5, damage = 12, hits = 3 },
				{ id = "finisher", duration = 0.3, range = 7, damage = 36 },
			},
		},
