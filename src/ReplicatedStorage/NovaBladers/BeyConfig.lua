	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 1.0, interval = 0.2, hitRadius = 6, damage = 10, hits = 5 },
				{ id = "finale", duration = 0.35, range = 7, damage = 28 },
			},
		},
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "pulse", duration = 1.2, interval = 0.35, range = 9, damage = 12 },
				{ id = "collapse", duration = 0.3, range = 10, damage = 22 },
			},
		},
		--[[ Solar Drift — fire trail drift + flare burst ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "drift", duration = 1.2, interval = 0.25, trailDamage = 8, hitRadius = 4.5 },
				{ id = "flare", duration = 0.3, range = 7, damage = 26 },
			},
		},
		--[[ Phantom Edge — vanish, multi-dash, reappear burst ]]
		PhantomEdgeSurge = {
			id = "PhantomEdgeSurge",
			...
			phases = {
				...
				{ id = "surge", duration = 0.9, dashes = 3, dashInterval = 0.28, damage = 14, hitRadius = 4 },
				{ id = "reappear", duration = 0.3, range = 6, damage = 32 },
			},
		},
	},
