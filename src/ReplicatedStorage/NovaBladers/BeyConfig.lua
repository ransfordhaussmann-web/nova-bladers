local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / Blood Rush ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "lunge", duration = 0.45, rushSpeed = 95 },
				{ id = "rip", duration = 0.55, hitInterval = 0.14, hitRadius = 4.5, damage = 12, hits = 3 },
			},
		},
		...
		GraniteBastion = {
			...
			phases = {
				...
				{ id = "reflect", duration = 0.7 },
				{ id = "quake", duration = 0.8, interval = 0.35, range = 9, damage = 14 },
			},
		},
		--[[ Solar Drift — Solar Flare / Burning Orbit ]]
		SolarFlareOrbit = {
			id = "SolarFlareOrbit",
			...
			phases = {
				...
				{ id = "drift", duration = 0.8 },
			},
		},
		--[[ Phantom Edge — Blade Mirage / Ghost Dash ]]
		PhantomBladeMirage = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.5, rushSpeed = 88, zigzags = 3 },
				{ id = "vanish", duration = 0.35, range = 7, damage = 32 },
			},
		},
	},
