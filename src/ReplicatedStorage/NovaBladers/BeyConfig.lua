local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — fiery meteor rush ]]
		FangInfernoBurst = {
			id = "FangInfernoBurst",
			...
			phases = {
				...
				{ id = "shower", duration = 0.8, hitInterval = 0.15, hitRadius = 5.8, damage = 12, hits = 5 },
			},
		},
		...
		--[[ Blaze Quill — rapid feather barrage ]]
		BlazeQuillBarrage = {
			...
			phases = {
				...
				{ id = "shower", duration = 0.9, hitInterval = 0.12, hitRadius = 5.2, damage = 10, hits = 6 },
			},
		},
		--[[ Tide Anchor — tidal fortress ]]
		TideAnchorSurge = {
			id = "TideAnchorSurge",
			...
			phases = {
				...
				{ id = "pulse", duration = 0.85, interval = 0.28, range = 9, damage = 12 },
			},
		},
	},
