local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — heat charge / hammer rush / shatter burst ]]
		CrimsonForgeBreak = {
			...
			phases = {
				...
				{ id = "hammer", duration = 0.45, rushSpeed = 85 },
				{ id = "shatter", duration = 0.5, range = 7, damage = 36 },
			},
		},
		--[[ Frost Crown — frost aura / ice crown / frostbite pulse ]]
		FrostCrownLock = {
			id = "FrostCrownLock",
			...
			phases = {
				...
				{ id = "frostbite", duration = 0.9, interval = 0.3, range = 7.5, damage = 12 },
			},
		},
	},
