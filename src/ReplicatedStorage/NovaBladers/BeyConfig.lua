local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		BlazeFeatherStorm = {
			...
			phases = {
				{ id = "windup", duration = 0.3 },
				{ id = "spiral", duration = 1.0, hitInterval = 0.2, hitRadius = 5, damage = 10, hits = 4 },
				{ id = "burst", duration = 0.2, range = 6, damage = 18 },
			},
		},
		TideAnchorCrash = {
			id = "TideAnchorCrash",
			...
			phases = {
				{ id = "rise", duration = 0.35, riseSpeed = 38 },
				{ id = "hang", duration = 0.25 },
				{ id = "slam", duration = 0.35, slamSpeed = 65 },
				{ id = "wave", duration = 0.45, range = 9, damage = 22 },
			},
		},
		CrimsonRend = {
			id = "CrimsonRend",
			...
			phases = {
				...
				{ id = "rend", duration = 0.45, interval = 0.15, damage = 12, range = 4 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				{ id = "roots", duration = 0.4 },
				{ id = "wall", duration = 0.6 },
				{ id = "shatter", duration = 0.9, interval = 0.3, range = 7, damage = 11 },
			},
		},
		SolarFlareLoop = {
			id = "SolarFlareLoop",
			...
			phases = {
				...
				{ id = "loop", duration = 1.0, interval = 0.25, damage = 8 },
		...
		PhantomPhaseSlash = {
			...
			phases = {
				...
				{ id = "dash", duration = 0.4, rushSpeed = 95 },
				{ id = "slash", duration = 0.35, range = 6, damage = 42 },
				{ id = "fade", duration = 0.15 },
			},
		},
	},
