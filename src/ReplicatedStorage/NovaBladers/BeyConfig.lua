local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — aggressive fang slash rush ]]
		CrimsonFangRush = {
			id = "CrimsonFangRush",
			...
			phases = {
				...
				{ id = "fangs", duration = 0.65, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 4 },
			},
		},
		--[[ Frost Halo — ice crown fortress + shatter burst ]]
		FrostHaloCrown = {
			id = "FrostHaloCrown",
