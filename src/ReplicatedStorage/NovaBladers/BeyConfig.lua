local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Frost Crown — ice barrier + shard waves ]]
		GlacierBastion = {
			id = "GlacierBastion",
			...
			phases = {
				...
				{ id = "shards", duration = 0.95, interval = 0.3, range = 8.5, damage = 12 },
			},
		},
		--[[ Ember Fang — fire rush + burn burst ]]
		InfernoClaw = {
			id = "InfernoClaw",
			name = "Inferno Claw",
			mode = "inferno",
			...
			phases = {
				...
				{ id = "claw", duration = 0.45, rushSpeed = 88 },
				{ id = "burn", duration = 0.35, range = 7, damage = 36 },
			},
		},
	},
