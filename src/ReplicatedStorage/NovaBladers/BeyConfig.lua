local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Forge — Molten rush + lava pulses ]]
		CrimsonMoltenSlam = {
			...
			phases = {
				...
				{ id = "eruption", duration = 0.85, interval = 0.3, range = 7, damage = 14 },
			},
		},
		--[[ Frost Prism — Ice shield + shard rings + shatter burst ]]
		PrismIceShatter = {
			id = "PrismIceShatter",
			...
			phases = {
				...
				{ id = "shards", duration = 0.7, interval = 0.25, damage = 8 },
				{ id = "shatter", duration = 0.6, range = 7, damage = 32 },
			},
		},
	},
