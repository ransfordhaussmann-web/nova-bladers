local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — Ember Cyclone / fire orbit burst ]]
		EmberCyclone = {
			id = "EmberCyclone",
			name = "Ember Cyclone",
			mode = "ember",
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.95, interval = 0.22, damage = 10 },
				{ id = "burst", duration = 0.4, range = 7.5, damage = 34 },
			},
		},
		--[[ Frost Veil — Glacier Shroud / ice fortress ]]
		GlacierShroud = {
			id = "GlacierShroud",
			name = "Glacier Shroud",
			mode = "glacier",
