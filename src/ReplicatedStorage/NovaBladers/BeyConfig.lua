local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — flame rush with burning trail ]]
		CrimsonInfernoRush = {
			...
			phases = {
				...
				{ id = "inferno", duration = 0.8, hitInterval = 0.16, hitRadius = 5, damage = 12, hits = 5 },
			},
		},
		--[[ Aurora Mantle — prism barrier and light pulses ]]
		AuroraPrismShield = {
			...
			phases = {
				...
				{ id = "reflect", duration = 0.9, interval = 0.3, range = 9, damage = 14 },
			},
		},
	},
