	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperBarrage = {
			...
			phases = {
				...
				{ id = "barrage", duration = 0.85, hitInterval = 0.15, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		GraniteRampart = {
			id = "GraniteRampart",
			...
			phases = {
				...
				{ id = "counter", duration = 0.95, interval = 0.35, range = 7, damage = 14 },
			},
		},
		SolarCoronaLoop = {
			id = "SolarCoronaLoop",
			...
			phases = {
				...
				{ id = "corona", duration = 0.8, interval = 0.3, damage = 8 },
		...
		FrostCrownShatter = {
			...
			phases = {
				...
				{ id = "crown", duration = 0.5, range = 6, damage = 8 },
				{ id = "shatter", duration = 0.5, range = 8, damage = 30 },
			},
		},
		CrimsonDriftSurge = {
			...
			phases = {
				...
				{ id = "drift", duration = 0.55, rushSpeed = 100 },
				{ id = "impact", duration = 0.35, range = 5.5, damage = 28 },
			},
		},
	},
