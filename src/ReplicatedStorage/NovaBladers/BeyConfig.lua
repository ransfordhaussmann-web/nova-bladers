	...
	SPECIAL_MOVES = {
		...
		CrimsonBladeCyclone = {
			...
			phases = {
				...
				{ id = "cyclone", duration = 0.7, interval = 0.22, range = 5, damage = 10 },
		...
		GraniteBastionPulse = {
			...
			phases = {
				...
				{ id = "quake", duration = 0.95, interval = 0.35, range = 9, damage = 14 },
			},
		},
		--[[ Solar Drift — solar flare + wide orbit drift ]]
		SolarFlareDrift = {
			id = "SolarFlareDrift",
			...
			phases = {
				...
				{ id = "flare", duration = 0.55, range = 7, damage = 22 },
		...
		PhantomEdgeSurge = {
			...
			phases = {
				...
				{ id = "surge", duration = 0.55, dashes = 3, dashSpeed = 88, damage = 12 },
