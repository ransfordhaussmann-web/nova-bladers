	...
	SPECIAL_MOVES = {
		...
		BlazeCorkscrew = {
			...
			phases = {
				...
				{ id = "spiral", duration = 0.55, rushSpeed = 88, spiralRadius = 2.5, spiralSpeed = 14, hitInterval = 0.15, hitRadius = 4.5, damage = 10 },
				{ id = "flare", duration = 0.35, range = 6.5, damage = 32 },
			},
		},
		--[[ Frost Orbit — ice barrier and shatter waves ]]
		GlacierLock = {
			id = "GlacierLock",
			name = "Glacier Lock",
			mode = "glacier",
