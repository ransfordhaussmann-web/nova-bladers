local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Crimson Fang — Ripper Lunge / crimson slash combo ]]
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.7, hitInterval = 0.14, hitRadius = 4.5, damage = 10, hits = 5 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / frost shockwave ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "hold", duration = 0.6, interval = 0.3, range = 7, damage = 10 },
				{ id = "burst", duration = 0.45, range = 9, damage = 22 },
			},
		},
	},
