	...
	SPECIAL_MOVES = {
		...
		CrimsonRipperLunge = {
			...
			phases = {
				...
				{ id = "rip", duration = 0.7, hitInterval = 0.22, hitRadius = 5, damage = 12, hits = 3 },
			},
		},
		--[[ Aurora Crest — Barrier Dome / reflect pulse ]]
		AuroraBarrierDome = {
			...
			phases = {
				...
				{ id = "guard", duration = 0.85, interval = 0.35, range = 7, damage = 10 },
				{ id = "release", duration = 0.5, range = 9, damage = 22 },
			},
		},
	},
