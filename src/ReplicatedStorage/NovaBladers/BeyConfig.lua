local BeyConfig = {
	...
	SPECIAL_MOVES = {
		...
		--[[ Blaze Wheel — fire cyclone / flame burst ]]
		EmberCyclone = {
			id = "EmberCyclone",
			name = "Ember Cyclone",
			mode = "cyclone",
			...
			phases = {
				...
				{ id = "burst", duration = 0.4, rushSpeed = 80, range = 7, damage = 28 },
			},
		},
		--[[ Frost Veil — ice shield / shard pulses / frost mist ]]
		GlacierShroud = {
			id = "GlacierShroud",
			name = "Glacier Shroud",
			mode = "glacier",
			...
			phases = {
				...
				{ id = "shards", duration = 0.8, interval = 0.3, range = 7, damage = 11 },
				{ id = "shroud", duration = 0.65, range = 9, damage = 14, spinLoss = 12 },
			},
		},
	},
