local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Rotierender Klingen-Cyclone mit Finishing-Lunge.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinmauer, Bastion und schwere Schockpulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Flare-Ringe und High-Speed-Drift.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Blink, Edge-Surge und Slash-Burst.",
	},
}
