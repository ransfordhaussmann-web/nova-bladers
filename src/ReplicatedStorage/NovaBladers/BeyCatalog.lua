local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Fang-Lunge und schnelle Rend-Schläge.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
		},
		-- Optional: Toolbox → Creator Store → "spinning top" → meshId einfügen
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Spirale, Frost-Ringe und Shatter-Burst.",
		modelRef = {
