local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Untertauchen, Anker-Schockwelle.",
	...
	},
	{
		...
		stats = { Attack = 9, Defense = 4, Speed = 7, Stamina = 4 },
		special = "Crimson Rend",
		specialId = "CrimsonRend",
		desc = "Attack-Typ: Blutiger Sprint und Zerreiß-Schläge.",
	...
	},
	{
		...
		stats = { Attack = 3, Defense = 10, Speed = 3, Stamina = 8 },
		special = "Granite Rampart",
		specialId = "GraniteRampart",
		desc = "Defense-Typ: Steinschild und Erdbeben-Pulse.",
	...
	},
	{
		...
		accentColor = Color3.fromRGB(255, 250, 150),
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Blink und Geister-Klinge.",
