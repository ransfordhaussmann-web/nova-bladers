local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Dreifach-Lunge mit Ripper-Finisher.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinanker, Bastion und Erdbeben-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 6, Speed = 7, Stamina = 9, SpinDecayMult = 0.62 },
		special = "Solar Flare Orbit",
		specialId = "SolarFlareOrbit",
		desc = "Stamina-Typ: Sonnen-Flares und Orbit-Dash.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Mirage-Klone, Feint und Klingen-Sturm.",
		modelAssets = {
			creatorStoreSearch = "spinning top cyan phantom balance",
		},
	},
}
