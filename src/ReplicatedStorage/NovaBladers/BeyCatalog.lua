local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Klingen-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Festungsmodus mit Schockwellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone, Dash und Vanish-Burst.",
		modelAssets = {
