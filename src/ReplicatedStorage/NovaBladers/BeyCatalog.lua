local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feder-Sturm mit Multi-Hit-Bursts.",
		modelAssets = {
			-- Creator Store: Toolbox → "spinning top" / "bey" → meshId einfügen
			meshId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Wasser-Anker-Slam mit Schockwelle.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		desc = "Attack-Typ: Blut-Rush mit Rend-Burst am Ziel.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(90, 70, 180),
		...
		desc = "Balance-Typ: Phasen-Dash und Hinterhalt-Schnitt.",
		modelAssets = {
			meshId = nil,
			size = Vector3.new(3.5, 1.1, 3.5),
		},
