local BeyCatalog = {
	{
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "bey blade metal", "attack bey" },
		},
	},
	{
		id = "IronShell",
		...
		modelRef = {
			...
			searchTerms = { "defense bey", "spinning top shield", "bey blade metal" },
		},
	},
	{
		id = "VoltDash",
		...
		modelRef = {
			...
			searchTerms = { "stamina bey", "spinning top yellow", "bey blade metal" },
		},
	},
	{
		id = "ShadowBite",
		...
		modelRef = {
			...
			searchTerms = { "balance bey", "dark spinning top", "bey blade metal" },
		},
	},
	{
		id = "CrimsonOrbit",
		...
		desc = "Attack-Typ: Solar-Charge, Flare-Rush und Burn-Ringe.",
		modelRef = {
			studioModelName = "CrimsonOrbit",
			searchTerms = { "red spinning top", "fire bey", "bey blade metal" },
		},
	},
	{
		id = "FrostAnchor",
		...
		desc = "Defense-Typ: Eis-Freeze, Gletscher-Mauer und Scherben-Pulse.",
		modelRef = {
			studioModelName = "FrostAnchor",
			searchTerms = { "ice spinning top", "frost bey", "bey blade metal" },
		},
	},
}
