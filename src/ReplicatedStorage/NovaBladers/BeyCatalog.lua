local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Dreifach-Lunge mit Ripper-Fang-Finale.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Anker, Counter-Pulse und Shatter-Welle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Hitzeringe und Solar-Orbit-Drift.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone, Blink-Dash und Edge-Slash.",
		modelAssets = {
