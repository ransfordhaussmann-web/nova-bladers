local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Blade Vortex",
		specialId = "CrimsonBladeVortex",
		desc = "Attack-Typ: Feuer-Rush mit rotierenden Klingen-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Schild, Frost-Pulse und Schutzmauer.",
		modelRef = {
