local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale und Explosions-Finale.",
		modelAssets = {
			-- Optional: Creator Store meshId einfügen (Toolbox → Creator Store → "spinning top")
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		desc = "Defense-Typ: Eis-Schild, Frost-Aura und Splitter-Stoß.",
		modelAssets = {
			-- Optional: Creator Store meshId einfügen
			-- meshId = "rbxassetid://0",
		},
	},
}
