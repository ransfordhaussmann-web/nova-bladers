local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Slash-Rush mit Klingen-Burst.",
		modelRef = {
			studioModelName = "CrimsonFang",
			toolboxHint = "Creator Store: spinning top / attack bey",
		},
	},
	{
		id = "FrostCrown",
		...
		desc = "Defense-Typ: Eiswall, Frost-Schild und Gefrier-Pulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Spiral-Orbit und Nova-Explosion.",
		modelRef = {
			studioModelName = "SolarFlare",
			toolboxHint = "Creator Store: spinning top / stamina bey",
		},
	},
}
