local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Rend Chain",
		specialId = "CrimsonRendChain",
		desc = "Attack-Typ: Dreifach-Lunge mit Reißzahn-Ketten.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Aura, Eisbarriere und Splitter.",
		modelRef = {
