local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rush und Feder-Hagel.",
	...
	},
	{
		...
		desc = "Defense-Typ: Gegner anziehen, Anker-Schlag und Wellen.",
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Dash und blutiger Finish-Hit.",
		modelAssets = { meshId = nil, size = Vector3.new(3.4, 1.0, 3.4) },
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinmauer, Schutz und Splitter-Explosion.",
		modelAssets = { meshId = nil, size = Vector3.new(4.0, 1.4, 4.0) },
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnen-Aufladung, Flare-Ringe und Orbit.",
		modelAssets = { meshId = nil, size = Vector3.new(3.9, 0.9, 3.9) },
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash durch Gegner und Geister-Schnitt.",
		modelAssets = { meshId = nil, size = Vector3.new(3.3, 1.0, 3.3) },
	},
}
