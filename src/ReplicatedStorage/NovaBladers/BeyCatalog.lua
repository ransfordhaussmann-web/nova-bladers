local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Inferno-Fang-Rush mit Feuer-Meteor-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Bastion, Schutzschild und Frost-Impulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Helix-Sonik-Ringe und Solar-Orbit.",
		modelRef = {
