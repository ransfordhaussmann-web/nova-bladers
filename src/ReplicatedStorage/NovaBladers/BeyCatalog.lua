local BeyCatalog = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 9, Speed = 4, Stamina = 9, SpinDecayMult = 0.75 },
		special = "Glacier Crown Lock",
		specialId = "GlacierCrownLock",
		desc = "Defense-Typ: Eiskrone, Frost-Schild und Shard-Pulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Attack-Typ: Rage-Aura, Blitz-Lunge und Fang-Burst.",
		modelRef = {
