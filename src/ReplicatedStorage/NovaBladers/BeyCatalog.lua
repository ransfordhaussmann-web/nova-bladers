local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rush und Klingen-Hagel.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Pulse Ring",
		specialId = "FrostPulseRing",
		desc = "Defense-Typ: Eis-Ringe und Frost-Orbit.",
		modelRef = {
			studioModelName = "FrostPulse",
			targetSize = 3.6,
		},
	},
}
