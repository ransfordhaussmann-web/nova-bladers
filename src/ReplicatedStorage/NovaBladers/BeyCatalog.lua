local BeyCatalog = {
	{
		...
		modelRef = {
			...
			targetSize = 3.5,
			creatorStoreSearch = "spinning top blue attack",
		},
	},
	{
		id = "IronShell",
	...
	},
	{
		...
		desc = "Attack-Typ: Sägeblatt-Spirale mit Shred-Finisher.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Kuppel, Slow-Aura und Frost-Shatter.",
		modelRef = {
