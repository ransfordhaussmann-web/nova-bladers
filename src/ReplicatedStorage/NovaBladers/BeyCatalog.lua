local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Dreifach-Schnitt und Sturzangriff.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Festung, Erdbeben-Wellen und Schockwelle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenflare, Brandringe und Orbit-Loop.",
		modelAssets = {
	...
	},
	{
		...
		special = "Phantom Edge Phase",
		specialId = "PhantomEdgePhase",
		desc = "Balance-Typ: Phasen-Vanish, Blink und Klingenstoß.",
		modelAssets = {
			size = Vector3.new(3.5, 1.0, 3.5),
			creatorStoreSearch = "spinning top balance edge",
		},
	},
}
