local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Aufladung, Spiral-Rush und Flammen-Flare.",
		modelRef = {
			studioModelName = "CrimsonBlaze",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			credit = "Creator Store — import as CrimsonBlaze",
		},
	},
	{
		id = "FrostCrown",
		...
		desc = "Defense-Typ: Eisschild, Shard-Barrage und Shatter-Finisher.",
		modelRef = {
			studioModelName = "FrostCrown",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			credit = "Creator Store — import as FrostCrown",
		},
	},
}
