local BeyCatalog = {
	...
	},
	{
		...
		modelRef = {
			...
			creatorStoreQuery = "spinning top balance purple",
			targetSize = 3.5,
		},
	},
	{
		...
		stats = { Attack = 9, Defense = 5, Speed = 6, Stamina = 4 },
		special = "Crimson Forge Break",
		specialId = "CrimsonForgeBreak",
		desc = "Attack-Typ: Hammer-Slam und Schrapnell-Burst.",
		modelRef = {
			studioModelName = "CrimsonForge",
			creatorStoreQuery = "spinning top attack red metal",
			targetSize = 3.7,
		},
	},
	{
		...
		desc = "Defense-Typ: Frost-Aura, Eiskrone und Shatter-Welle.",
		modelRef = {
			studioModelName = "FrostCrown",
			creatorStoreQuery = "spinning top ice blue defense",
			targetSize = 3.8,
		},
	},
}
