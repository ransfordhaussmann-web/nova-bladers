local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Bodenpulse und Nachbeben.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Drift mit Feuer-Ring und Flare-Burst.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash, Surge und Klingen-Schnitt.",
	},
}
