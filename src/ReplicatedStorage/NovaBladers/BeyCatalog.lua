local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Slash-Finisher.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Fort und Boden-Slam-Wellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Mirage-Klone und Phantom-Strikes.",
		modelAssets = {
