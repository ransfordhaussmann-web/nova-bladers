local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm mit rotierenden Reißzähnen.",
		modelAssets = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(170, 185, 160),
		stats = { Attack = 3, Defense = 9, Speed = 4, Stamina = 9 },
		special = "Granite Bastion",
		specialId = "GraniteBastion",
		desc = "Defense-Typ: Festungs-Anker, Steinmauer und Erdbeben-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und gleitender Flammen-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone, Zickzack-Dash und Klingen-Konvergenz.",
		modelAssets = {
			creatorStoreSearch = "spinning top balance ghost",
