local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Aufladung und Feder-Hagel.",
		modelAssets = {
			-- Creator Store: Toolbox → Creator Store → "spinning top" / "bey"
			-- meshId = "rbxassetid://0",
		},
	},
	{
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sprint und Reiß-Hieb.",
		modelAssets = {},
	},
	{
		id = "GraniteFort",
		...
		desc = "Defense-Typ: Steinmauer und Erdbeben-Welle.",
		modelAssets = {},
	},
	{
		id = "SolarDrift",
