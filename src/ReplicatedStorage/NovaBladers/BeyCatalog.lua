local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankerung, Erdbeben und Stein-Schock.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Dash und Spiegel-Schläge.",
		modelAssets = {
			creatorStoreSearch = "spinning top ghost phantom blade",
		},
	},
}
