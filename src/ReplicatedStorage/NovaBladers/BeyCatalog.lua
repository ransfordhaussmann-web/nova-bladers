local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Stoß und Ripper-Kombo.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Reflekt-Puls und Schockwelle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klingen, Dash und Echo-Treffer.",
		modelAssets = {
