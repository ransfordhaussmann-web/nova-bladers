local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Multi-Hits.",
		modelAssets = {
			creatorStoreSearch = "spinning top attack blade",
			note = "Studio Toolbox → Creator Store → paste meshId here",
		},
	},
	{
		id = "GraniteFort",
		...
		desc = "Defense-Typ: Verankerung, Stein-Schild und Gegenstoß.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flare-Ringe und Sonnen-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Spiegel-Klone, Feint und Phantom-Schlag.",
		modelAssets = {
