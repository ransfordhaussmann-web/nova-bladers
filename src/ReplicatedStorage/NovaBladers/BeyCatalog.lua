local BeyCatalog = {
	{
		...
		modelRef = {
			...
			creatorStoreQuery = "spinning top blue attack",
		},
	},
	{
		id = "IronShell",
		...
		modelRef = {
			...
			creatorStoreQuery = "spinning top green defense",
		},
	},
	{
		id = "VoltDash",
	...
	},
	{
		...
		desc = "Attack-Typ: Schmiede-Glut, Stampfer-Rush und Splitter-Burst.",
		modelRef = {
			studioModelName = "CrimsonForge",
			creatorStoreQuery = "spinning top red metal forge",
		},
	},
	{
		id = "FrostCrown",
		...
		desc = "Defense-Typ: Frost-Aura, Eiskrone und Gefrier-Burst.",
		modelRef = {
			studioModelName = "FrostCrown",
			creatorStoreQuery = "spinning top ice crystal crown",
		},
	},
}
