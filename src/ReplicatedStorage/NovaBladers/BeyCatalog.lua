local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Flammen-Aufladung, Rush und brennender Orbit.",
		modelRef = {
			studioModelName = "CrimsonVortex",
			targetSize = 3.5,
		},
		-- Creator Store: Toolbox → "spinning top" / "fire top" → paste MeshId here
	...
	},
	{
		...
		desc = "Defense-Typ: Kristallschild, Frostwellen und Schatter-Burst.",
		modelRef = {
			studioModelName = "FrostPrism",
			targetSize = 3.5,
		},
		-- Creator Store: Toolbox → "ice top" / "crystal spinner" → paste MeshId here
		-- modelAssets = { meshId = "rbxassetid://0", size = Vector3.new(3.6, 1.2, 3.6) },
	},
}
