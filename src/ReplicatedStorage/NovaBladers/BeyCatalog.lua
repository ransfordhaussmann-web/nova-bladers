local BeyCatalog = {
	...
	},
	{
		...
		-- Creator Store: Toolbox → meshId hier eintragen (procedural Fallback bleibt aktiv)
	...
	},
	{
		...
		special = "Crimson Nova Burst",
		specialId = "CrimsonNovaBurst",
		desc = "Attack-Typ: Feuer-Rush mit mehrfachen Burn-Hits.",
		modelRef = {
			studioModelName = "CrimsonFlare",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
		},
		-- Creator Store: z. B. Toolbox → "spinning top" / "bey blade" → MeshId kopieren
	...
	},
	{
		...
		special = "Frost Crown Shield",
		specialId = "FrostCrownShield",
		desc = "Defense-Typ: Eis-Barriere, Frost-Pulse und Schutzkrone.",
		modelRef = {
			studioModelName = "FrostCrown",
			targetSize = 3.7,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
		},
		-- Creator Store: z. B. Toolbox → "spin top" / "metal top" → MeshId kopieren
