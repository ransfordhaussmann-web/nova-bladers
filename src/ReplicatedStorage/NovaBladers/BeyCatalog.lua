local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Flammen-Rush und Klingen-Salve.",
		modelRef = {
	...
	},
	{
		...
		special = "Glacier Spiral Lock",
		specialId = "GlacierSpiralLock",
		desc = "Defense-Typ: Eis-Spirale, Frost-Schild und Einfrier-Burst.",
		modelRef = {
