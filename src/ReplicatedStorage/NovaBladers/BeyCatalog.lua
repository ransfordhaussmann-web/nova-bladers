local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Inferno Slice",
		specialId = "CrimsonInfernoSlice",
		desc = "Attack-Typ: Flammen-Rush und Inferno-Arc-Hits.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Bastion Nova",
		specialId = "FrostBastionNova",
