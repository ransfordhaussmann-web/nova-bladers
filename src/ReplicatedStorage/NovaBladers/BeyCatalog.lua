local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Rush mit schnellen Ripper-Hits.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinmauer und Erdstoß-Wellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenkrone und Feuer-Orbit.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash und Mirage-Schnitt.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		...
		desc = "Defense-Typ: Eiskrone und Frost-Splitter-Burst.",
	},
	{
		id = "CrimsonDrift",
		name = "Crimson Drift",
		beyType = "Attack",
		color = Color3.fromRGB(160, 30, 80),
		accentColor = Color3.fromRGB(255, 60, 120),
		stats = { Attack = 8, Defense = 4, Speed = 9, Stamina = 5 },
		special = "Crimson Drift Surge",
		specialId = "CrimsonDriftSurge",
		desc = "Attack-Typ: Drift-Boost und Surge-Kollision.",
	},
}
