local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Meteor-Salve mit Burn-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Mauer und Frost-Pulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Spiralen und Orbit-Ringe.",
		modelRef = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feder-Sturm mit schnellen Meteor-Hits.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 8, Speed = 4, Stamina = 8 },
		special = "Tide Anchor Surge",
		specialId = "TideAnchorSurge",
		desc = "Defense-Typ: Anker-Burrow und Wasser-Schockwellen.",
		modelRef = {
