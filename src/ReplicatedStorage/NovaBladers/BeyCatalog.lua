local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Stoß und Fang-Kombo.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer und Erdbeben-Schock.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und Flare-Ausbruch.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone und Klingenstoß.",
		modelRef = {
