local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelnde Klingen und Vorwärts-Sweep.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Verankerung, Steinschild und Schockwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Drift mit Flare-Burst am Ende.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash durch Gegner mit Klingen-Schnitt.",
	},
}
