local BeyCatalog = {
	...
	},
	{
		...
		desc = "Store-Attack: Rotierender Cyclone-Rush mit finalem Stoß.",
		storeItem = true,
		modelRef = {
	...
	},
	{
		...
		name = "Frost Halo",
		beyType = "Defense",
		color = Color3.fromRGB(140, 200, 245),
		...
		desc = "Store-Defense: Eiskrone, Schutzschild und Frost-Schockwelle.",
		storeItem = true,
		modelRef = {
