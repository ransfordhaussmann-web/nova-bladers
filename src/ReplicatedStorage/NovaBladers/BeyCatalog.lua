local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Rush mit Reißzahn-Kettenhits.",
		modelRef = {
			studioModelName = "CrimsonFang",
			creatorStoreSearch = "spinning top fire red",
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Spikes und Erdbeben-Pulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
	...
	},
	{
		...
		desc = "Balance-Typ: Mirage-Dash und Geisterklingen.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		...
		desc = "Defense-Typ: Frost-Aura und Eissplitter-Burst.",
	},
	{
		id = "CrimsonDrift",
		name = "Crimson Drift",
		beyType = "Attack",
		color = Color3.fromRGB(160, 25, 45),
		...
		desc = "Attack-Typ: Hochgeschwindigkeits-Surge mit Nachbeben.",
	},
}
