local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale und Zyklon-Ausbruch.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 9, Speed = 4, Stamina = 7, SpinDecayMult = 0.8 },
		special = "Glacier Vault",
		specialId = "GlacierVault",
		desc = "Defense-Typ: Eis-Schild und Frost-Schock.",
		modelRef = {
