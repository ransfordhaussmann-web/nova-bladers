local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelnde Klingen und Rush-Slash.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Festungs-Anker und Stein-Schockwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Gleitflug und Flare-Finale.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash und Klingen-Surge.",
	},
}
