local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Reaver Slash",
		specialId = "CrimsonReaverSlash",
		desc = "Attack-Typ: Blutrote Klingen-Rush und Finisher-Burst.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Aura, Frost-Mauer und Shatter-Welle.",
		modelRef = {
