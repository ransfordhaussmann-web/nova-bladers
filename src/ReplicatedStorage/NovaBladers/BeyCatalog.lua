local BeyCatalog = {
	...
	},
	{
		...
		name = "Crimson Forge",
		beyType = "Attack",
		color = Color3.fromRGB(185, 45, 30),
		...
		desc = "Attack-Typ: Feuerlanze mit Durchdringungs-Stoß.",
		modelRef = {
			studioModelName = "CrimsonForge",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
		},
		-- Optional Creator Store mesh: paste MeshId from Toolbox into modelAssets.meshId
	},
	{
		id = "FrostPrism",
		name = "Frost Prism",
		...
		desc = "Defense-Typ: Kristallpanzer und Eis-Schrapnell.",
		modelRef = {
