local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Ripper Blade",
		specialId = "CrimsonRipperBlade",
		desc = "Attack-Typ: Dreifach-Slash-Rush mit Blutspur.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Wurzeln und Gegenstoß.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Orbit, Spin-Recovery und Flare.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Ausblenden, Blink hinter Ziel, Schnitt.",
		modelAssets = {
