local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Parry, Riposte-Rush und Fang-Strike.",
		modelAssets = {
			-- Creator Store: paste rbxassetid from Toolbox → Creator Store
			meshId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Burrow, Steinmauer und Schockpulse.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Halo, Schockwellen und Orbit.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		desc = "Attack-Typ: Kristall-Shard Meteor-Shower.",
		modelAssets = {
			meshId = nil,
			size = Vector3.new(3.6, 1.2, 3.6),
		},
	},
	{
		...
		desc = "Balance-Typ: Kronen-Charge, Inferno-Ringe und Finale.",
		modelAssets = {
			meshId = nil,
