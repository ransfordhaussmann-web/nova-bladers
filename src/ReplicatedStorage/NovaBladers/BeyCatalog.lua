local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Schmiede-Flammen und Meteor-Salve.",
		modelRef = {
			studioModelName = "EmberForge",
			targetSize = 3.6,
		},
		modelAssets = {
			-- Creator Store: Toolbox → "fire spinning top" / "metal bey" → MeshId hier eintragen
