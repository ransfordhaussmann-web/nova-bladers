local BeyCatalog = {
	...
	},
	{
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "defense", "metal shell" },
		},
	},
	{
		id = "VoltDash",
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "lightning", "stamina" },
		},
	},
	{
		id = "ShadowBite",
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "dark", "fang" },
		},
	},
	{
		id = "CrimsonOrbit",
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "flame", "solar", "red" },
		},
	},
	{
		id = "FrostAnchor",
		...
		desc = "Defense-Typ: Gletscher-Aura, Eis-Mauer und Frost-Schock.",
		modelRef = {
			studioModelName = "FrostAnchor",
			searchTerms = { "spinning top", "ice", "glacier", "frost" },
		},
	},
}
