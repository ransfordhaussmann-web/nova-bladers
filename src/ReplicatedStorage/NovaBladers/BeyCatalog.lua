local BeyCatalog = {
	...
	},
	{
		...
		special = "Blaze Ring Inferno",
		specialId = "BlazeRingInferno",
		desc = "Attack-Typ: Flammen-Orbit und Inferno-Burst.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Halo, Frost-Schild und Kristall-Burst.",
		modelRef = {
