local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Parier-Stance und blitzschneller Konter.",
	...
	},
	{
		...
		-- modelAssets = { meshId = "rbxassetid://YOUR_ID", size = Vector3.new(3.8, 1.4, 3.8) },
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnen-Halo und Licht-Orbit.",
	...
	},
	{
		...
		desc = "Balance-Typ: Geister-Schleier, Phasen-Dive.",
	...
	},
	{
		...
		desc = "Attack-Typ: Eis-Splitter-Regen aus der Luft.",
		-- modelAssets = { meshId = "rbxassetid://YOUR_ID", size = Vector3.new(3.6, 1.2, 3.6) },
	},
	{
		id = "BlazeCrown",
		...
		desc = "Attack-Typ: Flammenkrone und Inferno-Ausbruch.",
		-- modelAssets = { meshId = "rbxassetid://YOUR_ID", size = Vector3.new(3.7, 1.3, 3.7) },
	},
}
