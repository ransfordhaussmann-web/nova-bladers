local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sturmlauf mit Reißzahn-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Verankerung und Gegenschlag.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Illusions-Klone und Klingenstoß.",
		modelRef = {
