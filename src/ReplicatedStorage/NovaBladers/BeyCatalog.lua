local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Federn und Sturzangriff.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer und Stachel-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		stats = { Attack = 6, Defense = 6, Speed = 7, Stamina = 10, SpinDecayMult = 0.6 },
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(100, 90, 160),
		accentColor = Color3.fromRGB(180, 160, 255),
