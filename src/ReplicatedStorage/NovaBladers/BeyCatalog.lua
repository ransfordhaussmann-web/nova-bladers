local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm mit Ripper-Hits.",
		modelAssets = {
			creatorStoreSearch = "spin top red attack blade",
		},
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		beyType = "Defense",
		color = Color3.fromRGB(110, 115, 105),
		accentColor = Color3.fromRGB(160, 170, 150),
		stats = { Attack = 3, Defense = 9, Speed = 4, Stamina = 9 },
		special = "Granite Bastion",
		specialId = "GraniteBastion",
		desc = "Defense-Typ: Festung, Schutzschild und Erdbeben-Pulse.",
		modelAssets = {
			creatorStoreSearch = "spin top defense fortress stone",
		},
	},
	{
		id = "SolarDrift",
		...
		desc = "Stamina-Typ: Solar-Flares und Feuer-Orbit.",
		modelAssets = {
			creatorStoreSearch = "spin top gold stamina sun",
		},
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(170, 150, 220),
		...
		desc = "Balance-Typ: Mirage-Klone, Dash-Kette und Phantom-Schlag.",
		modelAssets = {
			creatorStoreSearch = "spin top phantom blade balance",
		},
	},
}
