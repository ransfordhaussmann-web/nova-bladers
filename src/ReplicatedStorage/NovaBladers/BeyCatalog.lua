local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitzvorstoß mit Folge-Hits entlang der Bahn.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankerung, Schutzschild und Stoßwellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenflare-Ringe und Flammenspirale.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Illusions-Splitter und Multi-Angle-Stoß.",
		modelAssets = {
