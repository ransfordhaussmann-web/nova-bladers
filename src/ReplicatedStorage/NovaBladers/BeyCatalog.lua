local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Aufladung, Blitz-Rush und Cleave-Burst.",
		modelAssets = {
	...
	},
	{
		...
		special = "Frost Bastion Bloom",
		specialId = "FrostBastionBloom",
		desc = "Defense-Typ: Eis-Schild, Frost-Pulse und Schutz-Aura.",
		modelAssets = {
