local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutrote Klingen-Rush mit Slash-Kombo.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinbarriere, Anker und Boden-Beben.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone und Mehrfach-Strike.",
		modelAssets = {
