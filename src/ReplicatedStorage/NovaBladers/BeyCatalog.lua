local BeyCatalog = {
	...
	},
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "stamina top", "lightning top" },
		},
	},
	{
		id = "ShadowBite",
		...
		creatorStore = {
			searchTerms = { "spinning top", "dark top", "fang top" },
		},
	},
	{
		id = "BlazeWheel",
		...
		desc = "Attack-Typ: Feuer-Rush und expandierender Inferno-Ring.",
		creatorStore = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Schutzmantel, Kristall-Splitter und Frost-Burst.",
		creatorStore = {
