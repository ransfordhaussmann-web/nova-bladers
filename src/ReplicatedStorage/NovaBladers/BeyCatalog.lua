local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rush mit Glut-Trail und Ember-Burst.",
		creatorStore = {
			searchTerms = { "spinning top fire", "bey blade attack", "flame wheel" },
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Schutzmantel und Kristall-Schockwellen.",
		creatorStore = {
			searchTerms = { "spinning top ice", "bey blade defense", "crystal shield" },
