local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ketten-Ripper-Schlägen.",
		-- Optional Creator Store mesh (Toolbox → spinning top / bey blade metal)
	...
	},
	{
		...
		desc = "Defense-Typ: Schutzkuppel, Reflektions-Wellen und Crest-Burst.",
		-- Optional Creator Store mesh (Toolbox → spinning top / crystal shield)
		-- modelAssets = { meshId = "rbxassetid://YOUR_ID", size = Vector3.new(3.6, 1.2, 3.6) },
	},
}
