local BeyCatalog = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Spiralen und expandierende Schockwellen.",
		modelRef = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feder-Klingen-Salve mit schnellen Treffern.",
		modelRef = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(90, 210, 240),
		stats = { Attack = 5, Defense = 8, Speed = 5, Stamina = 7 },
		special = "Tide Anchor Surge",
		specialId = "TideAnchorSurge",
		desc = "Defense-Typ: Anker-Burrow, Wasserwall und Gezeiten-Pulse.",
		modelRef = {
