local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sturmlauf mit Klingen-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinpanzer, Erdbeben-Pulse und Gegenschlag.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone, Durchstoß und Mirage-Burst.",
		modelAssets = {
