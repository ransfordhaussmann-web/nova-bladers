local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rad-Rush mit Flammen-Spur und Flare-Burst.",
		creatorStore = {
			searchTerms = { "spinning top", "fire wheel", "flame top" },
	...
	},
	{
		...
		desc = "Defense-Typ: Eiskristall-Schild, Frost-Pulse und Shatter-Welle.",
		creatorStore = {
			searchTerms = { "spinning top", "ice crystal", "frost top" },
			note = "Toolbox → Creator Store → MeshId in modelAssets.meshId eintragen",
		},
		modelRef = {
