local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Rotierende Klingen-Stürme mit hohem Burst-Schaden.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
		},
		modelAssets = {
			-- meshId = "rbxassetid://PASTE_CREATOR_STORE_ID",
	...
	},
	{
		...
		desc = "Defense-Typ: Eisbarriere, Frost-Pulse und Schutzschild.",
		modelRef = {
