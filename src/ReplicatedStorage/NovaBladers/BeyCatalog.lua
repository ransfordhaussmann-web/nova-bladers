local BeyCatalog = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(255, 100, 110),
		stats = { Attack = 9, Defense = 3, Speed = 8, Stamina = 4 },
		special = "Crimson Ripper Fang",
		specialId = "CrimsonRipperFang",
		desc = "Attack-Typ: Dreifach-Slash gefolgt von einem Jagdstoß.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Schutzhaltung, Steinmauer und Splitter-Puls.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenkorona, Spin-Recovery und Drift-Angriff.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash durch Ziele und Schnitt-Burst.",
		modelRef = {
