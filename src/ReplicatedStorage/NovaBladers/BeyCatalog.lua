local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Quills und schnelle Meteor-Barrage.",
		modelRef = {
	...
	},
	{
		...
		name = "Tide Anchor",
		beyType = "Defense",
		color = Color3.fromRGB(45, 140, 195),
		...
		desc = "Defense-Typ: Wasser-Schild, Anker-Gewicht und Gezeiten-Pulse.",
		modelRef = {
