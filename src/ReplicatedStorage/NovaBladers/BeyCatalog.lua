local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Schlag.",
		modelAssets = {
			creatorStoreSearch = "spinning top attack red",
			hint = "Toolbox → Creator Store → spinning top / arena striker",
		},
	},
	{
		id = "GraniteFort",
		...
		desc = "Defense-Typ: Steinwall und Gegenstoß.",
		modelAssets = {
			creatorStoreSearch = "spinning top defense stone",
			hint = "Toolbox → Creator Store → heavy defense bey",
		},
	},
	{
		id = "SolarDrift",
		...
		modelAssets = {
			creatorStoreSearch = "spinning top stamina gold",
			hint = "Toolbox → Creator Store → stamina ring bey",
		},
	},
	{
		id = "PhantomEdge",
		...
		desc = "Balance-Typ: Phantom-Dashes und Blade-Mirage.",
		modelAssets = {
			creatorStoreSearch = "spinning top phantom blue",
			hint = "Toolbox → Creator Store → balance striker bey",
		},
	},
}
