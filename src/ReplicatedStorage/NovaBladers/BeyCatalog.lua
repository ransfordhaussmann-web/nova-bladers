local BeyCatalog = {
	...
	},
	{
		...
		desc = "Creator-Store Attack: Feuer-Spirale mit Hit-Trails.",
		storeItem = true,
		modelRef = {
			studioModelName = "CrimsonBlaze",
		},
		-- Optional: Toolbox meshId eintragen (rbxassetid://…)
		modelAssets = {},
	},
	{
		id = "FrostOrbit",
		...
		desc = "Creator-Store Defense: Eis-Schild und Frost-Schockwelle.",
		storeItem = true,
		modelRef = {
