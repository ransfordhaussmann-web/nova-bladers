local BeyCatalog = {
	...
	},
	{
		...
		modelRef = {
			...
			referenceName = "Rock Leone 145WD",
	...
	},
	{
		...
		modelRef = {
			...
			referenceName = "Poison Serpent SW145SD",
			credit = "Creator Store",
		},
	},
	{
		...
		desc = "Attack-Typ: Aufstieg, Schwerthieb und Boden-Schockwelle.",
		modelRef = {
			studioModelName = "CrimsonForge",
			referenceName = "L-Drago Destructor F:S",
			credit = "Creator Store",
		},
	},
	{
		...
		modelRef = {
			...
			referenceName = "Ice Gasher 145SF",
			credit = "Creator Store",
		},
	},
}
