local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Spiral-Orbit und Feuer-Burst.",
		modelRef = {
	...
	},
	{
		...
		special = "Glacial Barricade",
		specialId = "GlacialBarricade",
		desc = "Defense-Typ: Frost-Aura, Eisbarriere und Shatter-Wellen.",
		modelRef = {
