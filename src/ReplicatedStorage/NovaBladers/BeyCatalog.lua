local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm und Fang-Kombo.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Ring Shatter",
		specialId = "FrostRingShatter",
		desc = "Defense-Typ: Eis-Käfig, Frostwellen und Shatter-Burst.",
		modelRef = {
