local BeyCatalog = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(255, 110, 75),
		stats = { Attack = 9, Defense = 3, Speed = 8, Stamina = 4 },
		special = "Crimson Starfall Rush",
		specialId = "CrimsonStarfallRush",
		desc = "Attack-Typ: Blutrote Meteor-Klingen aus der Luft.",
		modelAssets = {
			-- Toolbox → Creator Store → paste rbxassetid when available
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Erdbeben-Pulse und Schutz.",
		modelAssets = {},
	},
	{
		id = "SolarDrift",
	...
	},
	{
		...
		special = "Phantom Void Rend",
		specialId = "PhantomVoidRend",
		desc = "Balance-Typ: Geist-Aura, Phantom-Dive und Void-Schnitt.",
		modelAssets = {},
	},
}
