local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Kometen-Sturz und Brandspuren.",
		modelAssets = {
			-- Optional Creator Store mesh: Toolbox → paste rbxassetid into meshId
		},
	},
	{
		id = "CrystalGuard",
		...
		desc = "Defense-Typ: Eisbarriere, Frostschutz und Kristall-Schockwelle.",
		modelAssets = {
			-- Optional Creator Store mesh: Toolbox → paste rbxassetid into meshId
		},
	},
