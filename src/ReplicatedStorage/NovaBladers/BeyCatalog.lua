local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Razor Flurry",
		specialId = "CrimsonRazorFlurry",
		...
		-- Optional Creator Store mesh: paste rbxassetid from Toolbox mesh
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Mauer, Frost-Pulse und Burrow.",
		modelRef = {
