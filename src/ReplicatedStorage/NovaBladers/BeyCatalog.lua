local BeyCatalog = {
	...
	},
	{
		...
		special = "Nova Meteor Shower",
		specialId = "NovaMeteorShower",
		desc = "Attack-Typ: Scharfe Reißzähne und Meteor-Rush.",
		modelAssets = {
	...
	},
	{
		...
		special = "Iron Vault Lock",
		specialId = "IronVaultLock",
		desc = "Defense-Typ: Granitpanzer und Schockmauer.",
		modelAssets = {
			meshId = nil,
		},
	},
	...
	},
	{
		...
		accentColor = Color3.fromRGB(120, 240, 230),
		stats = { Attack = 6, Defense = 5, Speed = 7, Stamina = 7 },
		special = "Shadow Eclipse Fang",
		specialId = "ShadowEclipseFang",
		desc = "Balance-Typ: Geisterklingen und Phantom-Dive.",
		modelAssets = {
			meshId = nil,
		},
	},
