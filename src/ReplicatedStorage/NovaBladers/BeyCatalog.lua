local BeyCatalog = {
	...
	},
	{
		...
		-- Optional Creator Store mesh: modelAssets = { meshId = "rbxassetid://...", size = Vector3.new(3.6, 1.2, 3.6) },
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinwall, Stampfer und Schockwellen.",
		-- Optional Creator Store mesh: modelAssets = { meshId = "rbxassetid://...", size = Vector3.new(3.8, 1.4, 3.8) },
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnen-Flare-Ringe und Burn-Drift.",
		-- Optional Creator Store mesh: modelAssets = { meshId = "rbxassetid://...", size = Vector3.new(3.6, 1.0, 3.6) },
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dashes und Finisher-Surge.",
		-- Optional Creator Store mesh: modelAssets = { meshId = "rbxassetid://...", size = Vector3.new(3.5, 1.1, 3.5) },
	},
}
