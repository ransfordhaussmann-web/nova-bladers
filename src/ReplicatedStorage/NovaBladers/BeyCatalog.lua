local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Bastion, Schadensreduktion und Schockpulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Flare-Ringe und langer Drift-Rush.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash, Mehrfach-Treffer und Surge-Burst.",
	},
}
