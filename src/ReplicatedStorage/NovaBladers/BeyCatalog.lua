local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Slash-Rush mit Finisher-Riss.",
		modelAssets = {
	...
	},
	{
		...
		name = "Granite Fort",
		beyType = "Defense",
		color = Color3.fromRGB(95, 85, 70),
		accentColor = Color3.fromRGB(160, 145, 120),
		stats = { Attack = 3, Defense = 9, Speed = 4, Stamina = 9 },
		special = "Granite Rampart",
		specialId = "GraniteRampart",
		desc = "Defense-Typ: Steinmauer verankern und Erschütterungswellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Orbit mit Flare-Ausbruch.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(130, 170, 210),
		...
		desc = "Balance-Typ: Phasen-Durchgang und Geister-Schnitt.",
		modelAssets = {
			creatorStoreSearch = "spinning top balance phantom edge",
		},
	},
}
