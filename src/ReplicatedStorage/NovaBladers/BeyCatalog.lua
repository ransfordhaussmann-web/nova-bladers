local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutiger Ansturm und rotierender Klingenhieb.",
		modelAssets = {
			meshId = nil,
			textureId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Erdbeben und Schutzschild.",
		modelAssets = {
			meshId = nil,
			textureId = nil,
	...
	},
	{
		...
		desc = "Balance-Typ: Verschwinden, Schnitt und Echo-Treffer.",
		modelAssets = {
			meshId = nil,
			textureId = nil,
