local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankerung, Reflektions-Schild und Schockwelle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Ringe und Burn-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Nachbilder, Feint und Seiten-Strike.",
		modelAssets = {
