local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankern, Schutzschild und Stein-Pulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Flare und weite Drift-Ringe.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Vanish, Surge-Dash und Edge-Schnitt.",
	},
}
