local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Aura, Flammen-Rush und Ember-Strikes.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
		},
		-- Creator Store: Toolbox → meshId eintragen, dann Kommentar entfernen
		-- modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Aura, Eisschild und Kristall-Schockwelle.",
		modelRef = {
