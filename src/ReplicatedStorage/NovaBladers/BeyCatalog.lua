local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale und Flammen-Rush.",
		-- Optional Creator Store mesh: Toolbox → "spinning top" / "bey blade" → paste MeshId
		modelAssets = {
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Schild, Frost-Pulse und Knockback.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
			size = Vector3.new(3.6, 1.2, 3.6),
		},
