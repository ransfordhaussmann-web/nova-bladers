local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutrote Klingen-Spirale und Fang-Sturm.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 7, Speed = 5, Stamina = 8 },
		special = "Frost Avalanche",
		specialId = "FrostAvalanche",
		desc = "Defense-Typ: Eiskrone, Frost-Schild und Schneesturm.",
		modelRef = {
