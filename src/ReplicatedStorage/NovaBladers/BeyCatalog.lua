local BeyCatalog = {
	...
	},
	{
		...
		-- Paste Creator Store meshId after inserting a model in Studio:
	...
	},
	{
		...
		special = "Fang Spiral Rush",
		specialId = "CrimsonFangSpiral",
		desc = "Attack-Typ: Spiralförmiger Fang-Rush mit Mehrfach-Hits.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 4, Defense = 7, Speed = 5, Stamina = 9, SpinDecayMult = 0.72 },
		special = "Glacier Coil Lock",
		specialId = "FrostCoilLock",
		desc = "Defense-Typ: Eis-Spirale, Frost-Schild und Kälte-Pulse.",
		modelRef = {
