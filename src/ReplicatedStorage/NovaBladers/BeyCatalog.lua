local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Inferno Loop",
		specialId = "CrimsonInfernoLoop",
		desc = "Attack-Typ: Feuer-Spiral und Inferno-Eruption.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 9, Speed = 5, Stamina = 8, SpinDecayMult = 0.7 },
		special = "Glacial Crown Shield",
		specialId = "GlacialCrownShield",
