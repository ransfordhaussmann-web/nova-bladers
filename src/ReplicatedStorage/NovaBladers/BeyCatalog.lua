local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Flammiger Klingen-Rush mit schnellen Slash-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Schild, Frost-Pulse und hohe Ausdauer.",
		modelRef = {
			studioModelName = "FrostCrown",
			targetSize = 3.6,
		},
		modelAssets = {
			-- Creator Store: Toolbox → "spinning top" / "crystal top" → MeshId einfügen
			-- meshId = "rbxassetid://0",
