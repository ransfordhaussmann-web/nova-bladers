local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rad, Burn-Spur und Inferno-Eruption.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 4, Defense = 9, Speed = 5, Stamina = 7, SpinDecayMult = 0.72 },
		special = "Frost Crown Avalanche",
		specialId = "FrostCrownAvalanche",
		desc = "Defense-Typ: Eis-Krone, Lawine und Kristall-Shatter.",
		modelRef = {
