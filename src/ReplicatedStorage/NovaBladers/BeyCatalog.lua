local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Ringe und Orbit-Finisher.",
		creatorStore = {
			searchTerms = { "spinning top", "fire top", "metal bey" },
			notes = "Toolbox → Creator Store → Modell einfügen, MeshId in modelAssets eintragen.",
		},
		modelRef = {
