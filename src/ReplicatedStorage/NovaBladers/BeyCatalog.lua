local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Sky Slash",
		specialId = "CrimsonSkySlash",
		desc = "Attack-Typ: Blitz-Rush mit rotierenden Schlagwellen.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
		},
		-- Optional Creator Store mesh: paste MeshId from Toolbox → modelAssets.meshId
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Aura, Eiswand und Kälte-Pulse.",
		modelRef = {
			studioModelName = "GlacierOrb",
			targetSize = 3.6,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
		},
		-- modelAssets = { meshId = "rbxassetid://YOUR_ID", size = Vector3.new(3.6, 1.3, 3.6) },
	},
}
