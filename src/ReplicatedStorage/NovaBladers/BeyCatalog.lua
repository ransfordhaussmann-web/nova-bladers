local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm und Ripper-Schnitt.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinschlag, Bastion und Schockwelle.",
		modelAssets = {
			creatorStoreSearch = "spinning top stone defense heavy",
		},
	},
	{
		id = "SolarDrift",
		...
		desc = "Stamina-Typ: Solar-Flare und Feuer-Orbit.",
		modelAssets = {
			creatorStoreSearch = "spinning top gold stamina ring",
		},
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(170, 185, 220),
		...
		desc = "Balance-Typ: Illusions-Klone und Phantom-Stoß.",
		modelAssets = {
			creatorStoreSearch = "spinning top silver phantom blade",
		},
	},
}
