local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sprint mit Riss-Klingen-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Wurzel-Stand und Erdstoß.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und Flare-Umlauf.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Teleport und Spiegelklingen.",
		modelAssets = {
