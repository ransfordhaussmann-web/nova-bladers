local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Dreifach-Fang-Rush mit hohem Burst-Schaden.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinmauer, Gegenstoß und Erdbeben-Pulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenkorona-Ringe und Flare-Sprint.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Verschwinden, Blitz-Schnitt und Nachbilder.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		...
		desc = "Defense-Typ: Eiskrone, Frost-Ring und Splitter-Explosion.",
	},
	{
		id = "CrimsonDrift",
		name = "Crimson Drift",
		...
		accentColor = Color3.fromRGB(255, 60, 100),
		stats = { Attack = 8, Defense = 4, Speed = 10, Stamina = 6 },
		special = "Crimson Drift Surge",
		specialId = "CrimsonDriftSurge",
		desc = "Attack-Typ: Drift-Boost, Gleit-Rush und Impact-Welle.",
	},
}
