local BeyCatalog = {
	...
	},
	{
		...
		desc = "Creator-Store Attack: Feuer-Spirale mit Multi-Hit-Rush.",
		storeItem = true,
		modelRef = {
			studioModelName = "CrimsonBlaze",
		},
		-- Optional: rbxassetid aus Creator Store eintragen
	...
	},
	{
		...
		desc = "Creator-Store Defense: Eis-Schild, Freeze und Shatter-Burst.",
		storeItem = true,
		modelRef = {
