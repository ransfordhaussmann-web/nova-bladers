local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankerung, Schutzschild und Stein-Schockwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Weite Drift-Spur mit Sonnen-Flare-Bursts.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash mit Nachbild-Schlägen.",
	},
}
