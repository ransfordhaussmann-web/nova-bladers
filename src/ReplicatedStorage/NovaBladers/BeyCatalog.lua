local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Slash-Rush mit Sweep-Finisher.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankert sich und feuert Stein-Schockwellen.",
		modelAssets = {
			creatorStoreSearch = "spinning top stone shield",
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash durch den Gegner, Slash von hinten.",
		modelAssets = {
			creatorStoreSearch = "spinning top cyan phantom",
