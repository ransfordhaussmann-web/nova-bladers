local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Rending Claw",
		specialId = "CrimsonRendingClaw",
		desc = "Attack-Typ: Blutroter Rush mit Fang-Kettenhieben.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 4, Defense = 8, Speed = 5, Stamina = 9, SpinDecayMult = 0.7 },
		special = "Frost Aegis Spiral",
		specialId = "FrostAegisSpiral",
		desc = "Defense-Typ: Eisschild, Frostwellen und Shatter-Burst.",
		modelRef = {
