local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rad-Rush mit Inferno-Trail.",
		creatorStore = {
			searchTerms = { "spinning top", "fire wheel", "blaze" },
	...
	},
	{
		...
		desc = "Defense-Typ: Kristall-Schild und Frost-Schockwelle.",
		creatorStore = {
			searchTerms = { "spinning top", "ice crystal", "frost" },
