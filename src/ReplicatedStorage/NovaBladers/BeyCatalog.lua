local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Federregen mit Burst-Hits.",
	...
	},
	{
		...
		desc = "Defense-Typ: Untertauchen, Anker-Schlag und Gezeiten-Welle.",
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sprint mit Reiß-Hits.",
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall und Erdbeben-Pulse.",
		modelAssets = { meshId = nil, textureId = nil, size = Vector3.new(4.0, 1.3, 4.0) },
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		modelAssets = { meshId = nil, textureId = nil, size = Vector3.new(3.7, 1.0, 3.7) },
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash und Geister-Klinge.",
		modelAssets = { meshId = nil, textureId = nil, size = Vector3.new(3.5, 1.2, 3.5) },
	},
}
