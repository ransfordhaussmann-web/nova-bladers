local BeyCatalog = {
	...
	},
	{
		...
		modelRef = {
			...
			creatorStoreHint = "Toolbox → Creator Store → defense top / metal shell",
		},
	},
	{
		id = "VoltDash",
		...
		modelRef = {
			...
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			creatorStoreHint = "Toolbox → Creator Store → stamina top / speed ring",
		},
	},
	{
		id = "ShadowBite",
		...
		modelRef = {
			...
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			creatorStoreHint = "Toolbox → Creator Store → balance top / dark blade",
		},
	},
	{
		id = "CrimsonBlaze",
		...
		modelRef = {
			...
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			creatorStoreHint = "Toolbox → Creator Store → spinning top / battle top",
		},
	},
	{
		id = "FrostCrown",
		...
		special = "Frost Bastion Lock",
		specialId = "FrostBastionLock",
		desc = "Defense-Typ: Eiskrone, Frostwall und Kälte-Pulse.",
		modelRef = {
			studioModelName = "FrostCrown",
			targetSize = 3.6,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			creatorStoreHint = "Toolbox → Creator Store → spinning top / crystal top",
		},
	},
}
