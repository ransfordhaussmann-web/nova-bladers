local BeyCatalog = {
	...
	},
	{
		...
		special = "Flame Claw Rampage",
		specialId = "FlameClawRampage",
		desc = "Attack-Typ: Feuer-Ansturm mit Klauen-Combo.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
		},
		-- Creator Store: Toolbox → "spinning top red" / "fire bey" → MeshId eintragen
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Schild, Frost-Aura und Splitter-Sturm.",
		modelRef = {
			studioModelName = "FrostCrown",
			targetSize = 3.6,
		},
		-- Creator Store: Toolbox → "ice spinning top" / "crystal bey" → MeshId eintragen
		-- modelAssets = { meshId = "rbxassetid://YOUR_ID", size = Vector3.new(3.6, 1.2, 3.6) },
	},
}
