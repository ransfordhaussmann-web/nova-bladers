local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Wirbel und Explosions-Flächenschaden.",
		modelRef = {
			studioModelName = "BlazeWheel",
			targetSize = 3.5,
		},
		modelAssets = {
			-- Toolbox → Creator Store → "spinning top" / "fire bey"
			-- meshId = "rbxassetid://REPLACE_IN_STUDIO",
		},
	},
	{
		id = "FrostVeil",
		...
		desc = "Defense-Typ: Eis-Schutzmantel und Frost-Schockwellen.",
		modelRef = {
			studioModelName = "FrostVeil",
			targetSize = 3.5,
		},
		modelAssets = {
			-- Toolbox → Creator Store → "spinning top" / "ice bey"
			-- meshId = "rbxassetid://REPLACE_IN_STUDIO",
		},
	},
}
