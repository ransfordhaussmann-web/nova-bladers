local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelnder Klingen-Sturm mit Nahkampf-Hits.",
		modelAssets = {
			-- Creator Store: Toolbox → "spin top" → rbxassetid hier einfügen
			-- meshId = "0",
		},
	},
	{
		...
		desc = "Defense-Typ: Steinschild und Splitter-Salve.",
		modelAssets = {
			-- meshId = "0",
		},
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Flares und Brenn-Orbit.",
		modelAssets = {
			-- meshId = "0",
		},
	},
