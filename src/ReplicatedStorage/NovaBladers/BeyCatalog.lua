local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Klingen-Rush mit Finisher-Burst.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Schadensreduktion und Erschütterungswelle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Orbit mit expandierenden Flare-Ringen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash durch Gegner und Reappear-Burst.",
		modelAssets = {
			creatorStoreSearch = "spinning top phantom edge cyan",
			meshId = nil,
		},
	},
}
