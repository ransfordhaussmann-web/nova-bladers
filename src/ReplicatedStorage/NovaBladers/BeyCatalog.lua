local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Klingen-Flurry und Ripper-Finale.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinmauer und Gegenstoß-Wellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenringe und Umlauf-Angriff.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Teleport und Schnitt-Kombo.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		...
		desc = "Defense-Typ: Eiskrone, Frost-Wellen und Scherben-Burst.",
	},
	{
		id = "CrimsonDrift",
		name = "Crimson Drift",
		beyType = "Attack",
		color = Color3.fromRGB(180, 30, 60),
		...
		desc = "Attack-Typ: Blitz-Sprint und Trail-Schläge.",
	},
}
