local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Federsturm mit Multi-Hit-Rush.",
		modelAssets = {
	...
	},
	{
		...
		name = "Tide Anchor",
		beyType = "Stamina",
		color = Color3.fromRGB(35, 110, 195),
		accentColor = Color3.fromRGB(90, 195, 255),
		stats = { Attack = 5, Defense = 7, Speed = 4, Stamina = 10, SpinDecayMult = 0.7 },
		special = "Tide Anchor Crash",
		specialId = "TideAnchorCrash",
		desc = "Stamina-Typ: Anker-Slam und Wasser-Schockwelle.",
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Dash und blutiger Schnitt.",
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer und Erdstoß.",
	...
	},
	{
		...
		stats = { Attack = 6, Defense = 5, Speed = 8, Stamina = 9, SpinDecayMult = 0.6 },
		special = "Solar Flare Loop",
		specialId = "SolarFlareLoop",
		desc = "Stamina-Typ: Sonnenringe und Flare-Orbit.",
		modelAssets = { meshId = nil, size = Vector3.new(3.7, 1.2, 3.7) },
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(70, 75, 120),
