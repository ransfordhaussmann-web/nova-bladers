local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Claw-Finisher.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Bastion und Boden-Quake.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flares und Burn-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Split, Dash und Blade-Slash.",
		modelAssets = {
