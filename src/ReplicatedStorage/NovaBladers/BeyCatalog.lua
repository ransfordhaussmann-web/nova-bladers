local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Parieren und blitzschneller Gegenstoß.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Halo und Orbit-Ringe.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		desc = "Balance-Typ: Unsichtbarer Dash und Phantom-Schnitt.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		desc = "Attack-Typ: Kristall-Splitter-Regen aus der Luft.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		stats = { Attack = 6, Defense = 5, Speed = 7, Stamina = 8 },
		special = "Blaze Crown Burst",
		specialId = "BlazeCrownBurst",
		desc = "Stamina-Typ: Feuer-Krone und Inferno-Ringe.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
