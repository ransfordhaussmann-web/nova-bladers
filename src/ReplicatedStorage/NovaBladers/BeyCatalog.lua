local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spiral-Rush mit Eruptions-Finale.",
		modelAssets = {
	...
	},
	{
		...
		special = "Frost Crown Bloom",
		specialId = "FrostCrownBloom",
		desc = "Defense-Typ: Eiskrone, Frost-Schild und Kristall-Impulse.",
		modelAssets = {
			size = Vector3.new(3.6, 1.2, 3.6),
		},
		modelRef = {
