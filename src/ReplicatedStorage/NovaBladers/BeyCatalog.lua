local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Meteor-Salve mit Brenn-Trails.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Bunker, Frostwall und Kältepulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Spiralen und Helix-Orbit.",
		modelRef = {
