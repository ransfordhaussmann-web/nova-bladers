local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge und schnelle Riposte-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Burrow, Steinmauer und Erd-Pulse.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		desc = "Stamina-Typ: Solar-Ringe und Halo-Orbit.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		accentColor = Color3.fromRGB(160, 190, 230),
		stats = { Attack = 7, Defense = 5, Speed = 7, Stamina = 6 },
		special = "Phantom Veil Slash",
		specialId = "PhantomVeilSlash",
		desc = "Balance-Typ: Geister-Aura, Phasen-Dive und Schleier-Burst.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		desc = "Attack-Typ: Kristall-Meteor-Schauer aus der Luft.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		stats = { Attack = 8, Defense = 6, Speed = 6, Stamina = 6 },
		special = "Blaze Crown Burst",
		specialId = "BlazeCrownBurst",
		desc = "Attack-Typ: Feuer-Krone, Flammen-Ringe und Inferno-Burst.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
		},
	},
