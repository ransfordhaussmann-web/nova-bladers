local BeyCatalog = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(255, 180, 230),
		stats = { Attack = 5, Defense = 6, Speed = 6, Stamina = 9, SpinDecayMult = 0.7 },
		special = "Crystal Petal Spiral",
		specialId = "CrystalPetalSpiral",
		desc = "Stamina-Typ: Kristall-Petals und Spiral-Ringe.",
		modelRef = {
			studioModelName = "CrystalBloom",
			targetSize = 3.5,
		},
		modelAssets = {
			-- Creator Store: Toolbox → spinning top → paste rbxassetid as meshId
		},
	},
	{
		id = "EmberForge",
		...
		desc = "Attack-Typ: Schmelz-Rush und Lava-Bursts.",
		modelRef = {
