local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Sturzflug mit Glut-Explosionen.",
		modelRef = {
	...
	},
	{
		...
		special = "Prism Barrier",
		specialId = "PrismBarrier",
		desc = "Defense-Typ: Kristall-Schild, Reflektions-Pulse und Splitter-Burst.",
		modelRef = {
