local BeyCatalog = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(255, 110, 50),
		stats = { Attack = 9, Defense = 3, Speed = 8, Stamina = 4 },
		special = "Crimson Fang Rush",
		specialId = "CrimsonFangRush",
		desc = "Attack-Typ: Blutroter Sturmlauf mit Flammen-Meteor-Hits.",
	...
	},
	{
		...
		name = "Granite Fort",
		beyType = "Defense",
		color = Color3.fromRGB(115, 105, 95),
		...
		desc = "Defense-Typ: Felsbollwerk, Graben und Schockwellen.",
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenwind-Ringe und Orbit-Schlag.",
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(155, 165, 185),
		accentColor = Color3.fromRGB(195, 115, 255),
		stats = { Attack = 7, Defense = 5, Speed = 7, Stamina = 6 },
		special = "Phantom Veil Strike",
		specialId = "PhantomVeilStrike",
		desc = "Balance-Typ: Geisterschleier, Tauch-Angriff, Gift-Burst.",
	...
	},
	{
		...
		name = "Blaze Crown",
		beyType = "Balance",
		color = Color3.fromRGB(250, 135, 25),
		...
		desc = "Balance-Typ: Flammenkrone, Spirale und Kronen-Burst.",
