local BeyCatalog = {
	...
	},
	{
		...
		name = "Granite Fort",
		beyType = "Defense",
		color = Color3.fromRGB(110, 95, 75),
		accentColor = Color3.fromRGB(170, 150, 120),
		stats = { Attack = 3, Defense = 9, Speed = 4, Stamina = 9 },
		special = "Granite Bastion",
		specialId = "GraniteBastion",
		desc = "Defense-Typ: Felsen-Schild und Erdbeben-Schock.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(90, 170, 200),
		...
		desc = "Balance-Typ: Phantom-Klone und Klingen-Hieb.",
		modelAssets = {
