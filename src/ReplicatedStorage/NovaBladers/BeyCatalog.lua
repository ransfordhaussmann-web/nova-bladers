local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Kometensturz mit Glut-Treffern.",
		modelRef = {
		...
		modelAssets = {
			-- meshId = "rbxassetid://0",  -- Creator Store MeshId hier eintragen
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Kristall-Schild und Frost-Schockwellen.",
		modelRef = {
