local BeyCatalog = {
	...
	},
	{
		...
		modelAssets = {
			...
			-- meshId = "rbxassetid://YOUR_ID",  -- Toolbox → Creator Store → paste MeshId
		},
	},
	{
		id = "GlacierRing",
		...
		special = "Glacier Shard Lock",
		specialId = "GlacierShardLock",
		desc = "Defense-Typ: Eis-Burrow, Frost-Mauer und Shard-Pulse.",
		modelAssets = {
