local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Sternschnuppen-Rush mit Multi-Hit-Finale.",
		modelRef = {
			studioModelName = "StarfallRush",
			targetSize = 3.5,
			creatorStoreSearch = "spinning top attack red",
		},
		-- Optional Creator Store mesh: paste rbxassetid into modelAssets.meshId in Studio
	...
	},
	{
		...
		desc = "Defense-Typ: Eiskrone, Schutzschild und Frost-Schockwelle.",
		modelRef = {
			studioModelName = "FrostCrown",
			targetSize = 3.6,
			creatorStoreSearch = "spinning top ice blue",
		},
		-- modelAssets = { meshId = "rbxassetid://...", size = Vector3.new(3.6, 1.3, 3.6) },
	},
}
