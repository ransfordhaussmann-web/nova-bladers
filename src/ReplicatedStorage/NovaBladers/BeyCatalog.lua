local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm mit drei Ripper-Hits.",
		modelAssets = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(255, 225, 90),
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(85, 195, 210),
		accentColor = Color3.fromRGB(175, 255, 255),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Blade Mirage",
		specialId = "PhantomBladeMirage",
		desc = "Balance-Typ: Phantom-Klone und Klingen-Schlag.",
		modelAssets = {
