local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit drei Klingen-Schnitten.",
		modelAssets = {
	...
	},
	{
		...
		special = "Granite Bastion Surge",
		specialId = "GraniteBastionSurge",
		desc = "Defense-Typ: Fels-Schild, Säulen und Bodenbeben.",
		modelAssets = {
	...
	},
	{
		...
		special = "Solar Flare Spiral",
		specialId = "SolarFlareSpiral",
		desc = "Stamina-Typ: Sonnen-Aufladung und Feuer-Spirale.",
		modelAssets = {
			creatorStoreSearch = "spinning top stamina orange",
			meshId = nil,
			textureId = nil,
	...
	},
	{
		...
		special = "Phantom Edge Slice",
		specialId = "PhantomEdgeSlice",
		desc = "Balance-Typ: Phantom-Blink und Klingen-Finisher.",
		modelAssets = {
			creatorStoreSearch = "spinning top balance silver",
			meshId = nil,
			textureId = nil,
