local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Klingen-Wirbel und Blutroter Rush.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinanker, Resonanz-Wellen und Quake.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnen-Drift mit Hitzespur und Flare-Burst.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash, Afterimage und Schnitt-Burst.",
	},
}
