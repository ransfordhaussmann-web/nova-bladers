local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Schnelle Rend-Hits und Fang-Dash.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 7, Speed = 6, Stamina = 9, SpinDecayMult = 0.55 },
		special = "Glacier Spiral",
		specialId = "GlacierSpiral",
		desc = "Stamina-Typ: Eis-Spiral, Freeze und Frost-Burst.",
		modelRef = {
