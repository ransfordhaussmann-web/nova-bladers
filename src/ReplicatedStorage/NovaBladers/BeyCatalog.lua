local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Rush mit Ripper-Schlag-Kombo.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinpanzer, Bastion und Scherben-Pulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Mirage-Blink und Phantom-Klingen.",
		modelRef = {
