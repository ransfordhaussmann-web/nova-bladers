local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Dreifach-Slash-Rush mit Blutmond-Finisher.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Schutzschild und Erdbeben-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und Flare-Orbit um den Gegner.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash, Geisterklinge und Echo-Burst.",
		modelAssets = {
