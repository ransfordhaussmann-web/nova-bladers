local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Ringe und Solar-Orbit-Angriff.",
		modelRef = {
	...
	},
	{
		...
		special = "Crystal Petal Guard",
		specialId = "CrystalPetalGuard",
		desc = "Defense-Typ: Kristallmauer und Petal-Schockwellen.",
		modelRef = {
