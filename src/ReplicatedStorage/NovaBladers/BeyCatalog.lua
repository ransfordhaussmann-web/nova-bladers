local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Schlag-Kombo.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Bastion und Boden-Schockwelle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Orbit mit Flare-Ringen.",
		modelAssets = {
