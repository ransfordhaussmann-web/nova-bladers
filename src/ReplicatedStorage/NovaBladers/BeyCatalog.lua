local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Rush mit Klingen-Arcs und Biss-Burst.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Halo Glacier",
		specialId = "FrostHaloGlacier",
		desc = "Defense-Typ: Eis-Halo, Schutzschild und Frost-Schockwelle.",
		modelRef = {
