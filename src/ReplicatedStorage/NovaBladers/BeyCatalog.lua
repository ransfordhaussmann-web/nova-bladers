local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Fang-Rush mit schnellen Combo-Hits.",
		modelAssets = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(180, 170, 140),
	...
	},
	{
		...
		modelAssets = {
			creatorStoreSearch = "spinning top stamina gold ring",
	...
	},
	{
		...
		accentColor = Color3.fromRGB(140, 255, 240),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Slice",
		specialId = "PhantomSlice",
		desc = "Balance-Typ: Phantom-Aura, Slice-Dive und Burst.",
		modelAssets = {
			creatorStoreSearch = "spinning top balance cyan edge",
