local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Claw Barrage",
		specialId = "CrimsonClawBarrage",
		desc = "Attack-Typ: Blitz-Klauen-Serie mit Feuer-Spur.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(60, 140, 160),
		...
		desc = "Balance-Typ: Phasen-Teleport und Geisterstoß.",
		modelAssets = {
			meshId = nil,
