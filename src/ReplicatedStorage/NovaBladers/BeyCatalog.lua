local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Doppel-Lunge mit Ripper-Ketten-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Schutz und Gegen-Schockwelle.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Feuer-Orbit und Solar-Burst.",
		modelRef = {
			studioModelName = "SolarDrift",
		},
		modelAssets = {
			creatorStoreSearch = "spinning top fire sun",
		},
	},
	{
		id = "PhantomEdge",
		...
		desc = "Balance-Typ: Illusions-Klone und Phantom-Schnitt.",
		modelRef = {
