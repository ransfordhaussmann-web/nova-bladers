local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Flammen-Spirale und Explosions-Finale.",
		modelRef = {
			studioModelName = "CrimsonBlaze",
		},
		-- Optional: Creator Store meshId aus Toolbox eintragen
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Aura, Frost-Pulse und Gletscher-Schild.",
		modelRef = {
