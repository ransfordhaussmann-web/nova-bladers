local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sturmlauf mit Ripper-Schlag-Kombos.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Flare-Ringe und Wärmewellen-Orbit.",
		modelRef = {
			studioModelName = "SolarDrift",
		},
		modelAssets = {
			creatorStoreSearch = "spinning top sun gold",
	...
	},
	{
		...
		desc = "Balance-Typ: Geister-Klingen, Doppel-Dash und Illusions-Burst.",
		modelRef = {
