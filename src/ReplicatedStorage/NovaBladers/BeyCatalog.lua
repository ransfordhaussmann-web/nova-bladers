local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Snap, Lunge und Ripper-Burst.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			creatorStoreHint = "spinning top / attack bey",
		},
	},
	{
		id = "AuroraCrest",
		...
		desc = "Defense-Typ: Aurora-Dome, Barrier und Ripple-Pulse.",
		modelRef = {
			studioModelName = "AuroraCrest",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			creatorStoreHint = "spinning top / defense bey",
		},
	},
}
