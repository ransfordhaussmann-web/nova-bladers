local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbel-Sog, Flammen-Kanten und Finisher-Rush.",
		modelAssets = {
			-- Creator Store: Toolbox → "spinning top" / "bey blade metal"
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Schilde, Eis-Stachel und Lock-Burst.",
		modelAssets = {
			-- Creator Store: Toolbox → "ice bey" / "spinning top"
			-- meshId = "rbxassetid://YOUR_MESH_ID",
