local BeyCatalog = {
	...
	},
	{
		...
		name = "Glacier Mantle",
		beyType = "Defense",
		color = Color3.fromRGB(110, 175, 225),
		...
		desc = "Defense-Typ: Frost-Aura, Eisschild und Frostwellen.",
		modelRef = {
