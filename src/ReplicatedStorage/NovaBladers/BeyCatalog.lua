local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Rotierende Klingen-Cyclone mit Finisher-Rush.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Verankerung, Steinsplitter und Erdbeben-Puls.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Flare-Boost und High-Speed-Drift.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dashes und Mehrfach-Schnitte.",
	},
}
