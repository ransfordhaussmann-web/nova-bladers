local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Meteor-Sturz mit Fang-Rippern.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und Flare-Orbit-Angriff.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Geister-Aura, Phantom-Dive und Schnitt-Burst.",
		modelAssets = {
