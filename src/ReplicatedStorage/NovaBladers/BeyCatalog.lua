local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Rend-Rush und rotierender Klingensturm.",
		modelRef = {
			studioModelName = "CrimsonFang",
			referenceName = "spinning top attack",
			targetSize = 3.6,
		},
	},
	{
		...
		desc = "Defense-Typ: Frost-Aura, Eiswall und Scherben-Burst.",
		modelRef = {
			studioModelName = "FrostCrown",
			referenceName = "spinning top defense",
			targetSize = 3.8,
		},
	},
}
