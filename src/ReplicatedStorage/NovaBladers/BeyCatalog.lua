local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Stoß mit Fang-Ketten-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und langsame Orbit-Drain.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Nachbilder, Teleport-Schnitt.",
		modelRef = {
	...
	},
	{
		...
		desc = "Attack-Typ: Eis-Kristalle, Shatter-Burst.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Feuerkrone, Spiral-Angriff.",
		modelRef = {
