local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelsturm aus Klingen, dann Vorwärtsstoß.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenaufstieg, Flare-Drift und Hitze-Burst.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash, Surge durch Gegner, Kreuzschlag.",
	},
}
