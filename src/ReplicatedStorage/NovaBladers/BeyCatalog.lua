local BeyCatalog = {
	...
	},
	{
		...
		-- Creator Store: Toolbox → "spinning top fire" / "phoenix blade"
		modelAssets = { meshId = nil, textureId = nil, size = Vector3.new(3.6, 1.2, 3.6) },
	},
	{
		id = "TideAnchor",
		name = "Tide Anchor",
		...
		desc = "Defense-Typ: Gezeiten-Sog, Anker-Slam und Wellen-Schock.",
		modelAssets = { meshId = nil, textureId = nil, size = Vector3.new(3.8, 1.4, 3.8) },
	},
	{
		id = "CrimsonFang",
		name = "Crimson Fang",
		...
		desc = "Attack-Typ: Blutiger Sprint und Reiß-Hieb.",
		modelAssets = { meshId = nil, textureId = nil, size = Vector3.new(3.5, 1.1, 3.5) },
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinmauer, Wurzeln und Erdbeben-Pulse.",
		modelAssets = { meshId = nil, textureId = nil, size = Vector3.new(4.0, 1.5, 4.0) },
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnen-Flares und Orbit-Schleife.",
		modelAssets = { meshId = nil, textureId = nil, size = Vector3.new(3.9, 1.0, 3.9) },
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		modelAssets = { meshId = nil, textureId = nil, size = Vector3.new(3.5, 1.0, 3.5) },
	},
}
