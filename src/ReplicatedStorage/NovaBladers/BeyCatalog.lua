local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sturmlauf mit Ripper-Kettenhieben.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinbollwerk, Reflektions-Schild und Scherbenstoß.",
		modelAssets = {
			creatorStoreSearch = "spinning top defense shield stone",
		},
	},
	{
		id = "SolarDrift",
		...
		desc = "Stamina-Typ: Sonnenringe, Flare-Orbit und Spin-Recovery.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone, Blink-Dash und Klingenstoß.",
		modelAssets = {
			creatorStoreSearch = "spinning top phantom blade cyan",
		},
	},
}
