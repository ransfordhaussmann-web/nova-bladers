local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Sägeklingen-Dreifach-Hit.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
		},
		-- Optional Creator Store mesh: paste rbxassetid into meshId after Studio import
	...
	},
	{
		...
		desc = "Defense-Typ: Aurora-Kuppel mit Reflektions-Pulsen.",
		modelRef = {
