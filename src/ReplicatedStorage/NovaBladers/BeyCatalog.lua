local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spiral-Rush mit Finisher-Burst.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 9, Speed = 4, Stamina = 7, SpinDecayMult = 0.55 },
		special = "Glacier Aegis",
		specialId = "GlacierAegis",
		desc = "Defense-Typ: Eis-Schild, Shard-Pulse und Slam-Welle.",
		modelRef = {
