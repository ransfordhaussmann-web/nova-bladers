local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Doppel-Lunge mit Ripper-Finisher.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Anker, Steinmauer und Schockwellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flares und Orbit-Angriff.",
		modelAssets = {
			creatorStoreSearch = "spinning top sun yellow stamina",
		},
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(170, 200, 240),
		...
		desc = "Balance-Typ: Fade, Slash und Mirage-Burst.",
		modelAssets = {
			creatorStoreSearch = "spinning top phantom silver balance",
		},
	},
}
