local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Spiral-Rush zieht Gegner ins Zentrum.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 3, Defense = 9, Speed = 4, Stamina = 8, SpinDecayMult = 0.7 },
		special = "Glacier Frost Lock",
		specialId = "GlacierFrostLock",
		desc = "Defense-Typ: Frost-Mantel, Eisbarriere und Freeze-Pulse.",
		modelRef = {
