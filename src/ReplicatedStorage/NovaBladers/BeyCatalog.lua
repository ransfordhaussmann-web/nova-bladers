local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Rush mit drei Fang-Schlägen.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenladung und expandierende Flare-Ringe.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Illusions-Klone und Teleport-Schlag.",
		modelRef = {
