local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutiger Sturzangriff mit Ripper-Ketten.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Schadensabsorption und Gegenschlag.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Flares und eiserne Orbit-Spur.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone, Feint-Dash und Klingenstoß.",
		modelAssets = {
