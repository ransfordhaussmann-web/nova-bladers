local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelsturm-Rush mit Reißzahn-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Schockwellen und Erdbeben.",
		modelAssets = {
			-- Toolbox → Creator Store → "stone spinning top" / "bey defense"
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Aura, Flammen-Ringe und Orbit.",
		modelAssets = {
			-- Toolbox → Creator Store → "golden spinning top" / "sun bey"
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		desc = "Balance-Typ: Void-Blink, Phantom-Slash und Burst.",
		modelAssets = {
			-- Toolbox → Creator Store → "ghost spinning top" / "phantom bey"
			-- meshId = "rbxassetid://0",
