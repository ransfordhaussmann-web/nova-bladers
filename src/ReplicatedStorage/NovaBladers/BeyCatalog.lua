local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Meteor-Dusche mit Flammen-Spuren.",
		modelAssets = {
			-- Creator Store: paste rbxassetid meshId here
			meshId = nil,
		},
	},
	{
		...
		desc = "Defense-Typ: Sprung und Gewichtsschock beim Landen.",
		modelAssets = {
			meshId = nil,
		},
	},
	{
		...
		accentColor = Color3.fromRGB(255, 80, 60),
		stats = { Attack = 8, Defense = 4, Speed = 7, Stamina = 5 },
		special = "Crimson Rend",
		specialId = "CrimsonRend",
		desc = "Attack-Typ: Blutiger Sprung und Reiß-Burst.",
		modelAssets = {
			meshId = nil,
		},
	},
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash durch Ziel und Burst.",
		modelAssets = {
			meshId = nil,
		},
	},
