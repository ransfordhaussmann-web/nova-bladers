local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Dreifach-Dash mit Klingen-Hits.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		stats = { Attack = 3, Defense = 10, Speed = 4, Stamina = 8 },
		special = "Granite Rampart",
		specialId = "GraniteRampart",
		desc = "Defense-Typ: Steinmauer und Boden-Beben.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		stats = { Attack = 6, Defense = 5, Speed = 8, Stamina = 10, SpinDecayMult = 0.55 },
