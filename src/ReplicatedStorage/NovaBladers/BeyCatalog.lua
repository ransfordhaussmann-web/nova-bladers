local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Flammensturz und Brenn-Rush.",
		modelRef = {
	...
	},
	{
		...
		name = "Frost Crown",
		beyType = "Defense",
		color = Color3.fromRGB(120, 185, 245),
		...
		desc = "Defense-Typ: Eiswall, Frost-Pulse und Schutz.",
		modelRef = {
			studioModelName = "FrostCrown",
			creatorStoreSearch = "spinning top ice crown defense",
			targetSize = 3.5,
		},
	},
}
