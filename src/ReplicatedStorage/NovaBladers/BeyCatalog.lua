local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rad, Flammenringe und Inferno-Burst.",
		creatorStore = {
			searchTerms = { "spinning top fire", "beyblade attack", "flame top" },
	...
	},
	{
		...
		desc = "Defense-Typ: Kristall-Schutzschild, Frostwellen und Eis-Splitter.",
		creatorStore = {
			searchTerms = { "spinning top ice", "beyblade defense", "crystal top" },
