local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Slash-Rush mit Explosions-Finale.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Aura, Frostwall und Kälte-Pulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Spirale und Nova-Detonation.",
		modelRef = {
