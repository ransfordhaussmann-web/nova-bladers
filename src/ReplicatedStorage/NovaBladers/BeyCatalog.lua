local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Slash-Rush mit Mehrfach-Hits.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
	...
	},
	{
		...
		desc = "Balance-Typ: Illusions-Dash und Phantom-Schnitt.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		...
		desc = "Defense-Typ: Eiskrone, Frost-Schockwelle.",
	},
	{
		id = "CrimsonDrift",
		name = "Crimson Drift",
		...
		accentColor = Color3.fromRGB(255, 70, 100),
		stats = { Attack = 6, Defense = 5, Speed = 9, Stamina = 8, SpinDecayMult = 0.7 },
		special = "Crimson Drift Surge",
		specialId = "CrimsonDriftSurge",
		desc = "Stamina-Typ: Drift-Surge mit Feuer-Spur.",
	},
}
