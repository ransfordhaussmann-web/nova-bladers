local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Rush mit schnellen Nahkampf-Hits.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash und Geisterschnitt.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
	...
	},
	{
		...
		stats = { Attack = 7, Defense = 5, Speed = 9, Stamina = 7, SpinDecayMult = 0.7 },
		special = "Crimson Drift Surge",
		specialId = "CrimsonDriftSurge",
		desc = "Stamina-Typ: Hochgeschwindigkeits-Drift mit Impact-Wellen.",
	},
}
