local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Felsbunker, Schockpulse und Widerstand.",
		modelAssets = {
			meshId = nil,
			textureId = nil,
	...
	},
	{
		...
		special = "Solar Pulse Tempest",
		specialId = "SolarPulseTempest",
		desc = "Stamina-Typ: Sonnenringe und Orbit-Druck.",
		modelAssets = {
			meshId = nil,
			textureId = nil,
	...
	},
	{
		...
		special = "Phantom Void Fang",
		specialId = "PhantomVoidFang",
		desc = "Balance-Typ: Geist-Aura, Void-Dive und Burst.",
		modelAssets = {
			meshId = nil,
			textureId = nil,
