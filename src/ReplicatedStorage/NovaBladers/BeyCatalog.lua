local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Schläge in schneller Folge.",
	...
	},
	{
		...
		accentColor = Color3.fromRGB(170, 175, 155),
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenflare und Orbit-Brennen.",
		modelAssets = {},
	},
	{
		id = "PhantomEdge",
		...
		desc = "Balance-Typ: Mirage-Blink und Phantom-Schnitt.",
		modelAssets = {},
	},
	{
		id = "FrostCrown",
		...
		stats = { Attack = 5, Defense = 7, Speed = 6, Stamina = 8 },
		special = "Frost Crown Shatter",
		specialId = "FrostCrownShatter",
		desc = "Defense-Typ: Frost-Aura und Eissplitter-Explosion.",
		modelAssets = {},
	},
	{
		id = "CrimsonDrift",
		...
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 7, SpinDecayMult = 0.7 },
		special = "Crimson Drift Surge",
		specialId = "CrimsonDriftSurge",
		desc = "Stamina-Typ: Feuer-Surge mit Trail-Hits.",
		modelAssets = {},
	},
}
