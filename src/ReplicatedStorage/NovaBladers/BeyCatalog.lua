local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Federn-Sturm mit Scatter-Hits.",
	...
	},
	{
		...
		desc = "Defense-Typ: Anker-Slam und Gezeiten-Schockwelle.",
		-- modelAssets: { meshId = "rbxassetid://...", size = Vector3.new(3.8, 1.4, 3.8) }
	},
	{
		id = "CrimsonFang",
		name = "Crimson Fang",
		...
		desc = "Attack-Typ: Blutiger Fang-Stoß mit Rend-Burst.",
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer und Gegenstoß-Pulse.",
		-- modelAssets: { meshId = "rbxassetid://...", size = Vector3.new(4.0, 1.5, 4.0) }
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		-- modelAssets: { meshId = "rbxassetid://...", size = Vector3.new(3.9, 1.0, 3.9) }
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash durch Gegner und Schlitzer.",
		-- modelAssets: { meshId = "rbxassetid://...", size = Vector3.new(3.5, 1.2, 3.5) }
	},
}
