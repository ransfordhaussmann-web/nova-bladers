local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelsturm aus Klingen und Finisher-Rush.",
		modelAssets = {
			-- Optional: paste Creator Store meshId here (Toolbox → Creator Store → spinning top)
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Schockwellen und Eruption.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenflare und High-Speed-Drift.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(170, 190, 210),
		accentColor = Color3.fromRGB(120, 220, 255),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 7 },
		special = "Phantom Edge Surge",
		specialId = "PhantomEdgeSurge",
		desc = "Balance-Typ: Phasen-Dash, Surge und Klingenschlag.",
	},
}
