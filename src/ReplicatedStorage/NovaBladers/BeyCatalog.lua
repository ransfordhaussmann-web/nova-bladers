local BeyCatalog = {
	...
	},
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "defense", "shell bey" },
		},
	},
	{
		id = "VoltDash",
		...
		creatorStore = {
			searchTerms = { "spinning top", "stamina", "speed bey" },
		},
	},
	{
		id = "ShadowBite",
		...
		creatorStore = {
			searchTerms = { "spinning top", "balance", "dark bey" },
		},
	},
	{
		id = "BlazeWheel",
		...
		desc = "Attack-Typ: Feuer-Rad, Flammen-Spur und Eruption.",
		creatorStore = {
			searchTerms = { "spinning top", "fire", "flame bey" },
	...
	},
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "ice", "frost bey" },
