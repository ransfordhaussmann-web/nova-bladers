local BeyCatalog = {
	...
	},
	{
		...
		modelRef = {
			...
			targetSize = 3.6,
			searchTerms = { "spinning top", "flat top", "stamina top" },
		},
	},
	{
		id = "ShadowBite",
		...
		modelRef = {
			...
			targetSize = 3.5,
			searchTerms = { "spinning top", "dark top", "balance top" },
		},
	},
	{
		id = "CrimsonEdge",
		...
		desc = "Attack-Typ: Flammen-Rush mit Meteor-Hits.",
		modelRef = {
			studioModelName = "CrimsonEdge",
			targetSize = 3.5,
			searchTerms = { "spinning top", "red top", "flame top" },
		},
	},
	{
		id = "FrostHalo",
		...
		desc = "Defense-Typ: Eis-Festung und Frost-Pulse.",
		modelRef = {
