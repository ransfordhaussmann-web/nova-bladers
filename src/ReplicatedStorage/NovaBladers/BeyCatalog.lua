local BeyCatalog = {
	...
	},
	{
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "lightning", "speed bey" },
		},
	},
	{
		id = "ShadowBite",
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "dark", "fang bey" },
		},
	},
	{
		id = "CrimsonOrbit",
		...
		desc = "Attack-Typ: Solar-Charge, Flare-Rush und Inferno-Burn.",
		modelRef = {
			studioModelName = "CrimsonOrbit",
			searchTerms = { "spinning top", "fire", "red bey", "solar" },
		},
	},
	{
		id = "FrostAnchor",
		...
		desc = "Defense-Typ: Frost-Aura, Gletscher-Mauer und Eis-Splitter.",
		modelRef = {
			studioModelName = "FrostAnchor",
			searchTerms = { "spinning top", "ice", "frost", "anchor bey" },
		},
	},
}
