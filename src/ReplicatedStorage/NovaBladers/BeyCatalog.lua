local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rush mit Inferno-Spur und Eruption.",
		modelRef = {
			studioModelName = "BlazeSurge",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
		},
		-- Optional Creator Store mesh: Toolbox → "spinning top fire" / "blaze top"
	...
	},
	{
		...
		special = "Crystal Tide Wall",
		specialId = "CrystalTideWall",
		desc = "Defense-Typ: Eisbarriere, Frost-Schutz und Kristall-Splitter.",
		modelRef = {
