local BeyCatalog = {
	...
	},
	{
		...
		special = "Glacial Surge",
		specialId = "GlacialSurge",
		desc = "Stamina-Typ: Frost-Ringe und Eis-Orbit.",
		modelRef = {
	...
	},
	{
		...
		special = "Solar Flare Barrage",
		specialId = "SolarFlareBarrage",
		desc = "Attack-Typ: Feuer-Rush und Flammen-Hagel.",
		modelRef = {
