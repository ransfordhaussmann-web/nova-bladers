local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Federn regnen auf Gegner herab.",
		modelAssets = {
			-- Creator Store: Toolbox → meshId einfügen (optional)
	...
	},
	{
		...
		desc = "Defense-Typ: Unterwasser-Anker und Wellen-Schock.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Flare-Ringe und Orbit.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(160, 170, 220),
