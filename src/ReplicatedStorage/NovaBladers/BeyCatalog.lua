local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm mit Reißzahn-Kombo.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinschild und Spiegel-Schockwelle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenring-Orbit und Flare-Burst.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(85, 175, 195),
