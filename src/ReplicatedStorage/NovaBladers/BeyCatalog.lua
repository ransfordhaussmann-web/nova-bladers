local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutiger Slash-Rush mit Mehrfach-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinschild und Erdbeben-Schockwellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und langsame Orbit-Drift.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phase-Blink hinter Gegner und Kreuz-Slash.",
		modelAssets = {
