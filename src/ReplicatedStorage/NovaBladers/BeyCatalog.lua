local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm mit blutroten Ripper-Hits.",
		modelRef = {
		...
		-- Optional: paste rbxassetid from Creator Store mesh into meshId
	...
	},
	{
		...
		desc = "Defense-Typ: Polar-Kuppel, Schutz und Frost-Schockwelle.",
		modelRef = {
