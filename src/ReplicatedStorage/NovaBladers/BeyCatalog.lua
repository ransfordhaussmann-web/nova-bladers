local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Inferno Lance",
		specialId = "CrimsonInfernoLance",
		desc = "Attack-Typ: Feuer-Lanze und Eruptions-Burst.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eisrüstung, Splitter-Ringe und Frost-Burst.",
		modelRef = {
