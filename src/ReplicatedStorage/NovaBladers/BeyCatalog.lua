local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Reflekt-Pulse und Erdbeben-Schock.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Ringe und Flare-Orbit um den Gegner.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Afterimages, Blink hinter den Gegner, Klingen-Burst.",
		modelAssets = {
