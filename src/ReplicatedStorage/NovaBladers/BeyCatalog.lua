local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Doppel-Ripper-Schlag.",
		modelAssets = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(160, 175, 190),
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flares und Umlaufbahn-Angriff.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone, Dash und Klingenstoß.",
		modelAssets = {
