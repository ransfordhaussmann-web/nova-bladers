local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm mit Ripper-Finisher.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Festung und Erdbeben-Wellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flare und Sonnen-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone und Blade-Slash.",
		modelAssets = {
			creatorStoreSearch = "spinning top cyan phantom blade",
		},
	},
}
