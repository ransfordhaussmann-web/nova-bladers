local BeyCatalog = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Drift mit Flare-Finisher.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(55, 175, 215),
		accentColor = Color3.fromRGB(150, 250, 255),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Edge Surge",
		specialId = "PhantomEdgeSurge",
		desc = "Balance-Typ: Phasen-Sprung, Schnitt-Kombo und Surge-Burst.",
	},
}
