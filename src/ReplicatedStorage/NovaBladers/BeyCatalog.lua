local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer und seismische Schockwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenkorona und Hitzeschleife.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Blink, Phantom-Schnitt und Burst.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		...
		desc = "Defense-Typ: Eiskrone, Schild und Frost-Burst.",
	},
	{
		id = "CrimsonDrift",
		name = "Crimson Drift",
		...
		stats = { Attack = 8, Defense = 4, Speed = 10, Stamina = 5 },
		special = "Crimson Drift Surge",
		specialId = "CrimsonDriftSurge",
		desc = "Attack-Typ: Hochgeschwindigkeits-Surge mit Nachbrenner.",
	},
}
