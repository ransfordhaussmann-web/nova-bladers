local BeyCatalog = {
	...
	},
	{
		...
		name = "Crimson Fang",
		beyType = "Attack",
		color = Color3.fromRGB(180, 35, 45),
		accentColor = Color3.fromRGB(255, 70, 55),
		stats = { Attack = 9, Defense = 3, Speed = 8, Stamina = 4 },
		special = "Crimson Ripper Lunge",
		specialId = "CrimsonRipperLunge",
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Ketten-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Festungs-Modus mit Granit-Schockwellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flares und gleitende Orbit-Spur.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(175, 175, 195),
		accentColor = Color3.fromRGB(225, 225, 255),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Blade Mirage",
		specialId = "PhantomBladeMirage",
		desc = "Balance-Typ: Phantom-Klone und Blade-Dash.",
		modelAssets = {
