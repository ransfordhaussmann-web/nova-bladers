local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Federn-Sturm mit Multi-Hit-Burst.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Hochsprung, Anker-Hover und Wellen-Slam.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge und blutiger Rend-Burst.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Fels-Burrow, Steinmauer und Schockpulse.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Vanish, Durchstoß und Geister-Schnitt.",
		modelAssets = {
			size = Vector3.new(3.5, 1.1, 3.5),
		},
	},
