local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutrote Klingen-Serie und finaler Cleave.",
		modelAssets = {
			-- Creator Store: Toolbox → spinning top / arena top → meshId eintragen
			meshId = nil,
			textureId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Nova, Eis-Halte und Shatter-Burst.",
		modelAssets = {
			meshId = nil,
			textureId = nil,
