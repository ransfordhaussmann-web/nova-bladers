local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Spiral-Rush mit Vortex-Slam.",
		modelAssets = {
			-- Optional: Toolbox → Creator Store → "spinning top" → meshId eintragen
			meshId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Aura, Eiswall und Gefrier-Pulse.",
		modelAssets = {
			meshId = nil,
