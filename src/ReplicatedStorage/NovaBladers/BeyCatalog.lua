local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Aufheizen, Hammer-Rush und Scherben-Burst.",
		modelRef = {
			studioModelName = "CrimsonForge",
			creatorStoreQuery = "spinning top metal red",
			targetSize = 3.5,
		},
	},
	{
		...
		desc = "Defense-Typ: Frost-Aura, Eiskrone und Frostbiss-Pulse.",
		modelRef = {
			studioModelName = "FrostCrown",
			creatorStoreQuery = "spinning top ice blue",
			targetSize = 3.5,
		},
	},
}
