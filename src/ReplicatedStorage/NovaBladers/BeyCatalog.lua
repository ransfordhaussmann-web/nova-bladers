local BeyCatalog = {
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "attack bey", "pegasus" },
			studioModelName = "NovaStriker",
		},
	},
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "defense bey", "turtle shell" },
	...
	},
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "balance bey", "dark fang" },
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spur und Inferno-Explosion.",
		creatorStore = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Schutzschild und Kristall-Splitter.",
		creatorStore = {
