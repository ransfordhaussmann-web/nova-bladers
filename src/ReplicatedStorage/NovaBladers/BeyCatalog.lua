local BeyCatalog = {
	...
	},
	{
		...
		name = "Granite Fort",
		beyType = "Defense",
		color = Color3.fromRGB(100, 110, 115),
		accentColor = Color3.fromRGB(170, 180, 190),
		stats = { Attack = 3, Defense = 9, Speed = 4, Stamina = 8 },
		special = "Granite Bastion",
		specialId = "GraniteBastion",
		desc = "Defense-Typ: Steinwall und Gegenstoß-Wellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und Flare-Burst.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Schläge und Klingen-Finale.",
		modelAssets = {
