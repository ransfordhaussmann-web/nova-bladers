local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Stoß mit Ripper-Klingen-Follow-up.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankerung, Steinmauer und Schockwelle.",
		modelAssets = {
			creatorStoreSearch = "spinning top stone defense shield",
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Flare und expandierende Orbit-Ringe.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(120, 130, 180),
		accentColor = Color3.fromRGB(200, 210, 255),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 6 },
		special = "Phantom Blade Mirage",
		specialId = "PhantomBladeMirage",
		desc = "Balance-Typ: Phantom-Klon, Dash und Klingen-Schnitt.",
		modelAssets = {
