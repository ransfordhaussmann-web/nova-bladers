local BeyCatalog = {
	...
	},
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "fire wheel", "blaze disc" },
			note = "Toolbox Creator Store — optional Mesh unter Models/BlazeWheel importieren",
		},
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Burrow, Frost-Mauer und Kälte-Wellen.",
		creatorStore = {
			searchTerms = { "spinning top", "ice disc", "frost shield" },
			note = "Toolbox Creator Store — optional Mesh unter Models/FrostVeil importieren",
		},
		modelRef = {
