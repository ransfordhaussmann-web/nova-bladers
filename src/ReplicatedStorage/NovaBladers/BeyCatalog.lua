local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Tornado mit Zugkraft und Flammen-Burst.",
		-- Creator Store: Toolbox → Creator Store → paste meshId from asset
		modelAssets = {
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		desc = "Defense-Typ: Eisschild, Frost-Aura und Gletscher-Schockwelle.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
