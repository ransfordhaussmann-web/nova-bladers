local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spiralen und Flammen-Meteore.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eisschild, Frost-Bindung und Kälte-Impulse.",
		modelAssets = {
			-- Creator Store: search "ice spinning top" / "frost bey"
			-- meshId = "rbxassetid://0",
			-- size = Vector3.new(3.6, 1.2, 3.6),
		},
	},
