local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale mit Flammenringen.",
		modelRef = {
			studioModelName = "CrimsonEdge",
			targetSize = 3.5,
		},
		-- Creator Store: paste rbxassetid from Toolbox mesh into meshId
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Panzer, Splitter und Frost-Schock.",
		modelRef = {
