local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rush mit Blaze-Trail und Flammen-Burst.",
		modelRef = {
	...
	},
	{
		...
		name = "Aqua Spiral",
		beyType = "Stamina",
		color = Color3.fromRGB(40, 180, 230),
		...
		desc = "Stamina-Typ: Wasser-Vortex zieht Gegner an und spritzt sie weg.",
		modelRef = {
