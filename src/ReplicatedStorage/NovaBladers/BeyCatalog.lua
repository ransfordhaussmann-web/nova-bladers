local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Slash-Kombo.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Fortifikation und Boden-Slam.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Vanish und Mirage-Ambush.",
		modelAssets = {
			creatorStoreSearch = "spinning top phantom purple",
			meshId = nil,
		},
	},
}
