local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Rotierende Klingen-Spirale mit Schnitt-Combo.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Schockwellen und Festung.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenringe und Flare-Burn.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash, Echo-Klingen und Surge-Burst.",
	},
}
