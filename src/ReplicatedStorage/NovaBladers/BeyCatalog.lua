local BeyCatalog = {
	...
	},
	{
		...
		stats = { Attack = 8, Defense = 3, Speed = 8, Stamina = 4 },
		special = "Blaze Feather Storm",
		specialId = "BlazeFeatherStorm",
		desc = "Attack-Typ: Feuer-Federn-Sturm mit Multi-Hit-Rush.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Gezeitenwelle, Anker-Slam und Schock.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Felsbrocken und Schockwellen.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		accentColor = Color3.fromRGB(230, 220, 255),
