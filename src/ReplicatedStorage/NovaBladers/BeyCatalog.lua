local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Brennende Meteor-Klingen aus der Luft.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eisbunker, Frostschutzmauer und Kältepulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Solar-Schockwellen und Helix-Orbit-Angriff.",
		modelRef = {
