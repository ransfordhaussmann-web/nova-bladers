local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelnde Klingen-Cyclone mit Flächenschaden.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Verankerung, Schutzschild und Stein-Pulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		stats = { Attack = 5, Defense = 5, Speed = 7, Stamina = 10, SpinDecayMult = 0.6 },
		special = "Solar Flare Drift",
		specialId = "SolarFlareDrift",
		desc = "Stamina-Typ: Solar-Drift mit Feuer-Spur und Flare-Burst.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(95, 155, 195),
		accentColor = Color3.fromRGB(175, 225, 255),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Edge Surge",
		specialId = "PhantomEdgeSurge",
		desc = "Balance-Typ: Phantom-Dashes und Edge-Surge.",
	},
}
