local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Rotierender Spiral-Rush mit Feuer-Trails.",
		modelRef = {
	...
	},
	{
		...
		special = "Glacier Shard Wall",
		specialId = "GlacierShardWall",
		desc = "Defense-Typ: Eisschild, Frost-Pulse und Schneewellen.",
		modelRef = {
