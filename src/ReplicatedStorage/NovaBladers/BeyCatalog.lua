local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Orbit und Flammen-Burst.",
		-- Optional Creator Store mesh: Toolbox → Creator Store → paste rbxassetid into modelAssets.meshId
		modelAssets = {
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		desc = "Defense-Typ: Eis-Mauer, Frostwellen und Shard-Burst.",
		modelAssets = {
			-- meshId = "rbxassetid://0",
		},
	},
