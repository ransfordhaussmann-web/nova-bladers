local BeyCatalog = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Ringe und Spin-Recovery-Drift.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash mit Klingen-Nachbildern.",
	},
}
