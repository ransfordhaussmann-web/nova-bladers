local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit blutroten Klingen-Schnitten.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Bastion und Erdbeben-Schlag.",
		modelAssets = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 6, Speed = 7, Stamina = 9, SpinDecayMult = 0.6 },
		special = "Solar Flare Orbit",
		specialId = "SolarFlareOrbit",
		desc = "Stamina-Typ: Sonnen-Aura, Flare-Ringe und Brenn-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Kopien, Klingen-Dash und Mirage-Strike.",
		modelAssets = {
