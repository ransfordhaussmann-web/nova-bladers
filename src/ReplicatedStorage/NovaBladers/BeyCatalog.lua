local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feder-Sturm und Flare-Rush.",
	...
	},
	{
		...
		stats = { Attack = 10, Defense = 3, Speed = 7, Stamina = 4 },
		special = "Crimson Rend",
		specialId = "CrimsonRend",
		desc = "Attack-Typ: Blitz-Rush und Blut-Stiche.",
		modelAssets = { meshId = nil, textureId = nil },
	},
	{
		id = "GraniteFort",
		...
		stats = { Attack = 4, Defense = 10, Speed = 3, Stamina = 8 },
		special = "Granite Rampart",
		specialId = "GraniteRampart",
		desc = "Defense-Typ: Steinmauer und Scherben-Puls.",
		modelAssets = { meshId = nil, textureId = nil },
	},
	{
		id = "SolarDrift",
		...
		desc = "Stamina-Typ: Sonnen-Ringe und Orbit-Brennen.",
		modelAssets = { meshId = nil, textureId = nil },
	},
	{
		id = "PhantomEdge",
		...
		accentColor = Color3.fromRGB(180, 190, 255),
