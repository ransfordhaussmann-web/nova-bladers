local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Brennender Spiral-Rush mit Feuer-Schleifspuren.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Icewall",
		specialId = "FrostIcewall",
		desc = "Defense-Typ: Eis-Bunker, Frostwall und Kälte-Schockwellen.",
		modelRef = {
