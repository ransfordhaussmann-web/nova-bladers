local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rush mit brennenden Meteor-Hits.",
		modelRef = {
	...
	},
	{
		...
		special = "Glacier Barrier",
		specialId = "GlacierBarrier",
		desc = "Defense-Typ: Eis-Mauer, Schutzschild und Frost-Schockwellen.",
		modelRef = {
