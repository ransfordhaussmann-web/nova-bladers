local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Orbit Slash",
		specialId = "CrimsonOrbitSlash",
		desc = "Attack-Typ: Roter Spiral-Angriff mit Sonic-Slices.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Anchor Lock",
		specialId = "FrostAnchorLock",
		desc = "Defense-Typ: Eis-Burrow, Frostwall und Kältepulse.",
		modelRef = {
