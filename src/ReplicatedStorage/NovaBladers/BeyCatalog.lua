local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Erdbeben und Reflex-Schock.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flares und weite Orbit-Drifts.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone und Klingen-Mirage.",
		modelAssets = {
