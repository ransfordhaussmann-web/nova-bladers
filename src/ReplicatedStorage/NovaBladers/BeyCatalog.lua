local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Schlag am Ziel.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Schild, Schockwellen und Standfestigkeit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Orbit mit Flare-Detonation.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klonen, Feint und Seitenhieb.",
		modelAssets = {
