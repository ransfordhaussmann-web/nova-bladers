local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Scharfe Reißzähne und Blut-Sturm-Rush.",
	...
	},
	{
		...
		special = "Phantom Slash",
		specialId = "PhantomSlash",
		desc = "Balance-Typ: Geisterrausch und Phantom-Stoß.",
	...
	},
	{
		...
		stats = { Attack = 8, Defense = 5, Speed = 6, Stamina = 7 },
		special = "Crystal Shatter",
		specialId = "CrystalShatter",
		desc = "Attack-Typ: Kristall-Splitter und Eissturm.",
	...
	},
	{
		...
		desc = "Attack-Typ: Flammenkrone und Hitze-Explosion.",
