local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Wasser-Anker, Schutzmauer und Wellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Dive und Reiß-Burst.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Bollwerk mit schweren Schockwellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Geister-Aura, Phasen-Dive und Schnitt-Burst.",
		modelAssets = {
			size = Vector3.new(3.5, 1.1, 3.5),
		},
	},
