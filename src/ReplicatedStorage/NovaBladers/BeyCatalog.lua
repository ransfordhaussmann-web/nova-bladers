local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sturmlauf mit Reißzahn-Kombo.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Spikes und Bodenbeben.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenflare-Ringe und Brenn-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Blink, Nachbilder und Klingenschlag.",
		modelAssets = {
