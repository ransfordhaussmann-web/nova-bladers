local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutrote Fang-Ketten und Meteor-Hagel.",
	...
	},
	{
		...
		accentColor = Color3.fromRGB(180, 255, 250),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Void Slash",
		specialId = "PhantomVoidSlash",
		desc = "Balance-Typ: Geister-Aura, Void-Dive und Energie-Schnitt.",
		modelAssets = { meshId = nil },
	},
}
