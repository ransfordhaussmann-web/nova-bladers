local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Rotierende Klingen-Cyclone mit Rush-Finale.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinmauer, Schutz und Schockwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Flare-Ringe und Drift-Angriff.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash, Teleport-Surge und Schnitt.",
	},
}
