local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rush mit Ember-Hits.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
			creatorStoreSearch = "spinning top fire red",
		},
		-- Creator Store: Toolbox → meshId eintragen → überschreibt Procedural-Modell
	...
	},
	{
		...
		desc = "Defense-Typ: Eisschild und Frost-Schockwelle.",
		modelRef = {
