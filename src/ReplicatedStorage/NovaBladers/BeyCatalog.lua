local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Fang Storm",
		specialId = "CrimsonFangStorm",
		desc = "Attack-Typ: Blitz-Rush mit drei Fang-Hits.",
		modelAssets = {
			creatorStoreSearch = "spinning top red attack blade",
			note = "Toolbox → Creator Store → passendes Attack-Top importieren, meshId eintragen",
		},
	},
	{
		id = "GraniteFort",
		...
		desc = "Defense-Typ: Steinmauer, Anker und Erschütterung.",
		modelAssets = {
			creatorStoreSearch = "spinning top defense heavy stone",
			note = "Toolbox → Creator Store → schweres Defense-Top, meshId eintragen",
		},
	},
	{
		id = "SolarDrift",
		...
		desc = "Stamina-Typ: Sonnenringe und Gravitations-Drift.",
		modelAssets = {
			creatorStoreSearch = "spinning top golden stamina ring",
			note = "Toolbox → Creator Store → flaches Stamina-Top, meshId eintragen",
		},
	},
	{
		id = "PhantomEdge",
		...
		accentColor = Color3.fromRGB(155, 135, 255),
		stats = { Attack = 7, Defense = 5, Speed = 7, Stamina = 7 },
		special = "Phantom Phase Strike",
		specialId = "PhantomPhaseStrike",
		desc = "Balance-Typ: Phasen-Teleport und Echo-Schlag.",
		modelAssets = {
			creatorStoreSearch = "spinning top phantom ghost balance",
			note = "Toolbox → Creator Store → Balance-Top mit Klingen, meshId eintragen",
		},
	},
}
