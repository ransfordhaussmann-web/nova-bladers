local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sturmlauf mit Ripper-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Boden-Slam und Nachbeben.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Orbit und Flare-Explosion.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klingen und Mirage-Konvergenz.",
		modelAssets = {
