local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Rend Cascade",
		specialId = "CrimsonRendCascade",
		desc = "Attack-Typ: Blitz-Rush und kaskadierende Klingen-Hits.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Shard Maelstrom",
		specialId = "FrostShardMaelstrom",
		desc = "Defense-Typ: Eiskristalle, Frostwall und Shard-Burst.",
		modelRef = {
