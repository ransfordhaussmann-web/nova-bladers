local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale mit expandierendem Flammenring.",
		modelRef = {
			studioModelName = "BlazeWheel",
			referenceName = "Creator Store spinning top (fire)",
			credit = "optional import",
		},
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Panzer, Frostwellen und Einfrier-Zone.",
		modelRef = {
			studioModelName = "FrostVeil",
			referenceName = "Creator Store spinning top (ice)",
			credit = "optional import",
		},
	},
}
