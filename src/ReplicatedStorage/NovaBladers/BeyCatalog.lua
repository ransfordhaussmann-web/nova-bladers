local BeyCatalog = {
	{
		...
		modelRef = {
			...
			creatorStoreQuery = "spinning top attack pegasus",
		},
	},
	{
		id = "IronShell",
		...
		modelRef = {
			...
			creatorStoreQuery = "spinning top defense metal",
		},
	},
	{
		id = "VoltDash",
		...
		modelRef = {
			...
			creatorStoreQuery = "spinning top stamina yellow",
		},
	},
	{
		id = "ShadowBite",
		...
		modelRef = {
			...
			creatorStoreQuery = "spinning top dark balance",
		},
	},
	{
		id = "CrimsonForge",
		...
		desc = "Attack-Typ: Aufheizen, Slam-Rush und Scherben-Explosion.",
		modelRef = {
			studioModelName = "CrimsonForge",
			creatorStoreQuery = "spinning top red attack forge",
		},
	},
	{
		id = "FrostCrown",
		...
		desc = "Defense-Typ: Eisnebel, Kristallkrone und Frost-Pulse.",
		modelRef = {
			studioModelName = "FrostCrown",
			creatorStoreQuery = "spinning top ice crystal defense",
		},
	},
}
