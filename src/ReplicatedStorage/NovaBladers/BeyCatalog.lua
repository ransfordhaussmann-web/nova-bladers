local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutrote Klingen-Rush mit Meteor-Hits.",
		modelRef = {
			studioModelName = "CrimsonFang",
			toolboxSearchHint = "spinning top metal red attack",
			targetSize = 3.5,
		},
	},
	{
		...
		desc = "Defense-Typ: Eiskrone, Schutzmauer und Frostwellen.",
		modelRef = {
