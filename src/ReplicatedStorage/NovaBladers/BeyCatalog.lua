local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Parieren und Gegenstoß mit Klauen-Schlag.",
		modelAssets = {
			-- Toolbox → Creator Store → paste rbxassetid meshId here
			-- meshId = "rbxassetid://0",
		},
	},
	{
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Halo und Orbit-Sog.",
		modelAssets = {},
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(100, 130, 180),
		...
		desc = "Balance-Typ: Phasen-Sprung und Schatten-Schnitt.",
		modelAssets = {},
	},
	{
		id = "CrystalEdge",
		...
		desc = "Attack-Typ: Kristall-Sturm mit Splitter-Hits.",
		modelAssets = {},
	},
	{
		id = "BlazeCrown",
		...
		desc = "Attack-Typ: Feuerkrone und Flammen-Detonation.",
		modelAssets = {},
	},
}
