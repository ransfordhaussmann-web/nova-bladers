local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelnder Klingen-Sturm mit zerfetzenden Treffern.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Stein-Festung mit schweren Schockwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnen-Drift mit Flammen-Spur und Burn-Hits.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		accentColor = Color3.fromRGB(170, 235, 255),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Edge Surge",
		specialId = "PhantomEdgeSurge",
		desc = "Balance-Typ: Phantom-Dash mit Afterimage-Schlag-Kette.",
	},
}
