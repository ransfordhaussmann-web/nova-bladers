local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelsturm aus Klingen und Feuer-Rush.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinbollwerk, Schutz und Erd-Pulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenflare, Drift und Hitze-Ringe.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash, Nachbilder und Klingen-Surge.",
	},
}
