local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Komet mit schnellen Streak-Hits.",
		modelRef = {
	...
	},
	{
		...
		special = "Crystal Tide Spiral",
		specialId = "CrystalTideSpiral",
		desc = "Stamina-Typ: Eiskristall-Ringe und Spiral-Orbit.",
		modelRef = {
