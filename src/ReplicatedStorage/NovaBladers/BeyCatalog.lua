local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Reißzahn-Kombo.",
		modelAssets = {
			creatorStoreSearch = "spinning top fang attack",
		},
	},
	{
		id = "GraniteFort",
		...
		desc = "Defense-Typ: Festungs-Schild und Gegenstoß.",
		modelAssets = {
			creatorStoreSearch = "spinning top fortress defense",
		},
	},
	{
		id = "SolarDrift",
		...
		desc = "Stamina-Typ: Sonnen-Orbit mit Flare-Bursts.",
		modelAssets = {
			creatorStoreSearch = "spinning top solar ring",
		},
	},
	{
		id = "PhantomEdge",
