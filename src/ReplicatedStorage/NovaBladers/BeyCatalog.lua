local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge und Dreifach-Schnitt.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankern, Steinmauer und Scherben-Stoß.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Feuer-Orbit und Solar-Ausbruch.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(50, 170, 185),
		...
		desc = "Balance-Typ: Ausblenden, Blink hinter Gegner, Kreuzschnitt.",
		modelAssets = {
			creatorStoreSearch = "spinning top ghost balance",
		},
	},
}
