local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Flame Inferno",
		specialId = "CrimsonFlameInferno",
		desc = "Attack-Typ: Feuer-Rush mit Brenn-Pulsen.",
		modelAssets = {
			-- meshId = "", -- Creator Store: Toolbox → "spinning top" / "beyblade"
	...
	},
	{
		...
		desc = "Defense-Typ: Eisschild, Splitter-Burst und Frost-Hagel.",
		modelAssets = {
			-- meshId = "", -- Creator Store: Toolbox → "spinning top" / "beyblade"
			size = Vector3.new(3.6, 1.2, 3.6),
		},
