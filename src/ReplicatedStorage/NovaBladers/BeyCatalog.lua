local BeyCatalog = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(255, 110, 45),
		stats = { Attack = 9, Defense = 3, Speed = 8, Stamina = 4 },
		special = "Crimson Spiral Cut",
		specialId = "CrimsonSpiralCut",
		desc = "Attack-Typ: Feuer-Spiralen und Orbit-Schnitt.",
		modelAssets = {
			-- Creator Store: Toolbox → "spinning top" / "bey blade" → MeshId eintragen
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		special = "Frost Barrier Surge",
		specialId = "FrostBarrierSurge",
		desc = "Defense-Typ: Eis-Mauer, Burrow und Frost-Pulse.",
		modelAssets = {
			-- Creator Store: Toolbox → "spinning top" / "bey blade" → MeshId eintragen
			-- meshId = "rbxassetid://0",
