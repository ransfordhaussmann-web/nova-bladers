local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelnde Klingen und Cyclone-Rush.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Verankerung, Schockwellen und Ramme.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Ring, Drift-Orbit und Flare-Burst.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(90, 185, 210),
		...
		desc = "Balance-Typ: Blink-Dash, Multi-Slash und Edge-Arc.",
	},
}
