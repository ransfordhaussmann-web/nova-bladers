local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Slash-Rush mit Finisher-Burst.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Spikes und Boden-Slam.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und defensive Orbit-Schleife.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash durch Gegner mit Afterimage-Schnitt.",
		modelAssets = {
