local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Ripper Surge",
		specialId = "CrimsonRipperSurge",
		desc = "Attack-Typ: Blitz-Rush mit scharfen Fang-Hits.",
		modelAssets = {
			meshId = nil, -- Creator Store: rbxassetid in Studio eintragen
	...
	},
	{
		...
		special = "Granite Bastion Crash",
		specialId = "GraniteBastionCrash",
	...
	},
	{
		...
		special = "Phantom Blade Rend",
		specialId = "PhantomBladeRend",
		desc = "Balance-Typ: Geister-Aura, Sturzflug und Klingen-Burst.",
		modelAssets = {
			meshId = nil,
