local BeyCatalog = {
	...
	},
	{
		...
		modelAssets = {
			-- Studio Toolbox → Creator Store → "spinning top" → meshId eintragen
			meshId = nil,
	...
	},
	{
		...
		special = "Crimson Inferno Burst",
		specialId = "CrimsonInfernoBurst",
		desc = "Attack-Typ: Feuer-Rush mit Inferno-Schlagwellen.",
		modelAssets = {
			meshId = nil,
