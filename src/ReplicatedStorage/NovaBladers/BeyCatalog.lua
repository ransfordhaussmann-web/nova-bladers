local BeyCatalog = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 9, Speed = 5, Stamina = 7, SpinDecayMult = 0.72 },
		special = "Glacier Prism Cage",
		specialId = "GlacierPrismCage",
		desc = "Defense-Typ: Eiskäfig, Schutz und Kristall-Splitter.",
		modelRef = {
	...
	},
	{
		...
		desc = "Attack-Typ: Überhitzung, Feuer-Rush und Eruption.",
		modelRef = {
