local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rush mit schnellen Klingen-Hits.",
		modelAssets = {
	...
	},
	{
		...
		stats = { Attack = 4, Defense = 9, Speed = 4, Stamina = 9, SpinDecayMult = 0.75 },
		special = "Frost Citadel Lock",
		specialId = "FrostCitadelLock",
		desc = "Defense-Typ: Eis-Mauer, Frost-Pulse und Spin-Schutz.",
		modelAssets = {
