local BeyCatalog = {
	...
	},
	{
		...
		special = "Blaze Overdrive",
		specialId = "BlazeOverdrive",
		desc = "Attack-Typ: Feuer-Rush mit Inferno-Spur.",
		creatorStore = true,
		modelRef = {
		...
		modelAssets = {
			-- Optional: rbxassetid from Studio Creator Store Toolbox
		},
	},
	{
		id = "FrostVeil",
		...
		desc = "Defense-Typ: Eis-Schild, Frostwellen und Schutz.",
		creatorStore = true,
		modelRef = {
