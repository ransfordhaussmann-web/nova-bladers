local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Rush mit schnellen Fang-Hits.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinmauer, Säulen und Erdbeben-Pulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(95, 175, 215),
		accentColor = Color3.fromRGB(195, 240, 255),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Mirage Cut",
		specialId = "PhantomMirageCut",
		desc = "Balance-Typ: Phasen-Dash und Spektral-Schnitt.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		beyType = "Defense",
		color = Color3.fromRGB(145, 215, 255),
		accentColor = Color3.fromRGB(220, 248, 255),
	...
	},
	{
		...
		name = "Crimson Drift",
		beyType = "Attack",
		color = Color3.fromRGB(195, 35, 75),
		accentColor = Color3.fromRGB(255, 95, 145),
		stats = { Attack = 7, Defense = 5, Speed = 10, Stamina = 6 },
		special = "Crimson Drift Surge",
		specialId = "CrimsonDriftSurge",
		desc = "Attack-Typ: Speed-Boost, Drift-Rush und Impact.",
	},
}
