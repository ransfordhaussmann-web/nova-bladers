local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eiskristalle, Frost-Schild und Shatter-Burst.",
		modelRef = { studioModelName = "FrostPrism" },
	},
	{
		id = "BlazeRipper",
		name = "Blaze Ripper",
		...
		desc = "Attack-Typ: Feuer-Zyklon, Brenn-Spur und Eruption.",
		modelRef = { studioModelName = "BlazeRipper" },
	},
}
