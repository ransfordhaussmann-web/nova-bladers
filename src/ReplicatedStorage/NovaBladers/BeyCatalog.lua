local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Lanze mit Explosions-Rush.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Bind Coil",
		specialId = "FrostBindCoil",
		desc = "Defense-Typ: Eis-Spirale, Frost-Schild und Bindungs-Impuls.",
		modelRef = {
