local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutiger Slash-Rush mit Mehrfach-Treffern.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Reflekt-Schutz und Boden-Schock.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Orbit mit expandierenden Flammen-Ringen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Unsichtbarkeit und Echo-Schläge.",
		modelAssets = {
