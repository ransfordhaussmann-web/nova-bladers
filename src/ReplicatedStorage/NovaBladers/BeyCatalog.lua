local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Federn im Kegel-Sturm.",
		modelAssets = {
			-- Toolbox → Creator Store → "spinning top" → meshId einfügen
			meshId = nil,
		},
	},
	{
		...
		desc = "Defense-Typ: Sprung, Anker-Schlag und Wasserwelle.",
		modelAssets = {
			meshId = nil,
		},
	},
	{
		...
		desc = "Attack-Typ: Blutiger Rush mit Mehrfach-Schnitten.",
		modelAssets = {
			meshId = nil,
		},
	},
