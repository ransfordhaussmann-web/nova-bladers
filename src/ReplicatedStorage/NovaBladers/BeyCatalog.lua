local BeyCatalog = {
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "attack bey", "pegasus top" },
		},
		modelRef = {
	...
	},
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "defense bey", "shell top" },
		},
	},
	{
		id = "VoltDash",
	...
	},
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "dark bey", "balance top" },
		},
	},
	{
		id = "BlazeWheel",
		...
		desc = "Attack-Typ: Feuer-Rad, Flammen-Orbit und Inferno-Burst.",
		creatorStore = {
			searchTerms = { "spinning top", "fire bey", "flame top" },
		},
	},
	{
		id = "FrostVeil",
		...
		desc = "Defense-Typ: Eis-Schleier, Frost-Schild und Kristall-Explosion.",
		creatorStore = {
			searchTerms = { "spinning top", "ice bey", "frost top" },
		},
	},
}
