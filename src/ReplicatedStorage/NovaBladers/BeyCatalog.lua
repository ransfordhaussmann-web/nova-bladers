local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuerkrone und Glut-Meteor-Regen.",
		modelRef = {
	...
	},
	{
		...
		name = "Crystal Tide",
		beyType = "Stamina",
		color = Color3.fromRGB(50, 160, 210),
		accentColor = Color3.fromRGB(130, 235, 255),
		stats = { Attack = 5, Defense = 7, Speed = 7, Stamina = 10, SpinDecayMult = 0.6 },
		special = "Crystal Tide Surge",
		specialId = "CrystalTideSurge",
		desc = "Stamina-Typ: Kristallwellen und Gezeiten-Orbit.",
		modelRef = {
