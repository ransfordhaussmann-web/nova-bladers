local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankerung, Steinsäulen und Bodenwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenflare-Ringe und Hitzegleit-Rush.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Afterimage-Dashes und Phasen-Schnitte.",
	},
}
