local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Slash und Blut-Rend-Kombo.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Erdbeben-Pulse und Festung.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Blink, Afterimage und Schnitt.",
		modelAssets = {
