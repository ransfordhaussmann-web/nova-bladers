local BeyCatalog = {
	...
	},
	{
		...
		name = "Frost Crown",
		beyType = "Defense",
		color = Color3.fromRGB(110, 190, 245),
		...
		modelRef = { studioModelName = "FrostCrown" },
	},
	{
		id = "SolarCoil",
		name = "Solar Coil",
		beyType = "Stamina",
		color = Color3.fromRGB(255, 175, 35),
		accentColor = Color3.fromRGB(255, 235, 90),
		stats = { Attack = 5, Defense = 5, Speed = 8, Stamina = 10, SpinDecayMult = 0.6 },
		special = "Helix Flare",
		specialId = "HelixFlare",
		desc = "Stamina-Typ: Helix-Sonic-Ringe und Sonnen-Orbit.",
		modelRef = { studioModelName = "SolarCoil" },
	},
	{
		id = "BlazeQuill",
		name = "Blaze Quill",
		beyType = "Attack",
		color = Color3.fromRGB(255, 95, 25),
		...
		desc = "Attack-Typ: Schnelle Feder-Salve mit Meteor-Treffern.",
		modelRef = { studioModelName = "BlazeQuill" },
	},
	{
		id = "TideAnchor",
		name = "Tide Anchor",
		beyType = "Balance",
		color = Color3.fromRGB(35, 115, 195),
		accentColor = Color3.fromRGB(75, 195, 215),
		stats = { Attack = 6, Defense = 7, Speed = 5, Stamina = 7 },
		special = "Tide Anchor Surge",
		specialId = "TideAnchorSurge",
		desc = "Balance-Typ: Untertauchen, Wasser-Mauer und Gezeiten-Pulse.",
		modelRef = { studioModelName = "TideAnchor" },
	},
}
