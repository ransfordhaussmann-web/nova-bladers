local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuerfedern regnen auf Gegner.",
		modelAssets = {
			-- Creator Store: Toolbox → "spinning top" / "bey" → MeshId hier eintragen
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		desc = "Defense-Typ: Anker zieht, dann Wasser-Schockwelle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Schnitt mit Nachblutung.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer und Splitter-Explosion.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(160, 170, 210),
		...
		desc = "Balance-Typ: Phasen-Dash durch den Gegner.",
		modelAssets = {
