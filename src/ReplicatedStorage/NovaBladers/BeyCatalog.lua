local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Rush mit Reißzahn-Ketten-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und langanhaltender Orbit.",
		modelRef = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(120, 255, 245),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Slice",
		specialId = "PhantomSlice",
		desc = "Balance-Typ: Geister-Dash, Phasen-Sprung und Schnitt-Burst.",
		modelRef = {
