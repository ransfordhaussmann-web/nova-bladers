local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm mit drei Kreuz-Hieben.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Schutz und Erdbeben-Wellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash durch den Gegner und Kreuzschnitt.",
		modelAssets = {
			creatorStoreSearch = "spinning top ghost cyan balance",
		},
	},
}
