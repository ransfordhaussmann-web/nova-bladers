local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Rush und kreisförmige Klingen-Bursts.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Aura, Frost-Schild und Splitter-Schock.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Spiral-Orbit und Solar-Nova-Finale.",
		modelRef = {
