local BeyCatalog = {
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "bey blade attack", "pegasus top" },
		},
	},
	{
		id = "IronShell",
		...
		creatorStore = {
			searchTerms = { "spinning top", "bey blade defense", "metal shield top" },
		},
	},
	{
		id = "VoltDash",
		...
		creatorStore = {
			searchTerms = { "spinning top", "bey blade stamina", "yellow top" },
		},
	},
	{
		id = "ShadowBite",
		...
		creatorStore = {
			searchTerms = { "spinning top", "bey blade balance", "dark purple top" },
		},
	},
	{
		id = "BlazeWheel",
		...
		creatorStore = {
			searchTerms = { "spinning top fire", "bey blade flame", "red attack top" },
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Schutzmantel, Frostwellen und Kristall-Burst.",
		creatorStore = {
			searchTerms = { "spinning top ice", "bey blade frost", "blue defense top" },
