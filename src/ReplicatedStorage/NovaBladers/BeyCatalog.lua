local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Schläge und Finisher-Rush.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Crystal Crown",
		specialId = "FrostCrystalCrown",
		desc = "Defense-Typ: Eiskrone, Frost-Pulse und Scherben-Burst.",
		modelRef = {
