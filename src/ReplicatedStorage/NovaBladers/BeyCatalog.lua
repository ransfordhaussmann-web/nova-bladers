local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelsturm aus Klingen und Rush-Finale.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Stein-Bastion, Schockwellen und Boden-Slam.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		stats = { Attack = 5, Defense = 6, Speed = 7, Stamina = 10, SpinDecayMult = 0.58 },
		special = "Solar Flare Drift",
		specialId = "SolarFlareDrift",
		desc = "Stamina-Typ: Solar-Flare-Ringe und Drift-Boost.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash, Afterimages und Edge-Burst.",
	},
}
