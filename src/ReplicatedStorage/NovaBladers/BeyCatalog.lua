local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Klingen-Salven und Ripper-Dash.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und Corona-Orbit.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Blink-Schnitte und Phantom-Rush.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		...
		desc = "Defense-Typ: Eissplitter und Kälte-Explosion.",
	},
	{
		id = "CrimsonDrift",
		name = "Crimson Drift",
		beyType = "Attack",
		color = Color3.fromRGB(180, 30, 70),
		...
		desc = "Attack-Typ: Blitz-Ansturm mit Speed-Knockback.",
	},
}
