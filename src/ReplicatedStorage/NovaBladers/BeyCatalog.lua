local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Slash-Rush mit Mehrfach-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Schutzschild und Erdbeben-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Ringe und Flare-Orbit um Gegner.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash durch den Gegner und Geister-Schnitt.",
		modelAssets = {
