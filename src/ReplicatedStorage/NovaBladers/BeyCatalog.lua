local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blut-Spiral-Rush und Fang-Finisher.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Crystal Bind",
		specialId = "FrostCrystalBind",
		desc = "Defense-Typ: Eis-Aura, Frost-Ring und Kristall-Burst.",
		modelRef = {
