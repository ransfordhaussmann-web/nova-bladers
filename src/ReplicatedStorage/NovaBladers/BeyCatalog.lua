local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuerfeder-Sturm mit Multi-Hit-Rush.",
		modelAssets = {
			-- Toolbox → Creator Store → "spinning top" / "bey" → meshId hier einfügen
			meshId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Untertauchen, Anker-Schock und Wellen-Pulse.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		desc = "Attack-Typ: Blutiger Sturzangriff mit Rend-Burst.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Schutzschild und Erd-Pulse.",
		modelAssets = {
			meshId = nil,
			size = Vector3.new(4.0, 1.5, 4.0),
		},
	},
	{
		id = "SolarDrift",
		...
		desc = "Stamina-Typ: Solar-Ringe und Orbit-Flare.",
		modelAssets = {
			meshId = nil,
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(160, 140, 220),
		accentColor = Color3.fromRGB(220, 200, 255),
		stats = { Attack = 7, Defense = 6, Speed = 8, Stamina = 6 },
		special = "Phantom Phase Slash",
		specialId = "PhantomPhaseSlash",
		desc = "Balance-Typ: Phasen-Blink und Phantom-Klingenschlag.",
		modelAssets = {
			meshId = nil,
			size = Vector3.new(3.5, 1.1, 3.5),
		},
