local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Spiralfang-Rush mit Sonic-Hits.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Crown Glacier",
		specialId = "FrostCrownGlacier",
		desc = "Defense-Typ: Eisgraben, Frostwall und Gletscher-Pulse.",
		modelRef = {
