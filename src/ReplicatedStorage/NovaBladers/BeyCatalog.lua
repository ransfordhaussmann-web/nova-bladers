local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sprint mit drei Fang-Schnitten.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Schutzschild und Erdstoß.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash durch Gegner und Schock-Schnitt.",
		modelAssets = {
