local BeyCatalog = {
	...
	},
	{
		...
		modelAssets = { meshId = "", size = Vector3.new(3.4, 1.1, 3.4) },
	},
	{
		id = "TideAnchor",
		name = "Tide Anchor",
		...
		desc = "Defense-Typ: Anker-Wurf, Gezeiten-Zug und Wellen-Schlag.",
		modelAssets = { meshId = "", size = Vector3.new(3.8, 1.3, 3.8) },
	},
	{
		id = "CrimsonFang",
		name = "Crimson Fang",
		...
		desc = "Attack-Typ: Blutiger Rush und Reiß-Hiebe.",
		modelAssets = { meshId = "", size = Vector3.new(3.5, 1.2, 3.5) },
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		modelAssets = { meshId = "", size = Vector3.new(4.0, 1.4, 4.0) },
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		modelAssets = { meshId = "", size = Vector3.new(3.6, 1.0, 3.6) },
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		modelAssets = { meshId = "", size = Vector3.new(3.3, 1.1, 3.3) },
	},
}
