local BeyCatalog = {
	{
		...
		modelRef = {
			...
			searchTerms = { "spinning top attack", "beyblade pegasus", "storm top" },
		},
	},
	{
		id = "IronShell",
		...
		modelRef = {
			...
			searchTerms = { "spinning top defense", "beyblade shield", "metal top" },
		},
	},
	{
		id = "VoltDash",
		...
		modelRef = {
			...
			searchTerms = { "spinning top stamina", "beyblade lightning", "electric top" },
		},
	},
	{
		id = "ShadowBite",
		...
		modelRef = {
			...
			searchTerms = { "spinning top balance", "beyblade dark", "shadow top" },
		},
	},
	{
		id = "CrimsonOrbit",
		...
		desc = "Attack-Typ: Solar-Ringe und Flammen-Rush.",
		modelRef = {
			studioModelName = "CrimsonOrbit",
			searchTerms = { "spinning top fire", "beyblade attack red", "flame top" },
		},
	},
	{
		id = "FrostAnchor",
		...
		desc = "Defense-Typ: Gletscher-Aura, Eisring und Frost-Sperre.",
		modelRef = {
			studioModelName = "FrostAnchor",
			searchTerms = { "spinning top ice", "beyblade defense blue", "frost top" },
		},
	},
}
