local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Flammen-Spirale und Eruptions-Burst.",
		modelRef = { studioModelName = "CrimsonEdge" },
	},
	{
		id = "FrostCore",
		name = "Frost Core",
		...
		desc = "Defense-Typ: Frostfeld, Eisschild und Scherben-Puls.",
		modelRef = { studioModelName = "FrostCore" },
	},
}
