local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Fang-Salve mit schnellen Meteor-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Bunker mit verstärkter Schutzmauer.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Spiralförmige Sonnen-Ringe und enger Orbit.",
		modelRef = {
