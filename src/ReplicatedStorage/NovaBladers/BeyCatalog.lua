local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Schlägen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Bastion und Erdbeben-Wellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Flares und Orbit-Nova.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone und Täuschungs-Schlag.",
		modelAssets = {
