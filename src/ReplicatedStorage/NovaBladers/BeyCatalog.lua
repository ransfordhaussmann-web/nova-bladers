local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutiger Vorstoß mit Ripper-Finale.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Bastion und Scherben-Explosion.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Orbit und Flare-Burst.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(55, 175, 190),
		...
		desc = "Balance-Typ: Mirage-Klone, Blink und Phantom-Schnitt.",
		modelAssets = {
