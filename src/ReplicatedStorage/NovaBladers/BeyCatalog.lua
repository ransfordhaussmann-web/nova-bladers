local BeyCatalog = {
	...
	},
	{
		...
		modelRef = {
			...
			searchTerms = { "defense beyblade", "spinning top green", "metal shield top" },
		},
		-- Optional Creator Store mesh: paste MeshId from Toolbox
	...
	},
	{
		...
		modelRef = {
			...
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			searchTerms = { "yellow spinning top", "lightning beyblade", "stamina top" },
		},
	},
	{
		id = "ShadowBite",
		...
		modelRef = {
			...
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			searchTerms = { "purple spinning top", "dark beyblade", "fang top" },
		},
	},
	{
		id = "CrimsonBlaze",
		...
		desc = "Attack-Typ: Flammen-Ringe und Feuer-Orbit.",
		modelRef = {
			studioModelName = "CrimsonBlaze",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			searchTerms = { "red spinning top", "fire beyblade", "flame top" },
		},
	},
	{
		id = "FrostCrown",
		...
		desc = "Defense-Typ: Eis-Bollwerk, Frost-Pulse und Schutz.",
		modelRef = {
			studioModelName = "FrostCrown",
			targetSize = 3.7,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			searchTerms = { "ice spinning top", "frost beyblade", "crystal top" },
		},
	},
}
