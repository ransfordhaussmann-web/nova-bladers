local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinbastion und schwere Schockwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Drift mit aufbauenden Flare-Ringen.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Blink, Surge-Dash und Klingen-Burst.",
	},
}
