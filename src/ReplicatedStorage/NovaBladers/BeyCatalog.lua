local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Zickzack-Slash-Rush mit finalem Ripper-Burst.",
		modelRef = {
			studioModelName = "CrimsonFang",
			creatorStoreSearch = "spinning top metal red attack",
			targetSize = 3.5,
		},
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Säulen und Erdbeben-Schock.",
		modelRef = {
			studioModelName = "GraniteFort",
			creatorStoreSearch = "bey blade defense stone fortress",
			targetSize = 3.6,
		},
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Ladung, Flammen-Ringe und Nova-Burst.",
		modelRef = {
			studioModelName = "SolarDrift",
			creatorStoreSearch = "spin top yellow gold stamina",
			targetSize = 3.5,
		},
	},
	{
		...
		desc = "Balance-Typ: Illusionen, Phantom-Dash und Geister-Schlag.",
		modelRef = {
			studioModelName = "PhantomEdge",
			creatorStoreSearch = "spinning top white silver phantom",
			targetSize = 3.5,
		},
	},
}
