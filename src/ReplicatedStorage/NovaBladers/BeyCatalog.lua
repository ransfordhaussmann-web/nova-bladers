local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm mit Ripper-Schlag-Kombo.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Festungsmodus mit Gegenstoß-Wellen.",
		modelAssets = {
			creatorStoreSearch = "spinning top stone fortress",
		},
	},
	{
		id = "SolarDrift",
		...
		desc = "Stamina-Typ: Sonnen-Orbits und Flare-Explosion.",
		modelAssets = {
			creatorStoreSearch = "spinning top solar gold ring",
		},
	},
	{
		id = "PhantomEdge",
		...
		desc = "Balance-Typ: Phantom-Klone und Klingen-Dashes.",
		modelAssets = {
