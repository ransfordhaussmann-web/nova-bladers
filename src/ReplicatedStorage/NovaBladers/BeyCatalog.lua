local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit karmesinroten Slash-Ketten.",
		modelAssets = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(140, 255, 220),
		stats = { Attack = 4, Defense = 9, Speed = 5, Stamina = 7 },
		special = "Aurora Barrier Dome",
		specialId = "AuroraBarrierDome",
		desc = "Defense-Typ: Frost-Kuppel, Schutzschild und Aurora-Release.",
		modelAssets = {
			-- Optional: Creator Store meshId eintragen (Toolbox → Creator Store)
			-- meshId = "rbxassetid://0",
		},
