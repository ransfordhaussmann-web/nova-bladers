local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelsturm aus Klingen, dann Vorwärts-Sweep.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Verankerung, Steinmauer und Bodenbeben.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Flare, Gleit-Drift und Flare-Burst.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash, Surge und Klingen-Schlag.",
	},
}
