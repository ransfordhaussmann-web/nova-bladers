local BeyCatalog = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Feuer-Drift mit Solar-Flare-Finale.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dashes und Klingen-Slash.",
	},
}
