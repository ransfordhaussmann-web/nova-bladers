local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Slash Storm",
		specialId = "CrimsonSlashStorm",
		desc = "Attack-Typ: Doppel-Slash-Rush und Finisher-Burst.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eiskrone, Schutzschild und Frost-Schockwellen.",
		modelRef = {
