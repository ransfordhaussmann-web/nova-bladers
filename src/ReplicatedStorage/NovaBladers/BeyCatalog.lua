local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Ansturm mit Klingen-Schnitten.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Festung, Spikes und Erdbeben.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone und Klingen-Illusionen.",
		modelAssets = {
