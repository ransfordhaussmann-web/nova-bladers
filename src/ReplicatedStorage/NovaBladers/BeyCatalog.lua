local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Federn und Sturm-Rush.",
	...
	},
	{
		...
		desc = "Stamina-Typ: Gezeiten-Zug und Anker-Schlag.",
		modelAssets = { size = Vector3.new(3.8, 1.4, 3.8) },
	},
	{
		id = "CrimsonFang",
		name = "Crimson Fang",
		...
		desc = "Attack-Typ: Blutiger Sprint und Klingen-Hieb.",
		modelAssets = { size = Vector3.new(3.4, 1.0, 3.4) },
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		modelAssets = { size = Vector3.new(4.0, 1.5, 4.0) },
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		stats = { Attack = 6, Defense = 6, Speed = 8, Stamina = 7 },
		special = "Solar Flare Loop",
		specialId = "SolarFlareLoop",
		desc = "Balance-Typ: Sonnen-Flare und Orbit-Schleife.",
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Durchgang und Geister-Klinge.",
		modelAssets = { size = Vector3.new(3.3, 1.0, 3.3) },
	},
}
