local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Wurzeln und Boden-Slam.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flares und Sonnen-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(60, 190, 200),
		...
		desc = "Balance-Typ: Phantom-Klone und Mehrfach-Schnitte.",
		modelAssets = {
