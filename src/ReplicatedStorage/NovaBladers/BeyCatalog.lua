local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelnde Klingen-Cyclone mit AoE-Hits.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Granite-Wall und Schockpulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Trail und Spin-Recovery.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(70, 190, 215),
		...
		desc = "Balance-Typ: Phantom-Dashes mit Afterimage-Schaden.",
	},
}
