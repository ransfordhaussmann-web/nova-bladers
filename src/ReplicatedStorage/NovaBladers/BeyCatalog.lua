local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Ringe und Brenn-Orbit.",
		-- Creator Store: meshId eintragen → überspringt Procedural-Layer
		modelAssets = {
			-- meshId = "rbxassetid://YOUR_CREATOR_STORE_MESH",
	...
	},
	{
		...
		desc = "Defense-Typ: Eisgraben, Frostmauer und Kältepulse.",
		modelAssets = {
			-- meshId = "rbxassetid://YOUR_CREATOR_STORE_MESH",
