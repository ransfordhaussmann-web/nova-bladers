local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rad, Flammen-Spur und Inferno-Burst.",
		creatorStore = {
			searchTerms = { "fire spinning top", "blaze wheel", "flame bey" },
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Schleier, Kristall-Schild und Shard-Pulse.",
		creatorStore = {
			searchTerms = { "ice spinning top", "frost crystal", "frozen bey" },
