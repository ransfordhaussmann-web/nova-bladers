local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Blaze Fang",
		specialId = "CrimsonBlazeFang",
		desc = "Attack-Typ: Flammen-Rush mit Inferno-Schlagkette.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eiskrone, Frost-Pulse und Kristall-Burst.",
		modelRef = {
