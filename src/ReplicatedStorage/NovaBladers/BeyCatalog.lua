local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Flammen-Rush und Kreuz-Schnitt.",
		modelAssets = {
			-- Toolbox → Creator Store → "spinning top" → MeshId hier einfügen
			size = Vector3.new(3.6, 1.2, 3.6),
		},
		modelRef = {
			studioModelName = "CrimsonReaver",
		},
	},
	{
		id = "GlacierCrown",
		...
		special = "Glacier Crown Frost",
		specialId = "GlacierCrownFrost",
		desc = "Defense-Typ: Eisschild, Frostwellen und Kristall-Shatter.",
		modelAssets = {
			size = Vector3.new(3.6, 1.2, 3.6),
		},
		modelRef = {
