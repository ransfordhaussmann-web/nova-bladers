local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Rush mit brennendem Rad-Trail.",
		creatorStore = {
			searchTerms = { "spinning top", "fire top", "bey blade metal" },
			studioModelName = "BlazeWheel",
			-- meshId = "rbxassetid://YOUR_ID",  -- optional: Creator Store MeshId
		},
	},
	{
		id = "FrostVeil",
		...
		desc = "Defense-Typ: Eis-Schutzmantel und Kristall-Splitter.",
		creatorStore = {
			searchTerms = { "spinning top", "ice top", "bey blade metal" },
