local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutrote Klinge mit Dreifach-Stoß.",
	...
	},
	{
		...
		accentColor = Color3.fromRGB(170, 255, 245),
		stats = { Attack = 4, Defense = 9, Speed = 5, Stamina = 7 },
		special = "Aurora Barrier Dome",
		specialId = "AuroraBarrierDome",
		desc = "Defense-Typ: Eisbogen-Kuppel und Reflektionspulse.",
		modelRef = { studioModelName = "AuroraCrest" },
		modelAssets = {},
	},
}
