local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Fury Rend",
		specialId = "CrimsonFuryRend",
		desc = "Attack-Typ: Blutrote Klingen-Serie mit Meteor-Rush.",
		creatorStore = {
			searchTerms = { "spinning top", "attack blade", "metal top" },
			suggestedStyle = "sharp red attack bey",
		},
	},
	{
		id = "GraniteFort",
		...
		desc = "Defense-Typ: Steinerne Festung mit Schockwellen.",
		creatorStore = {
			searchTerms = { "spinning top", "defense shield", "heavy metal" },
			suggestedStyle = "stone fortress bey",
		},
	},
	{
		id = "SolarDrift",
		...
		creatorStore = {
			searchTerms = { "spinning top", "golden top", "stamina ring" },
			suggestedStyle = "solar gold stamina bey",
		},
	},
	{
		id = "PhantomEdge",
		...
		desc = "Balance-Typ: Geister-Phase, Dive und Burst.",
		creatorStore = {
			searchTerms = { "spinning top", "ghost blade", "phantom" },
			suggestedStyle = "ethereal blue phantom bey",
		},
	},
	{
		id = "CrystalEdge",
		...
		creatorStore = {
			searchTerms = { "spinning top", "crystal", "ice blade" },
			suggestedStyle = "crystal ice attack bey",
		},
	},
	{
		id = "BlazeCrown",
		...
		stats = { Attack = 6, Defense = 7, Speed = 6, Stamina = 8 },
		special = "Blaze Inferno Crown",
		specialId = "BlazeInfernoCrown",
		desc = "Balance-Typ: Feuerkrone, Orbit und Inferno-Burst.",
		creatorStore = {
			searchTerms = { "spinning top", "fire crown", "flame top" },
			suggestedStyle = "flaming crown balance bey",
		},
	},
}
