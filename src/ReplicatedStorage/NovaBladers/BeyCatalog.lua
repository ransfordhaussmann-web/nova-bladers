local BeyCatalog = {
	...
	},
	{
		...
		specialId = "IronVaultLock",
		desc = "Defense-Typ: Steinerne Festung und Schockwellen.",
		modelRef = {
	...
	},
	{
		...
		specialId = "VoltSonicTempest",
		desc = "Stamina-Typ: Sonnenring und Orbit-Angriff.",
		modelRef = {
	...
	},
	{
		...
		specialId = "NovaMeteorShower",
		desc = "Attack-Typ: Kristallklingen und Splitter-Hagel.",
		modelRef = {
	...
	},
	{
		...
		specialId = "VoltSonicTempest",
		desc = "Balance-Typ: Flammenkrone und Spiral-Angriff.",
		modelRef = {
