local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale und Ember-Burst.",
		modelRef = {
	...
	},
	{
		...
		special = "Glacier Mirror Wall",
		specialId = "GlacierMirrorWall",
		desc = "Defense-Typ: Eisschild, Spiegelung und Frost-Nova.",
		modelRef = {
