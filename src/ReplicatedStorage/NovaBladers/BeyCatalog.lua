local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuerfeder-Sturm mit schnellen Mehrfach-Treffern.",
		modelAssets = {
			-- Creator Store: Toolbox → Creator Store → "spinning top" → meshId einfügen
			meshId = nil,
		},
	},
	{
		...
		name = "Tide Anchor",
		beyType = "Defense",
		color = Color3.fromRGB(45, 140, 200),
		...
		desc = "Defense-Typ: Untertauchen, Anker-Lock und Gezeiten-Schockwelle.",
		modelAssets = {
			meshId = nil,
		},
	},
	...
	},
	{
		...
		accentColor = Color3.fromRGB(180, 185, 195),
		stats = { Attack = 3, Defense = 10, Speed = 4, Stamina = 9 },
		special = "Granite Rampart",
		specialId = "GraniteRampart",
		desc = "Defense-Typ: Felsbunker, Steinmauer und Erdbeben-Pulse.",
		modelAssets = {
			meshId = nil,
		},
	},
	{
		...
		desc = "Stamina-Typ: Sonnenladung, Flare-Ringe und Orbit-Angriff.",
		modelAssets = {
			meshId = nil,
		},
	},
	{
		...
		desc = "Balance-Typ: Phasenverschiebung, Schnitt und Nachbild-Burst.",
		modelAssets = {
			meshId = nil,
		},
	},
