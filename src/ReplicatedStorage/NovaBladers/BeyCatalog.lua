local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale mit Inferno-Multi-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Bastion, Frostwall und Kälte-Pulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Spirale und helixförmige Schockwellen.",
		modelRef = {
