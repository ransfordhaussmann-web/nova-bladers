local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Klingen-Wirbelsturm und Spurt-Schnitt.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		beyType = "Defense",
		color = Color3.fromRGB(100, 110, 95),
		...
		desc = "Defense-Typ: Bastion, Stein-Schilde und Boden-Puls.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenringe und Flare-Gleitflug.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Phase, Surge-Dash und Klingenhieb.",
	},
}
