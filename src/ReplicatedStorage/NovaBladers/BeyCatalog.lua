local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelsturm mit Klingen-Schlägen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Wurzeln und Erdbeben-Pulse.",
		modelAssets = {
			meshId = "",
	...
	},
	{
		...
		desc = "Balance-Typ: Void-Blink, Phasen-Dash und Breitschlag.",
		modelAssets = {
			meshId = "",
