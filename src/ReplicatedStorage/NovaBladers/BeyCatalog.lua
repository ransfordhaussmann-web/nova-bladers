local BeyCatalog = {
	...
	},
	{
		...
		modelAssets = {
			creatorStoreSearch = "spinning top crimson attack blade",
		},
	},
	{
		id = "GraniteFort",
		...
		desc = "Defense-Typ: Verankerung, Steinwall und Boden-Quake.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Aufladung, Heat-Ringe und Orbit.",
		modelAssets = {
			creatorStoreSearch = "spinning top solar stamina ring",
		},
	},
	{
		id = "PhantomEdge",
		...
		desc = "Balance-Typ: Vanish, Mirage-Dashes und Phantom-Strike.",
		modelAssets = {
			creatorStoreSearch = "spinning top phantom balance edge",
		},
	},
}
