local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge und fünf schnelle Klingen-Hits.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 7, Speed = 5, Stamina = 10, SpinDecayMult = 0.55 },
		special = "Glacier Spiral",
		specialId = "GlacierSpiral",
		desc = "Stamina-Typ: Frost-Aura, Eis-Spiralen und Shatter-Burst.",
		modelRef = {
