local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit blutroten Ripper-Schnitten.",
		modelAssets = {
			-- Optional: Studio Toolbox → Creator Store → "spinning top" → meshId eintragen
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		desc = "Defense-Typ: Frost-Kuppel, Schutz und Aurora-Entladung.",
		modelAssets = {
			-- Optional: Studio Toolbox → Creator Store → "spinning top" → meshId eintragen
			-- meshId = "rbxassetid://0",
		},
