local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Rend Strike",
		specialId = "CrimsonRendStrike",
		desc = "Attack-Typ: Wind-up, Blitz-Rush und Cleave-Bursts.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Bastion Gale",
		specialId = "FrostBastionGale",
		desc = "Defense-Typ: Eiskrone, Bastion-Mauer und Frost-Stoßwellen.",
		modelRef = {
