local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Schadensreduktion und Spike-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenstrahlen und Flare-Burst.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Mirage-Fade, Blink und Phantom-Slash.",
		modelAssets = {
