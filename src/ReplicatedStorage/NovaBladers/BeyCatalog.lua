local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eisring, Frost-Schild und Kristall-Burst.",
		modelRef = {
	...
	},
	{
		...
		special = "Crimson Rage Cascade",
		specialId = "CrimsonRageCascade",
		desc = "Attack-Typ: Flammen-Rush, Klingen-Hits und Inferno-Burst.",
		modelRef = {
