local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Bastion und Schockwellen-Puls.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Flare und Drift-Speed-Boost.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash mit Nachbildern und Echo-Schlag.",
	},
}
