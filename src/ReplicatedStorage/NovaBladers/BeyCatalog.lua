local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Festungsmauer und Gegenstoß.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnenringe und Orbit-Hitze.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash und Schnitt-Burst.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		...
		desc = "Defense-Typ: Frost-Aura und Eis-Splitter.",
	},
	{
		id = "CrimsonDrift",
		name = "Crimson Drift",
		...
		stats = { Attack = 6, Defense = 5, Speed = 10, Stamina = 8, SpinDecayMult = 0.7 },
		special = "Crimson Drift Surge",
		specialId = "CrimsonDriftSurge",
		desc = "Stamina-Typ: Geschwindigkeits-Surge und Drift-Hits.",
	},
}
