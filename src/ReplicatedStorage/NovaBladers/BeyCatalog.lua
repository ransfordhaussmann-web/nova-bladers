local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Klingen-Wirbel und finaler Sturmlauf.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Verankerung, Stein-Pulse und Rückstoß-Welle.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Flares und hoher Drift-Speed.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Dash mit Nachbildern und Klingen-Burst.",
	},
}
