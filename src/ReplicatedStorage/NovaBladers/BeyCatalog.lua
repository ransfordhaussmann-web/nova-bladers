local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinpanzer und expandierende Schockwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Drift mit Brenn-Spur und Flare-Detonation.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dashes mit Nachbild-Schlägen.",
	},
}
