local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eiskäfig am Ziel — Gegner verlangsamt, dann Zerbruch-Welle.",
		modelRef = {
	...
	},
	{
		...
		name = "Ember Core",
		beyType = "Attack",
		color = Color3.fromRGB(240, 85, 35),
		...
		desc = "Attack-Typ: Feuer-Rush, Hitzespur und Core-Explosion.",
		modelRef = {
