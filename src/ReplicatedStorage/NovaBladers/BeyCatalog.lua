local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sturzangriff mit Klingen-Ripper.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinbollwerk mit Stachel-Pulsen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone und Klingen-Dash.",
		modelAssets = {
