local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale und Klauen-Rush.",
		modelRef = {
	...
	},
	{
		...
		special = "Frostbite Dominion",
		specialId = "FrostbiteDominion",
		desc = "Defense-Typ: Eis-Krone, Frost-Schild und Schneesturm.",
		modelRef = {
