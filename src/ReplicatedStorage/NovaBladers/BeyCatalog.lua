local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Spiral-Angriff mit rotem Feuer-Trail.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Crystal Fortress",
		specialId = "FrostCrystalFortress",
		desc = "Defense-Typ: Eiskristall-Mauer und Frost-Schockwelle.",
		modelRef = {
