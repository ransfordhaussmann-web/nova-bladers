local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sturzangriff mit Sägeschlägen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Verankerung und Erschütterungswelle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und brennende Orbit-Spur.",
		modelAssets = {
			creatorStoreSearch = "spinning top sun stamina",
		},
	},
	{
		id = "PhantomEdge",
		...
		desc = "Balance-Typ: Phantom-Klingen, Dash und Konvergenz-Burst.",
		modelAssets = {
