local BeyCatalog = {
	...
	},
	{
		...
		specialId = "FangSpiralRush",
		desc = "Attack-Typ: Spiralförmiger Rend-Angriff mit Blutsturz-Finale.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 4, Defense = 7, Speed = 5, Stamina = 9, SpinDecayMult = 0.7 },
		special = "Glacier Coil Lock",
		specialId = "GlacierCoilLock",
		desc = "Defense-Typ: Eis-Aura, Gegner einfrieren und Eissplitter-Burst.",
		modelRef = {
