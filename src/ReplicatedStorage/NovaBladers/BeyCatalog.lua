local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Aufladung, Sprung und Schockwellen-Slam.",
		modelRef = {
			studioModelName = "CrimsonForge",
			targetSize = 3.6,
		},
		-- Optional: Creator Store meshId in Studio einfügen
	...
	},
	{
		...
		desc = "Defense-Typ: Kristallisieren, Schild und Eis-Burst.",
		modelRef = {
