local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutrote Klingen-Serie mit Rush-Finale.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dash, Unsichtbarkeit und Schnitt.",
		modelAssets = {
			creatorStoreSearch = "spinning top ghost cyan",
		},
	},
}
