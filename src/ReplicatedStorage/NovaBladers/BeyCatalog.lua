local BeyCatalog = {
	...
	},
	{
		...
		modelRef = {
			...
			creatorStoreQuery = "spinning top electric yellow",
			targetSize = 3.5,
		},
	},
	{
	...
	},
	{
		...
		desc = "Attack-Typ: Aufheizen, Schmiede-Slam und Splitter-Explosion.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Aura, Eiskrone und Splitter-Sturm.",
		modelRef = {
