local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Aufladung, Sturmlauf und Flammen-Burst.",
		modelRef = {
	...
	},
	{
		...
		special = "Frost Spiral Bind",
		specialId = "FrostSpiralBind",
		desc = "Stamina-Typ: Eis-Spiralen, Frost-Ringe und Bindungs-Puls.",
		modelRef = {
