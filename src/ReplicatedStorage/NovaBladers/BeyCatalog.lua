local BeyCatalog = {
	...
	},
	{
		...
		-- Optional Creator Store mesh: modelAssets = { meshId = "rbxassetid://..." }
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinbollwerk und Boden-Impulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Dashes und Schatten-Schnitt.",
	},
}
