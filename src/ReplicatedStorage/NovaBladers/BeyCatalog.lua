local BeyCatalog = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(185, 235, 255),
		stats = { Attack = 5, Defense = 8, Speed = 5, Stamina = 7, SpinDecayMult = 0.75 },
		special = "Glacier Dome",
		specialId = "GlacierDome",
		desc = "Defense-Typ: Eisdom-Schutzschild und Frost-Schockwelle.",
		modelRef = {
