local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Slash am Ziel.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verwurzeln, Schutzschild und Erdbeben-Schock.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flare-Ringe und Brenn-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone, Triple-Dash und Konvergenz.",
		modelAssets = {
