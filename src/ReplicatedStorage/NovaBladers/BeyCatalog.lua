local BeyCatalog = {
	{
		...
		creatorStore = {
			searchTerms = { "spinning top", "metal top attack", "bey blade" },
		},
	},
	{
		id = "IronShell",
		...
		creatorStore = {
			searchTerms = { "spinning top defense", "heavy metal top", "bey blade metal" },
		},
	},
	{
		id = "VoltDash",
		...
		creatorStore = {
			searchTerms = { "spinning top flat", "speed top", "bey blade stamina" },
		},
	},
	{
		id = "ShadowBite",
		...
		creatorStore = {
			searchTerms = { "dark spinning top", "balance top", "bey blade balance" },
		},
	},
	{
		id = "BlazeWheel",
		...
		desc = "Attack-Typ: Feuer-Rush mit expandierenden Flammen-Ringen.",
		creatorStore = {
			searchTerms = { "fire spinning top", "flame top", "bey blade attack" },
		},
	},
	{
		id = "FrostVeil",
		...
		creatorStore = {
			searchTerms = { "ice spinning top", "crystal top", "bey blade defense" },
		},
	},
}
