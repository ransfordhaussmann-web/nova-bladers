local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Klinge.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinschild, Erdbeben und Schockwelle.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenflare, Hitzewelle und Orbit-Burn.",
		modelAssets = {
	...
	},
	{
		...
		accentColor = Color3.fromRGB(200, 170, 255),
		stats = { Attack = 7, Defense = 5, Speed = 8, Stamina = 5 },
		special = "Phantom Blade Mirage",
		specialId = "PhantomBladeMirage",
		desc = "Balance-Typ: Phantom-Klone, Täuschung und Klingenstoß.",
		modelAssets = {
			creatorStoreSearch = "spinning top balance purple",
		},
	},
}
