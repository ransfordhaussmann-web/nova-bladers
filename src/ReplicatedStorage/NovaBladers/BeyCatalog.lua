local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale mit Finisher-Explosion.",
		modelRef = {
	...
	},
	{
		...
		special = "Crystal Resonance",
		specialId = "CrystalResonance",
		desc = "Stamina-Typ: Resonanz-Wellen und Kristall-Snap.",
		modelRef = {
