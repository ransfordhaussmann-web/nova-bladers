local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Klingen-Wirbelsturm und Finishing-Rush.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
	...
	},
	{
		...
		accentColor = Color3.fromRGB(255, 205, 75),
		stats = { Attack = 5, Defense = 6, Speed = 7, Stamina = 10, SpinDecayMult = 0.6 },
		special = "Solar Flare Drift",
		specialId = "SolarFlareDrift",
		desc = "Stamina-Typ: Solar-Orbit mit Flammen-Drift.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(95, 195, 215),
		...
		desc = "Balance-Typ: Phantom-Dash und Nachbilder-Schlag.",
	},
}
