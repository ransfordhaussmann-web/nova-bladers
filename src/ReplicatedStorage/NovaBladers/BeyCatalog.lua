local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutrote Klingen-Salve und Meteor-Sturm.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
		},
		-- Creator Store: Toolbox → spinning top / battle top → meshId eintragen
		modelAssets = {
			-- meshId = "rbxassetid://0",
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Festung, Frost-Pulse und Schutzmauer.",
		modelRef = {
