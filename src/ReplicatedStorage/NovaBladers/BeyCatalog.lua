local BeyCatalog = {
	...
	},
	{
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "lightning", "stamina bey" },
		},
	},
	{
		id = "ShadowBite",
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "dark", "balance bey" },
		},
	},
	{
		id = "CrimsonOrbit",
		...
		desc = "Attack-Typ: Solar-Charge, Flare-Rush und Burn-Zone.",
		modelRef = {
			studioModelName = "CrimsonOrbit",
			searchTerms = { "spinning top", "fire", "solar", "attack bey" },
		},
	},
	{
		id = "FrostAnchor",
		...
		modelRef = {
			...
			searchTerms = { "spinning top", "ice", "frost", "defense bey" },
		},
	},
}
