local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Slash-Rush mit Rend-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Brace und Gegen-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flares und Orbit-Loop.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phase-Shift, Phantom-Dash und Burst.",
		modelAssets = {
