local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Meteor Bite",
		specialId = "CrimsonMeteorBite",
		desc = "Attack-Typ: Blutrote Meteor-Klingen aus der Luft.",
		modelAssets = {
			-- Toolbox → Creator Store → "spinning top" / "bey" — rbxassetid hier eintragen
			meshId = nil,
			textureId = nil,
	...
	},
	{
		...
		special = "Solar Cyclone",
		specialId = "SolarCyclone",
		desc = "Stamina-Typ: Sonnenringe und Orbit-Sturm.",
		modelAssets = {
			meshId = nil,
			textureId = nil,
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(70, 180, 175),
		accentColor = Color3.fromRGB(180, 240, 235),
		stats = { Attack = 7, Defense = 5, Speed = 7, Stamina = 6 },
		special = "Phantom Reaver",
		specialId = "PhantomReaver",
