local BeyCatalog = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Ringe und Orbit-Flare.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Mirage-Aura, Phantom-Dive, Schnitt-Burst.",
	},
	{
		id = "FrostCrown",
		name = "Frost Crown",
		...
		desc = "Attack-Typ: Eis-Aura, Frost-Ringe, Shatter-Burst.",
	},
	{
		id = "CrimsonDrift",
		name = "Crimson Drift",
		beyType = "Stamina",
		color = Color3.fromRGB(150, 30, 45),
		...
		desc = "Stamina-Typ: Blut-Surge, Drift-Orbit, Abschluss-Rush.",
	},
}
