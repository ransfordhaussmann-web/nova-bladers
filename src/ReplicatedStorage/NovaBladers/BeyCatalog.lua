local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Kristall-Bastion und Schockwellen-Crumble.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Flares und Energie-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Feint und Blade-Mirage-Strike.",
		modelAssets = {
