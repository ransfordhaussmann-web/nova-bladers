local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Dreifach-Lunge mit Reißzahn-Ketten-Hits.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinanker, Säulenwall und Erdbeben-Pulse.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenkern, Hitzewellen und Orbit-Glow.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Spiegel-Decoy, Blink und Klingen-Burst.",
		modelRef = {
			creatorStoreSearch = "spinning top silver blade",
