local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankerung, Schutzmauer und Erdbeben.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Orbit mit Supernova-Ausbruch.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Mirage-Klone und Echo-Schlag.",
		modelAssets = {
