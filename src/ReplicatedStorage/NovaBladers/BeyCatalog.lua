local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Klingen-Wirbel mit Frontal-Rush.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Drift mit expandierenden Flare-Ringen.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(175, 185, 205),
		...
		desc = "Balance-Typ: Phasen-Dash mit Echo-Burst.",
	},
}
