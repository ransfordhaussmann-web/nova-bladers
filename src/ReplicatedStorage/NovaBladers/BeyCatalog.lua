local BeyCatalog = {
	...
	},
	{
		...
		-- Optional Creator Store meshId (Toolbox → copy MeshId):
	...
	},
	{
		...
		desc = "Attack-Typ: Eissplitter-Salve in alle Richtungen.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Feuer-Spirale mit Ausdehnungs-Wellen.",
		modelRef = {
