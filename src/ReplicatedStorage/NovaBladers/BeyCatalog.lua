local BeyCatalog = {
	...
	},
	{
		...
		creatorStore = { search = "beyblade defense green", studioModelName = "IronShell" },
	...
	},
	{
		...
		creatorStore = { search = "spinning top yellow lightning", studioModelName = "VoltDash" },
		modelAssets = { size = Vector3.new(3.9, 1.1, 3.9) },
	},
	{
		id = "ShadowBite",
		name = "Shadow Bite",
		...
		creatorStore = { search = "beyblade purple dark", studioModelName = "ShadowBite" },
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Fang-Sturm mit schnellen Schnitt-Hits.",
		creatorStore = { search = "spinning top red attack", studioModelName = "CrimsonFang" },
	...
	},
	{
		...
		creatorStore = { search = "beyblade ice blue defense", studioModelName = "FrostCore" },
		modelAssets = { size = Vector3.new(3.9, 1.4, 3.9) },
	},
}
