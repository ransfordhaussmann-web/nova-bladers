local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Slash mit Wild-Burst-Finisher.",
		modelRef = {
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 7, Speed = 5, Stamina = 9, SpinDecayMult = 0.72 },
		special = "Frost Crown Shatter",
		specialId = "FrostCrownShatter",
		desc = "Defense-Typ: Frost-Aura, Verlangsamung und Eis-Burst.",
		modelRef = {
