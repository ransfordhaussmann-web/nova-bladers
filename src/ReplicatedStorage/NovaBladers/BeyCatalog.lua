local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Blade-Rush mit Mehrfach-Schnitten.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Felsen-Schild, Verankerung und Erdbeben-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Klone, Dash und Illusions-Schlag.",
		modelAssets = {
			creatorStoreSearch = "spinning top purple ghost",
		},
	},
}
