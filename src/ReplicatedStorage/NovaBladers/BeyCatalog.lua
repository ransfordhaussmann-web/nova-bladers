local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Wirbelsturm und Blitz-Ansturm.",
		modelAssets = {
			-- Toolbox → Creator Store → "spinning top" / "bey" — meshId hier eintragen
			meshId = nil,
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer und Schock-Splitter.",
		modelAssets = {
			meshId = nil,
