local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Schnelle Klingen-Salven und Rush-Hits.",
		modelRef = {
			studioModelName = "CrimsonReaver",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
		},
		-- Optional: Toolbox → Creator Store → spinning top → MeshId hier eintragen
	...
	},
	{
		...
		special = "Arctic Frost Lock",
		specialId = "ArcticFrostLock",
		desc = "Defense-Typ: Frost-Schild, Eis-Pulse und Schutzphase.",
		modelRef = {
