local BeyCatalog = {
	...
	},
	{
		...
		modelAssets = {
			-- meshId = "rbxassetid://", -- Creator Store: "spinning top" / "beyblade"
	...
	},
	{
		...
		name = "Tide Anchor",
		beyType = "Defense",
		color = Color3.fromRGB(40, 160, 180),
		...
		desc = "Defense-Typ: Gezeiten-Welle und Anker-Schlag.",
		modelAssets = {
			-- meshId = "rbxassetid://",
	...
	},
	{
		...
		desc = "Attack-Typ: Blut-Rush und Reiß-Hieb.",
		modelAssets = {
			-- meshId = "rbxassetid://",
	...
	},
	{
		...
		name = "Granite Fort",
		beyType = "Defense",
		color = Color3.fromRGB(100, 105, 90),
		accentColor = Color3.fromRGB(170, 165, 140),
		stats = { Attack = 3, Defense = 9, Speed = 4, Stamina = 9 },
		special = "Granite Rampart",
		specialId = "GraniteRampart",
		desc = "Defense-Typ: Fels-Bollwerk und Schock-Pulse.",
		modelAssets = {
			-- meshId = "rbxassetid://",
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Flare und Orbit-Schleife.",
		modelAssets = {
			-- meshId = "rbxassetid://",
	...
	},
	{
		...
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(150, 140, 190),
