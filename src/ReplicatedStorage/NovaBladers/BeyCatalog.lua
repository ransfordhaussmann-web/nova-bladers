local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Klingen-Cyclone und Rush-Sprint.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Stein-Anker, Schockwellen und Eruption.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnen-Drift am Rand und Flare-Burst.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Blink, Phantom-Schläge und Exit-Burst.",
	},
}
