local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Zyklon mit Brenn-Spur und Eruption.",
		modelRef = {
		...
		modelAssets = {
			-- Optional: Creator Store mesh — Toolbox → "spinning top" / "beyblade"
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		desc = "Defense-Typ: Eis-Schleier, Frost-Schild und Splitter-Burst.",
		modelRef = {
