local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge mit Ripper-Klingen und Slash-Combo.",
		modelRef = {
	...
	},
	{
		...
		name = "Aurora Crest",
		beyType = "Defense",
		color = Color3.fromRGB(70, 200, 240),
		...
		desc = "Defense-Typ: Aurora-Kuppel absorbiert Treffer und schlägt zurück.",
		modelRef = {
