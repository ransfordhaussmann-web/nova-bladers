local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Rush und Fang-Kombo-Hits.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			referenceName = "Creator Store spin top",
			credit = "Import from Toolbox → Creator Store",
		},
		-- Optional: paste MeshId from Creator Store → uncomment modelAssets
	...
	},
	{
		...
		desc = "Defense-Typ: Eis-Kuppel, Frost-Schutz und Shard-Burst.",
		modelRef = {
