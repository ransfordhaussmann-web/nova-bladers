local BeyCatalog = {
	...
	},
	{
		...
		-- Creator Store: Toolbox → "spinning top" / "beyblade attack" → meshId eintragen
	...
	},
	{
		...
		desc = "Attack-Typ: Doppel-Klingen-Rush mit Finisher.",
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer und Splitter-Pulse.",
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnen-Flares und Orbit-Angriff.",
		modelAssets = { meshId = nil, size = Vector3.new(3.9, 1.0, 3.9) },
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash durch Gegner und Schnitt-Burst.",
