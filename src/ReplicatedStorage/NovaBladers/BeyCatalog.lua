local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Brennende Meteor-Ketten und Fang-Rush.",
		modelRef = {
			studioModelName = "CrimsonFang",
			targetSize = 3.5,
		},
		modelAssets = {
			-- meshId = "rbxassetid://", -- Creator Store / Toolbox mesh
	...
	},
	{
		...
		desc = "Defense-Typ: Eiskrone, Frost-Schutzwall und Gletscher-Pulse.",
		modelRef = {
