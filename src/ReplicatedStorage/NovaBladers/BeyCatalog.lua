local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Dreifacher Ripper-Ansturm mit Blutspur.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Verankerung, Steinmauer und Erdbeben-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenflare-Ringe und Flammorbit.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Illusions-Klone, Feint und Phantom-Schnitt.",
		modelAssets = {
