local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Lunge und Ripper-Kettenhiebe.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Anker und Bodenbeben.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenflare-Ringe und Umlaufbahn.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Spaltung, Schnitt und Fade-Burst.",
		modelAssets = {
