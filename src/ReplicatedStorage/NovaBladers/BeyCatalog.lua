local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Spirale mit Hit-Streak.",
		modelRef = {
			studioModelName = "CrimsonBlaze",
		},
		-- Optional Creator Store mesh: Toolbox → Creator Store → paste rbxassetid
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Aura, Eisschild und Eiswellen.",
		modelRef = {
