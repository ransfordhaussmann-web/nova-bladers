local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Spiral-Angriff mit Fang-Finale.",
		modelRef = {
			studioModelName = "CrimsonVortex",
			targetSize = 3.8,
		},
		modelAssets = {
			-- Creator Store: MeshId aus Toolbox einfügen (siehe docs/BEY-MODELS.md)
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Schild, Verlangsamung und Eis-Puls.",
		modelRef = {
