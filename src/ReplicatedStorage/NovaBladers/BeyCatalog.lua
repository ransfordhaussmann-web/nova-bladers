local BeyCatalog = {
	...
	},
	{
		...
		special = "Nova Meteor Shower",
		specialId = "NovaMeteorShower",
		desc = "Attack-Typ: Aggressive Klingen, Meteor-Rush-Special.",
		modelAssets = {
	...
	},
	{
		...
		special = "Iron Vault Lock",
		specialId = "IronVaultLock",
		desc = "Defense-Typ: Felsige Panzerung, Burrow und Schockwellen.",
		modelAssets = {
	...
	},
	{
		...
		special = "Volt Sonic Tempest",
		specialId = "VoltSonicTempest",
		desc = "Stamina-Typ: Breiter Sonnenring, langer Spin, Sonic-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		special = "Shadow Eclipse Fang",
		specialId = "ShadowEclipseFang",
		desc = "Balance-Typ: Geisterklingen, Eclipse-Dive und Burst.",
		modelAssets = {
