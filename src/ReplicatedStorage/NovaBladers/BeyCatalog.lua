local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Riposte Fang",
		specialId = "CrimsonRiposteFang",
		desc = "Attack-Typ: Feint, Lunge und blutiger Cross-Slash.",
		modelRef = {
	...
	},
	{
		...
		special = "Glacier Crown Shatter",
		specialId = "GlacierCrownShatter",
		desc = "Defense-Typ: Frostfeld, Eis-Bastion und Shatter-Burst.",
		modelRef = {
