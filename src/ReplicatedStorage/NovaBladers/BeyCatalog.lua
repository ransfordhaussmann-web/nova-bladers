local BeyCatalog = {
	...
	},
	{
		...
		special = "Crimson Spiral Rip",
		specialId = "CrimsonSpiralRip",
		desc = "Attack-Typ: Wirbel-Aufladung, Schockringe und Spiral-Rush.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Frost-Bunker, Eisschild und Kälte-Pulse.",
		modelRef = {
