local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Spiral-Rush mit aufziehenden Vortex-Hits.",
		modelRef = {
	...
	},
	{
		...
		name = "Glacier Mantle",
		beyType = "Defense",
		color = Color3.fromRGB(100, 185, 240),
		accentColor = Color3.fromRGB(210, 245, 255),
		stats = { Attack = 3, Defense = 9, Speed = 4, Stamina = 8, SpinDecayMult = 0.68 },
		special = "Glacier Frost Lock",
		specialId = "GlacierFrostLock",
		desc = "Defense-Typ: Frost-Mantel, Slow und kurzer Freeze.",
		modelRef = {
