local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Feuer-Federn und Spiral-Rush.",
		-- Creator Store: Toolbox → Creator Store → "spinning top fire"
		modelAssets = { meshId = "", textureId = "" },
	},
	{
		id = "TideAnchor",
		name = "Tide Anchor",
		...
		desc = "Defense-Typ: Gezeiten-Welle und Anker-Slam.",
		modelAssets = { meshId = "", textureId = "" },
	},
	{
		id = "CrimsonFang",
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und Orbit-Loop.",
		modelAssets = { meshId = "", textureId = "" },
	},
	{
		id = "PhantomEdge",
		...
		desc = "Balance-Typ: Phasen-Teleport und Energie-Schnitt.",
		modelAssets = { meshId = "", textureId = "" },
	},
}
