local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Kristall-Splitter-Rush mit Shatter-Bursts.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Bodenstampfer und Geröll-Lawine.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Feuer-Orbit und expandierende Glut-Ringe.",
		modelRef = {
