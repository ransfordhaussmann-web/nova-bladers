local BeyCatalog = {
	...
	},
	{
		...
		modelAssets = {
			creatorStoreSearch = "spinning top red attack bey",
		},
	},
	{
		id = "GraniteFort",
		...
		desc = "Defense-Typ: Anker, Stein-Fort und Schockwellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Solar-Aura, Flare-Ringe und Orbit-Angriff.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phantom-Split, Blade-Dash und Mirage-Burst.",
		modelAssets = {
