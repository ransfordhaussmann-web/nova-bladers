local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Eisschild, Frostwellen und Blizzard-Pulse.",
		modelRef = {
			studioModelName = "FrostCrown",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			creatorStoreHint = "spinning top ice / frost crystal",
		},
	},
	{
		id = "EmberFang",
		...
		desc = "Attack-Typ: Feuer-Rush, Klauen-Hits und Inferno-Burst.",
		modelRef = {
			studioModelName = "EmberFang",
			targetSize = 3.5,
			importRotation = CFrame.Angles(math.rad(-90), 0, 0),
			creatorStoreHint = "spinning top fire / flame claw",
		},
	},
}
