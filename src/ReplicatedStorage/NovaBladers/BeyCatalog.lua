local BeyCatalog = {
	...
	},
	{
		...
		desc = "Defense-Typ: Stein-Festung und Schockwellen-Pulse.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnen-Flares und Gleit-Angriff.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		beyType = "Balance",
		color = Color3.fromRGB(50, 180, 170),
		...
		desc = "Balance-Typ: Phasen-Dashes und Geister-Schnitt.",
	},
}
