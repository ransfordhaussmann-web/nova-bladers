local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Slash-Rush mit Lacerate-Hits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinsäulen, Schutzmauer und Erdbeben-Pulse.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Durchschlag und Afterimage-Schnitt.",
		modelAssets = {
