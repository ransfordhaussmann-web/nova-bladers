local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutrote Klingen-Serie mit Cleave-Finisher.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer halten, dann Boden-Slam.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Balance-Typ: Phasen-Vanish und Rücken-Schnitt.",
		modelAssets = {
