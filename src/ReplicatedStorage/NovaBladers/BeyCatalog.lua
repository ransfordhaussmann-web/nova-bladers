local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Rotierende Klingen-Cyclone und Finisher-Rush.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Stein-Bastion, Schadensreduktion und Schockwellen.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Solar-Drift mit Feuer-Trail und Flare-Burst.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phantom-Klone, Multi-Dash und Edge-Burst.",
	},
}
