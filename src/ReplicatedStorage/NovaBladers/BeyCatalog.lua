local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Klingen-Wirbel, dann Sturm-Ansturm.",
	},
	{
		id = "GraniteFort",
		name = "Granite Fort",
		...
		desc = "Defense-Typ: Steinwall, Erdbeben-Pulse und Boden-Slam.",
	},
	{
		id = "SolarDrift",
		name = "Solar Drift",
		...
		desc = "Stamina-Typ: Sonnen-Drift mit Brenn-Spur und Flare-Burst.",
	},
	{
		id = "PhantomEdge",
		name = "Phantom Edge",
		...
		desc = "Balance-Typ: Phasen-Dash, Surge-Klingen und Edge-Burst.",
	},
}
