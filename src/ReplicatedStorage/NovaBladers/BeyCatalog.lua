local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blitz-Slash und Blut-Rip-Kette.",
		modelRef = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinmauer, Erdbeben und Bastion.",
		modelRef = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenringe und Flare-Drift.",
		modelRef = {
	...
	},
	{
		...
		desc = "Balance-Typ: Spiegel-Klon, Blink und Präzisions-Schnitt.",
		modelRef = {
