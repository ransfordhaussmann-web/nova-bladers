local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Stoß mit Ripper-Kettenhits.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Defense-Typ: Steinwall, Verankerung und Rückstoßwellen.",
		modelAssets = {
	...
	},
	{
		...
		desc = "Stamina-Typ: Sonnenflare-Ringe und Wärmewellen-Orbit.",
		modelAssets = {
	...
	},
	{
		...
		stats = { Attack = 7, Defense = 5, Speed = 9, Stamina = 5 },
		special = "Phantom Blade Mirage",
		specialId = "PhantomBladeMirage",
		desc = "Balance-Typ: Phasen-Dashes und Mirage-Schnitte.",
		modelAssets = {
			creatorStoreSearch = "spinning top balance phantom blade",
		},
	},
}
