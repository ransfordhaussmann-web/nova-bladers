local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Ketten-Haken, Zug und Ripper-Finisher.",
		modelAssets = {
			-- Studio Toolbox → Creator Store → "spinning top" / "bey" → meshId hier einfügen
			-- meshId = "1234567890",
	...
	},
	{
		...
		stats = { Attack = 5, Defense = 6, Speed = 6, Stamina = 10, SpinDecayMult = 0.6 },
		special = "Crystal Tidal Surge",
		specialId = "CrystalTidalSurge",
		desc = "Stamina-Typ: Kristall-Wellen und Gezeiten-Schub.",
		modelAssets = {
			-- Studio Toolbox → Creator Store → "crystal top" / "spinning top" → meshId hier einfügen
			-- meshId = "1234567890",
			-- textureId = "rbxassetid://...",
			-- size = Vector3.new(3.6, 1.2, 3.6),
		},
