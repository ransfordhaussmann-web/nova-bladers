local BeyCatalog = {
	...
	},
	{
		...
		desc = "Attack-Typ: Blutroter Sturmlauf mit Klingen-Schlägen.",
		modelAssets = {
			-- Optional: Creator Store meshId eintragen (Toolbox → spinning top)
			-- meshId = "rbxassetid://0",
		},
	},
	{
		...
		accentColor = Color3.fromRGB(160, 110, 255),
