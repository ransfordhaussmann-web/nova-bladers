...
function SpecialMoveRunner.onPhaseStart(controller, move, phase)
	...
	elseif move.id == "IronVaultLock" or move.id == "GraniteRampart" then
	...
	elseif move.id == "VoltSonicTempest" or move.id == "SolarFlareLoop" then
		...
		elseif (phase.id == "orbit" or phase.id == "loop") and target and target.part then
...
function SpecialMoveRunner.update(controller, dt, allControllers)
	...
	elseif move.id == "VoltSonicTempest" or move.id == "SolarFlareLoop" then
		...
		elseif (phase.id == "orbit" or phase.id == "loop") and controller.orbitCenter then
