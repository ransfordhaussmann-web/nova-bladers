...
function SpecialMoveRunner.onPhaseStart(controller, move, phase)
	...
	if move.id == "NovaMeteorShower" or move.id == "CrimsonRipperBarrage" then
	...
	elseif move.id == "VoltSonicTempest" or move.id == "SolarCoronaLoop" then
	...
	elseif move.id == "ShadowEclipseFang" or move.id == "PhantomMirageCut" then
