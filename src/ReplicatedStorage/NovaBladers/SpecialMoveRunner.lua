...
function SpecialMoveRunner.onPhaseStart(controller, move, phase)
	...
	elseif mode == "riposte" then
		if phase.id == "brace" then
			...
			SpecialVFX.riposteBrace(controller, color, phase.duration)
		elseif phase.id == "counter" then
			...
			SpecialVFX.riposteFlash(controller, color, folder)
		elseif phase.id == "followup" then
			SpecialVFX.riposteBurst(controller.part.Position, color, folder)
		end

	elseif mode == "veil" then
		if phase.id == "fade" then
			SpecialVFX.setVeiled(controller, true)
		...
		elseif phase.id == "slash" then
			...
			controller.facing = dir
			controller.velocity = dir * (phase.rushSpeed or move.rushSpeed)
			SpecialVFX.veilSlash(controller, color, folder)
		elseif phase.id == "aftermath" then
			SpecialVFX.setVeiled(controller, false)
	...
	elseif mode == "inferno" then
		...
		elseif phase.id == "crown" then
			SpecialVFX.infernoCrown(controller.part.Position, color, folder)
		end
	end
end
