...
function SpecialMoveRunner.onPhaseStart(controller, move, phase)
	...
	elseif move.id == "CrimsonRend" then
		...
		elseif phase.id == "sweep" then
			SpecialVFX.crimsonSweep(controller.part.Position, color, folder)
		end
	elseif move.id == "GraniteRampart" then
		...
		elseif phase.id == "shock" then
			SpecialVFX.graniteShock(controller.part.Position, phase.range or 9, color, folder)
		end
	...
	elseif move.id == "PhantomPhaseSlash" then
		...
		elseif phase.id == "slash" then
			...
			SpecialVFX.phaseSlash(controller.part.Position, controller.facing, color, folder)
		end
	end
end
