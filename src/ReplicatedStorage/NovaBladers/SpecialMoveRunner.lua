...
function SpecialMoveRunner.onPhaseStart(controller, move, phase)
	...
	if move.id == "NovaMeteorShower" or move.id == "BlazeInfernoSpiral" then
		...
		elseif phase.id == "shower" or phase.id == "flare" then
			controller.meteorHitsLeft = phase.hits or 4
			controller.meteorTimer = 0
		end
	elseif move.id == "IronVaultLock" or move.id == "FrostGlacierBastion" then
...
function SpecialMoveRunner.update(controller, dt, allControllers)
	...
	if move.id == "NovaMeteorShower" or move.id == "BlazeInfernoSpiral" then
		if phase.id == "windup" then
			controller.velocity = Vector3.zero
		elseif phase.id == "launch" or phase.id == "shower" or phase.id == "spiral" or phase.id == "flare" then
			controller.velocity = controller.facing * (phase.rushSpeed or move.rushSpeed or 70)
		end
		if phase.id == "shower" or phase.id == "flare" then
	...
	elseif move.id == "IronVaultLock" or move.id == "FrostGlacierBastion" then
		...
		elseif phase.id == "freeze" or phase.id == "wall" or phase.id == "bastion" then
			controller.velocity = Vector3.zero
		elseif phase.id == "pulse" or phase.id == "shatter" then
