...
function SpecialMoveRunner.onPhaseStart(controller, move, phase)
	...
	elseif move.id == "CrimsonInfernoSlice" then
	...
	elseif move.id == "FrostBastionNova" then
