...
function SpecialMoveRunner.onPhaseStart(controller, move, phase)
	...
	elseif move.id == "CrimsonRipperLunge" then
		if phase.id == "ignite" then
			SpecialVFX.igniteBurst(controller, color, phase.duration)
	...
	elseif move.id == "AuroraBarrierDome" then
		...
		if phase.id == "gather" then
			SpecialVFX.auroraGather(controller, color, accent, phase.duration)
		...
		elseif phase.id == "shatter" then
			...
			SpecialVFX.auroraShatter(controller.part.Position, color, accent, folder)
		end
	end
end
