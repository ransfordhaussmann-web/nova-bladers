...
function SpecialMoveRunner.onPhaseStart(controller, move, phase)
	...
	elseif move.id == "InfernoPierce" then
		...
		elseif phase.id == "detonate" then
			SpecialVFX.fireDetonate(controller.part.Position, color, folder)
		end
	elseif move.id == "GlacialTomb" then
		if phase.id == "crown" then
			SpecialVFX.frostAura(controller, color, phase.duration)
			controller.velocity = Vector3.zero
		elseif phase.id == "tomb" then
...
function SpecialMoveRunner.update(controller, dt, allControllers)
	...
	elseif move.id == "GlacialTomb" then
		if phase.id == "crown" or phase.id == "tomb" then
			controller.velocity = Vector3.zero
		elseif phase.id == "shatter" then
