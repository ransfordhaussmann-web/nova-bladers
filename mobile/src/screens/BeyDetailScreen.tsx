          ...
          {special && (
            <>
              ...
              <View style={[styles.specialCard, { borderColor: special.color }]}>
                ...
                <Text style={[styles.phaseLine, { color: special.color }]}>{special.phases}</Text>
                <View style={styles.specialStats}>
                  ...
                  {special.rushSpeed != null && (
                    <SpecialStat label="Rush" value={String(special.rushSpeed)} />
                  )}
...
function getTip(type: string): string {
  const tips: Record<string, string> = {
    Attack: 'Charge und Special kombinieren für maximalen Meteor-Rush.',
    Defense: 'Iron Vault Lock aktivieren, wenn der Gegner angreift — dann kontern.',
    Stamina: 'Halte Abstand und lass den Spin auslaufen. Sonic Tempest für Orbit-Treffer.',
    Balance: 'Flexibel spielen — Shadow Eclipse Fang für den entscheidenden Dive-Burst.',
  };
