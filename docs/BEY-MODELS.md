...
| **Crimson Fang** | Red attack fangs, neon tips, fast spin ring |
| **Granite Fort** | Stone block segments, heavy rampart, slow spin |
| **Solar Drift** | Sun disk, radiating rays, wide stamina ring |
| **Phantom Edge** | Glass core, translucent phantom blades, cyan aura |
...
modelAssets = {
    ...
    creatorStoreSearch = "beyblade attack red",  -- Toolbox hint (optional)
