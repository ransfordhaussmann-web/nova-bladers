...
| **Crimson Fang** | 4 ripper blades, red fang tips, blood glow ring |
| **Aurora Crest** | Crest segments, aurora shield, defensive spikes |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/` as:
   - `NovaStriker`, `CrimsonFang`, or `AuroraCrest`
