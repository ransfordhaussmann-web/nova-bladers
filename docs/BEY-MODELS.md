...
| **Blaze Coil** | Coiled spring segments, flame tips, orange heat glow |
| **Glacier Mantle** | Ice spikes, thick frost mantle, glass frost base |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/` (e.g. `BlazeCoil`, `GlacierMantle`)
