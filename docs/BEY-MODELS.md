...
| **Crimson Fang** | 4 ripper fangs, blood-red neon ring, aggressive attack blades |
| **Granite Fort** | 8 stone rampart segments, heavy brick bumper, slow spin |
| **Solar Drift** | Golden sun core, 6 flare petals, warm corona glow |
| **Phantom Edge** | Translucent ghost blades, force-field mirage aura |
...
```lua
modelAssets = {
    creatorStoreSearch = "spinning top red attack",  -- Studio Toolbox search hint
    meshId = "rbxassetid://YOUR_ID_HERE",          -- optional: paste after import
