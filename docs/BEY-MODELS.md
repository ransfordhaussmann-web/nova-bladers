...
| **Crimson Fang** | 4 attack fangs, crimson spin ring, glass tip |
| **Azure Tide** | Layered wave rings, orbiting droplets, teal glow |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Creator Store meshes: set `modelAssets.meshId` in `BeyCatalog.lua` (see Crimson Fang / Azure Tide entries).
