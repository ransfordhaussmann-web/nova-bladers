...
| **Crimson Forge** | Hammer heads, ember ring, forge plate (Creator Store hook: `CrimsonForge`) |
| **Frost Crown** | Ice crown spikes, frost aura, glass base (Creator Store hook: `FrostCrown`) |
