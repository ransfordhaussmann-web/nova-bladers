...
| **Crimson Fang** | 4 ripper blades, red neon edges, fast spin ring |
| **Granite Fort** | Stone rampart segments, brick shield, heavy core |
| **Solar Drift** | Corona ring, solar rays, gold neon stamina core |
| **Phantom Edge** | Glass core, ghost aura, translucent phantom blades |
