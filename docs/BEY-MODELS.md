...
| **Crimson Fang** | Triple ripper fangs, crimson neon ring, aggressive blades |
| **Granite Fort** | Stone rampart segments, heavy concrete shell, slow spin |
| **Solar Drift** | Corona flare ring, solar spokes, golden outer glow |
| **Phantom Edge** | Glass core, phase blades, ghost counter-spin ring |
