...
| **Crimson Fang** | Four ripper fangs, crimson spin ring |
| **Granite Fort** | Stone shell segments, rock spikes, heavy bastion ring |
| **Solar Drift** | Sun disc, eight solar rays, corona glow |
| **Phantom Edge** | Translucent phantom blades, ghost counter-spin ring |
...
modelAssets = {
    ...
    -- creatorStoreSearch = "spinning top red attack",  -- hint for Toolbox search
},
```
