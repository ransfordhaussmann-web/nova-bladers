...
| **Crimson Vortex** | 4 neon blades, inner vortex ring, crimson outer flare |
| **Glacier Mantle** | Ice shell segments, frost plate, crystal spikes |
...
Set `modelRef.studioModelName` in `BeyCatalog.lua` — procedural layers are skipped when a matching model exists.
