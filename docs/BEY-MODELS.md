...
| **Crimson Flare** | Flame spikes, heat ring, outer fire glow |
| **Aqua Spiral** | Spiral glass fins, droplet core, counter-rotating fluid ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store / Studio imports** via `modelRef.studioModelName` (clone from `Models/<Name>`) or `modelAssets.meshId`.
