...
| **Crimson Reaver** | 4 reaver blades, ember core, flame ring (Creator Store `modelAssets` optional) |
| **Glacier Crown** | Ice crown segments, crystal spikes, frost shield (Creator Store `modelAssets` optional) |
