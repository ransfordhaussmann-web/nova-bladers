...
| **Frost Prism** | Ice prism facets, glass core, frost shield ring |
| **Ember Core** | Molten magma ring, flame spikes, heat glow |
...
| **Frost Prism** | `Models/FrostPrism` |
| **Ember Core** | `Models/EmberCore` |
