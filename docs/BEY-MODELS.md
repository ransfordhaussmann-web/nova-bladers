...
| **Frost Crown** | Ice crown spikes, frosted shield ring, glass layers |
...
| Crimson Vortex | `Models/CrimsonVortex` | Procedural flame vortex |
| Frost Crown | `Models/FrostCrown` | Procedural ice crown |
