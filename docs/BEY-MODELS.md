...
| **Ember Core** | Magma layer, flame blades, heat glow (Creator Store `modelAssets` optional) |
| **Crystal Tide** | Glass crystal segments, ice shards, frost ring (Creator Store `modelAssets` optional) |
