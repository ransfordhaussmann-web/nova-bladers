...
| **Crimson Fang** | 4 fang blades, ember ring, aggressive red spin |
| **Frost Halo** | Ice segments, glass halo, crystal tip |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support **Creator Store / Studio import** via `modelRef.studioModelName` — drop a model into `ReplicatedStorage/NovaBladers/Models/<Name>` in Studio.
