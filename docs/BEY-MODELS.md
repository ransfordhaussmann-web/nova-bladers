...
| **Crimson Forge** | Hammer blades, ember tips, heat ring |
| **Azure Tide** | Wave fins, glass core, mist outer ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store meshes via `modelRef` (Studio Models folder) or `modelAssets.meshId` (direct MeshId).
