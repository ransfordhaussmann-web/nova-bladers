...
| **Ember Core** | Hot metal core, flame petals, orange heat glow |
| **Frost Veil** | Ice shards, glass frost ring, crystal tip |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**6 Beys total** — Nova Striker, Iron Shell, Volt Dash, Shadow Bite, Ember Core, Frost Veil.
