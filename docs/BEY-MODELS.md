...
| **Blaze Orbit** | Ember ring, flame tongues, solar glow (fire stamina) |
| **Frost Crown** | Ice crown spikes, frost shield, glass bumper (ice defense) |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `NovaStriker`, `BlazeOrbit`, `FrostCrown`)
