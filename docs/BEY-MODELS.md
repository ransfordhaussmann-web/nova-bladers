...
| **Crimson Edge** | 4 serrated saw blades, red heat ring, aggressive spin |
| **Frost Halo** | Ice shell segments, frost crystals, glass frost aura |
...
5. `BeyModelBuilder` clones from folder when present (see `Models/README.md`)
