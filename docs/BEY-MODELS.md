...
| **Crimson Fang** | Four fang blades, blood-red neon ring, aggressive attack profile |
| **Frost Crown** | Ice crystal crown spikes, frost ring, outer mist glow |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store meshes via `modelRef.studioModelName` (Studio import) or `modelAssets.meshId` (Toolbox MeshId).
