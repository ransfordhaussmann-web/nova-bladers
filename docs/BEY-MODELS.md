...
| **Crimson Blaze** | Flame ring, fire spikes, ember core |
| **Frost Crown** | Ice crown segments, crystal ring, floating shards |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store / Studio imports via `modelRef.studioModelName` in `BeyCatalog.lua`. See `Models/README.md` for folder names.
