...
| **Crimson Fang** | 4 ripper fangs, blood-red spin ring, aggressive attack blades |
| **Aurora Crest** | Crest shield petals, aurora glow, counter-rotating barrier ring |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `NovaStriker`, `CrimsonFang`, `AuroraCrest`)
