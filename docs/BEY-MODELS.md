...
| **Crystal Fang** | Ice shards, frost ring, glass core |
| **Blaze Wheel** | Flame petals, heat ring, ember core |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store / Studio imports via `modelRef.studioModelName`.
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `CrystalFang`, `BlazeWheel`)
