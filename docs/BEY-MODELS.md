...
| **Frost Crown** | Ice crown spikes, frost ring, heavy ice bumper |
| **Blaze Core** | Ember heart, flame blades, heat haze ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Optional **Creator Store** meshes: set `modelAssets.meshId` in `BeyCatalog.lua` (Frost Crown, Blaze Core ready).
