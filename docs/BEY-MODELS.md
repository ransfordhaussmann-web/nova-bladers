...
| **Crimson Fang** | 4 sharp fangs, red blood ring, aggressive spin |
| **Granite Fort** | 8 stone segments, brick rampart, slow heavy spin |
| **Solar Drift** | Sun disk, 6 solar rays, corona glow |
| **Phantom Edge** | Force-field veil, translucent ghost blades |
