...
| **Crimson Fang** | Four sharp red blades, crimson neon edges |
| **Granite Fort** | Stone block ring, heavy rampart, slow spin |
| **Solar Drift** | Sun disc with rays, warm corona glow |
| **Phantom Edge** | Glass core, ghost edges, force-field halo |
