...
| **Frost Crown** | Ice crystal crown spikes, glass core, frost ring |
| **Crimson Fang** | Aggressive red fangs, rage glow, fast spin ring |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `FrostCrown`, `CrimsonFang`)
