...
| **Crimson Vortex** | 4 flame blades, crimson spin ring, fast attack profile |
| **Glacier Mantle** | Ice shell segments, frost shield ring, slow heavy spin |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/` — e.g. `NovaStriker`, `CrimsonVortex`, `GlacierMantle`
