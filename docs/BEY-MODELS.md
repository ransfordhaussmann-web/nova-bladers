...
| **Crimson Fang** | 3 red fang blades, blood ring, glass tip |
| **Frost Crown** | Ice crown segments, frost aura, crystal tip |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store meshes via `modelRef` (Studio folder import) or `modelAssets.meshId`.
