...
| **Crimson Fang** | 4 fang blades, red blood glow, fast attack ring |
| **Frost Ring** | Icy segments, glass frost aura, crystal spikes |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys have `modelRef.studioModelName` — drop Creator Store models into `ReplicatedStorage/NovaBladers/Models/<Name>` in Studio to override procedural meshes.
