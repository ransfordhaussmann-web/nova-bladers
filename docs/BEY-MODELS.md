...
| **Crimson Ripper** | Four attack claws, red neon glow, fast spin ring |
| **Frost Ward** | Ice glass segments, prism ring, frost tip |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Roster: **6 Beys** — import optional Creator Store models under `Models/<BeyId>` (see `Models/README.md`).
