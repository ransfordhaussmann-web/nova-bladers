...
| **Frost Crown** | Ice crown spikes, frost ring, glass core (Creator Store: `FrostCrown`) |
| **Crimson Forge** | Molten core, forge blades, ember spin ring (Creator Store: `CrimsonForge`) |
