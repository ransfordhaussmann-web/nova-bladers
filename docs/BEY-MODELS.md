...
| **Crimson Vortex** | 4 vortex blades, fast neon ring (Creator Store `modelAssets` optional) |
| **Glacier Shield** | Ice plates, frost crystals, glass shield ring (Creator Store optional) |
