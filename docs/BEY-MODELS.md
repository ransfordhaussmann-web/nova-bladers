...
| **Frost Prism** | Crystal shards, glass prism ring, frost glow |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Optional **Creator Store / Studio imports** via `modelRef.studioModelName` in `ReplicatedStorage/NovaBladers/Models/`.
