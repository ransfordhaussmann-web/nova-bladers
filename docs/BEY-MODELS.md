...
| **Frost Prism** | Ice crystals, glass frost ring, cyan prism shards |
| **Blaze Forge** | Forge blades, heat ring, orange inferno glow |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `FrostPrism`, `BlazeForge`)
