...
| **Crimson Blaze** | Flame petals, inner fire ring, ember tip |
| **Frost Crown** | Ice crown spikes, frost ring, crystal core |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys have `modelRef.studioModelName` — drop Creator Store models into `Models/` to override procedural meshes.
