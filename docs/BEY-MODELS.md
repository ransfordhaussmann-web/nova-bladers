...
| **Crimson Fang** | Four red attack fangs, crimson neon ring |
| **Granite Fort** | Stone block ramparts, heavy concrete shell |
| **Solar Drift** | Eight sun-ray petals, warm solar halo |
| **Phantom Edge** | Translucent ghost blades, cyan phantom wisp |
...
New Creator-Store-ready beys (Crimson Fang, Granite Fort, Solar Drift, Phantom Edge) ship with `modelAssets.meshId = nil` — paste a Toolbox mesh ID when you find one.
