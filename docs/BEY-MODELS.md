...
| **Crimson Edge** | Serrated saw blades, flame ring, crimson attack core |
| **Frost Core** | Ice crystal segments, frost shield ring, ice spikes |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store / Studio imports via `modelRef.studioModelName` under `Models/<Name>`.
