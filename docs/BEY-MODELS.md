...
| **Crimson Edge** | Flame blades, heat ring, orange spin glow |
| **Frost Core** | Ice crystal segments, glass frost shield, cyan aura |
...
### Import via Studio Models folder (recommended)
...
5. Set `modelRef.studioModelName` in `BeyCatalog.lua` (already configured for all 6 beys)
