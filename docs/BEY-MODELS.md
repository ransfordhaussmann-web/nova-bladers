...
| **Crimson Fang** | Four red attack fangs, aggressive spin ring |
| **Granite Fort** | Stone shell segments, heavy rampart ring |
| **Solar Drift** | Sun disc with flare petals, wide stamina ring |
| **Phantom Edge** | Translucent ghost edges, force-field ring |
