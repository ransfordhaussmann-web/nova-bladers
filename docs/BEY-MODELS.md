...
| **Aqua Spiral** | Glass core, spiral water fins, cyan spin ring |
| **Crimson Blaze** | Ember core, flame blades, expanding heat ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

New beys support optional Creator Store meshes via `modelRef` (Studio import) or `modelAssets.meshId` (Toolbox MeshId).
