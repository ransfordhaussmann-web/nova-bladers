...
| **Crimson Ripper** | 4 ripper blades, ember ring, aggressive attack profile |
| **Frost Halo** | Glass ice halo, crystal spikes, wide stamina ring |
...
These beys support optional Studio-imported meshes under `ReplicatedStorage/NovaBladers/Models/`:

| Bey | Studio folder name |
|-----|-------------------|
| Nova Striker | `NovaStriker` |
| Iron Shell | `IronShell` |
| Crimson Ripper | `CrimsonRipper` |
| Frost Halo | `FrostHalo` |

If no imported model exists, procedural layers are built automatically.
