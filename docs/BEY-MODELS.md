...
| **Crimson Forge** | Molten forge ring, 4 hammer-blades, orange forge tip |
| **Frost Crown** | Ice crown spikes, glass frost ring, slow outer crown |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys have `modelRef.studioModelName` + `creatorStoreQuery` in `BeyCatalog.lua`.
