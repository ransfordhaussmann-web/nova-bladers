...
| **Blaze Comet** | Comet fins, flame ring, hot neon tip |
| **Crystal Guard** | Crystal facets, ice shield, frost spikes |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

### Creator Store / Studio import

All 6 beys support optional Studio models via `modelRef.studioModelName` under `ReplicatedStorage/NovaBladers/Models/`.
