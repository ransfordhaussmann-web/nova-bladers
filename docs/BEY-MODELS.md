...
| **Crimson Blaze** | Flame blades, ember core, fast fire spin ring |
| **Frost Crown** | Ice crystal shards, glass crown ring, frost shield |
...
| Crimson Blaze | `Models/CrimsonBlaze` |
| Frost Crown | `Models/FrostCrown` |

Import a Creator Store mesh into Studio under the matching folder name — procedural layers are skipped when the model is present.
