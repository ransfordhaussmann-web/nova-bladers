...
| **Crystal Fang** | Ice crystal spikes, frost ring, glass core |
| **Crimson Wheel** | Hot neon ring, flame accents, fast outer burn |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support **Creator Store / Studio import** via `modelRef.studioModelName` (Models folder) or `modelAssets.meshId` (Toolbox MeshId).
