...
| **Blaze Orbit** | Flame petals, orange fire ring, glass tip |
...
Place imported models under `ReplicatedStorage/NovaBladers/Models/`. Procedural fallback is used when no model is found.
