...
| **Blaze Orbit** | Ember orbit blades, solar flame ring, fast outer glow |
| **Frost Crown** | Ice crown spikes, frost shell, glass tip |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Optional **Creator Store** meshes: Blaze Orbit and Frost Crown include `modelRef.studioModelName` — import a spinning-top model in Studio under `Models/BlazeOrbit` or `Models/FrostCrown` to replace procedural visuals.
