...
| **Crimson Fang** | 4 red fang blades, crimson spin ring |
| **Granite Fort** | 8 rock shell segments, heavy slate core |
| **Solar Drift** | 6 sun-ray spokes, bright golden glow ring |
| **Phantom Edge** | Translucent phantom blades, teal force-field core |
| **Crystal Edge** | 6 ice crystal shards around glass core |
| **Blaze Crown** | 6 flame crown spikes, fiery neon ring |
