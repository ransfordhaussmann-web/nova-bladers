...
| **Crimson Fang** | 4 crimson claws, rage ring, fast aggressive spin |
| **Frost Crown** | Ice shell segments, crystal crown spikes, frost shield |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Total: **6 Beys** — all support optional Creator Store meshes via `modelAssets` or Studio import via `modelRef`.
