...
| **Crystal Fang** | Glass core, 4 ice crystal shards, frost ring |
| **Crimson Forge** | Forge spikes with ember tips, heat ring, corroded core |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `CrystalFang`, `CrimsonForge`)
