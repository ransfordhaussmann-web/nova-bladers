...
| **Blaze Comet** | Flame ring, comet tail, orange fire spikes |
| **Frost Prism** | Ice core, crystal shards, glass prism ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Roster: **6 Beys** — scrollable selection in match lobby.
