...
| **Crimson Fang** | 4 spiral blades, crimson spin ring, glass tip |
| **Frost Crown** | Ice crown segments, glass spikes, frost shield ring |
...
5. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `CrimsonFang`, `FrostCrown`)
