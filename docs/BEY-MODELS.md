...
| **Crimson Forge** | Molten core, 4 hammer blades, ember glow ring |
| **Frost Crown** | Ice crown spikes, glass frost ring, crystal tip |
...
3. Search: `spinning top`, `spin top metal`, `spinning top ice`
