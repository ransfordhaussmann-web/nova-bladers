...
| **Frost Crown** | Ice crown spikes, frost ring, glass tip (Defense) |
| **Crimson Fang** | 4 fang blades, flame ring, fast spin (Attack) |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

### Creator Store import (Frost Crown / Crimson Fang)
...
3. Move to `ReplicatedStorage/NovaBladers/Models/FrostCrown` or `CrimsonFang`
4. Or paste **MeshId** into `BeyCatalog.lua` → uncomment `modelAssets.meshId`
