...
| **Crimson Fang** | 4 ripper fangs, heat ring, aggressive red spin layers |
| **Frost Halo** | Ice shell segments, crystal tip, frost halo ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**Crimson Fang** and **Frost Halo** ship with procedural models and optional `modelAssets.meshId` slots for Creator Store meshes (see catalog entries).
