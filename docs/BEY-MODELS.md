...
| **Crimson Reaver** | Saw blades, heat ring, ember glow (Creator Store: `CrimsonReaver`) |
| **Frost Halo** | Ice shell segments, crystal shards, frost halo ring (Creator Store: `FrostHalo`) |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `CrimsonReaver`, `FrostHalo`)
