...
| **Crimson Edge** | 4 sharp crimson blades, dark core, fast attack ring |
| **Frost Halo** | Ice crystal segments, glass halo, frost defense ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**6 Beys** total — optional Creator Store meshes via `modelRef` (Studio import) or `modelAssets.meshId`.
