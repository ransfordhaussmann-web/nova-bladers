...
| **Blaze Comet** | Comet tail fins, flame ring, fast attack blades |
| **Frost Prism** | Crystal facets, ice shield ring, frost outer ring |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `NovaStriker`, `BlazeComet`, `FrostPrism`)
