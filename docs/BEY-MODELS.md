...
| **Crimson Vortex** | Flame fins, heat ring, fast crimson spin layers |
| **Glacier Ring** | Ice crystal facets, frost shield, heavy outer rim |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store** meshes via `modelAssets.meshId` or Studio import via `Models/` folder.
