...
| **Crimson Fang** | Four fang blades, red blood glow, aggressive attack profile |
| **Frost Ring** | Ice segments, glass spikes, frost aura shield ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store / Studio imports via `modelRef.studioModelName` in `BeyCatalog.lua` (see `Models/README.md`).
