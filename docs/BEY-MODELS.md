...
| **Crimson Viper** | Coil segments, asymmetric fangs, red venom ring |
| **Frost Crown** | Ice crown spikes, frost shield, slow defensive spin |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All six beys support optional **Creator Store / imported meshes** via `modelRef.studioModelName` in `BeyCatalog.lua`. See `src/ReplicatedStorage/NovaBladers/Models/README.md`.
