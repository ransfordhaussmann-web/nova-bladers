...
| **Blaze Quill** | Four flame quills, ember ring, fast spin layers |
| **Tide Anchor** | Anchor flukes, wave segments, tidal shield ring |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `NovaStriker`, `BlazeQuill`, `TideAnchor`)
