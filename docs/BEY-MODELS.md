...
| **Ember Core** | Volcanic core, flame spikes, orange magma ring |
| **Crystal Guard** | Ice crystal segments, glass prism shield, cyan glow |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `NovaStriker`, `EmberCore`, `CrystalGuard`)
