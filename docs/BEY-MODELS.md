...
| **Crimson Fang** | 4 flame fangs, fire layer, fast crimson spin ring |
| **Frost Halo** | Ice crystal segments, glass halo, slow outer frost ring |
...
| Crimson Fang | `Models/CrimsonFang` | paste mesh ID in `BeyCatalog` |
| Frost Halo | `Models/FrostHalo` | paste mesh ID in `BeyCatalog` |
