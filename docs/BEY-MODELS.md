...
| **Blaze Orbit** | Flame petals, heat ring, fast orange spin layers |
| **Crystal Bloom** | Glass crystal facets, prism shield ring, icy bloom |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Creator Store hooks: **Nova Striker**, **Blaze Orbit**, **Crystal Bloom** support `modelRef.studioModelName` (import into `ReplicatedStorage/NovaBladers/Models/<Name>`) or `modelAssets.meshId`.
