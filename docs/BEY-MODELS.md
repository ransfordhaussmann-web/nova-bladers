...
| **Crimson Fang** | 4 attack fangs, flame ring, red-orange neon spin layers |
| **Frost Crown** | Ice shell segments, glass crown spikes, frost aura |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `CrimsonFang`, `FrostCrown`)
