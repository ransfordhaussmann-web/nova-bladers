...
| **Crimson Fang** | Four attack fangs, red neon spin ring |
| **Granite Fort** | Stone blocks, granite rampart, heavy spin layers |
| **Solar Drift** | Sun rays, golden halo, wide stamina ring |
| **Phantom Edge** | Ghost blades, translucent wisp core, cyan ring |
