...
| **Frost Orbit** | Ice shell segments, glass frost shield, slow spin ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store meshes via `modelRef.studioModelName` or `modelAssets.meshId`.
