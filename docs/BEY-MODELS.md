...
| **Crimson Fang** | 4 ripper fangs, crimson spin ring, aggressive attack profile |
| **Granite Fort** | Stone ramparts, cobblestone shell, heavy fort segments |
| **Solar Drift** | Sun disc, 8 solar rays, golden stamina glow |
| **Phantom Edge** | Glass ghost layer, translucent phantom blades |
