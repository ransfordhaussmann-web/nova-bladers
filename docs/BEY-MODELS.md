...
| **Blaze Orbit** | Solar fins, orange flame layer, fast outer flare |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/` with the bey id as folder name:
   - `NovaStriker`, `BlazeOrbit`, `FrostCrown`, etc.
...
6. Procedural fallback builds automatically if no Studio model is present
