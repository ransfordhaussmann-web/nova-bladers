...
| **Crimson Edge** | Four flame blades, orange spin ring, fire accents |
| **Frost Core** | Ice crystal segments, glass frost shell, slow counter-spin outer ring |
...
5. Match `studioModelName` in `BeyCatalog.modelRef` (e.g. `CrimsonEdge`, `FrostCore`)
