...
| **Crimson Comet** | Fiery comet spikes, orange flame ring, trailing tail |
| **Frost Crown** | Ice crystal crown, glass frost ring, pale blue core |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `CrimsonComet`, `FrostCrown`)
