...
| **Blaze Lance** | Central fire lance, 4 flame wings, ember glow ring |
| **Coral Tide** | Wave shell segments, coral reef bumps, aqua tide glow |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/NovaStriker` (or `BlazeLance`, `CoralTide`)
