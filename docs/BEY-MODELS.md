...
| **Crimson Fang** | 4 sharp blades, crimson neon ring, glass tip |
| **Frost Ring** | Wide frost ring, ice crystals, pale blue glow |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store meshes via `modelRef.studioModelName` (Models folder) or `modelAssets.meshId` (Toolbox).
