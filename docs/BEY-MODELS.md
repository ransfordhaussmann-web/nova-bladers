...
| **Crimson Fang** | 4 burning fang blades, ember glow, aggressive spin ring |
| **Frost Crown** | Ice spike crown, frost aura, heavy glass crown ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store imports via `modelRef.studioModelName` (Studio Models folder) or `modelAssets.meshId` (Toolbox mesh).
