...
| **Crimson Fang** | 4 crimson attack fangs, blood-red neon ring |
| **Frost Crown** | Ice crown spikes, glass frost shield, slow heavy spin |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store imports via `modelRef.studioModelName` in `BeyCatalog.lua` (see `Models/README.md`).
