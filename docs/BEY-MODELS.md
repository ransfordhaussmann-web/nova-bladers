...
| **Crimson Fang** | 4 claw blades, blood-red spin ring, aggressive tips |
| **Aurora Crest** | Crystal crest crown, glass shield dome, frost shimmer |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/` (e.g. `NovaStriker`, `CrimsonFang`, `AuroraCrest`)
