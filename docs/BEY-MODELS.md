...
| **Crystal Tide** | Glass crystal facets, aqua tide ring, neon droplet tip |
| **Blaze Fang** | Flame fangs, ember ring, heat glow outer layer |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store** meshes via `modelRef.studioModelName` (see `Models/README.md`).
