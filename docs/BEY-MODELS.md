...
| **Crimson Vortex** | 4 vortex blades, red spin ring, neon tip |
| **Glacier Mantle** | Ice shell segments, frost shield, crystal core |
...
Set `modelRef.studioModelName` in `BeyCatalog.lua` — procedural layers are used as fallback.
