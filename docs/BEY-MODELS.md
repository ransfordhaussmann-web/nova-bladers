...
| **Crimson Fang** | Flame fangs, ember ring, crimson attack blades |
| **Frost Crown** | Ice segments, crown spikes, glass frost shield |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**Crimson Fang** and **Frost Crown** support optional Creator Store / Studio imports via `modelRef.studioModelName` (`CrimsonFang`, `FrostCrown` under `Models/`).
