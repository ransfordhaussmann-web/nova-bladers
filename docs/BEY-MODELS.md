...
| **Crystal Crown** | Glass core, ice facets, prism ring (Creator Store slot: `Models/CrystalCrown`) |
| **Blaze Reactor** | Reactor vents, heat ring, orange glow (Creator Store slot: `Models/BlazeReactor`) |
