...
| **Crimson Comet** | Blazing comet fins, fire ring, glass tip |
| **Frost Crown** | Ice crown spikes, frost shield ring, slow bumper |
...
|-----|-------------------|----------|
| Nova Striker | `NovaStriker` | Procedural |
| Iron Shell | `IronShell` | Procedural |
| Crimson Comet | `CrimsonComet` | Procedural |
| Frost Crown | `FrostCrown` | Procedural |
| Volt Dash / Shadow Bite | — | Procedural only |
