...
| **Crimson Vortex** | Jagged blades, crimson inner ring, counter-spin outer glow |
| **Glacier Mantle** | Ice crystal segments, frost shield, heavy mantle ring |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>`
   - `IronShell`, `CrimsonVortex`, `GlacierMantle` (optional Creator Store imports)
