...
| **Crimson Vortex** | 4 spiral wings, red vortex ring, fang tip |
| **Glacier Shield** | Ice plates, frost crystals, heavy ice bumper |
...
|--------------|-----|-------|
| `Models/NovaStriker` | Nova Striker | Sketchfab / Creator Store |
| `Models/CrimsonVortex` | Crimson Vortex | Paste mesh under this name in Studio |
| `Models/GlacierShield` | Glacier Shield | Paste mesh under this name in Studio |

Or set `modelAssets.meshId` in `BeyCatalog.lua` (see below).
