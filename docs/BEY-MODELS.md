...
| **Frost Crown** | Ice crystal crown spikes, frost ring, glass tip |
| **Crimson Forge** | Molten vents, forge ring, glowing magma core |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Creator Store: `FrostCrown` and `CrimsonForge` support `modelAssets.meshId` or Studio import under `Models/`.
