...
| **Crimson Edge** | 4 sharp edge blades, crimson flare ring, fast spin |
| **Frost Halo** | Ice-glass segments, frost halo, central crystal core |
...
5. Future: clone from folder instead of procedural build (see `Models/README.md` for all 6 slots)
