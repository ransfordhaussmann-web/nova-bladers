...
| **Blaze Vortex** | Flame wings, heat ring, ember tip (Creator Store slot: `BlazeVortex`) |
| **Crystal Tide** | Ice shards, frost ring, glass core (Creator Store slot: `CrystalTide`) |
