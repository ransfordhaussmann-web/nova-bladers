...
| **Crimson Fang** | Flame core, 3 sharp fangs, fast red spin ring |
| **Frost Crown** | Ice crown spikes, glass frost ring, slow outer ice layer |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Creator-Store-ready: **Crimson Fang** and **Frost Crown** include `modelRef.studioModelName` plus commented `modelAssets` slots for Toolbox meshes.
