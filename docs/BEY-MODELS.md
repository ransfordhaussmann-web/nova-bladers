...
| **Crimson Fang** | 4 crimson blades, blood-red energy ring, sharp tips |
| **Frost Ring** | Ice shell segments, crystal spikes, frosty aura |

All 6 beys support optional Creator Store / Studio models via `modelRef.studioModelName` in `BeyCatalog.lua`. Place imported models under `ReplicatedStorage/NovaBladers/Models/<BeyId>`.
