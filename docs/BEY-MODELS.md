...
| **Crimson Vortex** | Flame spiral blades, ember core, fast vortex ring |
| **Glacier Mantle** | Ice crystal segments, frost shield, glass icicle tip |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `NovaStriker`, `IronShell`, `CrimsonVortex`, `GlacierMantle`)
