...
| **Crimson Fang** | 4 crimson attack blades, flame ring, aggressive tips |
| **Frost Ring** | Ice shell segments, glass crystals, frost aura |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store / Studio imports via `modelRef.studioModelName` in `BeyCatalog.lua`.
