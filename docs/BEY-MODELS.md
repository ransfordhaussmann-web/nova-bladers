...
| **Glacier Shield** | Hex ice shell, frost crystals, heavy ice bumper |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

### Studio-Import-Slots

Optional Creator Store / Sketchfab models can be placed under `ReplicatedStorage/NovaBladers/Models/`:
...
When a matching model exists, procedural layers are skipped automatically.
