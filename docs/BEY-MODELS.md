...
| **Blaze Orbit** | Flame wings, heat ring, fast orange spin glow |
| **Frost Crown** | Ice crown spikes, glass frost ring, slow defensive spin |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store imports via `modelRef.studioModelName` (Models folder) or `modelAssets.meshId`.
