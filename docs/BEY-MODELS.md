...
| **Crimson Forge** | Flame blades, ember core, orange heat ring |
| **Frost Crown** | Ice segments, crystal crown spikes, glass frost ring |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `NovaStriker`, `CrimsonForge`, `FrostCrown`)
