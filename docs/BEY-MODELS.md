...
| **Crimson Fang** | 4 attack fangs, blood-red energy ring, ripper blades |
| **Aurora Crest** | Layered crest rings, aurora shards, glass core |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Creator Store / Studio imports: `NovaStriker`, `CrimsonFang`, `AuroraCrest` (see `modelRef` in catalog).
