...
| **Crimson Fang** | Saw-blade fangs, crimson energy ring, aggressive attack profile |
| **Frost Ring** | Ice crystal segments, frost shield ring, slow heavy defense |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 Beys support optional Creator Store imports via `modelRef.studioModelName` (see `Models/README.md`).
