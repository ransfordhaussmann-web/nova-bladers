...
| **Blaze Comet** | Fiery comet fins, orange flame layer, fast spin ring |
| **Frost Crown** | Ice crown spikes, frosted shield ring, cold bumper |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store** imports via `modelRef.studioModelName` (place model under `ReplicatedStorage/NovaBladers/Models/`).
