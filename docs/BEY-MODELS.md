...
| **Crimson Fang** | 4 spiral fangs, crimson spin ring, glass tip |
| **Frost Coil** | Ice coil segments, frost shield, slow bumper ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store imports via `modelRef.studioModelName` in `BeyCatalog.lua`.
Place matching models under `ReplicatedStorage/NovaBladers/Models/`.
