...
| **Blaze Quill** | Flame layer, spinning feathers, ember tip (Creator Store slot: BlazeQuill) |
| **Tide Anchor** | Wave shell segments, anchor fluke, tide glow (Creator Store slot: TideAnchor) |
