...
| **Crimson Anvil** | Hammer faces, heat ring, forge tip (Creator Store `modelAssets` ready) |
| **Crystal Tide** | Ice shards, frost ring, glass core (Creator Store `modelAssets` ready) |
