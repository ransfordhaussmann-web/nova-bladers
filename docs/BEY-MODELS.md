...
| **Crimson Fang** | 4 crimson attack blades, fast spin ring |
| **Frost Crown** | Ice crown segments, glass spikes, slow outer ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store / Studio meshes via `modelRef.studioModelName` in `BeyCatalog.lua`.
