...
| **Flame Spiral** | Spiral flame wings, dual spin rings, outer flare |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/NovaStriker` (or `CrystalEdge`, `FlameSpiral`, etc.)
