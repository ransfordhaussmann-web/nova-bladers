...
| **Crimson Fang** | 4 flame fangs, red energy ring, attack tip |
...
3. Move to `ReplicatedStorage/NovaBladers/Models/` as **CrimsonFang** or **FrostCrown**
4. Play — `BeyModelBuilder` clones the Studio model when present; procedural fallback otherwise
