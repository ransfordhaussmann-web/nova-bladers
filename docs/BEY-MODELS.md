...
| **Crimson Fang** | 4 ripper fangs, crimson spin ring, aggressive attack blades |
| **Granite Fort** | Concrete shell segments, granite rampart, heavy stone core |
| **Solar Drift** | Golden sun disc, 8 solar rays, stamina outer glow |
| **Phantom Edge** | Translucent phantom blades, glass core, neon edge accents |
