...
| **Frost Crown** | Ice crown spikes, frost ring, slow outer halo |
...
| Iron Shell | `Models/IronShell` | optional |
| Crimson Fang | `Models/CrimsonFang` | optional |
| Frost Crown | `Models/FrostCrown` | optional |

Volt Dash and Shadow Bite use procedural meshes only (no `modelRef` yet).
