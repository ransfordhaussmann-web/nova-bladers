...
| **Crimson Vortex** | Flame blades, red energy ring, fiery attack tips |
| **Frost Prism** | Ice crystal segments, glass core, slow heavy shield ring |
...
|-----|---------------------|----------------------|
| Nova Striker | `Models/NovaStriker` | optional |
| Crimson Vortex | `Models/CrimsonVortex` | commented placeholder in `BeyCatalog` |
| Frost Prism | `Models/FrostPrism` | commented placeholder in `BeyCatalog` |

Priority: `Models/` clone → `modelAssets.meshId` → procedural build.
