...
| **Crystal Vortex** | Glass facets, cyan vortex ring, crystal tip |
| **Ember Ring** | Flame wings, orange ember ring, outer fire glow |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store / Studio imports** via `modelRef.studioModelName` in `BeyCatalog.lua`. Place models under `ReplicatedStorage/NovaBladers/Models/<Name>`.
