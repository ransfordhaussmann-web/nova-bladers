...
| **Crimson Fang** | 4 neon fangs, crimson spin ring, glass tip |
| **Azure Crown** | Ice crown spikes, frosted shell segments |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Creator-Store meshes: set `modelAssets.meshId` in `BeyCatalog.lua` (Crimson Fang / Azure Crown have placeholders).
