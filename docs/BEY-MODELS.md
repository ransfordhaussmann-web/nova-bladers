...
| **Blaze Comet** | Comet tail fins, orange flame ring, fast spin |
| **Frost Crown** | Ice crystal crown, glass frost shield, slow heavy spin |
...
2. Procedural layers are skipped when a matching model is found
