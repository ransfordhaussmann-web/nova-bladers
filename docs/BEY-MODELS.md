...
| **Crimson Fang** | Four ripper fangs, red blood ring, fast spin layers |
| **Aurora Crest** | Glass crest segments, aurora glow, neon crest cap |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Studio-import slots: `NovaStriker`, `CrimsonFang`, `AuroraCrest` under `ReplicatedStorage/NovaBladers/Models/`.
