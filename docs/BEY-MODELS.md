...
| **Starfall Edge** | Four star spikes, crimson ring, fast neon spin layer |
| **Stone Halo** | Stone shell segments, teal halo glass ring |
| **Thunder Coil** | Dual counter-rotating coils, blue lightning bolts |
| **Night Maw** | Dark maw aura, three night claws, purple spin ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 8 beys support optional Creator Store meshes via `modelAssets.meshId` or Studio models under `Models/`.
