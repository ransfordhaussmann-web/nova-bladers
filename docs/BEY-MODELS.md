...
| **Blaze Vortex** | Flame blades, heat ring, fast orange spin glow |
| **Frost Crown** | Ice crown segments, crystal spikes, frost aura |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store** meshes via `modelRef.studioModelName` (Studio import) or `modelAssets.meshId` (rbxassetid).
