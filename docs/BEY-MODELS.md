...
| **Crimson Edge** | 4 sharp red blades, fast crimson spin ring |
| **Frost Halo** | Ice crystal segments, glass halo, frost shield ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**Crimson Edge** and **Frost Halo** ship with procedural 3D models. To use a Creator Store mesh instead, uncomment `modelAssets` in `BeyCatalog.lua` and paste the `rbxassetid` from Studio Toolbox.
