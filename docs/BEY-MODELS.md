...
| **Ember Coil** | Coiled flame segments, inner heat glow, orange spin ring |
| **Frost Crown** | Ice crystal crown, glass frost ring, counter-spin outer layer |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store** or **Studio-imported** meshes via `modelRef.studioModelName` (place under `Models/<Name>`) or `modelAssets.meshId`.
