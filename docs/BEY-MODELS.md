...
| **Blaze Core** | 4 flame blades, heat ring, ember tip (Creator Store `meshId` optional) |
| **Frost Anchor** | Ice shell segments, crystal ring, anchor spike (Creator Store `meshId` optional) |
