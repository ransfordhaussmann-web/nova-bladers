...
| **Crimson Fang** | 4 spiral fangs, red blood ring, aggressive attack blades |
| **Frost Coil** | Ice coil segments, frost crystals, glass shield ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys have `modelRef.studioModelName` — drop Creator Store imports under `Models/<Name>` in Studio to override procedural meshes.
