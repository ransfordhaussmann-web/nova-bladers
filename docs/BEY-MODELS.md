...
| **Blaze Fang** | 4 flame fangs, ember core, fast orange spin ring |
| **Frost Veil** | Ice shards, glass veil shield, counter-spin frost ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**Creator Store / Studio import** (`modelRef.studioModelName`): Nova Striker, Iron Shell, Blaze Fang, Frost Veil  
**Procedural only:** Volt Dash, Shadow Bite
...
3. Place under `ReplicatedStorage/NovaBladers/Models/` with matching name:
   - `NovaStriker`, `IronShell`, `BlazeFang`, `FrostVeil`
