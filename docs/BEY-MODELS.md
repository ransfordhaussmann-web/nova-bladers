...
| **Crimson Vortex** | Spiral attack blades, counter-rotating vortex rings |
| **Glacier Mantle** | Ice shell plates, frost spikes, heavy frost aura |
...
`BeyCatalog.modelRef.studioModelName` selects the folder; procedural layers are the fallback.
