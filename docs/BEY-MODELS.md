...
| **Crimson Fang** | Sawtooth fang ring, blood-red neon spin layer |
| **Aurora Crest** | Crystalline crest petals, prism shield dome |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Optional **Creator Store / Studio imports** via `modelRef.studioModelName` (Nova Striker, Crimson Fang, Aurora Crest).
