...
| **Ember Crown** | Flame crown spikes, orange fire ring, glass tip |
| **Crystal Tide** | Crystal facets, glass tide ring, outer wave glow |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

### Creator Store import (Ember Crown, Crystal Tide)
...
| `EmberCrown` | Ember Crown |
| `CrystalTide` | Crystal Tide |

Procedural fallback is used when no Studio model is present.
