...
| **Crimson Fang** | 4 ripper blades, red blood ring, aggressive attack profile |
| **Aurora Crest** | Ice crest segments, frost aura, glass outer crest |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Studio-Import optional für **Nova Striker**, **Crimson Fang**, **Aurora Crest** — siehe `Models/README.md`.
