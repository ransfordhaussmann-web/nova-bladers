...
| **Crimson Fang** | 4 red fang blades, crimson spin ring, aggressive attack look |
| **Neon Pulse** | Dual neon rings (cyan/magenta), pulse dots, stamina style |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store** models via `modelRef.studioModelName` — place imported models under `ReplicatedStorage/NovaBladers/Models/<Name>`.
