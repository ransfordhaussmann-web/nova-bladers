...
| **Crimson Fang** | Four fang blades, red neon ring, aggressive attack profile |
| **Frost Crown** | Ice crown spikes, glass frost ring, counter-rotating outer layer |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**6 Beys total** — each supports optional Creator Store `modelAssets.meshId` or Studio import via `modelRef.studioModelName`.
