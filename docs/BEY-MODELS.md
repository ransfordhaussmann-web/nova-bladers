...
| **Crimson Fang** | 4 sharp fang blades, red neon edges, glass tip |
| **Glacier Orb** | Ice crystal segments, frost ring, glowing orb core |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `CrimsonFang`, `GlacierOrb`)
