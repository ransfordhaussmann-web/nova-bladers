...
| **Crimson Vortex** | Spiral attack blades, crimson vortex ring, glass tip |
| **Glacier Mantle** | Icy shell segments, frost shield, ice bumper ring |
...
Procedural layers are used as fallback when no Studio model is found.
