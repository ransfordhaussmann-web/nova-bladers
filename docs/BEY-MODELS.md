...
| **Crimson Edge** | 4 crimson blades, flame ring, glass tip (Creator Store `modelAssets` ready) |
| **Aqua Spiral** | Wave segments, water ring, droplet core (Creator Store `modelAssets` ready) |
