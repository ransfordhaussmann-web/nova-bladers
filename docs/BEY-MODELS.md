...
| **Crimson Fang** | 4 fang blades, blood-red spin ring, aggressive attack profile |
| **Frost Crown** | Ice crown spikes, glass frost ring, slow outer ice layer |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional Creator Store / Studio imports via `modelRef.studioModelName` or `modelAssets.meshId`.
