...
| **Blaze Quill** | Ember core, 4 flame quills, fast orange spin ring |
| **Tide Anchor** | Wave segments, dual anchor hooks, tidal shield ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**Blaze Quill** and **Tide Anchor** ship with procedural 3D models and optional `modelAssets.meshId` slots for Creator Store meshes.
