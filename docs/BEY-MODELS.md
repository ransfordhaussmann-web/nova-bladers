...
| **Crimson Fang** | 4 flame blades, crimson spin ring, attack-focused core |
| **Frost Anchor** | Ice shell segments, crystal spikes, glass frost shield |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

### Creator Store import slots

**Crimson Fang** and **Frost Anchor** ship with procedural 3D models and optional import hooks:

| Bey | Studio folder | `modelAssets.meshId` |
|-----|---------------|----------------------|
| Crimson Fang | `Models/CrimsonFang` | Uncomment in `BeyCatalog.lua` |
| Frost Anchor | `Models/FrostAnchor` | Uncomment in `BeyCatalog.lua` |
