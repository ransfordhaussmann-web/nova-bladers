...
| **Blaze Orbit** | Flame petals, ember ring, fast orange spin layers |
| **Crystal Bloom** | Glass crystal facets, frost shield, slow counter-spin |
...
|-----|---------------------|----------|
| Nova Striker | `Models/NovaStriker` | Procedural attack blades |
| Blaze Orbit | `Models/BlazeOrbit` | Procedural flame petals |
| Crystal Bloom | `Models/CrystalBloom` | Procedural crystal facets |
