...
| **Crimson Edge** | Flame blades, heat ring, aggressive red-orange spin |
| **Frost Core** | Ice shell segments, frost aura, crystal core |
...
3. Search: `spinning top`, `metal top`, `arena spinner` (avoid trademarked names)
