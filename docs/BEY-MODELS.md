...
| **Crimson Edge** | Flame blades, ember ring, hot spin glow |
| **Frost Core** | Ice shell segments, frost aura, crystal shards |
...
Procedural layers are used when no Studio model folder exists.
