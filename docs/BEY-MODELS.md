...
| **Blaze Vortex** | Flame wings, counter-rotating vortex glow, orange attack ring |
...
Each bey in `BeyCatalog.lua` has `modelRef.studioModelName`. After importing a Creator Store mesh in Studio:
