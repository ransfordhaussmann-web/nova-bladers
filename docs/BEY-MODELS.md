...
| **Crimson Edge** | Flame blades, orange energy ring, fast spin layers |
| **Frost Core** | Ice crystal segments, glass frost shield, slow heavy spin |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Each bey has a `modelRef.studioModelName` for optional Studio import under `ReplicatedStorage/NovaBladers/Models/<Name>`.
