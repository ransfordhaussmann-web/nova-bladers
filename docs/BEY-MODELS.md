...
| **Crimson Fang** | Twin fang blades, heat ring, fast red spin layer |
| **Frost Crown** | Ice crown spikes, glass frost shield, slow outer rim |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

### Creator Store import slots

| Studio model folder | Bey | Notes |
|---------------------|-----|-------|
| `Models/NovaStriker` | Nova Striker | Sketchfab import (see `docs/SKETCHFAB-NOVA-STRIKER.md`) |
| `Models/IronShell` | Iron Shell | Insert Creator Store mesh in Studio |
| `Models/CrimsonFang` | Crimson Fang | Set `modelAssets.meshId` or import model |
| `Models/FrostCrown` | Frost Crown | Set `modelAssets.meshId` or import model |
