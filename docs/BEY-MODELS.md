...
| **Crimson Vortex** | Spiral vortex blades, crimson neon ring, fast spin |
| **Frost Crown** | Ice crown spikes, glass frost ring, slow heavy spin |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store** imports via `Models/` folder (see `Models/README.md`).
