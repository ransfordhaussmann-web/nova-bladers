...
| **Crimson Edge** | Spiral flame blades, heat ring, crimson attack profile |
| **Frost Core** | Ice crystal facets, glass shell, frost aura |
...
5. Set `modelRef.studioModelName` in `BeyCatalog.lua` to match folder name

Supported `studioModelName` folders: `NovaStriker`, `IronShell`, `VoltDash`, `ShadowBite`, `CrimsonEdge`, `FrostCore`
