...
| **Crimson Fang** | 4 crimson attack blades, red neon rip ring |
| **Granite Fort** | Stone rampart segments, heavy concrete shell |
| **Solar Drift** | Triple sun rings, golden rays, stamina glow |
| **Phantom Edge** | Force-field mirage halo, twin phantom edges |
