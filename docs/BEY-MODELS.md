...
| **Blaze Comet** | Comet tail fins, orange flame ring, fast spin glow |
| **Frost Crown** | Ice crown spikes, frost shield ring, crystal tip |
...
```lua
modelRef = { studioModelName = "BlazeComet" },  -- Studio folder name
modelAssets = {
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<studioModelName>`
   (e.g. `NovaStriker`, `BlazeComet`, `FrostCrown`)
