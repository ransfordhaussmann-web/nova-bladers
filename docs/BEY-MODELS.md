...
| **Crimson Fang** | 4 spinning fang blades, crimson neon edges |
| **Granite Fort** | Concrete ramparts, heavy stone segments, slow spin |
| **Solar Drift** | Sun disc, radiating rays, warm flare glow |
| **Phantom Edge** | Glass core, ghost ring counter-spin, edge shards |
