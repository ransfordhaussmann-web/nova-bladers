...
| **Crimson Fang** | 4 fang blades, crimson rage ring, aggressive attack profile |
| **Frost Crown** | Ice crystal spikes, glass crown ring, slow frost aura |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

New beys include `modelRef.studioModelName` for Studio imports and optional `modelAssets.meshId` for Creator Store meshes.
