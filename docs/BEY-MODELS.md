...
| **Tide Anchor** | Heavy anchor core, glass wave segments, blue shield |
| **Crimson Fang** | Triple crimson fangs, blood-red energy ring |
| **Granite Fort** | Stone blocks, brick rampart ring, slow heavy spin |
| **Solar Drift** | Sun disc with rays, golden flare ring |
| **Phantom Edge** | Ghost blades, force-field aura, translucent core |
