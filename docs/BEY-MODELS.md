...
| **Crystal Fang** | Glass core, 4 crystal shards, prism ring |
| **Granite Crush** | Heavy rock segments, concrete crush plate |
| **Ember Orbit** | Ember ring, flame accents, outer flare |
...
```lua
modelRef = {
    studioModelName = "CrystalFang",  -- name in Models folder
    targetSize = 3.5,
},
-- OR use meshId directly:
modelAssets = {
