...
| **Crimson Fang** | Red fang blades, ember ring, inferno spin layer |
| **Frost Crown** | Ice crown spikes, glass frost shell, slow spin ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Creator Store models: import into `Models/` as **CrimsonFang** / **FrostCrown**, or set `modelAssets.meshId` in `BeyCatalog.lua`.
