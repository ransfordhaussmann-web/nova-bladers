...
| **Blaze Orbit** | Flame ring, comet tails, ember outer glow |
| **Frost Crown** | Ice shell segments, crown spikes, frost aura |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Special moves for all 6: Nova Meteor Shower, Iron Vault Lock, Volt Sonic Tempest, Shadow Eclipse Fang, Blaze Comet Loop, Frost Crown Lock.
