...
| **Crimson Fang** | Four curved fangs, crimson blood ring, dark metal core |
| **Frost Halo** | Ice crystal segments, glass frost halo, crystal tip |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**Crimson Fang** and **Frost Halo** ship with procedural models and optional `modelAssets.meshId` slots for Creator Store meshes. Studio imports go under `Models/CrimsonFang` and `Models/FrostHalo`.
