...
| **Crimson Fang** | Four sharp fang blades, crimson blood ring, dark metal core |
| **Frost Crown** | Ice crown spikes, frost ring segments, crystal aura |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**Crimson Fang** and **Frost Crown** ship with procedural models and optional `modelAssets.meshId` slots for Creator Store meshes. All six Beys have `modelRef.studioModelName` for Studio import under `Models/<BeyId>`.
