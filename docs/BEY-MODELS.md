...
| **Crystal Tide** | Glass core, crystal shards, slow tide ring (Creator Store ready) |
| **Ember Core** | Magma glow, flame spikes, fast spin ring (Creator Store ready) |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `CrystalTide`, `EmberCore`)
