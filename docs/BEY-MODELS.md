...
| **Crimson Fang** | 4 fire fangs, ember ring, aggressive attack blades |
| **Frost Crown** | Ice spikes, glass crown ring, slow heavy spin |
| **Solar Coil** | Helix coil arms, wide stamina ring, fast outer glow |
| **Blaze Quill** | 5 feather quills, flame ring, wood core |
| **Tide Anchor** | Anchor core, wave segments, tidal glass ring |
