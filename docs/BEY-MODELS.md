...
| **Crimson Ripper** | 4 red attack claws, crimson spin ring |
| **Frost Ward** | Ice crystal segments, frost shield ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store / imported meshes** via `modelRef.studioModelName` (place model under `ReplicatedStorage/NovaBladers/Models/<id>`) or `modelAssets.meshId`.
