...
| **Crimson Fang** | Twin fang blades, heat ring, glass tip (Creator Store ready) |
| **Glacier Core** | Ice shell segments, frost shield, glass bumper (Creator Store ready) |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/NovaStriker` (or `CrimsonFang`, `GlacierCore`)
