...
| **Crimson Edge** | 4 slash blades, crimson neon edges, fast spin ring |
| **Frost Halo** | Ice shell segments, glass frost halo, crystal core |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All **6 beys** have `modelRef.studioModelName` for optional Studio imports under `ReplicatedStorage/NovaBladers/Models/`.
