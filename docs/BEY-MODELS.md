...
| **Crimson Ember** | Flame ring, 4 fire spikes, ember core glow |
| **Frost Gyre** | Ice shell segments, frost shield, crystal accents |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**6 Beys** total — last two support optional Creator Store / Studio imports via `modelRef` and `modelAssets`.
