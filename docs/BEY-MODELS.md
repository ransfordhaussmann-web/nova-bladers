...
| **Crimson Edge** | Flame blades, heat ring, ember glow |
| **Frost Halo** | Ice crystals, frost ring, counter-rotating halo |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

All 6 beys support optional **Creator Store** models via `modelRef.studioModelName` — see `src/ReplicatedStorage/NovaBladers/Models/README.md`.
