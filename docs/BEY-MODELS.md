...
| **Crimson Fang** | Cross blades, red neon edges, fang tip |
| **Frost Core** | Ice crystal shards, frost ring, glass outer shell |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/` with matching name:
   - `NovaStriker`, `IronShell`, `CrimsonFang`, `FrostCore`
