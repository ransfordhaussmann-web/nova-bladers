...
| **Crimson Vortex** | Flame blades, ember ring, fast outer fire glow |
| **Frost Prism** | Crystal facets, glass shield ring, diamond outer shell |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `CrimsonVortex`, `FrostPrism`)
