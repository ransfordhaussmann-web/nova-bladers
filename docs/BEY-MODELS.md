...
| **Blaze Comet** | Comet fins, fire tail streaks, orange heat glow |
| **Crystal Tide** | Glass core, crystal shards, wide tide ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**Creator-Store-ready:** Blaze Comet and Crystal Tide ship with `modelAssets` + `modelRef.studioModelName` — paste a Toolbox mesh ID or import a model into `Models/`.
