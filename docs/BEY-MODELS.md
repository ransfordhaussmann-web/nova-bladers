...
| **Crimson Edge** | 4 typhoon blades, crimson spin ring, aggressive attack profile |
| **Frost Halo** | Ice shell segments, glass halo ring, frost crystal core |

All 6 beys support optional Creator Store meshes via `modelRef` (Studio import) or `modelAssets.meshId` (Toolbox).
