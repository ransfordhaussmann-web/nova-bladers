...
| **Crimson Fang** | Twin fang blades, crimson blood ring, fast attack spin |
| **Frost Halo** | Ice crown icicles, frost ring, halo glow |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

### Creator Store import slots

| Bey | Studio folder (`Models/`) | `modelAssets.meshId` |
|-----|---------------------------|----------------------|
| Nova Striker | `NovaStriker` | optional |
| Crimson Fang | `CrimsonFang` | optional (comment in catalog) |
| Frost Halo | `FrostHalo` | optional (comment in catalog) |
