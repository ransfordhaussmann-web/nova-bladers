...
| **Crimson Ripper** | Heat ring, four ripper fangs, ember glow |
| **Glacier Halo** | Ice segments, frost shield, crystal counter-ring |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<studioModelName>` (see `BeyCatalog.modelRef.studioModelName`)
