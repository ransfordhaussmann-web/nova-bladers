...
| **Crimson Fang** | 4 sharp fangs, crimson spin ring, glass tip |
| **Frost Crown** | Ice crown spikes, glass shield, frost bumper ring |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

Each bey has a `modelRef.studioModelName` — import Creator Store meshes to `ReplicatedStorage/NovaBladers/Models/<Name>` to replace procedural visuals.
