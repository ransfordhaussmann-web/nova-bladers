...
| **Blaze Drift** | Flame blades, ember ring, orange heat glow |
...
5. Place under `ReplicatedStorage/NovaBladers/Models/<studioModelName>`
   (e.g. `BlazeDrift`, `FrostCrown` — see `BeyCatalog.modelRef.studioModelName`)
