...
| **Crimson Fang** | Four fang blades, crimson energy ring, aggressive spin |
| **Frost Ring** | Ice shell segments, glass frost aura, slow outer ring |
...
3. Place under `ReplicatedStorage/NovaBladers/Models/<BeyId>` (e.g. `IronShell`, `CrimsonFang`)
