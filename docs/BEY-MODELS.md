...
| **Crimson Fang** | 4 fang blades, crimson spin ring, glass tip |
| **Frost Ward** | Ice shell segments, frost crystal, slow outer frost ring |
...
### Studio Models folder (recommended for Creator Store imports)
