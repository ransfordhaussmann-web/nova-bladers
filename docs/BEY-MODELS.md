...
| **Crimson Fang** | Flame ring, 4 neon claws, ember core (Attack) |
| **Frost Crown** | Ice spikes, glass crown ring, frost plate (Defense) |

Layers **spin visually** while the bey moves (RPM affects spin speed + ring opacity).

**Crimson Fang** and **Frost Crown** ship with procedural models and optional `modelAssets.meshId` slots for Creator Store meshes (see below).
