...
- [x] 6 Beys (inkl. Frost Fang, Blaze Crown + Creator-Store-Hooks)
...
- [x] Eigene Special-Moves pro Bey (Starfall Rush, Shell Guard, Thunder Loop, Night Fang, Glacier Shatter, Solar Flare Ring)
- [x] GameManager + Bey-Physik (Match-Flow, Arena, Training/1v1/FFA)
- [x] Mehr Creator-Store-Beys (Frost Fang, Blaze Crown — procedural + modelRef/modelAssets)
- [ ] Matchmaking-Queue
