...
- [x] 6 Beys (inkl. Frost Prism, Ember Core)
...
- [x] Eigene Special-Moves pro Bey (Starfall Rush, Shell Guard, Thunder Loop, Night Fang, Glacier Shard Storm, Inferno Spiral)
- [x] GameManager + Bey-Physik (Match-Flow, Arena, Training/1v1/FFA)
- [x] Mehr Creator-Store-Beys (Frost Prism, Ember Core mit modelRef)
- [ ] Matchmaking-Queue
