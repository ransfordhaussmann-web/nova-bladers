...
- [x] 6 Beys (Crimson Fang, Frost Halo)
...
- [x] Eigene Special-Moves pro Bey (Starfall Rush, Shell Guard, Thunder Loop, Night Fang, Crimson Razor Flurry, Frost Halo Lock)
- [x] GameManager + Bey-Physik (Match-Flow, Arena, Training/1v1/FFA)
- [x] Mehr Creator-Store-Beys (Crimson Fang, Frost Halo + modelRef für Studio-Import)
- [ ] Matchmaking-Queue
