...
- [x] 6 Beys (inkl. Crimson Fang, Frost Core)
...
- [x] Eigene Special-Moves pro Bey (Starfall Rush, Shell Guard, Thunder Loop, Night Fang, Crimson Cross Slash, Frost Crystal Bastion)
- [x] GameManager + Bey-Physik (Match-Flow, Arena, Training/1v1/FFA)
- [x] Mehr Creator-Store-Beys (Crimson Fang, Frost Core + modelRef für Iron Shell)
- [ ] Matchmaking-Queue
