...
- [x] 6 Beys (Crimson Edge, Frost Core + Creator-Store-Hooks)
...
- [x] Eigene Special-Moves pro Bey (Starfall Rush, Shell Guard, Thunder Loop, Night Fang, Blaze Spiral, Glacier Aegis)
- [x] GameManager + Bey-Physik (Match-Flow, Arena, Training/1v1/FFA)
- [x] Mehr Creator-Store-Beys (Crimson Edge, Frost Core + Studio-Import-Hooks)
- [ ] Matchmaking-Queue
