...
- [x] 6 Beys (inkl. Blaze Comet, Frost Crown)
...
- [x] Eigene Special-Moves pro Bey (Starfall Rush, Shell Guard, Thunder Loop, Night Fang, Comet Flare, Glacier Bastion)
- [x] GameManager + Bey-Physik (Match-Flow, Arena, Training/1v1/FFA)
- [x] Mehr Creator-Store-Beys (6 Beys mit modelRef + Studio-Import-Hooks)
- [ ] Matchmaking-Queue
